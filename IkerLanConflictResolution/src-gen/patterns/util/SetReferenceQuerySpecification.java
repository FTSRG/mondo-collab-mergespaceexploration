...
public final class SetReferenceQuerySpecification extends BaseGeneratedQuerySpecification<SetReferenceMatcher> {
  ...
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("setRefOp", "DseMergeDiffModel.SetReference"),new PParameter("target", "wtspecid.IdentifiableWTElement"),new PParameter("ref", "wtspecid.IdentifiableWTElement"));
  }
  ...
  public SetReferenceMatch newMatch(final Object... parameters) {
    return SetReferenceMatch.newMatch((DseMergeDiffModel.SetReference) parameters[0], (wtspecid.IdentifiableWTElement) parameters[1], (wtspecid.IdentifiableWTElement) parameters[2]);
  }
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeBinary(body, CONTEXT, var_setRefOp, var_id, getFeatureLiteral("http://dsemerge.diffmodel/1.0", "Identifiable", "targetID"), "http://dsemerge.diffmodel/1.0/Identifiable.targetID");
      ...
      new TypeBinary(body, CONTEXT, var_setRefOp, var_id2, getFeatureLiteral("http://dsemerge.diffmodel/1.0", "SetReference", "refID"), "http://dsemerge.diffmodel/1.0/SetReference.refID");
      bodies.add(body);
    }
    return bodies;
  }

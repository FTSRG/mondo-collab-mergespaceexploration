...
public final class ResetReferenceQuerySpecification extends BaseGeneratedQuerySpecification<ResetReferenceMatcher> {
  ...
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("resetRefOp", "DseMergeDiffModel.ResetReference"),new PParameter("target", "wtspecid.IdentifiableWTElement"),new PParameter("ref", "wtspecid.IdentifiableWTElement"));
  }
  ...
  public ResetReferenceMatch newMatch(final Object... parameters) {
    return ResetReferenceMatch.newMatch((DseMergeDiffModel.ResetReference) parameters[0], (wtspecid.IdentifiableWTElement) parameters[1], (wtspecid.IdentifiableWTElement) parameters[2]);
  }
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeBinary(body, CONTEXT, var_resetRefOp, var_id, getFeatureLiteral("http://dsemerge.diffmodel/1.0", "Identifiable", "targetID"), "http://dsemerge.diffmodel/1.0/Identifiable.targetID");
      new TypeBinary(body, CONTEXT, var_ref, var_id2, getFeatureLiteral("http://dsemergewtspecid/1.0", "IdentifiableWTElement", "ID"), "http://dsemergewtspecid/1.0/IdentifiableWTElement.ID");
      new TypeBinary(body, CONTEXT, var_resetRefOp, var_id2, getFeatureLiteral("http://dsemerge.diffmodel/1.0", "ResetReference", "refID"), "http://dsemerge.diffmodel/1.0/ResetReference.refID");
      bodies.add(body);
    }
    return bodies;
  }

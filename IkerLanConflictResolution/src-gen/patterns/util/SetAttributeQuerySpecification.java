...
public final class SetAttributeQuerySpecification extends BaseGeneratedQuerySpecification<SetAttributeMatcher> {
  ...
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("setAttrOp", "DseMergeDiffModel.SetAttribute"),new PParameter("target", "wtspecid.IdentifiableWTElement"));
  }
  ...
  public SetAttributeMatch newMatch(final Object... parameters) {
    return SetAttributeMatch.newMatch((DseMergeDiffModel.SetAttribute) parameters[0], (wtspecid.IdentifiableWTElement) parameters[1]);
  }
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeUnary(body, var_setAttrOp, getClassifierLiteral("http://dsemerge.diffmodel/1.0", "SetAttribute"), "http://dsemerge.diffmodel/1.0/SetAttribute");
      new TypeBinary(body, CONTEXT, var_setAttrOp, var_id, getFeatureLiteral("http://dsemerge.diffmodel/1.0", "Identifiable", "targetID"), "http://dsemerge.diffmodel/1.0/Identifiable.targetID");
      bodies.add(body);
    }
    return bodies;
  }

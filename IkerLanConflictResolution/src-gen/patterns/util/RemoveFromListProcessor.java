...
public abstract class RemoveFromListProcessor implements IMatchProcessor<RemoveFromListMatch> {
   ...
   * 
   */
  public abstract void process(final RemoveFromList pRemoveFromListOp, final IdentifiableWTElement pTarget);
  
  @Override
  public void process(final RemoveFromListMatch match) {
    process(match.getRemoveFromListOp(), match.getTarget());

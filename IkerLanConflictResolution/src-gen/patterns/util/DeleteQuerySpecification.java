...
public final class DeleteQuerySpecification extends BaseGeneratedQuerySpecification<DeleteMatcher> {
  ...
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("deleteOp", "DseMergeDiffModel.Delete"),new PParameter("target", "wtspecid.IdentifiableWTElement"));
  }
  ...
  public DeleteMatch newMatch(final Object... parameters) {
    return DeleteMatch.newMatch((DseMergeDiffModel.Delete) parameters[0], (wtspecid.IdentifiableWTElement) parameters[1]);
  }

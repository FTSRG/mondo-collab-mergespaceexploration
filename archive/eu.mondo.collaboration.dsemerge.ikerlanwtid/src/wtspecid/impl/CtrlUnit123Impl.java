 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit123Impl#getInput__iUpperStatus <em>Input iUpper Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit123Impl#getInput__iLowerStatus <em>Input iLower Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit123Impl#getOutput__oBrakeStatus <em>Output oBrake Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit123Impl extends wtcImpl implements CtrlUnit123 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit123();
	}
		...
		if (input__iUpperStatus != null && input__iUpperStatus.eIsProxy()) {
			...
			if (input__iUpperStatus != oldInput__iUpperStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT123__INPUT_IUPPER_STATUS, oldInput__iUpperStatus, input__iUpperStatus));
			}
		}
	...
	public void setInput__iUpperStatus(WTCInput newInput__iUpperStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT123__INPUT_IUPPER_STATUS, oldInput__iUpperStatus, input__iUpperStatus));
	}
	...
	public WTCInput getInput__iLowerStatus() {
		if (input__iLowerStatus != null && input__iLowerStatus.eIsProxy()) {
			...
			if (input__iLowerStatus != oldInput__iLowerStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT123__INPUT_ILOWER_STATUS, oldInput__iLowerStatus, input__iLowerStatus));
			}
		}
	...
	public void setInput__iLowerStatus(WTCInput newInput__iLowerStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT123__INPUT_ILOWER_STATUS, oldInput__iLowerStatus, input__iLowerStatus));
	}
	...
	public WTCOutput getOutput__oBrakeStatus() {
		if (output__oBrakeStatus != null && output__oBrakeStatus.eIsProxy()) {
			...
			if (output__oBrakeStatus != oldOutput__oBrakeStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT123__OUTPUT_OBRAKE_STATUS, oldOutput__oBrakeStatus, output__oBrakeStatus));
			}
		}
	...
	public void setOutput__oBrakeStatus(WTCOutput newOutput__oBrakeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT123__OUTPUT_OBRAKE_STATUS, oldOutput__oBrakeStatus, output__oBrakeStatus));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT123__INPUT_IUPPER_STATUS:
				if (resolve) return getInput__iUpperStatus();
				return basicGetInput__iUpperStatus();
			case WtspecidPackage.CTRL_UNIT123__INPUT_ILOWER_STATUS:
				if (resolve) return getInput__iLowerStatus();
				return basicGetInput__iLowerStatus();
			case WtspecidPackage.CTRL_UNIT123__OUTPUT_OBRAKE_STATUS:

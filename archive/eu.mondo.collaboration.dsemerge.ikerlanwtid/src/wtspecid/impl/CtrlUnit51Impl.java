 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit51Impl#getParameter__pHour <em>Parameter pHour</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit51Impl#getFault__fFault <em>Fault fFault</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit51Impl extends wtcImpl implements CtrlUnit51 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit51();
	}
		...
		if (parameter__pHour != null && parameter__pHour.eIsProxy()) {
			...
			if (parameter__pHour != oldParameter__pHour) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT51__PARAMETER_PHOUR, oldParameter__pHour, parameter__pHour));
			}
		}
	...
	public void setParameter__pHour(WTCParam newParameter__pHour) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT51__PARAMETER_PHOUR, oldParameter__pHour, parameter__pHour));
	}
	...
	public WTCFault getFault__fFault() {
		if (fault__fFault != null && fault__fFault.eIsProxy()) {
			...
			if (fault__fFault != oldFault__fFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT51__FAULT_FFAULT, oldFault__fFault, fault__fFault));
			}
		}
	...
	public void setFault__fFault(WTCFault newFault__fFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT51__FAULT_FFAULT, oldFault__fFault, fault__fFault));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT51__PARAMETER_PHOUR:
				if (resolve) return getParameter__pHour();
				return basicGetParameter__pHour();
			case WtspecidPackage.CTRL_UNIT51__FAULT_FFAULT:

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit35Impl#getInput__iFeedback <em>Input iFeedback</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit35Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit35Impl#getFault__fFaultOn <em>Fault fFault On</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit35Impl#getFault__fFaultOff <em>Fault fFault Off</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit35Impl#getTimer__tDelayOn <em>Timer tDelay On</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit35Impl#getTimer__tDelayOff <em>Timer tDelay Off</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit35Impl#getBhvParam__bpLogicType <em>Bhv Param bp Logic Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit35Impl extends wtcImpl implements CtrlUnit35 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit35();
	}
		...
		if (input__iFeedback != null && input__iFeedback.eIsProxy()) {
			...
			if (input__iFeedback != oldInput__iFeedback) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT35__INPUT_IFEEDBACK, oldInput__iFeedback, input__iFeedback));
			}
		}
	...
	public void setInput__iFeedback(WTCInput newInput__iFeedback) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT35__INPUT_IFEEDBACK, oldInput__iFeedback, input__iFeedback));
	}
	...
	public WTCOutput getOutput__oOutput() {
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT35__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT35__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public WTCFault getFault__fFaultOn() {
		if (fault__fFaultOn != null && fault__fFaultOn.eIsProxy()) {
			...
			if (fault__fFaultOn != oldFault__fFaultOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT35__FAULT_FFAULT_ON, oldFault__fFaultOn, fault__fFaultOn));
			}
		}
	...
	public void setFault__fFaultOn(WTCFault newFault__fFaultOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT35__FAULT_FFAULT_ON, oldFault__fFaultOn, fault__fFaultOn));
	}
	...
	public WTCFault getFault__fFaultOff() {
		if (fault__fFaultOff != null && fault__fFaultOff.eIsProxy()) {
			...
			if (fault__fFaultOff != oldFault__fFaultOff) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT35__FAULT_FFAULT_OFF, oldFault__fFaultOff, fault__fFaultOff));
			}
		}
	...
	public void setFault__fFaultOff(WTCFault newFault__fFaultOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT35__FAULT_FFAULT_OFF, oldFault__fFaultOff, fault__fFaultOff));
	}
	...
	public WTCTimer getTimer__tDelayOn() {
		if (timer__tDelayOn != null && timer__tDelayOn.eIsProxy()) {
			...
			if (timer__tDelayOn != oldTimer__tDelayOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT35__TIMER_TDELAY_ON, oldTimer__tDelayOn, timer__tDelayOn));
			}
		}
	...
	public void setTimer__tDelayOn(WTCTimer newTimer__tDelayOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT35__TIMER_TDELAY_ON, oldTimer__tDelayOn, timer__tDelayOn));
	}
	...
	public WTCTimer getTimer__tDelayOff() {
		if (timer__tDelayOff != null && timer__tDelayOff.eIsProxy()) {
			...
			if (timer__tDelayOff != oldTimer__tDelayOff) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT35__TIMER_TDELAY_OFF, oldTimer__tDelayOff, timer__tDelayOff));
			}
		}
	...
	public void setTimer__tDelayOff(WTCTimer newTimer__tDelayOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT35__TIMER_TDELAY_OFF, oldTimer__tDelayOff, timer__tDelayOff));
	}
	...
	public void setBhvParam__bpLogicType(String newBhvParam__bpLogicType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT35__BHV_PARAM_BP_LOGIC_TYPE, oldBhvParam__bpLogicType, bhvParam__bpLogicType));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.SubsystemImpl#getSysId <em>Sys Id</em>}</li>
 *   <li>{@link wtspecid.impl.SubsystemImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link wtspecid.impl.SubsystemImpl#getItsWTCs <em>Its WT Cs</em>}</li>
 *   <li>{@link wtspecid.impl.SubsystemImpl#getItsSubsystems <em>Its Subsystems</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SubsystemImpl extends IdentifiableWTElementImpl implements Subsystem {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getSubsystem();
	}
	...
	public void setSysId(String newSysId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.SUBSYSTEM__SYS_ID, oldSysId, sysId));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.SUBSYSTEM__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<wtc> getItsWTCs() {
		if (itsWTCs == null) {
			itsWTCs = new EObjectContainmentEList<wtc>(wtc.class, this, WtspecidPackage.SUBSYSTEM__ITS_WT_CS);
		}
		return itsWTCs;
	}
	...
	public EList<Subsystem> getItsSubsystems() {
		if (itsSubsystems == null) {
			itsSubsystems = new EObjectContainmentEList<Subsystem>(Subsystem.class, this, WtspecidPackage.SUBSYSTEM__ITS_SUBSYSTEMS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WtspecidPackage.SUBSYSTEM__ITS_WT_CS:
				return ((InternalEList<?>)getItsWTCs()).basicRemove(otherEnd, msgs);
			case WtspecidPackage.SUBSYSTEM__ITS_SUBSYSTEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.SUBSYSTEM__SYS_ID:
				return getSysId();
			case WtspecidPackage.SUBSYSTEM__DESCRIPTION:

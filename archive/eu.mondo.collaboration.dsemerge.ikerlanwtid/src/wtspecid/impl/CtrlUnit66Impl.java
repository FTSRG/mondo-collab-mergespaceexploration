 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit66Impl#getInput__iMaintenancePreventiveButton <em>Input iMaintenance Preventive Button</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit66Impl#getInput__iMaintenanceCorrectiveButton <em>Input iMaintenance Corrective Button</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit66Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit66Impl#getOutput__oMaintenanceStatus <em>Output oMaintenance Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit66Impl#getFault__fMaintenancePreventive <em>Fault fMaintenance Preventive</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit66Impl#getFault__fMaintenanceCorrective <em>Fault fMaintenance Corrective</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit66Impl extends wtcImpl implements CtrlUnit66 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit66();
	}
		...
		if (input__iMaintenancePreventiveButton != null && input__iMaintenancePreventiveButton.eIsProxy()) {
			...
			if (input__iMaintenancePreventiveButton != oldInput__iMaintenancePreventiveButton) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT66__INPUT_IMAINTENANCE_PREVENTIVE_BUTTON, oldInput__iMaintenancePreventiveButton, input__iMaintenancePreventiveButton));
			}
		}
	...
	public void setInput__iMaintenancePreventiveButton(WTCInput newInput__iMaintenancePreventiveButton) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT66__INPUT_IMAINTENANCE_PREVENTIVE_BUTTON, oldInput__iMaintenancePreventiveButton, input__iMaintenancePreventiveButton));
	}
	...
	public WTCInput getInput__iMaintenanceCorrectiveButton() {
		if (input__iMaintenanceCorrectiveButton != null && input__iMaintenanceCorrectiveButton.eIsProxy()) {
			...
			if (input__iMaintenanceCorrectiveButton != oldInput__iMaintenanceCorrectiveButton) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT66__INPUT_IMAINTENANCE_CORRECTIVE_BUTTON, oldInput__iMaintenanceCorrectiveButton, input__iMaintenanceCorrectiveButton));
			}
		}
	...
	public void setInput__iMaintenanceCorrectiveButton(WTCInput newInput__iMaintenanceCorrectiveButton) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT66__INPUT_IMAINTENANCE_CORRECTIVE_BUTTON, oldInput__iMaintenanceCorrectiveButton, input__iMaintenanceCorrectiveButton));
	}
	...
	public WTCInput getInput__iDontCheckInput() {
		if (input__iDontCheckInput != null && input__iDontCheckInput.eIsProxy()) {
			...
			if (input__iDontCheckInput != oldInput__iDontCheckInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT66__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
			}
		}
	...
	public void setInput__iDontCheckInput(WTCInput newInput__iDontCheckInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT66__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
	}
	...
	public WTCOutput getOutput__oMaintenanceStatus() {
		if (output__oMaintenanceStatus != null && output__oMaintenanceStatus.eIsProxy()) {
			...
			if (output__oMaintenanceStatus != oldOutput__oMaintenanceStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT66__OUTPUT_OMAINTENANCE_STATUS, oldOutput__oMaintenanceStatus, output__oMaintenanceStatus));
			}
		}
	...
	public void setOutput__oMaintenanceStatus(WTCOutput newOutput__oMaintenanceStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT66__OUTPUT_OMAINTENANCE_STATUS, oldOutput__oMaintenanceStatus, output__oMaintenanceStatus));
	}
	...
	public WTCFault getFault__fMaintenancePreventive() {
		if (fault__fMaintenancePreventive != null && fault__fMaintenancePreventive.eIsProxy()) {
			...
			if (fault__fMaintenancePreventive != oldFault__fMaintenancePreventive) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT66__FAULT_FMAINTENANCE_PREVENTIVE, oldFault__fMaintenancePreventive, fault__fMaintenancePreventive));
			}
		}
	...
	public void setFault__fMaintenancePreventive(WTCFault newFault__fMaintenancePreventive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT66__FAULT_FMAINTENANCE_PREVENTIVE, oldFault__fMaintenancePreventive, fault__fMaintenancePreventive));
	}
	...
	public WTCFault getFault__fMaintenanceCorrective() {
		if (fault__fMaintenanceCorrective != null && fault__fMaintenanceCorrective.eIsProxy()) {
			...
			if (fault__fMaintenanceCorrective != oldFault__fMaintenanceCorrective) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT66__FAULT_FMAINTENANCE_CORRECTIVE, oldFault__fMaintenanceCorrective, fault__fMaintenanceCorrective));
			}
		}
	...
	public void setFault__fMaintenanceCorrective(WTCFault newFault__fMaintenanceCorrective) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT66__FAULT_FMAINTENANCE_CORRECTIVE, oldFault__fMaintenanceCorrective, fault__fMaintenanceCorrective));
	}

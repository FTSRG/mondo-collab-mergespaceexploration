 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getInput__iLowWindActive <em>Input iLow Wind Active</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getInput__iWindDirectionRelAvg <em>Input iWind Direction Rel Avg</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getInput__iInhibitAutoYaw <em>Input iInhibit Auto Yaw</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getOutput__oRelWindPreCommand <em>Output oRel Wind Pre Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getOutput__oFlagIntoWind <em>Output oFlag Into Wind</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getOutput__oExcessiveYawingTime <em>Output oExcessive Yawing Time</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getParameter__pWindDirectionTolerance <em>Parameter pWind Direction Tolerance</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getParameter__pYawFilterTime <em>Parameter pYaw Filter Time</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getParameter__pYawStopAngleLimit <em>Parameter pYaw Stop Angle Limit</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit127Impl#getTimer__tMaximumTimeYawing <em>Timer tMaximum Time Yawing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit127Impl extends wtcImpl implements CtrlUnit127 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit127();
	}
		...
		if (input__iLowWindActive != null && input__iLowWindActive.eIsProxy()) {
			...
			if (input__iLowWindActive != oldInput__iLowWindActive) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__INPUT_ILOW_WIND_ACTIVE, oldInput__iLowWindActive, input__iLowWindActive));
			}
		}
	...
	public void setInput__iLowWindActive(WTCInput newInput__iLowWindActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__INPUT_ILOW_WIND_ACTIVE, oldInput__iLowWindActive, input__iLowWindActive));
	}
	...
	public WTCInput getInput__iWindDirectionRelAvg() {
		if (input__iWindDirectionRelAvg != null && input__iWindDirectionRelAvg.eIsProxy()) {
			...
			if (input__iWindDirectionRelAvg != oldInput__iWindDirectionRelAvg) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__INPUT_IWIND_DIRECTION_REL_AVG, oldInput__iWindDirectionRelAvg, input__iWindDirectionRelAvg));
			}
		}
	...
	public void setInput__iWindDirectionRelAvg(WTCInput newInput__iWindDirectionRelAvg) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__INPUT_IWIND_DIRECTION_REL_AVG, oldInput__iWindDirectionRelAvg, input__iWindDirectionRelAvg));
	}
	...
	public WTCInput getInput__iTwistAngle() {
		if (input__iTwistAngle != null && input__iTwistAngle.eIsProxy()) {
			...
			if (input__iTwistAngle != oldInput__iTwistAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
			}
		}
	...
	public void setInput__iTwistAngle(WTCInput newInput__iTwistAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
	}
	...
	public WTCInput getInput__iInhibitAutoYaw() {
		if (input__iInhibitAutoYaw != null && input__iInhibitAutoYaw.eIsProxy()) {
			...
			if (input__iInhibitAutoYaw != oldInput__iInhibitAutoYaw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__INPUT_IINHIBIT_AUTO_YAW, oldInput__iInhibitAutoYaw, input__iInhibitAutoYaw));
			}
		}
	...
	public void setInput__iInhibitAutoYaw(WTCInput newInput__iInhibitAutoYaw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__INPUT_IINHIBIT_AUTO_YAW, oldInput__iInhibitAutoYaw, input__iInhibitAutoYaw));
	}
	...
	public WTCOutput getOutput__oRelWindPreCommand() {
		if (output__oRelWindPreCommand != null && output__oRelWindPreCommand.eIsProxy()) {
			...
			if (output__oRelWindPreCommand != oldOutput__oRelWindPreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__OUTPUT_OREL_WIND_PRE_COMMAND, oldOutput__oRelWindPreCommand, output__oRelWindPreCommand));
			}
		}
	...
	public void setOutput__oRelWindPreCommand(WTCOutput newOutput__oRelWindPreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__OUTPUT_OREL_WIND_PRE_COMMAND, oldOutput__oRelWindPreCommand, output__oRelWindPreCommand));
	}
	...
	public WTCOutput getOutput__oFlagIntoWind() {
		if (output__oFlagIntoWind != null && output__oFlagIntoWind.eIsProxy()) {
			...
			if (output__oFlagIntoWind != oldOutput__oFlagIntoWind) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__OUTPUT_OFLAG_INTO_WIND, oldOutput__oFlagIntoWind, output__oFlagIntoWind));
			}
		}
	...
	public void setOutput__oFlagIntoWind(WTCOutput newOutput__oFlagIntoWind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__OUTPUT_OFLAG_INTO_WIND, oldOutput__oFlagIntoWind, output__oFlagIntoWind));
	}
	...
	public WTCOutput getOutput__oExcessiveYawingTime() {
		if (output__oExcessiveYawingTime != null && output__oExcessiveYawingTime.eIsProxy()) {
			...
			if (output__oExcessiveYawingTime != oldOutput__oExcessiveYawingTime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__OUTPUT_OEXCESSIVE_YAWING_TIME, oldOutput__oExcessiveYawingTime, output__oExcessiveYawingTime));
			}
		}
	...
	public void setOutput__oExcessiveYawingTime(WTCOutput newOutput__oExcessiveYawingTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__OUTPUT_OEXCESSIVE_YAWING_TIME, oldOutput__oExcessiveYawingTime, output__oExcessiveYawingTime));
	}
	...
	public WTCParam getParameter__pWindDirectionTolerance() {
		if (parameter__pWindDirectionTolerance != null && parameter__pWindDirectionTolerance.eIsProxy()) {
			...
			if (parameter__pWindDirectionTolerance != oldParameter__pWindDirectionTolerance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__PARAMETER_PWIND_DIRECTION_TOLERANCE, oldParameter__pWindDirectionTolerance, parameter__pWindDirectionTolerance));
			}
		}
	...
	public void setParameter__pWindDirectionTolerance(WTCParam newParameter__pWindDirectionTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__PARAMETER_PWIND_DIRECTION_TOLERANCE, oldParameter__pWindDirectionTolerance, parameter__pWindDirectionTolerance));
	}
	...
	public WTCParam getParameter__pYawFilterTime() {
		if (parameter__pYawFilterTime != null && parameter__pYawFilterTime.eIsProxy()) {
			...
			if (parameter__pYawFilterTime != oldParameter__pYawFilterTime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__PARAMETER_PYAW_FILTER_TIME, oldParameter__pYawFilterTime, parameter__pYawFilterTime));
			}
		}
	...
	public void setParameter__pYawFilterTime(WTCParam newParameter__pYawFilterTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__PARAMETER_PYAW_FILTER_TIME, oldParameter__pYawFilterTime, parameter__pYawFilterTime));
	}
	...
	public WTCParam getParameter__pYawStopAngleLimit() {
		if (parameter__pYawStopAngleLimit != null && parameter__pYawStopAngleLimit.eIsProxy()) {
			...
			if (parameter__pYawStopAngleLimit != oldParameter__pYawStopAngleLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__PARAMETER_PYAW_STOP_ANGLE_LIMIT, oldParameter__pYawStopAngleLimit, parameter__pYawStopAngleLimit));
			}
		}
	...
	public void setParameter__pYawStopAngleLimit(WTCParam newParameter__pYawStopAngleLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__PARAMETER_PYAW_STOP_ANGLE_LIMIT, oldParameter__pYawStopAngleLimit, parameter__pYawStopAngleLimit));
	}
	...
	public WTCTimer getTimer__tMaximumTimeYawing() {
		if (timer__tMaximumTimeYawing != null && timer__tMaximumTimeYawing.eIsProxy()) {
			...
			if (timer__tMaximumTimeYawing != oldTimer__tMaximumTimeYawing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT127__TIMER_TMAXIMUM_TIME_YAWING, oldTimer__tMaximumTimeYawing, timer__tMaximumTimeYawing));
			}
		}
	...
	public void setTimer__tMaximumTimeYawing(WTCTimer newTimer__tMaximumTimeYawing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT127__TIMER_TMAXIMUM_TIME_YAWING, oldTimer__tMaximumTimeYawing, timer__tMaximumTimeYawing));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getInput__iInverterToOnOrder <em>Input iInverter To On Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getInput__iInverterReadyRef <em>Input iInverter Ready Ref</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getInput__iRemoteResetOrder <em>Input iRemote Reset Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getInput__iInverterTorqueReg <em>Input iInverter Torque Reg</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getInput__iInverterHwState <em>Input iInverter Hw State</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getInput__iResetOrder <em>Input iReset Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getInput__iMotorizing <em>Input iMotorizing</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getOutput__oInverterToOn <em>Output oInverter To On</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getOutput__oInverterResetCommand <em>Output oInverter Reset Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getOutput__oInverterTorqueRef <em>Output oInverter Torque Ref</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getOutput__oInverterResetAlarms <em>Output oInverter Reset Alarms</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getFault__fEtherCAT <em>Fault fEther CAT</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getTimer__tResetTime <em>Timer tReset Time</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getTimer__tDelayBetweenResets <em>Timer tDelay Between Resets</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit61Impl#getErrorReaction__erStop <em>Error Reaction er Stop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit61Impl extends wtcImpl implements CtrlUnit61 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit61();
	}
		...
		if (input__iInverterToOnOrder != null && input__iInverterToOnOrder.eIsProxy()) {
			...
			if (input__iInverterToOnOrder != oldInput__iInverterToOnOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__INPUT_IINVERTER_TO_ON_ORDER, oldInput__iInverterToOnOrder, input__iInverterToOnOrder));
			}
		}
	...
	public void setInput__iInverterToOnOrder(WTCInput newInput__iInverterToOnOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__INPUT_IINVERTER_TO_ON_ORDER, oldInput__iInverterToOnOrder, input__iInverterToOnOrder));
	}
	...
	public WTCInput getInput__iInverterReadyRef() {
		if (input__iInverterReadyRef != null && input__iInverterReadyRef.eIsProxy()) {
			...
			if (input__iInverterReadyRef != oldInput__iInverterReadyRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__INPUT_IINVERTER_READY_REF, oldInput__iInverterReadyRef, input__iInverterReadyRef));
			}
		}
	...
	public void setInput__iInverterReadyRef(WTCInput newInput__iInverterReadyRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__INPUT_IINVERTER_READY_REF, oldInput__iInverterReadyRef, input__iInverterReadyRef));
	}
	...
	public WTCInput getInput__iRemoteResetOrder() {
		if (input__iRemoteResetOrder != null && input__iRemoteResetOrder.eIsProxy()) {
			...
			if (input__iRemoteResetOrder != oldInput__iRemoteResetOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__INPUT_IREMOTE_RESET_ORDER, oldInput__iRemoteResetOrder, input__iRemoteResetOrder));
			}
		}
	...
	public void setInput__iRemoteResetOrder(WTCInput newInput__iRemoteResetOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__INPUT_IREMOTE_RESET_ORDER, oldInput__iRemoteResetOrder, input__iRemoteResetOrder));
	}
	...
	public WTCInput getInput__iInverterTorqueReg() {
		if (input__iInverterTorqueReg != null && input__iInverterTorqueReg.eIsProxy()) {
			...
			if (input__iInverterTorqueReg != oldInput__iInverterTorqueReg) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__INPUT_IINVERTER_TORQUE_REG, oldInput__iInverterTorqueReg, input__iInverterTorqueReg));
			}
		}
	...
	public void setInput__iInverterTorqueReg(WTCInput newInput__iInverterTorqueReg) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__INPUT_IINVERTER_TORQUE_REG, oldInput__iInverterTorqueReg, input__iInverterTorqueReg));
	}
	...
	public WTCInput getInput__iInverterHwState() {
		if (input__iInverterHwState != null && input__iInverterHwState.eIsProxy()) {
			...
			if (input__iInverterHwState != oldInput__iInverterHwState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__INPUT_IINVERTER_HW_STATE, oldInput__iInverterHwState, input__iInverterHwState));
			}
		}
	...
	public void setInput__iInverterHwState(WTCInput newInput__iInverterHwState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__INPUT_IINVERTER_HW_STATE, oldInput__iInverterHwState, input__iInverterHwState));
	}
	...
	public WTCInput getInput__iResetOrder() {
		if (input__iResetOrder != null && input__iResetOrder.eIsProxy()) {
			...
			if (input__iResetOrder != oldInput__iResetOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__INPUT_IRESET_ORDER, oldInput__iResetOrder, input__iResetOrder));
			}
		}
	...
	public void setInput__iResetOrder(WTCInput newInput__iResetOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__INPUT_IRESET_ORDER, oldInput__iResetOrder, input__iResetOrder));
	}
	...
	public WTCInput getInput__iMotorizing() {
		if (input__iMotorizing != null && input__iMotorizing.eIsProxy()) {
			...
			if (input__iMotorizing != oldInput__iMotorizing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__INPUT_IMOTORIZING, oldInput__iMotorizing, input__iMotorizing));
			}
		}
	...
	public void setInput__iMotorizing(WTCInput newInput__iMotorizing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__INPUT_IMOTORIZING, oldInput__iMotorizing, input__iMotorizing));
	}
	...
	public WTCOutput getOutput__oInverterToOn() {
		if (output__oInverterToOn != null && output__oInverterToOn.eIsProxy()) {
			...
			if (output__oInverterToOn != oldOutput__oInverterToOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__OUTPUT_OINVERTER_TO_ON, oldOutput__oInverterToOn, output__oInverterToOn));
			}
		}
	...
	public void setOutput__oInverterToOn(WTCOutput newOutput__oInverterToOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__OUTPUT_OINVERTER_TO_ON, oldOutput__oInverterToOn, output__oInverterToOn));
	}
	...
	public WTCOutput getOutput__oInverterResetCommand() {
		if (output__oInverterResetCommand != null && output__oInverterResetCommand.eIsProxy()) {
			...
			if (output__oInverterResetCommand != oldOutput__oInverterResetCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__OUTPUT_OINVERTER_RESET_COMMAND, oldOutput__oInverterResetCommand, output__oInverterResetCommand));
			}
		}
	...
	public void setOutput__oInverterResetCommand(WTCOutput newOutput__oInverterResetCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__OUTPUT_OINVERTER_RESET_COMMAND, oldOutput__oInverterResetCommand, output__oInverterResetCommand));
	}
	...
	public WTCOutput getOutput__oInverterTorqueRef() {
		if (output__oInverterTorqueRef != null && output__oInverterTorqueRef.eIsProxy()) {
			...
			if (output__oInverterTorqueRef != oldOutput__oInverterTorqueRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__OUTPUT_OINVERTER_TORQUE_REF, oldOutput__oInverterTorqueRef, output__oInverterTorqueRef));
			}
		}
	...
	public void setOutput__oInverterTorqueRef(WTCOutput newOutput__oInverterTorqueRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__OUTPUT_OINVERTER_TORQUE_REF, oldOutput__oInverterTorqueRef, output__oInverterTorqueRef));
	}
	...
	public WTCOutput getOutput__oInverterResetAlarms() {
		if (output__oInverterResetAlarms != null && output__oInverterResetAlarms.eIsProxy()) {
			...
			if (output__oInverterResetAlarms != oldOutput__oInverterResetAlarms) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__OUTPUT_OINVERTER_RESET_ALARMS, oldOutput__oInverterResetAlarms, output__oInverterResetAlarms));
			}
		}
	...
	public void setOutput__oInverterResetAlarms(WTCOutput newOutput__oInverterResetAlarms) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__OUTPUT_OINVERTER_RESET_ALARMS, oldOutput__oInverterResetAlarms, output__oInverterResetAlarms));
	}
	...
	public WTCFault getFault__fEtherCAT() {
		if (fault__fEtherCAT != null && fault__fEtherCAT.eIsProxy()) {
			...
			if (fault__fEtherCAT != oldFault__fEtherCAT) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__FAULT_FETHER_CAT, oldFault__fEtherCAT, fault__fEtherCAT));
			}
		}
	...
	public void setFault__fEtherCAT(WTCFault newFault__fEtherCAT) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__FAULT_FETHER_CAT, oldFault__fEtherCAT, fault__fEtherCAT));
	}
	...
	public WTCTimer getTimer__tResetTime() {
		if (timer__tResetTime != null && timer__tResetTime.eIsProxy()) {
			...
			if (timer__tResetTime != oldTimer__tResetTime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__TIMER_TRESET_TIME, oldTimer__tResetTime, timer__tResetTime));
			}
		}
	...
	public void setTimer__tResetTime(WTCTimer newTimer__tResetTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__TIMER_TRESET_TIME, oldTimer__tResetTime, timer__tResetTime));
	}
	...
	public WTCTimer getTimer__tDelayBetweenResets() {
		if (timer__tDelayBetweenResets != null && timer__tDelayBetweenResets.eIsProxy()) {
			...
			if (timer__tDelayBetweenResets != oldTimer__tDelayBetweenResets) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__TIMER_TDELAY_BETWEEN_RESETS, oldTimer__tDelayBetweenResets, timer__tDelayBetweenResets));
			}
		}
	...
	public void setTimer__tDelayBetweenResets(WTCTimer newTimer__tDelayBetweenResets) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__TIMER_TDELAY_BETWEEN_RESETS, oldTimer__tDelayBetweenResets, timer__tDelayBetweenResets));
	}
	...
	public WTCErrorReaction getErrorReaction__erStop() {
		if (errorReaction__erStop != null && errorReaction__erStop.eIsProxy()) {
			...
			if (errorReaction__erStop != oldErrorReaction__erStop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT61__ERROR_REACTION_ER_STOP, oldErrorReaction__erStop, errorReaction__erStop));
			}
		}
	...
	public void setErrorReaction__erStop(WTCErrorReaction newErrorReaction__erStop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT61__ERROR_REACTION_ER_STOP, oldErrorReaction__erStop, errorReaction__erStop));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit98Impl#getInput__iSafetyLineStopped <em>Input iSafety Line Stopped</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit98Impl#getOutput__oEmergencyRearmCommand <em>Output oEmergency Rearm Command</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit98Impl extends wtcImpl implements CtrlUnit98 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit98();
	}
		...
		if (input__iSafetyLineStopped != null && input__iSafetyLineStopped.eIsProxy()) {
			...
			if (input__iSafetyLineStopped != oldInput__iSafetyLineStopped) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT98__INPUT_ISAFETY_LINE_STOPPED, oldInput__iSafetyLineStopped, input__iSafetyLineStopped));
			}
		}
	...
	public void setInput__iSafetyLineStopped(WTCInput newInput__iSafetyLineStopped) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT98__INPUT_ISAFETY_LINE_STOPPED, oldInput__iSafetyLineStopped, input__iSafetyLineStopped));
	}
	...
	public WTCOutput getOutput__oEmergencyRearmCommand() {
		if (output__oEmergencyRearmCommand != null && output__oEmergencyRearmCommand.eIsProxy()) {
			...
			if (output__oEmergencyRearmCommand != oldOutput__oEmergencyRearmCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT98__OUTPUT_OEMERGENCY_REARM_COMMAND, oldOutput__oEmergencyRearmCommand, output__oEmergencyRearmCommand));
			}
		}
	...
	public void setOutput__oEmergencyRearmCommand(WTCOutput newOutput__oEmergencyRearmCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT98__OUTPUT_OEMERGENCY_REARM_COMMAND, oldOutput__oEmergencyRearmCommand, output__oEmergencyRearmCommand));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT98__INPUT_ISAFETY_LINE_STOPPED:
				if (resolve) return getInput__iSafetyLineStopped();
				return basicGetInput__iSafetyLineStopped();
			case WtspecidPackage.CTRL_UNIT98__OUTPUT_OEMERGENCY_REARM_COMMAND:

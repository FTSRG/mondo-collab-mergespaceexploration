 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit29Impl#getInput__iDigitalInput <em>Input iDigital Input</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit29Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit29Impl#getFault__fFault <em>Fault fFault</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit29Impl#getBhvParam__bpResetMode <em>Bhv Param bp Reset Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit29Impl extends wtcImpl implements CtrlUnit29 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit29();
	}
		...
		if (input__iDigitalInput != null && input__iDigitalInput.eIsProxy()) {
			...
			if (input__iDigitalInput != oldInput__iDigitalInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT29__INPUT_IDIGITAL_INPUT, oldInput__iDigitalInput, input__iDigitalInput));
			}
		}
	...
	public void setInput__iDigitalInput(WTCInput newInput__iDigitalInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT29__INPUT_IDIGITAL_INPUT, oldInput__iDigitalInput, input__iDigitalInput));
	}
	...
	public WTCInput getInput__iDontCheckInput() {
		if (input__iDontCheckInput != null && input__iDontCheckInput.eIsProxy()) {
			...
			if (input__iDontCheckInput != oldInput__iDontCheckInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT29__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
			}
		}
	...
	public void setInput__iDontCheckInput(WTCInput newInput__iDontCheckInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT29__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
	}
	...
	public WTCFault getFault__fFault() {
		if (fault__fFault != null && fault__fFault.eIsProxy()) {
			...
			if (fault__fFault != oldFault__fFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT29__FAULT_FFAULT, oldFault__fFault, fault__fFault));
			}
		}
	...
	public void setFault__fFault(WTCFault newFault__fFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT29__FAULT_FFAULT, oldFault__fFault, fault__fFault));
	}
	...
	public void setBhvParam__bpResetMode(String newBhvParam__bpResetMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT29__BHV_PARAM_BP_RESET_MODE, oldBhvParam__bpResetMode, bhvParam__bpResetMode));
	}

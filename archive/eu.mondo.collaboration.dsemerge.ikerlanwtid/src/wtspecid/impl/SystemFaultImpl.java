 ...
 * <ul>
 *   <li>{@link wtspecid.impl.SystemFaultImpl#getSysId <em>Sys Id</em>}</li>
 *   <li>{@link wtspecid.impl.SystemFaultImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemFaultImpl extends WTCFaultImpl implements SystemFault {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getSystemFault();
	}
	...
	public void setSysId(String newSysId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.SYSTEM_FAULT__SYS_ID, oldSysId, sysId));
	}
	...
	public void setValue(int newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.SYSTEM_FAULT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.SYSTEM_FAULT__SYS_ID:
				return getSysId();
			case WtspecidPackage.SYSTEM_FAULT__VALUE:
				return getValue();
		}

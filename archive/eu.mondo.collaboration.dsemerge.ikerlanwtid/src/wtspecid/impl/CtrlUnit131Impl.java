 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit131Impl#getInput__iExcessivePressure <em>Input iExcessive Pressure</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit131Impl#getInput__iBrakeCommand <em>Input iBrake Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit131Impl#getFault__fCommError <em>Fault fComm Error</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit131Impl#getFault__fFault <em>Fault fFault</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit131Impl#getBhvParam__bpLogicType <em>Bhv Param bp Logic Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit131Impl extends wtcImpl implements CtrlUnit131 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit131();
	}
		...
		if (input__iExcessivePressure != null && input__iExcessivePressure.eIsProxy()) {
			...
			if (input__iExcessivePressure != oldInput__iExcessivePressure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT131__INPUT_IEXCESSIVE_PRESSURE, oldInput__iExcessivePressure, input__iExcessivePressure));
			}
		}
	...
	public void setInput__iExcessivePressure(WTCInput newInput__iExcessivePressure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT131__INPUT_IEXCESSIVE_PRESSURE, oldInput__iExcessivePressure, input__iExcessivePressure));
	}
	...
	public WTCInput getInput__iBrakeCommand() {
		if (input__iBrakeCommand != null && input__iBrakeCommand.eIsProxy()) {
			...
			if (input__iBrakeCommand != oldInput__iBrakeCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT131__INPUT_IBRAKE_COMMAND, oldInput__iBrakeCommand, input__iBrakeCommand));
			}
		}
	...
	public void setInput__iBrakeCommand(WTCInput newInput__iBrakeCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT131__INPUT_IBRAKE_COMMAND, oldInput__iBrakeCommand, input__iBrakeCommand));
	}
	...
	public WTCFault getFault__fCommError() {
		if (fault__fCommError != null && fault__fCommError.eIsProxy()) {
			...
			if (fault__fCommError != oldFault__fCommError) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT131__FAULT_FCOMM_ERROR, oldFault__fCommError, fault__fCommError));
			}
		}
	...
	public void setFault__fCommError(WTCFault newFault__fCommError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT131__FAULT_FCOMM_ERROR, oldFault__fCommError, fault__fCommError));
	}
	...
	public WTCFault getFault__fFault() {
		if (fault__fFault != null && fault__fFault.eIsProxy()) {
			...
			if (fault__fFault != oldFault__fFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT131__FAULT_FFAULT, oldFault__fFault, fault__fFault));
			}
		}
	...
	public void setFault__fFault(WTCFault newFault__fFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT131__FAULT_FFAULT, oldFault__fFault, fault__fFault));
	}
	...
	public void setBhvParam__bpLogicType(String newBhvParam__bpLogicType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT131__BHV_PARAM_BP_LOGIC_TYPE, oldBhvParam__bpLogicType, bhvParam__bpLogicType));
	}

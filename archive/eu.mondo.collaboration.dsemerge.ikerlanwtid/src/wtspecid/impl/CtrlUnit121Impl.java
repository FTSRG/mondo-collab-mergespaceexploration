 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit121Impl#getInput__iManualYawPreCommand <em>Input iManual Yaw Pre Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit121Impl#getInput__iMaxTwistPreCommand <em>Input iMax Twist Pre Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit121Impl#getInput__iRetwistPreCommand <em>Input iRetwist Pre Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit121Impl#getInput__iRelWindPreCommand <em>Input iRel Wind Pre Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit121Impl#getOutput__oYawCommand <em>Output oYaw Command</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit121Impl extends wtcImpl implements CtrlUnit121 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit121();
	}
		...
		if (input__iManualYawPreCommand != null && input__iManualYawPreCommand.eIsProxy()) {
			...
			if (input__iManualYawPreCommand != oldInput__iManualYawPreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT121__INPUT_IMANUAL_YAW_PRE_COMMAND, oldInput__iManualYawPreCommand, input__iManualYawPreCommand));
			}
		}
	...
	public void setInput__iManualYawPreCommand(WTCInput newInput__iManualYawPreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT121__INPUT_IMANUAL_YAW_PRE_COMMAND, oldInput__iManualYawPreCommand, input__iManualYawPreCommand));
	}
	...
	public WTCInput getInput__iMaxTwistPreCommand() {
		if (input__iMaxTwistPreCommand != null && input__iMaxTwistPreCommand.eIsProxy()) {
			...
			if (input__iMaxTwistPreCommand != oldInput__iMaxTwistPreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT121__INPUT_IMAX_TWIST_PRE_COMMAND, oldInput__iMaxTwistPreCommand, input__iMaxTwistPreCommand));
			}
		}
	...
	public void setInput__iMaxTwistPreCommand(WTCInput newInput__iMaxTwistPreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT121__INPUT_IMAX_TWIST_PRE_COMMAND, oldInput__iMaxTwistPreCommand, input__iMaxTwistPreCommand));
	}
	...
	public WTCInput getInput__iRetwistPreCommand() {
		if (input__iRetwistPreCommand != null && input__iRetwistPreCommand.eIsProxy()) {
			...
			if (input__iRetwistPreCommand != oldInput__iRetwistPreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT121__INPUT_IRETWIST_PRE_COMMAND, oldInput__iRetwistPreCommand, input__iRetwistPreCommand));
			}
		}
	...
	public void setInput__iRetwistPreCommand(WTCInput newInput__iRetwistPreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT121__INPUT_IRETWIST_PRE_COMMAND, oldInput__iRetwistPreCommand, input__iRetwistPreCommand));
	}
	...
	public WTCInput getInput__iRelWindPreCommand() {
		if (input__iRelWindPreCommand != null && input__iRelWindPreCommand.eIsProxy()) {
			...
			if (input__iRelWindPreCommand != oldInput__iRelWindPreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT121__INPUT_IREL_WIND_PRE_COMMAND, oldInput__iRelWindPreCommand, input__iRelWindPreCommand));
			}
		}
	...
	public void setInput__iRelWindPreCommand(WTCInput newInput__iRelWindPreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT121__INPUT_IREL_WIND_PRE_COMMAND, oldInput__iRelWindPreCommand, input__iRelWindPreCommand));
	}
	...
	public WTCOutput getOutput__oYawCommand() {
		if (output__oYawCommand != null && output__oYawCommand.eIsProxy()) {
			...
			if (output__oYawCommand != oldOutput__oYawCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT121__OUTPUT_OYAW_COMMAND, oldOutput__oYawCommand, output__oYawCommand));
			}
		}
	...
	public void setOutput__oYawCommand(WTCOutput newOutput__oYawCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT121__OUTPUT_OYAW_COMMAND, oldOutput__oYawCommand, output__oYawCommand));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getInput__iPitchHwStandby <em>Input iPitch Hw Standby</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getInput__iPitchHwFault <em>Input iPitch Hw Fault</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getInput__iPitchStopCommand <em>Input iPitch Stop Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getInput__iPitchBrakePosition <em>Input iPitch Brake Position</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getOutput__oBrakes <em>Output oBrakes</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getOutput__oPitchNormalOrder <em>Output oPitch Normal Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getOutput__oPitchEmergencyOrder <em>Output oPitch Emergency Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getOutput__oPitchTestUCapOrder <em>Output oPitch Test UCap Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getErrorReaction__erEmergency <em>Error Reaction er Emergency</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit86Impl#getErrorReaction__erSecurityLine <em>Error Reaction er Security Line</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit86Impl extends wtcImpl implements CtrlUnit86 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit86();
	}
		...
		if (input__iPitchHwStandby != null && input__iPitchHwStandby.eIsProxy()) {
			...
			if (input__iPitchHwStandby != oldInput__iPitchHwStandby) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__INPUT_IPITCH_HW_STANDBY, oldInput__iPitchHwStandby, input__iPitchHwStandby));
			}
		}
	...
	public void setInput__iPitchHwStandby(WTCInput newInput__iPitchHwStandby) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__INPUT_IPITCH_HW_STANDBY, oldInput__iPitchHwStandby, input__iPitchHwStandby));
	}
	...
	public WTCInput getInput__iPitchHwFault() {
		if (input__iPitchHwFault != null && input__iPitchHwFault.eIsProxy()) {
			...
			if (input__iPitchHwFault != oldInput__iPitchHwFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__INPUT_IPITCH_HW_FAULT, oldInput__iPitchHwFault, input__iPitchHwFault));
			}
		}
	...
	public void setInput__iPitchHwFault(WTCInput newInput__iPitchHwFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__INPUT_IPITCH_HW_FAULT, oldInput__iPitchHwFault, input__iPitchHwFault));
	}
	...
	public WTCInput getInput__iPitchStopCommand() {
		if (input__iPitchStopCommand != null && input__iPitchStopCommand.eIsProxy()) {
			...
			if (input__iPitchStopCommand != oldInput__iPitchStopCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__INPUT_IPITCH_STOP_COMMAND, oldInput__iPitchStopCommand, input__iPitchStopCommand));
			}
		}
	...
	public void setInput__iPitchStopCommand(WTCInput newInput__iPitchStopCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__INPUT_IPITCH_STOP_COMMAND, oldInput__iPitchStopCommand, input__iPitchStopCommand));
	}
	...
	public WTCInput getInput__iPitchBrakePosition() {
		if (input__iPitchBrakePosition != null && input__iPitchBrakePosition.eIsProxy()) {
			...
			if (input__iPitchBrakePosition != oldInput__iPitchBrakePosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__INPUT_IPITCH_BRAKE_POSITION, oldInput__iPitchBrakePosition, input__iPitchBrakePosition));
			}
		}
	...
	public void setInput__iPitchBrakePosition(WTCInput newInput__iPitchBrakePosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__INPUT_IPITCH_BRAKE_POSITION, oldInput__iPitchBrakePosition, input__iPitchBrakePosition));
	}
	...
	public WTCOutput getOutput__oBrakes() {
		if (output__oBrakes != null && output__oBrakes.eIsProxy()) {
			...
			if (output__oBrakes != oldOutput__oBrakes) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__OUTPUT_OBRAKES, oldOutput__oBrakes, output__oBrakes));
			}
		}
	...
	public void setOutput__oBrakes(WTCOutput newOutput__oBrakes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__OUTPUT_OBRAKES, oldOutput__oBrakes, output__oBrakes));
	}
	...
	public WTCOutput getOutput__oPitchNormalOrder() {
		if (output__oPitchNormalOrder != null && output__oPitchNormalOrder.eIsProxy()) {
			...
			if (output__oPitchNormalOrder != oldOutput__oPitchNormalOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__OUTPUT_OPITCH_NORMAL_ORDER, oldOutput__oPitchNormalOrder, output__oPitchNormalOrder));
			}
		}
	...
	public void setOutput__oPitchNormalOrder(WTCOutput newOutput__oPitchNormalOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__OUTPUT_OPITCH_NORMAL_ORDER, oldOutput__oPitchNormalOrder, output__oPitchNormalOrder));
	}
	...
	public WTCOutput getOutput__oPitchEmergencyOrder() {
		if (output__oPitchEmergencyOrder != null && output__oPitchEmergencyOrder.eIsProxy()) {
			...
			if (output__oPitchEmergencyOrder != oldOutput__oPitchEmergencyOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__OUTPUT_OPITCH_EMERGENCY_ORDER, oldOutput__oPitchEmergencyOrder, output__oPitchEmergencyOrder));
			}
		}
	...
	public void setOutput__oPitchEmergencyOrder(WTCOutput newOutput__oPitchEmergencyOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__OUTPUT_OPITCH_EMERGENCY_ORDER, oldOutput__oPitchEmergencyOrder, output__oPitchEmergencyOrder));
	}
	...
	public WTCOutput getOutput__oPitchTestUCapOrder() {
		if (output__oPitchTestUCapOrder != null && output__oPitchTestUCapOrder.eIsProxy()) {
			...
			if (output__oPitchTestUCapOrder != oldOutput__oPitchTestUCapOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__OUTPUT_OPITCH_TEST_UCAP_ORDER, oldOutput__oPitchTestUCapOrder, output__oPitchTestUCapOrder));
			}
		}
	...
	public void setOutput__oPitchTestUCapOrder(WTCOutput newOutput__oPitchTestUCapOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__OUTPUT_OPITCH_TEST_UCAP_ORDER, oldOutput__oPitchTestUCapOrder, output__oPitchTestUCapOrder));
	}
	...
	public WTCErrorReaction getErrorReaction__erEmergency() {
		if (errorReaction__erEmergency != null && errorReaction__erEmergency.eIsProxy()) {
			...
			if (errorReaction__erEmergency != oldErrorReaction__erEmergency) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__ERROR_REACTION_ER_EMERGENCY, oldErrorReaction__erEmergency, errorReaction__erEmergency));
			}
		}
	...
	public void setErrorReaction__erEmergency(WTCErrorReaction newErrorReaction__erEmergency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__ERROR_REACTION_ER_EMERGENCY, oldErrorReaction__erEmergency, errorReaction__erEmergency));
	}
	...
	public WTCErrorReaction getErrorReaction__erSecurityLine() {
		if (errorReaction__erSecurityLine != null && errorReaction__erSecurityLine.eIsProxy()) {
			...
			if (errorReaction__erSecurityLine != oldErrorReaction__erSecurityLine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT86__ERROR_REACTION_ER_SECURITY_LINE, oldErrorReaction__erSecurityLine, errorReaction__erSecurityLine));
			}
		}
	...
	public void setErrorReaction__erSecurityLine(WTCErrorReaction newErrorReaction__erSecurityLine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT86__ERROR_REACTION_ER_SECURITY_LINE, oldErrorReaction__erSecurityLine, errorReaction__erSecurityLine));
	}

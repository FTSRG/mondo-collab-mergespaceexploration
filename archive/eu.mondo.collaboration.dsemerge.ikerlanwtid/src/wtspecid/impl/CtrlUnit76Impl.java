 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit76Impl#getInput__iCtrlYawBrakeStatus <em>Input iCtrl Yaw Brake Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit76Impl#getOutput__oOpcYawBrakeStatus <em>Output oOpc Yaw Brake Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit76Impl extends wtcImpl implements CtrlUnit76 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit76();
	}
		...
		if (input__iCtrlYawBrakeStatus != null && input__iCtrlYawBrakeStatus.eIsProxy()) {
			...
			if (input__iCtrlYawBrakeStatus != oldInput__iCtrlYawBrakeStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT76__INPUT_ICTRL_YAW_BRAKE_STATUS, oldInput__iCtrlYawBrakeStatus, input__iCtrlYawBrakeStatus));
			}
		}
	...
	public void setInput__iCtrlYawBrakeStatus(WTCInput newInput__iCtrlYawBrakeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT76__INPUT_ICTRL_YAW_BRAKE_STATUS, oldInput__iCtrlYawBrakeStatus, input__iCtrlYawBrakeStatus));
	}
	...
	public WTCOutput getOutput__oOpcYawBrakeStatus() {
		if (output__oOpcYawBrakeStatus != null && output__oOpcYawBrakeStatus.eIsProxy()) {
			...
			if (output__oOpcYawBrakeStatus != oldOutput__oOpcYawBrakeStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT76__OUTPUT_OOPC_YAW_BRAKE_STATUS, oldOutput__oOpcYawBrakeStatus, output__oOpcYawBrakeStatus));
			}
		}
	...
	public void setOutput__oOpcYawBrakeStatus(WTCOutput newOutput__oOpcYawBrakeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT76__OUTPUT_OOPC_YAW_BRAKE_STATUS, oldOutput__oOpcYawBrakeStatus, output__oOpcYawBrakeStatus));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT76__INPUT_ICTRL_YAW_BRAKE_STATUS:
				if (resolve) return getInput__iCtrlYawBrakeStatus();
				return basicGetInput__iCtrlYawBrakeStatus();
			case WtspecidPackage.CTRL_UNIT76__OUTPUT_OOPC_YAW_BRAKE_STATUS:

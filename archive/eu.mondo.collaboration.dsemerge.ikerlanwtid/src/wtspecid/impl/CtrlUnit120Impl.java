 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit120Impl#getInput__iYawCwFinalButton <em>Input iYaw Cw Final Button</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit120Impl#getInput__iYawCcwFinalButton <em>Input iYaw Ccw Final Button</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit120Impl#getOutput__oManualYawPreCommand <em>Output oManual Yaw Pre Command</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit120Impl extends wtcImpl implements CtrlUnit120 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit120();
	}
		...
		if (input__iYawCwFinalButton != null && input__iYawCwFinalButton.eIsProxy()) {
			...
			if (input__iYawCwFinalButton != oldInput__iYawCwFinalButton) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT120__INPUT_IYAW_CW_FINAL_BUTTON, oldInput__iYawCwFinalButton, input__iYawCwFinalButton));
			}
		}
	...
	public void setInput__iYawCwFinalButton(WTCInput newInput__iYawCwFinalButton) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT120__INPUT_IYAW_CW_FINAL_BUTTON, oldInput__iYawCwFinalButton, input__iYawCwFinalButton));
	}
	...
	public WTCInput getInput__iYawCcwFinalButton() {
		if (input__iYawCcwFinalButton != null && input__iYawCcwFinalButton.eIsProxy()) {
			...
			if (input__iYawCcwFinalButton != oldInput__iYawCcwFinalButton) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT120__INPUT_IYAW_CCW_FINAL_BUTTON, oldInput__iYawCcwFinalButton, input__iYawCcwFinalButton));
			}
		}
	...
	public void setInput__iYawCcwFinalButton(WTCInput newInput__iYawCcwFinalButton) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT120__INPUT_IYAW_CCW_FINAL_BUTTON, oldInput__iYawCcwFinalButton, input__iYawCcwFinalButton));
	}
	...
	public WTCOutput getOutput__oManualYawPreCommand() {
		if (output__oManualYawPreCommand != null && output__oManualYawPreCommand.eIsProxy()) {
			...
			if (output__oManualYawPreCommand != oldOutput__oManualYawPreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT120__OUTPUT_OMANUAL_YAW_PRE_COMMAND, oldOutput__oManualYawPreCommand, output__oManualYawPreCommand));
			}
		}
	...
	public void setOutput__oManualYawPreCommand(WTCOutput newOutput__oManualYawPreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT120__OUTPUT_OMANUAL_YAW_PRE_COMMAND, oldOutput__oManualYawPreCommand, output__oManualYawPreCommand));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT120__INPUT_IYAW_CW_FINAL_BUTTON:
				if (resolve) return getInput__iYawCwFinalButton();
				return basicGetInput__iYawCwFinalButton();
			case WtspecidPackage.CTRL_UNIT120__INPUT_IYAW_CCW_FINAL_BUTTON:
				if (resolve) return getInput__iYawCcwFinalButton();
				return basicGetInput__iYawCcwFinalButton();
			case WtspecidPackage.CTRL_UNIT120__OUTPUT_OMANUAL_YAW_PRE_COMMAND:

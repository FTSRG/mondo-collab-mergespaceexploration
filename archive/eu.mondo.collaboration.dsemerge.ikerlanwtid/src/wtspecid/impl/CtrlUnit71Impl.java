 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit71Impl#getInput__iSelect1 <em>Input iSelect1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit71Impl#getInput__iSelect2 <em>Input iSelect2</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit71Impl#getInput__iSelect3 <em>Input iSelect3</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit71Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit71Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit71Impl#getInput__iInput3 <em>Input iInput3</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit71Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit71Impl#getOutput__oOutputWrongStatus <em>Output oOutput Wrong Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit71Impl extends wtcImpl implements CtrlUnit71 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit71();
	}
		...
		if (input__iSelect1 != null && input__iSelect1.eIsProxy()) {
			...
			if (input__iSelect1 != oldInput__iSelect1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT71__INPUT_ISELECT1, oldInput__iSelect1, input__iSelect1));
			}
		}
	...
	public void setInput__iSelect1(WTCInput newInput__iSelect1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT71__INPUT_ISELECT1, oldInput__iSelect1, input__iSelect1));
	}
	...
	public WTCInput getInput__iSelect2() {
		if (input__iSelect2 != null && input__iSelect2.eIsProxy()) {
			...
			if (input__iSelect2 != oldInput__iSelect2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT71__INPUT_ISELECT2, oldInput__iSelect2, input__iSelect2));
			}
		}
	...
	public void setInput__iSelect2(WTCInput newInput__iSelect2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT71__INPUT_ISELECT2, oldInput__iSelect2, input__iSelect2));
	}
	...
	public WTCInput getInput__iSelect3() {
		if (input__iSelect3 != null && input__iSelect3.eIsProxy()) {
			...
			if (input__iSelect3 != oldInput__iSelect3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT71__INPUT_ISELECT3, oldInput__iSelect3, input__iSelect3));
			}
		}
	...
	public void setInput__iSelect3(WTCInput newInput__iSelect3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT71__INPUT_ISELECT3, oldInput__iSelect3, input__iSelect3));
	}
	...
	public WTCInput getInput__iInput1() {
		if (input__iInput1 != null && input__iInput1.eIsProxy()) {
			...
			if (input__iInput1 != oldInput__iInput1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT71__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
			}
		}
	...
	public void setInput__iInput1(WTCInput newInput__iInput1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT71__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
	}
	...
	public WTCInput getInput__iInput2() {
		if (input__iInput2 != null && input__iInput2.eIsProxy()) {
			...
			if (input__iInput2 != oldInput__iInput2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT71__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
			}
		}
	...
	public void setInput__iInput2(WTCInput newInput__iInput2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT71__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
	}
	...
	public WTCInput getInput__iInput3() {
		if (input__iInput3 != null && input__iInput3.eIsProxy()) {
			...
			if (input__iInput3 != oldInput__iInput3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT71__INPUT_IINPUT3, oldInput__iInput3, input__iInput3));
			}
		}
	...
	public void setInput__iInput3(WTCInput newInput__iInput3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT71__INPUT_IINPUT3, oldInput__iInput3, input__iInput3));
	}
	...
	public WTCOutput getOutput__oOutput() {
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT71__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT71__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public WTCOutput getOutput__oOutputWrongStatus() {
		if (output__oOutputWrongStatus != null && output__oOutputWrongStatus.eIsProxy()) {
			...
			if (output__oOutputWrongStatus != oldOutput__oOutputWrongStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT71__OUTPUT_OOUTPUT_WRONG_STATUS, oldOutput__oOutputWrongStatus, output__oOutputWrongStatus));
			}
		}
	...
	public void setOutput__oOutputWrongStatus(WTCOutput newOutput__oOutputWrongStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT71__OUTPUT_OOUTPUT_WRONG_STATUS, oldOutput__oOutputWrongStatus, output__oOutputWrongStatus));
	}

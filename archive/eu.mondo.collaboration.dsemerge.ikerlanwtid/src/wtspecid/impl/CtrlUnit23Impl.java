 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit23Impl#getInput__iWindSpeed <em>Input iWind Speed</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit23Impl#getInput__iInverterPower <em>Input iInverter Power</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit23Impl#getOutput__oRelationError <em>Output oRelation Error</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit23Impl#getParameter__pWindSpeedLimit <em>Parameter pWind Speed Limit</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit23Impl#getParameter__pInverterPowerLimit <em>Parameter pInverter Power Limit</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit23Impl#getTimer__tWindMinimumTime <em>Timer tWind Minimum Time</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit23Impl#getTimer__tPowerAndWindMinimumTime <em>Timer tPower And Wind Minimum Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit23Impl extends wtcImpl implements CtrlUnit23 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit23();
	}
		...
		if (input__iWindSpeed != null && input__iWindSpeed.eIsProxy()) {
			...
			if (input__iWindSpeed != oldInput__iWindSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT23__INPUT_IWIND_SPEED, oldInput__iWindSpeed, input__iWindSpeed));
			}
		}
	...
	public void setInput__iWindSpeed(WTCInput newInput__iWindSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT23__INPUT_IWIND_SPEED, oldInput__iWindSpeed, input__iWindSpeed));
	}
	...
	public WTCInput getInput__iInverterPower() {
		if (input__iInverterPower != null && input__iInverterPower.eIsProxy()) {
			...
			if (input__iInverterPower != oldInput__iInverterPower) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT23__INPUT_IINVERTER_POWER, oldInput__iInverterPower, input__iInverterPower));
			}
		}
	...
	public void setInput__iInverterPower(WTCInput newInput__iInverterPower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT23__INPUT_IINVERTER_POWER, oldInput__iInverterPower, input__iInverterPower));
	}
	...
	public WTCOutput getOutput__oRelationError() {
		if (output__oRelationError != null && output__oRelationError.eIsProxy()) {
			...
			if (output__oRelationError != oldOutput__oRelationError) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT23__OUTPUT_ORELATION_ERROR, oldOutput__oRelationError, output__oRelationError));
			}
		}
	...
	public void setOutput__oRelationError(WTCOutput newOutput__oRelationError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT23__OUTPUT_ORELATION_ERROR, oldOutput__oRelationError, output__oRelationError));
	}
	...
	public WTCParam getParameter__pWindSpeedLimit() {
		if (parameter__pWindSpeedLimit != null && parameter__pWindSpeedLimit.eIsProxy()) {
			...
			if (parameter__pWindSpeedLimit != oldParameter__pWindSpeedLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT23__PARAMETER_PWIND_SPEED_LIMIT, oldParameter__pWindSpeedLimit, parameter__pWindSpeedLimit));
			}
		}
	...
	public void setParameter__pWindSpeedLimit(WTCParam newParameter__pWindSpeedLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT23__PARAMETER_PWIND_SPEED_LIMIT, oldParameter__pWindSpeedLimit, parameter__pWindSpeedLimit));
	}
	...
	public WTCParam getParameter__pInverterPowerLimit() {
		if (parameter__pInverterPowerLimit != null && parameter__pInverterPowerLimit.eIsProxy()) {
			...
			if (parameter__pInverterPowerLimit != oldParameter__pInverterPowerLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT23__PARAMETER_PINVERTER_POWER_LIMIT, oldParameter__pInverterPowerLimit, parameter__pInverterPowerLimit));
			}
		}
	...
	public void setParameter__pInverterPowerLimit(WTCParam newParameter__pInverterPowerLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT23__PARAMETER_PINVERTER_POWER_LIMIT, oldParameter__pInverterPowerLimit, parameter__pInverterPowerLimit));
	}
	...
	public WTCTimer getTimer__tWindMinimumTime() {
		if (timer__tWindMinimumTime != null && timer__tWindMinimumTime.eIsProxy()) {
			...
			if (timer__tWindMinimumTime != oldTimer__tWindMinimumTime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT23__TIMER_TWIND_MINIMUM_TIME, oldTimer__tWindMinimumTime, timer__tWindMinimumTime));
			}
		}
	...
	public void setTimer__tWindMinimumTime(WTCTimer newTimer__tWindMinimumTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT23__TIMER_TWIND_MINIMUM_TIME, oldTimer__tWindMinimumTime, timer__tWindMinimumTime));
	}
	...
	public WTCTimer getTimer__tPowerAndWindMinimumTime() {
		if (timer__tPowerAndWindMinimumTime != null && timer__tPowerAndWindMinimumTime.eIsProxy()) {
			...
			if (timer__tPowerAndWindMinimumTime != oldTimer__tPowerAndWindMinimumTime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT23__TIMER_TPOWER_AND_WIND_MINIMUM_TIME, oldTimer__tPowerAndWindMinimumTime, timer__tPowerAndWindMinimumTime));
			}
		}
	...
	public void setTimer__tPowerAndWindMinimumTime(WTCTimer newTimer__tPowerAndWindMinimumTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT23__TIMER_TPOWER_AND_WIND_MINIMUM_TIME, oldTimer__tPowerAndWindMinimumTime, timer__tPowerAndWindMinimumTime));
	}

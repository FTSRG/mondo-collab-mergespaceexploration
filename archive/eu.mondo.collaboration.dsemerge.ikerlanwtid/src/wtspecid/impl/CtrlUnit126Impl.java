 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit126Impl#getInput__iTorqueVal <em>Input iTorque Val</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit126Impl#getInput__iInvRol <em>Input iInv Rol</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit126Impl#getOutput__oMaxTorque <em>Output oMax Torque</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit126Impl#getOutput__oMinTorque <em>Output oMin Torque</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit126Impl#getParameter__pMaxTorque <em>Parameter pMax Torque</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit126Impl#getParameter__pMinTorque <em>Parameter pMin Torque</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit126Impl extends wtcImpl implements CtrlUnit126 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit126();
	}
		...
		if (input__iTorqueVal != null && input__iTorqueVal.eIsProxy()) {
			...
			if (input__iTorqueVal != oldInput__iTorqueVal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT126__INPUT_ITORQUE_VAL, oldInput__iTorqueVal, input__iTorqueVal));
			}
		}
	...
	public void setInput__iTorqueVal(WTCInput newInput__iTorqueVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT126__INPUT_ITORQUE_VAL, oldInput__iTorqueVal, input__iTorqueVal));
	}
	...
	public WTCInput getInput__iInvRol() {
		if (input__iInvRol != null && input__iInvRol.eIsProxy()) {
			...
			if (input__iInvRol != oldInput__iInvRol) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT126__INPUT_IINV_ROL, oldInput__iInvRol, input__iInvRol));
			}
		}
	...
	public void setInput__iInvRol(WTCInput newInput__iInvRol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT126__INPUT_IINV_ROL, oldInput__iInvRol, input__iInvRol));
	}
	...
	public WTCOutput getOutput__oMaxTorque() {
		if (output__oMaxTorque != null && output__oMaxTorque.eIsProxy()) {
			...
			if (output__oMaxTorque != oldOutput__oMaxTorque) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT126__OUTPUT_OMAX_TORQUE, oldOutput__oMaxTorque, output__oMaxTorque));
			}
		}
	...
	public void setOutput__oMaxTorque(WTCOutput newOutput__oMaxTorque) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT126__OUTPUT_OMAX_TORQUE, oldOutput__oMaxTorque, output__oMaxTorque));
	}
	...
	public WTCOutput getOutput__oMinTorque() {
		if (output__oMinTorque != null && output__oMinTorque.eIsProxy()) {
			...
			if (output__oMinTorque != oldOutput__oMinTorque) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT126__OUTPUT_OMIN_TORQUE, oldOutput__oMinTorque, output__oMinTorque));
			}
		}
	...
	public void setOutput__oMinTorque(WTCOutput newOutput__oMinTorque) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT126__OUTPUT_OMIN_TORQUE, oldOutput__oMinTorque, output__oMinTorque));
	}
	...
	public WTCParam getParameter__pMaxTorque() {
		if (parameter__pMaxTorque != null && parameter__pMaxTorque.eIsProxy()) {
			...
			if (parameter__pMaxTorque != oldParameter__pMaxTorque) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT126__PARAMETER_PMAX_TORQUE, oldParameter__pMaxTorque, parameter__pMaxTorque));
			}
		}
	...
	public void setParameter__pMaxTorque(WTCParam newParameter__pMaxTorque) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT126__PARAMETER_PMAX_TORQUE, oldParameter__pMaxTorque, parameter__pMaxTorque));
	}
	...
	public WTCParam getParameter__pMinTorque() {
		if (parameter__pMinTorque != null && parameter__pMinTorque.eIsProxy()) {
			...
			if (parameter__pMinTorque != oldParameter__pMinTorque) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT126__PARAMETER_PMIN_TORQUE, oldParameter__pMinTorque, parameter__pMinTorque));
			}
		}
	...
	public void setParameter__pMinTorque(WTCParam newParameter__pMinTorque) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT126__PARAMETER_PMIN_TORQUE, oldParameter__pMinTorque, parameter__pMinTorque));
	}

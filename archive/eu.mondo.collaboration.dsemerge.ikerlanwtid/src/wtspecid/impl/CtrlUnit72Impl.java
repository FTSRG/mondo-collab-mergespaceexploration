 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit72Impl#getInput__iInput <em>Input iInput</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit72Impl#getTimer__tDelay <em>Timer tDelay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit72Impl extends wtcImpl implements CtrlUnit72 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit72();
	}
		...
		if (input__iInput != null && input__iInput.eIsProxy()) {
			...
			if (input__iInput != oldInput__iInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT72__INPUT_IINPUT, oldInput__iInput, input__iInput));
			}
		}
	...
	public void setInput__iInput(WTCInput newInput__iInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT72__INPUT_IINPUT, oldInput__iInput, input__iInput));
	}
	...
	public WTCTimer getTimer__tDelay() {
		if (timer__tDelay != null && timer__tDelay.eIsProxy()) {
			...
			if (timer__tDelay != oldTimer__tDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT72__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
			}
		}
	...
	public void setTimer__tDelay(WTCTimer newTimer__tDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT72__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT72__INPUT_IINPUT:
				if (resolve) return getInput__iInput();
				return basicGetInput__iInput();
			case WtspecidPackage.CTRL_UNIT72__TIMER_TDELAY:

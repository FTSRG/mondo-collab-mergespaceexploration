 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit2Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit2Impl#getOutput__oNorthDirection <em>Output oNorth Direction</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit2Impl#getParameter__pNorthOffset <em>Parameter pNorth Offset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit2Impl extends wtcImpl implements CtrlUnit2 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit2();
	}
		...
		if (input__iTwistAngle != null && input__iTwistAngle.eIsProxy()) {
			...
			if (input__iTwistAngle != oldInput__iTwistAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT2__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
			}
		}
	...
	public void setInput__iTwistAngle(WTCInput newInput__iTwistAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT2__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
	}
	...
	public WTCOutput getOutput__oNorthDirection() {
		if (output__oNorthDirection != null && output__oNorthDirection.eIsProxy()) {
			...
			if (output__oNorthDirection != oldOutput__oNorthDirection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT2__OUTPUT_ONORTH_DIRECTION, oldOutput__oNorthDirection, output__oNorthDirection));
			}
		}
	...
	public void setOutput__oNorthDirection(WTCOutput newOutput__oNorthDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT2__OUTPUT_ONORTH_DIRECTION, oldOutput__oNorthDirection, output__oNorthDirection));
	}
	...
	public WTCParam getParameter__pNorthOffset() {
		if (parameter__pNorthOffset != null && parameter__pNorthOffset.eIsProxy()) {
			...
			if (parameter__pNorthOffset != oldParameter__pNorthOffset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT2__PARAMETER_PNORTH_OFFSET, oldParameter__pNorthOffset, parameter__pNorthOffset));
			}
		}
	...
	public void setParameter__pNorthOffset(WTCParam newParameter__pNorthOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT2__PARAMETER_PNORTH_OFFSET, oldParameter__pNorthOffset, parameter__pNorthOffset));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT2__INPUT_ITWIST_ANGLE:
				if (resolve) return getInput__iTwistAngle();
				return basicGetInput__iTwistAngle();
			case WtspecidPackage.CTRL_UNIT2__OUTPUT_ONORTH_DIRECTION:
				if (resolve) return getOutput__oNorthDirection();
				return basicGetOutput__oNorthDirection();
			case WtspecidPackage.CTRL_UNIT2__PARAMETER_PNORTH_OFFSET:

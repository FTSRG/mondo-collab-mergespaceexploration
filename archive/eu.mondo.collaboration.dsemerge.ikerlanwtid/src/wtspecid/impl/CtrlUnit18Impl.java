 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getInput__iOrderCw <em>Input iOrder Cw</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getInput__iOrderCcw <em>Input iOrder Ccw</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getInput__iFault <em>Input iFault</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getInput__iCmdDisable <em>Input iCmd Disable</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getInput__iCmdReset <em>Input iCmd Reset</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getInput__iStaReadyToOn <em>Input iSta Ready To On</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getOutput__oControlWord <em>Output oControl Word</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getParameter__pCmdDisabled <em>Parameter pCmd Disabled</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getParameter__pCmdEnabled <em>Parameter pCmd Enabled</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getParameter__pCmdCw <em>Parameter pCmd Cw</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getParameter__pCmdCcw <em>Parameter pCmd Ccw</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getParameter__pCmdReset <em>Parameter pCmd Reset</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getParameter__pCmdSwitchOn <em>Parameter pCmd Switch On</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getParameter__pCmdBraking <em>Parameter pCmd Braking</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit18Impl#getTimer__tDelay <em>Timer tDelay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit18Impl extends wtcImpl implements CtrlUnit18 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit18();
	}
		...
		if (input__iOrderCw != null && input__iOrderCw.eIsProxy()) {
			...
			if (input__iOrderCw != oldInput__iOrderCw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__INPUT_IORDER_CW, oldInput__iOrderCw, input__iOrderCw));
			}
		}
	...
	public void setInput__iOrderCw(WTCInput newInput__iOrderCw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__INPUT_IORDER_CW, oldInput__iOrderCw, input__iOrderCw));
	}
	...
	public WTCInput getInput__iOrderCcw() {
		if (input__iOrderCcw != null && input__iOrderCcw.eIsProxy()) {
			...
			if (input__iOrderCcw != oldInput__iOrderCcw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__INPUT_IORDER_CCW, oldInput__iOrderCcw, input__iOrderCcw));
			}
		}
	...
	public void setInput__iOrderCcw(WTCInput newInput__iOrderCcw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__INPUT_IORDER_CCW, oldInput__iOrderCcw, input__iOrderCcw));
	}
	...
	public WTCInput getInput__iFault() {
		if (input__iFault != null && input__iFault.eIsProxy()) {
			...
			if (input__iFault != oldInput__iFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__INPUT_IFAULT, oldInput__iFault, input__iFault));
			}
		}
	...
	public void setInput__iFault(WTCInput newInput__iFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__INPUT_IFAULT, oldInput__iFault, input__iFault));
	}
	...
	public WTCInput getInput__iCmdDisable() {
		if (input__iCmdDisable != null && input__iCmdDisable.eIsProxy()) {
			...
			if (input__iCmdDisable != oldInput__iCmdDisable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__INPUT_ICMD_DISABLE, oldInput__iCmdDisable, input__iCmdDisable));
			}
		}
	...
	public void setInput__iCmdDisable(WTCInput newInput__iCmdDisable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__INPUT_ICMD_DISABLE, oldInput__iCmdDisable, input__iCmdDisable));
	}
	...
	public WTCInput getInput__iCmdReset() {
		if (input__iCmdReset != null && input__iCmdReset.eIsProxy()) {
			...
			if (input__iCmdReset != oldInput__iCmdReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__INPUT_ICMD_RESET, oldInput__iCmdReset, input__iCmdReset));
			}
		}
	...
	public void setInput__iCmdReset(WTCInput newInput__iCmdReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__INPUT_ICMD_RESET, oldInput__iCmdReset, input__iCmdReset));
	}
	...
	public WTCInput getInput__iStaReadyToOn() {
		if (input__iStaReadyToOn != null && input__iStaReadyToOn.eIsProxy()) {
			...
			if (input__iStaReadyToOn != oldInput__iStaReadyToOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__INPUT_ISTA_READY_TO_ON, oldInput__iStaReadyToOn, input__iStaReadyToOn));
			}
		}
	...
	public void setInput__iStaReadyToOn(WTCInput newInput__iStaReadyToOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__INPUT_ISTA_READY_TO_ON, oldInput__iStaReadyToOn, input__iStaReadyToOn));
	}
	...
	public WTCOutput getOutput__oControlWord() {
		if (output__oControlWord != null && output__oControlWord.eIsProxy()) {
			...
			if (output__oControlWord != oldOutput__oControlWord) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__OUTPUT_OCONTROL_WORD, oldOutput__oControlWord, output__oControlWord));
			}
		}
	...
	public void setOutput__oControlWord(WTCOutput newOutput__oControlWord) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__OUTPUT_OCONTROL_WORD, oldOutput__oControlWord, output__oControlWord));
	}
	...
	public WTCParam getParameter__pCmdDisabled() {
		if (parameter__pCmdDisabled != null && parameter__pCmdDisabled.eIsProxy()) {
			...
			if (parameter__pCmdDisabled != oldParameter__pCmdDisabled) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_DISABLED, oldParameter__pCmdDisabled, parameter__pCmdDisabled));
			}
		}
	...
	public void setParameter__pCmdDisabled(WTCParam newParameter__pCmdDisabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_DISABLED, oldParameter__pCmdDisabled, parameter__pCmdDisabled));
	}
	...
	public WTCParam getParameter__pCmdEnabled() {
		if (parameter__pCmdEnabled != null && parameter__pCmdEnabled.eIsProxy()) {
			...
			if (parameter__pCmdEnabled != oldParameter__pCmdEnabled) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_ENABLED, oldParameter__pCmdEnabled, parameter__pCmdEnabled));
			}
		}
	...
	public void setParameter__pCmdEnabled(WTCParam newParameter__pCmdEnabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_ENABLED, oldParameter__pCmdEnabled, parameter__pCmdEnabled));
	}
	...
	public WTCParam getParameter__pCmdCw() {
		if (parameter__pCmdCw != null && parameter__pCmdCw.eIsProxy()) {
			...
			if (parameter__pCmdCw != oldParameter__pCmdCw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_CW, oldParameter__pCmdCw, parameter__pCmdCw));
			}
		}
	...
	public void setParameter__pCmdCw(WTCParam newParameter__pCmdCw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_CW, oldParameter__pCmdCw, parameter__pCmdCw));
	}
	...
	public WTCParam getParameter__pCmdCcw() {
		if (parameter__pCmdCcw != null && parameter__pCmdCcw.eIsProxy()) {
			...
			if (parameter__pCmdCcw != oldParameter__pCmdCcw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_CCW, oldParameter__pCmdCcw, parameter__pCmdCcw));
			}
		}
	...
	public void setParameter__pCmdCcw(WTCParam newParameter__pCmdCcw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_CCW, oldParameter__pCmdCcw, parameter__pCmdCcw));
	}
	...
	public WTCParam getParameter__pCmdReset() {
		if (parameter__pCmdReset != null && parameter__pCmdReset.eIsProxy()) {
			...
			if (parameter__pCmdReset != oldParameter__pCmdReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_RESET, oldParameter__pCmdReset, parameter__pCmdReset));
			}
		}
	...
	public void setParameter__pCmdReset(WTCParam newParameter__pCmdReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_RESET, oldParameter__pCmdReset, parameter__pCmdReset));
	}
	...
	public WTCParam getParameter__pCmdSwitchOn() {
		if (parameter__pCmdSwitchOn != null && parameter__pCmdSwitchOn.eIsProxy()) {
			...
			if (parameter__pCmdSwitchOn != oldParameter__pCmdSwitchOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_SWITCH_ON, oldParameter__pCmdSwitchOn, parameter__pCmdSwitchOn));
			}
		}
	...
	public void setParameter__pCmdSwitchOn(WTCParam newParameter__pCmdSwitchOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_SWITCH_ON, oldParameter__pCmdSwitchOn, parameter__pCmdSwitchOn));
	}
	...
	public WTCParam getParameter__pCmdBraking() {
		if (parameter__pCmdBraking != null && parameter__pCmdBraking.eIsProxy()) {
			...
			if (parameter__pCmdBraking != oldParameter__pCmdBraking) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_BRAKING, oldParameter__pCmdBraking, parameter__pCmdBraking));
			}
		}
	...
	public void setParameter__pCmdBraking(WTCParam newParameter__pCmdBraking) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__PARAMETER_PCMD_BRAKING, oldParameter__pCmdBraking, parameter__pCmdBraking));
	}
	...
	public WTCTimer getTimer__tDelay() {
		if (timer__tDelay != null && timer__tDelay.eIsProxy()) {
			...
			if (timer__tDelay != oldTimer__tDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT18__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
			}
		}
	...
	public void setTimer__tDelay(WTCTimer newTimer__tDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT18__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
	}

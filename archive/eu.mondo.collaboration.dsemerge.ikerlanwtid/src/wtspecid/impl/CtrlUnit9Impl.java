 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getInput__iValueToCheck <em>Input iValue To Check</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getInput__iLimitValue <em>Input iLimit Value</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getInput__iLimitReset <em>Input iLimit Reset</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getOutput__oLimitReached <em>Output oLimit Reached</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getParameter__pLimitValue <em>Parameter pLimit Value</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getParameter__pLimitReset <em>Parameter pLimit Reset</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getTimer__tDelay <em>Timer tDelay</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit9Impl#getBhvParam__bpLimitsType <em>Bhv Param bp Limits Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit9Impl extends wtcImpl implements CtrlUnit9 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit9();
	}
		...
		if (input__iValueToCheck != null && input__iValueToCheck.eIsProxy()) {
			...
			if (input__iValueToCheck != oldInput__iValueToCheck) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT9__INPUT_IVALUE_TO_CHECK, oldInput__iValueToCheck, input__iValueToCheck));
			}
		}
	...
	public void setInput__iValueToCheck(WTCInput newInput__iValueToCheck) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__INPUT_IVALUE_TO_CHECK, oldInput__iValueToCheck, input__iValueToCheck));
	}
	...
	public WTCInput getInput__iDontCheckInput() {
		if (input__iDontCheckInput != null && input__iDontCheckInput.eIsProxy()) {
			...
			if (input__iDontCheckInput != oldInput__iDontCheckInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT9__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
			}
		}
	...
	public void setInput__iDontCheckInput(WTCInput newInput__iDontCheckInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
	}
	...
	public WTCInput getInput__iLimitValue() {
		if (input__iLimitValue != null && input__iLimitValue.eIsProxy()) {
			...
			if (input__iLimitValue != oldInput__iLimitValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT9__INPUT_ILIMIT_VALUE, oldInput__iLimitValue, input__iLimitValue));
			}
		}
	...
	public void setInput__iLimitValue(WTCInput newInput__iLimitValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__INPUT_ILIMIT_VALUE, oldInput__iLimitValue, input__iLimitValue));
	}
	...
	public WTCInput getInput__iLimitReset() {
		if (input__iLimitReset != null && input__iLimitReset.eIsProxy()) {
			...
			if (input__iLimitReset != oldInput__iLimitReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT9__INPUT_ILIMIT_RESET, oldInput__iLimitReset, input__iLimitReset));
			}
		}
	...
	public void setInput__iLimitReset(WTCInput newInput__iLimitReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__INPUT_ILIMIT_RESET, oldInput__iLimitReset, input__iLimitReset));
	}
	...
	public WTCOutput getOutput__oLimitReached() {
		if (output__oLimitReached != null && output__oLimitReached.eIsProxy()) {
			...
			if (output__oLimitReached != oldOutput__oLimitReached) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT9__OUTPUT_OLIMIT_REACHED, oldOutput__oLimitReached, output__oLimitReached));
			}
		}
	...
	public void setOutput__oLimitReached(WTCOutput newOutput__oLimitReached) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__OUTPUT_OLIMIT_REACHED, oldOutput__oLimitReached, output__oLimitReached));
	}
	...
	public WTCParam getParameter__pLimitValue() {
		if (parameter__pLimitValue != null && parameter__pLimitValue.eIsProxy()) {
			...
			if (parameter__pLimitValue != oldParameter__pLimitValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT9__PARAMETER_PLIMIT_VALUE, oldParameter__pLimitValue, parameter__pLimitValue));
			}
		}
	...
	public void setParameter__pLimitValue(WTCParam newParameter__pLimitValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__PARAMETER_PLIMIT_VALUE, oldParameter__pLimitValue, parameter__pLimitValue));
	}
	...
	public WTCParam getParameter__pLimitReset() {
		if (parameter__pLimitReset != null && parameter__pLimitReset.eIsProxy()) {
			...
			if (parameter__pLimitReset != oldParameter__pLimitReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT9__PARAMETER_PLIMIT_RESET, oldParameter__pLimitReset, parameter__pLimitReset));
			}
		}
	...
	public void setParameter__pLimitReset(WTCParam newParameter__pLimitReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__PARAMETER_PLIMIT_RESET, oldParameter__pLimitReset, parameter__pLimitReset));
	}
	...
	public WTCTimer getTimer__tDelay() {
		if (timer__tDelay != null && timer__tDelay.eIsProxy()) {
			...
			if (timer__tDelay != oldTimer__tDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT9__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
			}
		}
	...
	public void setTimer__tDelay(WTCTimer newTimer__tDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
	}
	...
	public void setBhvParam__bpMode(String newBhvParam__bpMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__BHV_PARAM_BP_MODE, oldBhvParam__bpMode, bhvParam__bpMode));
	}
	...
	public void setBhvParam__bpLimitsType(String newBhvParam__bpLimitsType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT9__BHV_PARAM_BP_LIMITS_TYPE, oldBhvParam__bpLimitsType, bhvParam__bpLimitsType));
	}

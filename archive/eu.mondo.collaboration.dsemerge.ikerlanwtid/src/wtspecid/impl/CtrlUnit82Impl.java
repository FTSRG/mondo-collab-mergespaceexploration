 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit82Impl#getInput__iVarInput <em>Input iVar Input</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit82Impl#getInput__iWriteTwistAngleRequest <em>Input iWrite Twist Angle Request</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit82Impl#getInput__iNewTwistAngleValue <em>Input iNew Twist Angle Value</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit82Impl#getOutput__oVarOutput <em>Output oVar Output</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit82Impl#getParameter__pMinDifferenceToConsider <em>Parameter pMin Difference To Consider</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit82Impl#getTimer__tSyncDelay <em>Timer tSync Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit82Impl extends wtcImpl implements CtrlUnit82 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit82();
	}
		...
		if (input__iVarInput != null && input__iVarInput.eIsProxy()) {
			...
			if (input__iVarInput != oldInput__iVarInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT82__INPUT_IVAR_INPUT, oldInput__iVarInput, input__iVarInput));
			}
		}
	...
	public void setInput__iVarInput(WTCInput newInput__iVarInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT82__INPUT_IVAR_INPUT, oldInput__iVarInput, input__iVarInput));
	}
	...
	public WTCInput getInput__iWriteTwistAngleRequest() {
		if (input__iWriteTwistAngleRequest != null && input__iWriteTwistAngleRequest.eIsProxy()) {
			...
			if (input__iWriteTwistAngleRequest != oldInput__iWriteTwistAngleRequest) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT82__INPUT_IWRITE_TWIST_ANGLE_REQUEST, oldInput__iWriteTwistAngleRequest, input__iWriteTwistAngleRequest));
			}
		}
	...
	public void setInput__iWriteTwistAngleRequest(WTCInput newInput__iWriteTwistAngleRequest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT82__INPUT_IWRITE_TWIST_ANGLE_REQUEST, oldInput__iWriteTwistAngleRequest, input__iWriteTwistAngleRequest));
	}
	...
	public WTCInput getInput__iNewTwistAngleValue() {
		if (input__iNewTwistAngleValue != null && input__iNewTwistAngleValue.eIsProxy()) {
			...
			if (input__iNewTwistAngleValue != oldInput__iNewTwistAngleValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT82__INPUT_INEW_TWIST_ANGLE_VALUE, oldInput__iNewTwistAngleValue, input__iNewTwistAngleValue));
			}
		}
	...
	public void setInput__iNewTwistAngleValue(WTCInput newInput__iNewTwistAngleValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT82__INPUT_INEW_TWIST_ANGLE_VALUE, oldInput__iNewTwistAngleValue, input__iNewTwistAngleValue));
	}
	...
	public WTCOutput getOutput__oVarOutput() {
		if (output__oVarOutput != null && output__oVarOutput.eIsProxy()) {
			...
			if (output__oVarOutput != oldOutput__oVarOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT82__OUTPUT_OVAR_OUTPUT, oldOutput__oVarOutput, output__oVarOutput));
			}
		}
	...
	public void setOutput__oVarOutput(WTCOutput newOutput__oVarOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT82__OUTPUT_OVAR_OUTPUT, oldOutput__oVarOutput, output__oVarOutput));
	}
	...
	public WTCParam getParameter__pMinDifferenceToConsider() {
		if (parameter__pMinDifferenceToConsider != null && parameter__pMinDifferenceToConsider.eIsProxy()) {
			...
			if (parameter__pMinDifferenceToConsider != oldParameter__pMinDifferenceToConsider) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT82__PARAMETER_PMIN_DIFFERENCE_TO_CONSIDER, oldParameter__pMinDifferenceToConsider, parameter__pMinDifferenceToConsider));
			}
		}
	...
	public void setParameter__pMinDifferenceToConsider(WTCParam newParameter__pMinDifferenceToConsider) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT82__PARAMETER_PMIN_DIFFERENCE_TO_CONSIDER, oldParameter__pMinDifferenceToConsider, parameter__pMinDifferenceToConsider));
	}
	...
	public WTCTimer getTimer__tSyncDelay() {
		if (timer__tSyncDelay != null && timer__tSyncDelay.eIsProxy()) {
			...
			if (timer__tSyncDelay != oldTimer__tSyncDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT82__TIMER_TSYNC_DELAY, oldTimer__tSyncDelay, timer__tSyncDelay));
			}
		}
	...
	public void setTimer__tSyncDelay(WTCTimer newTimer__tSyncDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT82__TIMER_TSYNC_DELAY, oldTimer__tSyncDelay, timer__tSyncDelay));
	}

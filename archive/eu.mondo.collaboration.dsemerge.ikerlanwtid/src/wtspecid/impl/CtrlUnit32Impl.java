 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit32Impl#getOutput__oChangeCmd <em>Output oChange Cmd</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit32Impl#getOutput__oPersistentHour <em>Output oPersistent Hour</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit32Impl#getParameter__pDayChangeHour <em>Parameter pDay Change Hour</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit32Impl extends wtcImpl implements CtrlUnit32 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit32();
	}
		...
		if (output__oChangeCmd != null && output__oChangeCmd.eIsProxy()) {
			...
			if (output__oChangeCmd != oldOutput__oChangeCmd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT32__OUTPUT_OCHANGE_CMD, oldOutput__oChangeCmd, output__oChangeCmd));
			}
		}
	...
	public void setOutput__oChangeCmd(WTCOutput newOutput__oChangeCmd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT32__OUTPUT_OCHANGE_CMD, oldOutput__oChangeCmd, output__oChangeCmd));
	}
	...
	public WTCOutput getOutput__oPersistentHour() {
		if (output__oPersistentHour != null && output__oPersistentHour.eIsProxy()) {
			...
			if (output__oPersistentHour != oldOutput__oPersistentHour) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT32__OUTPUT_OPERSISTENT_HOUR, oldOutput__oPersistentHour, output__oPersistentHour));
			}
		}
	...
	public void setOutput__oPersistentHour(WTCOutput newOutput__oPersistentHour) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT32__OUTPUT_OPERSISTENT_HOUR, oldOutput__oPersistentHour, output__oPersistentHour));
	}
	...
	public WTCParam getParameter__pDayChangeHour() {
		if (parameter__pDayChangeHour != null && parameter__pDayChangeHour.eIsProxy()) {
			...
			if (parameter__pDayChangeHour != oldParameter__pDayChangeHour) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT32__PARAMETER_PDAY_CHANGE_HOUR, oldParameter__pDayChangeHour, parameter__pDayChangeHour));
			}
		}
	...
	public void setParameter__pDayChangeHour(WTCParam newParameter__pDayChangeHour) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT32__PARAMETER_PDAY_CHANGE_HOUR, oldParameter__pDayChangeHour, parameter__pDayChangeHour));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT32__OUTPUT_OCHANGE_CMD:
				if (resolve) return getOutput__oChangeCmd();
				return basicGetOutput__oChangeCmd();
			case WtspecidPackage.CTRL_UNIT32__OUTPUT_OPERSISTENT_HOUR:
				if (resolve) return getOutput__oPersistentHour();
				return basicGetOutput__oPersistentHour();
			case WtspecidPackage.CTRL_UNIT32__PARAMETER_PDAY_CHANGE_HOUR:

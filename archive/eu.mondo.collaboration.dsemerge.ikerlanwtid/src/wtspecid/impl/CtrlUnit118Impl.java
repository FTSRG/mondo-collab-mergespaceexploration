 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit118Impl#getInput__iYawBrakeStatus <em>Input iYaw Brake Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit118Impl#getInput__iRetwistPreCommand <em>Input iRetwist Pre Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit118Impl#getInput__iYawBrakeCommand <em>Input iYaw Brake Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit118Impl#getOutput__oYawHydraulicbrake2Order <em>Output oYaw Hydraulicbrake2 Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit118Impl extends wtcImpl implements CtrlUnit118 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit118();
	}
		...
		if (input__iYawBrakeStatus != null && input__iYawBrakeStatus.eIsProxy()) {
			...
			if (input__iYawBrakeStatus != oldInput__iYawBrakeStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT118__INPUT_IYAW_BRAKE_STATUS, oldInput__iYawBrakeStatus, input__iYawBrakeStatus));
			}
		}
	...
	public void setInput__iYawBrakeStatus(WTCInput newInput__iYawBrakeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT118__INPUT_IYAW_BRAKE_STATUS, oldInput__iYawBrakeStatus, input__iYawBrakeStatus));
	}
	...
	public WTCInput getInput__iRetwistPreCommand() {
		if (input__iRetwistPreCommand != null && input__iRetwistPreCommand.eIsProxy()) {
			...
			if (input__iRetwistPreCommand != oldInput__iRetwistPreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT118__INPUT_IRETWIST_PRE_COMMAND, oldInput__iRetwistPreCommand, input__iRetwistPreCommand));
			}
		}
	...
	public void setInput__iRetwistPreCommand(WTCInput newInput__iRetwistPreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT118__INPUT_IRETWIST_PRE_COMMAND, oldInput__iRetwistPreCommand, input__iRetwistPreCommand));
	}
	...
	public WTCInput getInput__iYawBrakeCommand() {
		if (input__iYawBrakeCommand != null && input__iYawBrakeCommand.eIsProxy()) {
			...
			if (input__iYawBrakeCommand != oldInput__iYawBrakeCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT118__INPUT_IYAW_BRAKE_COMMAND, oldInput__iYawBrakeCommand, input__iYawBrakeCommand));
			}
		}
	...
	public void setInput__iYawBrakeCommand(WTCInput newInput__iYawBrakeCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT118__INPUT_IYAW_BRAKE_COMMAND, oldInput__iYawBrakeCommand, input__iYawBrakeCommand));
	}
	...
	public WTCOutput getOutput__oYawHydraulicbrake2Order() {
		if (output__oYawHydraulicbrake2Order != null && output__oYawHydraulicbrake2Order.eIsProxy()) {
			...
			if (output__oYawHydraulicbrake2Order != oldOutput__oYawHydraulicbrake2Order) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT118__OUTPUT_OYAW_HYDRAULICBRAKE2_ORDER, oldOutput__oYawHydraulicbrake2Order, output__oYawHydraulicbrake2Order));
			}
		}
	...
	public void setOutput__oYawHydraulicbrake2Order(WTCOutput newOutput__oYawHydraulicbrake2Order) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT118__OUTPUT_OYAW_HYDRAULICBRAKE2_ORDER, oldOutput__oYawHydraulicbrake2Order, output__oYawHydraulicbrake2Order));
	}

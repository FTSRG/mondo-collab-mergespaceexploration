 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit88Impl#getInput__iPthResetCommand <em>Input iPth Reset Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit88Impl#getInput__iPthResetOrder <em>Input iPth Reset Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit88Impl#getOutput__oPthResetCommand <em>Output oPth Reset Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit88Impl#getOutput__oPthResetOrder <em>Output oPth Reset Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit88Impl#getOutput__oPthReset <em>Output oPth Reset</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit88Impl#getTimer__tResetTimer <em>Timer tReset Timer</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit88Impl#getTimer__tTimeBetweenResets <em>Timer tTime Between Resets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit88Impl extends wtcImpl implements CtrlUnit88 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit88();
	}
		...
		if (input__iPthResetCommand != null && input__iPthResetCommand.eIsProxy()) {
			...
			if (input__iPthResetCommand != oldInput__iPthResetCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT88__INPUT_IPTH_RESET_COMMAND, oldInput__iPthResetCommand, input__iPthResetCommand));
			}
		}
	...
	public void setInput__iPthResetCommand(WTCInput newInput__iPthResetCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT88__INPUT_IPTH_RESET_COMMAND, oldInput__iPthResetCommand, input__iPthResetCommand));
	}
	...
	public WTCInput getInput__iPthResetOrder() {
		if (input__iPthResetOrder != null && input__iPthResetOrder.eIsProxy()) {
			...
			if (input__iPthResetOrder != oldInput__iPthResetOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT88__INPUT_IPTH_RESET_ORDER, oldInput__iPthResetOrder, input__iPthResetOrder));
			}
		}
	...
	public void setInput__iPthResetOrder(WTCInput newInput__iPthResetOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT88__INPUT_IPTH_RESET_ORDER, oldInput__iPthResetOrder, input__iPthResetOrder));
	}
	...
	public WTCOutput getOutput__oPthResetCommand() {
		if (output__oPthResetCommand != null && output__oPthResetCommand.eIsProxy()) {
			...
			if (output__oPthResetCommand != oldOutput__oPthResetCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT88__OUTPUT_OPTH_RESET_COMMAND, oldOutput__oPthResetCommand, output__oPthResetCommand));
			}
		}
	...
	public void setOutput__oPthResetCommand(WTCOutput newOutput__oPthResetCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT88__OUTPUT_OPTH_RESET_COMMAND, oldOutput__oPthResetCommand, output__oPthResetCommand));
	}
	...
	public WTCOutput getOutput__oPthResetOrder() {
		if (output__oPthResetOrder != null && output__oPthResetOrder.eIsProxy()) {
			...
			if (output__oPthResetOrder != oldOutput__oPthResetOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT88__OUTPUT_OPTH_RESET_ORDER, oldOutput__oPthResetOrder, output__oPthResetOrder));
			}
		}
	...
	public void setOutput__oPthResetOrder(WTCOutput newOutput__oPthResetOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT88__OUTPUT_OPTH_RESET_ORDER, oldOutput__oPthResetOrder, output__oPthResetOrder));
	}
	...
	public WTCOutput getOutput__oPthReset() {
		if (output__oPthReset != null && output__oPthReset.eIsProxy()) {
			...
			if (output__oPthReset != oldOutput__oPthReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT88__OUTPUT_OPTH_RESET, oldOutput__oPthReset, output__oPthReset));
			}
		}
	...
	public void setOutput__oPthReset(WTCOutput newOutput__oPthReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT88__OUTPUT_OPTH_RESET, oldOutput__oPthReset, output__oPthReset));
	}
	...
	public WTCTimer getTimer__tResetTimer() {
		if (timer__tResetTimer != null && timer__tResetTimer.eIsProxy()) {
			...
			if (timer__tResetTimer != oldTimer__tResetTimer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT88__TIMER_TRESET_TIMER, oldTimer__tResetTimer, timer__tResetTimer));
			}
		}
	...
	public void setTimer__tResetTimer(WTCTimer newTimer__tResetTimer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT88__TIMER_TRESET_TIMER, oldTimer__tResetTimer, timer__tResetTimer));
	}
	...
	public WTCTimer getTimer__tTimeBetweenResets() {
		if (timer__tTimeBetweenResets != null && timer__tTimeBetweenResets.eIsProxy()) {
			...
			if (timer__tTimeBetweenResets != oldTimer__tTimeBetweenResets) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT88__TIMER_TTIME_BETWEEN_RESETS, oldTimer__tTimeBetweenResets, timer__tTimeBetweenResets));
			}
		}
	...
	public void setTimer__tTimeBetweenResets(WTCTimer newTimer__tTimeBetweenResets) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT88__TIMER_TTIME_BETWEEN_RESETS, oldTimer__tTimeBetweenResets, timer__tTimeBetweenResets));
	}

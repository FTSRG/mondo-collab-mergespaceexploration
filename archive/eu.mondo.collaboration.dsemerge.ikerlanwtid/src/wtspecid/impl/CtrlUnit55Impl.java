 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit55Impl#getOutput__oSignal <em>Output oSignal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit55Impl extends wtcImpl implements CtrlUnit55 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit55();
	}
		...
		if (output__oSignal != null && output__oSignal.eIsProxy()) {
			...
			if (output__oSignal != oldOutput__oSignal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT55__OUTPUT_OSIGNAL, oldOutput__oSignal, output__oSignal));
			}
		}
	...
	public void setOutput__oSignal(WTCOutput newOutput__oSignal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT55__OUTPUT_OSIGNAL, oldOutput__oSignal, output__oSignal));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT55__OUTPUT_OSIGNAL:

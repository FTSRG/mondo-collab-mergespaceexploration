 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit109Impl#getInput__iInvHwRun <em>Input iInv Hw Run</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit109Impl#getInput__iVoltageDrop <em>Input iVoltage Drop</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit109Impl#getInput__iTorqueDemand <em>Input iTorque Demand</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit109Impl#getInput__iInvStopOrder <em>Input iInv Stop Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit109Impl#getOutput__oTorqueReference <em>Output oTorque Reference</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit109Impl#getErrorReaction__erStop <em>Error Reaction er Stop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit109Impl extends wtcImpl implements CtrlUnit109 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit109();
	}
		...
		if (input__iInvHwRun != null && input__iInvHwRun.eIsProxy()) {
			...
			if (input__iInvHwRun != oldInput__iInvHwRun) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT109__INPUT_IINV_HW_RUN, oldInput__iInvHwRun, input__iInvHwRun));
			}
		}
	...
	public void setInput__iInvHwRun(WTCInput newInput__iInvHwRun) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT109__INPUT_IINV_HW_RUN, oldInput__iInvHwRun, input__iInvHwRun));
	}
	...
	public WTCInput getInput__iVoltageDrop() {
		if (input__iVoltageDrop != null && input__iVoltageDrop.eIsProxy()) {
			...
			if (input__iVoltageDrop != oldInput__iVoltageDrop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT109__INPUT_IVOLTAGE_DROP, oldInput__iVoltageDrop, input__iVoltageDrop));
			}
		}
	...
	public void setInput__iVoltageDrop(WTCInput newInput__iVoltageDrop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT109__INPUT_IVOLTAGE_DROP, oldInput__iVoltageDrop, input__iVoltageDrop));
	}
	...
	public WTCInput getInput__iTorqueDemand() {
		if (input__iTorqueDemand != null && input__iTorqueDemand.eIsProxy()) {
			...
			if (input__iTorqueDemand != oldInput__iTorqueDemand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT109__INPUT_ITORQUE_DEMAND, oldInput__iTorqueDemand, input__iTorqueDemand));
			}
		}
	...
	public void setInput__iTorqueDemand(WTCInput newInput__iTorqueDemand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT109__INPUT_ITORQUE_DEMAND, oldInput__iTorqueDemand, input__iTorqueDemand));
	}
	...
	public WTCInput getInput__iInvStopOrder() {
		if (input__iInvStopOrder != null && input__iInvStopOrder.eIsProxy()) {
			...
			if (input__iInvStopOrder != oldInput__iInvStopOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT109__INPUT_IINV_STOP_ORDER, oldInput__iInvStopOrder, input__iInvStopOrder));
			}
		}
	...
	public void setInput__iInvStopOrder(WTCInput newInput__iInvStopOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT109__INPUT_IINV_STOP_ORDER, oldInput__iInvStopOrder, input__iInvStopOrder));
	}
	...
	public WTCOutput getOutput__oTorqueReference() {
		if (output__oTorqueReference != null && output__oTorqueReference.eIsProxy()) {
			...
			if (output__oTorqueReference != oldOutput__oTorqueReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT109__OUTPUT_OTORQUE_REFERENCE, oldOutput__oTorqueReference, output__oTorqueReference));
			}
		}
	...
	public void setOutput__oTorqueReference(WTCOutput newOutput__oTorqueReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT109__OUTPUT_OTORQUE_REFERENCE, oldOutput__oTorqueReference, output__oTorqueReference));
	}
	...
	public WTCErrorReaction getErrorReaction__erStop() {
		if (errorReaction__erStop != null && errorReaction__erStop.eIsProxy()) {
			...
			if (errorReaction__erStop != oldErrorReaction__erStop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT109__ERROR_REACTION_ER_STOP, oldErrorReaction__erStop, errorReaction__erStop));
			}
		}
	...
	public void setErrorReaction__erStop(WTCErrorReaction newErrorReaction__erStop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT109__ERROR_REACTION_ER_STOP, oldErrorReaction__erStop, errorReaction__erStop));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit22Impl#getInput__iYawStatus <em>Input iYaw Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit22Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit22Impl#getInput__iMaxTwistCW <em>Input iMax Twist CW</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit22Impl#getInput__iMaxTwistCCW <em>Input iMax Twist CCW</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit22Impl#getOutput__oMaxTwistPreCommand <em>Output oMax Twist Pre Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit22Impl#getParameter__pMaxTwistHysteresis <em>Parameter pMax Twist Hysteresis</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit22Impl#getFault__fTwistExcessiveCW <em>Fault fTwist Excessive CW</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit22Impl#getFault__fTwistExcessiveCCW <em>Fault fTwist Excessive CCW</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit22Impl extends wtcImpl implements CtrlUnit22 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit22();
	}
		...
		if (input__iYawStatus != null && input__iYawStatus.eIsProxy()) {
			...
			if (input__iYawStatus != oldInput__iYawStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT22__INPUT_IYAW_STATUS, oldInput__iYawStatus, input__iYawStatus));
			}
		}
	...
	public void setInput__iYawStatus(WTCInput newInput__iYawStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT22__INPUT_IYAW_STATUS, oldInput__iYawStatus, input__iYawStatus));
	}
	...
	public WTCInput getInput__iTwistAngle() {
		if (input__iTwistAngle != null && input__iTwistAngle.eIsProxy()) {
			...
			if (input__iTwistAngle != oldInput__iTwistAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT22__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
			}
		}
	...
	public void setInput__iTwistAngle(WTCInput newInput__iTwistAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT22__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
	}
	...
	public WTCInput getInput__iMaxTwistCW() {
		if (input__iMaxTwistCW != null && input__iMaxTwistCW.eIsProxy()) {
			...
			if (input__iMaxTwistCW != oldInput__iMaxTwistCW) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT22__INPUT_IMAX_TWIST_CW, oldInput__iMaxTwistCW, input__iMaxTwistCW));
			}
		}
	...
	public void setInput__iMaxTwistCW(WTCInput newInput__iMaxTwistCW) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT22__INPUT_IMAX_TWIST_CW, oldInput__iMaxTwistCW, input__iMaxTwistCW));
	}
	...
	public WTCInput getInput__iMaxTwistCCW() {
		if (input__iMaxTwistCCW != null && input__iMaxTwistCCW.eIsProxy()) {
			...
			if (input__iMaxTwistCCW != oldInput__iMaxTwistCCW) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT22__INPUT_IMAX_TWIST_CCW, oldInput__iMaxTwistCCW, input__iMaxTwistCCW));
			}
		}
	...
	public void setInput__iMaxTwistCCW(WTCInput newInput__iMaxTwistCCW) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT22__INPUT_IMAX_TWIST_CCW, oldInput__iMaxTwistCCW, input__iMaxTwistCCW));
	}
	...
	public WTCOutput getOutput__oMaxTwistPreCommand() {
		if (output__oMaxTwistPreCommand != null && output__oMaxTwistPreCommand.eIsProxy()) {
			...
			if (output__oMaxTwistPreCommand != oldOutput__oMaxTwistPreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT22__OUTPUT_OMAX_TWIST_PRE_COMMAND, oldOutput__oMaxTwistPreCommand, output__oMaxTwistPreCommand));
			}
		}
	...
	public void setOutput__oMaxTwistPreCommand(WTCOutput newOutput__oMaxTwistPreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT22__OUTPUT_OMAX_TWIST_PRE_COMMAND, oldOutput__oMaxTwistPreCommand, output__oMaxTwistPreCommand));
	}
	...
	public WTCParam getParameter__pMaxTwistHysteresis() {
		if (parameter__pMaxTwistHysteresis != null && parameter__pMaxTwistHysteresis.eIsProxy()) {
			...
			if (parameter__pMaxTwistHysteresis != oldParameter__pMaxTwistHysteresis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT22__PARAMETER_PMAX_TWIST_HYSTERESIS, oldParameter__pMaxTwistHysteresis, parameter__pMaxTwistHysteresis));
			}
		}
	...
	public void setParameter__pMaxTwistHysteresis(WTCParam newParameter__pMaxTwistHysteresis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT22__PARAMETER_PMAX_TWIST_HYSTERESIS, oldParameter__pMaxTwistHysteresis, parameter__pMaxTwistHysteresis));
	}
	...
	public WTCFault getFault__fTwistExcessiveCW() {
		if (fault__fTwistExcessiveCW != null && fault__fTwistExcessiveCW.eIsProxy()) {
			...
			if (fault__fTwistExcessiveCW != oldFault__fTwistExcessiveCW) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT22__FAULT_FTWIST_EXCESSIVE_CW, oldFault__fTwistExcessiveCW, fault__fTwistExcessiveCW));
			}
		}
	...
	public void setFault__fTwistExcessiveCW(WTCFault newFault__fTwistExcessiveCW) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT22__FAULT_FTWIST_EXCESSIVE_CW, oldFault__fTwistExcessiveCW, fault__fTwistExcessiveCW));
	}
	...
	public WTCFault getFault__fTwistExcessiveCCW() {
		if (fault__fTwistExcessiveCCW != null && fault__fTwistExcessiveCCW.eIsProxy()) {
			...
			if (fault__fTwistExcessiveCCW != oldFault__fTwistExcessiveCCW) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT22__FAULT_FTWIST_EXCESSIVE_CCW, oldFault__fTwistExcessiveCCW, fault__fTwistExcessiveCCW));
			}
		}
	...
	public void setFault__fTwistExcessiveCCW(WTCFault newFault__fTwistExcessiveCCW) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT22__FAULT_FTWIST_EXCESSIVE_CCW, oldFault__fTwistExcessiveCCW, fault__fTwistExcessiveCCW));
	}

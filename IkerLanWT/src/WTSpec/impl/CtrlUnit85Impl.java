 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit85Impl#getInput__iPitchAngle1 <em>Input iPitch Angle1</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit85Impl#getInput__iPitchAngle2 <em>Input iPitch Angle2</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit85Impl#getInput__iPitchAngle3 <em>Input iPitch Angle3</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit85Impl#getOutput__oPitchBrakePosition <em>Output oPitch Brake Position</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit85Impl#getParameter__pPitchMaxBrakeAngle <em>Parameter pPitch Max Brake Angle</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit85Impl#getParameter__pPitchMinBrakeAngle <em>Parameter pPitch Min Brake Angle</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit85Impl#getParameter__pPitchBrakeAngleHysteresis <em>Parameter pPitch Brake Angle Hysteresis</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

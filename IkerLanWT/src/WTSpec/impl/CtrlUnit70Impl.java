 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit70Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit70Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit70Impl#getInput__iInput3 <em>Input iInput3</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit70Impl#getOutput__oResult <em>Output oResult</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit70Impl extends wtcImpl implements CtrlUnit70 {
	...
	protected EClass eStaticClass() {
		return WTSpecPackage.eINSTANCE.getCtrlUnit70();
	}
		...
		if (input__iInput1 != null && input__iInput1.eIsProxy()) {
			...
			if (input__iInput1 != oldInput__iInput1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT70__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
			}
		}
	...
	public void setInput__iInput1(WTCInput newInput__iInput1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT70__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
	}
	...
	public WTCInput getInput__iInput2() {
		if (input__iInput2 != null && input__iInput2.eIsProxy()) {
			...
			if (input__iInput2 != oldInput__iInput2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT70__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
			}
		}
	...
	public void setInput__iInput2(WTCInput newInput__iInput2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT70__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
	}
	...
	public WTCInput getInput__iInput3() {
		if (input__iInput3 != null && input__iInput3.eIsProxy()) {
			...
			if (input__iInput3 != oldInput__iInput3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT70__INPUT_IINPUT3, oldInput__iInput3, input__iInput3));
			}
		}
	...
	public void setInput__iInput3(WTCInput newInput__iInput3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT70__INPUT_IINPUT3, oldInput__iInput3, input__iInput3));
	}
	...
	public WTCOutput getOutput__oResult() {
		if (output__oResult != null && output__oResult.eIsProxy()) {
			...
			if (output__oResult != oldOutput__oResult) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT70__OUTPUT_ORESULT, oldOutput__oResult, output__oResult));
			}
		}
	...
	public void setOutput__oResult(WTCOutput newOutput__oResult) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT70__OUTPUT_ORESULT, oldOutput__oResult, output__oResult));
	}

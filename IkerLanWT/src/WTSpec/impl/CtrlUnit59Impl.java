 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit59Impl#getInput__iVarInput <em>Input iVar Input</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit59Impl#getOutput__oVarOutput <em>Output oVar Output</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit59Impl extends wtcImpl implements CtrlUnit59 {
	...
	protected EClass eStaticClass() {
		return WTSpecPackage.eINSTANCE.getCtrlUnit59();
	}
		...
		if (input__iVarInput != null && input__iVarInput.eIsProxy()) {
			...
			if (input__iVarInput != oldInput__iVarInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT59__INPUT_IVAR_INPUT, oldInput__iVarInput, input__iVarInput));
			}
		}
	...
	public void setInput__iVarInput(WTCInput newInput__iVarInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT59__INPUT_IVAR_INPUT, oldInput__iVarInput, input__iVarInput));
	}
	...
	public WTCOutput getOutput__oVarOutput() {
		if (output__oVarOutput != null && output__oVarOutput.eIsProxy()) {
			...
			if (output__oVarOutput != oldOutput__oVarOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT59__OUTPUT_OVAR_OUTPUT, oldOutput__oVarOutput, output__oVarOutput));
			}
		}
	...
	public void setOutput__oVarOutput(WTCOutput newOutput__oVarOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT59__OUTPUT_OVAR_OUTPUT, oldOutput__oVarOutput, output__oVarOutput));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecPackage.CTRL_UNIT59__INPUT_IVAR_INPUT:
				if (resolve) return getInput__iVarInput();
				return basicGetInput__iVarInput();
			case WTSpecPackage.CTRL_UNIT59__OUTPUT_OVAR_OUTPUT:

 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit71Impl#getInput__iSelect1 <em>Input iSelect1</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit71Impl#getInput__iSelect2 <em>Input iSelect2</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit71Impl#getInput__iSelect3 <em>Input iSelect3</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit71Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit71Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit71Impl#getInput__iInput3 <em>Input iInput3</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit71Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit71Impl#getOutput__oOutputWrongStatus <em>Output oOutput Wrong Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

 ...
 * <ul>
 *   <li>{@link WTSpec.impl.SystemParamImpl#getSysId <em>Sys Id</em>}</li>
 *   <li>{@link WTSpec.impl.SystemParamImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemParamImpl extends WTCParamImpl implements SystemParam {
	...
	protected EClass eStaticClass() {
		return WTSpecPackage.eINSTANCE.getSystemParam();
	}
	...
	public void setSysId(String newSysId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.SYSTEM_PARAM__SYS_ID, oldSysId, sysId));
	}
	...
	public void setValue(int newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.SYSTEM_PARAM__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecPackage.SYSTEM_PARAM__SYS_ID:
				return getSysId();
			case WTSpecPackage.SYSTEM_PARAM__VALUE:
				return getValue();
		}

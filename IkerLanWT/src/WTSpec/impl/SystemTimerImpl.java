 ...
 * <ul>
 *   <li>{@link WTSpec.impl.SystemTimerImpl#getSysId <em>Sys Id</em>}</li>
 *   <li>{@link WTSpec.impl.SystemTimerImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemTimerImpl extends WTCTimerImpl implements SystemTimer {
	...
	protected EClass eStaticClass() {
		return WTSpecPackage.eINSTANCE.getSystemTimer();
	}
	...
	public void setSysId(String newSysId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.SYSTEM_TIMER__SYS_ID, oldSysId, sysId));
	}
	...
	public void setValue(int newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.SYSTEM_TIMER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecPackage.SYSTEM_TIMER__SYS_ID:
				return getSysId();
			case WTSpecPackage.SYSTEM_TIMER__VALUE:
				return getValue();
		}

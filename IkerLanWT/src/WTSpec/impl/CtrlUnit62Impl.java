 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit62Impl#getInput__iInverterTorqueRef <em>Input iInverter Torque Ref</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit62Impl#getInput__iInverterTorqueRefLocking <em>Input iInverter Torque Ref Locking</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit62Impl#getInput__iMotorizing <em>Input iMotorizing</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit62Impl#getOutput__oInverterTorqueRefFinal <em>Output oInverter Torque Ref Final</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit62Impl#getOutput__oInverterMotorizeCommand <em>Output oInverter Motorize Command</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getInput__iAngleGH1 <em>Input iAngle GH1</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getInput__iAngleGH2 <em>Input iAngle GH2</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getInput__iAngleGH3 <em>Input iAngle GH3</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getInput__iStopCommand <em>Input iStop Command</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getInput__iFlBrakes <em>Input iFl Brakes</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getOutput__oAngleReference1 <em>Output oAngle Reference1</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getOutput__oAngleReference2 <em>Output oAngle Reference2</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getOutput__oAngleReference3 <em>Output oAngle Reference3</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getOutput__oSpeedReference <em>Output oSpeed Reference</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getOutput__oAccelerationReference <em>Output oAcceleration Reference</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getParameter__pPitchBrakeAngle <em>Parameter pPitch Brake Angle</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getParameter__pPitchStdSpeed <em>Parameter pPitch Std Speed</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getParameter__pPitchStdAcceleration <em>Parameter pPitch Std Acceleration</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getParameter__pPitchRegulationSpeed <em>Parameter pPitch Regulation Speed</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getParameter__pPitchRegulationAcceleration <em>Parameter pPitch Regulation Acceleration</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit84Impl#getErrorReaction__erEmergency <em>Error Reaction er Emergency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

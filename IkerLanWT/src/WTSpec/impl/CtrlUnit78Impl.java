 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit78Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit78Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit78Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit78Impl extends wtcImpl implements CtrlUnit78 {
	...
	protected EClass eStaticClass() {
		return WTSpecPackage.eINSTANCE.getCtrlUnit78();
	}
		...
		if (input__iInput1 != null && input__iInput1.eIsProxy()) {
			...
			if (input__iInput1 != oldInput__iInput1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT78__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
			}
		}
	...
	public void setInput__iInput1(WTCInput newInput__iInput1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT78__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
	}
	...
	public WTCInput getInput__iInput2() {
		if (input__iInput2 != null && input__iInput2.eIsProxy()) {
			...
			if (input__iInput2 != oldInput__iInput2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT78__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
			}
		}
	...
	public void setInput__iInput2(WTCInput newInput__iInput2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT78__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
	}
	...
	public WTCOutput getOutput__oOutput() {
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT78__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT78__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecPackage.CTRL_UNIT78__INPUT_IINPUT1:
				if (resolve) return getInput__iInput1();
				return basicGetInput__iInput1();
			case WTSpecPackage.CTRL_UNIT78__INPUT_IINPUT2:
				if (resolve) return getInput__iInput2();
				return basicGetInput__iInput2();
			case WTSpecPackage.CTRL_UNIT78__OUTPUT_OOUTPUT:

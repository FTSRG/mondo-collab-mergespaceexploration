 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit92Impl#getInput__iTemp <em>Input iTemp</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit92Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit92Impl#getParameter__pLimitError <em>Parameter pLimit Error</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit92Impl#getParameter__pLimitReset <em>Parameter pLimit Reset</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit92Impl#getFault__fError <em>Fault fError</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit92Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit92Impl extends wtcImpl implements CtrlUnit92 {
	...
	protected EClass eStaticClass() {
		return WTSpecPackage.eINSTANCE.getCtrlUnit92();
	}
		...
		if (input__iTemp != null && input__iTemp.eIsProxy()) {
			...
			if (input__iTemp != oldInput__iTemp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT92__INPUT_ITEMP, oldInput__iTemp, input__iTemp));
			}
		}
		return input__iTemp;
	}
	...
	public void setInput__iTemp(WTCInput newInput__iTemp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT92__INPUT_ITEMP, oldInput__iTemp, input__iTemp));
	}
	...
	public WTCInput getInput__iDontCheckInput() {
		if (input__iDontCheckInput != null && input__iDontCheckInput.eIsProxy()) {
			...
			if (input__iDontCheckInput != oldInput__iDontCheckInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT92__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
			}
		}
	...
	public void setInput__iDontCheckInput(WTCInput newInput__iDontCheckInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT92__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
	}
	...
	public WTCParam getParameter__pLimitError() {
		if (parameter__pLimitError != null && parameter__pLimitError.eIsProxy()) {
			...
			if (parameter__pLimitError != oldParameter__pLimitError) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT92__PARAMETER_PLIMIT_ERROR, oldParameter__pLimitError, parameter__pLimitError));
			}
		}
	...
	public void setParameter__pLimitError(WTCParam newParameter__pLimitError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT92__PARAMETER_PLIMIT_ERROR, oldParameter__pLimitError, parameter__pLimitError));
	}
	...
	public WTCParam getParameter__pLimitReset() {
		if (parameter__pLimitReset != null && parameter__pLimitReset.eIsProxy()) {
			...
			if (parameter__pLimitReset != oldParameter__pLimitReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT92__PARAMETER_PLIMIT_RESET, oldParameter__pLimitReset, parameter__pLimitReset));
			}
		}
	...
	public void setParameter__pLimitReset(WTCParam newParameter__pLimitReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT92__PARAMETER_PLIMIT_RESET, oldParameter__pLimitReset, parameter__pLimitReset));
	}
	...
	public WTCFault getFault__fError() {
		if (fault__fError != null && fault__fError.eIsProxy()) {
			...
			if (fault__fError != oldFault__fError) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT92__FAULT_FERROR, oldFault__fError, fault__fError));
			}
		}
	...
	public void setFault__fError(WTCFault newFault__fError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT92__FAULT_FERROR, oldFault__fError, fault__fError));
	}
	...
	public void setBhvParam__bpMode(String newBhvParam__bpMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT92__BHV_PARAM_BP_MODE, oldBhvParam__bpMode, bhvParam__bpMode));
	}

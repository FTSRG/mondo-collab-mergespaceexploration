 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getOutput__oOutDiv <em>Output oOut Div</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getOutput__oOutMod <em>Output oOut Mod</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getParameter__pDiv <em>Parameter pDiv</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getParameter__pParam1 <em>Parameter pParam1</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getParameter__pParam2 <em>Parameter pParam2</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit43Impl#getBhvParam__bpType <em>Bhv Param bp Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

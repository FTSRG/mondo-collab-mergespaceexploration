 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit20Impl#getInput__iMasterOrder <em>Input iMaster Order</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit20Impl#getInput__iInverterOrder <em>Input iInverter Order</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit20Impl#getInput__iChangeOrder <em>Input iChange Order</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit20Impl#getInput__iManualStop <em>Input iManual Stop</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit20Impl#getOutput__oMasterSelected <em>Output oMaster Selected</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit20Impl#getOutput__oInverterEnabled <em>Output oInverter Enabled</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit20Impl#getOutput__oForceInvOff <em>Output oForce Inv Off</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit121Impl#getInput__iManualYawPreCommand <em>Input iManual Yaw Pre Command</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit121Impl#getInput__iMaxTwistPreCommand <em>Input iMax Twist Pre Command</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit121Impl#getInput__iRetwistPreCommand <em>Input iRetwist Pre Command</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit121Impl#getInput__iRelWindPreCommand <em>Input iRel Wind Pre Command</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit121Impl#getOutput__oYawCommand <em>Output oYaw Command</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

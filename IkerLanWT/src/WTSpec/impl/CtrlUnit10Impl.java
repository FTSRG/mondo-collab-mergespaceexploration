 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit10Impl#getInput__iAnalogInput <em>Input iAnalog Input</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit10Impl#getOutput__oAnalogScaled <em>Output oAnalog Scaled</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit10Impl#getParameter__pFactor <em>Parameter pFactor</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit10Impl#getParameter__pOffset <em>Parameter pOffset</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit10Impl#getParameter__pUpLimit <em>Parameter pUp Limit</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit10Impl#getParameter__pUpValue <em>Parameter pUp Value</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit10Impl#getParameter__pDownLimit <em>Parameter pDown Limit</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit10Impl#getParameter__pDownValue <em>Parameter pDown Value</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit10Impl#getBhvParam__bpOperation <em>Bhv Param bp Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Remove From List</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link DiffModel.impl.RemoveFromListImpl#getList <em>List</em>}</li>
 *   <li>{@link DiffModel.impl.RemoveFromListImpl#getRefID <em>Ref ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RemoveFromListImpl extends IdentifiableImpl implements RemoveFromList {
	/**
	...
	protected EClass eStaticClass() {
		return DiffModelPackage.Literals.REMOVE_FROM_LIST;
	}
	...
	public void setList(String newList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffModelPackage.REMOVE_FROM_LIST__LIST, oldList, list));
	}
	...
	public void setRefID(String newRefID) {
		...
		refID = newRefID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffModelPackage.REMOVE_FROM_LIST__REF_ID, oldRefID, refID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DiffModelPackage.REMOVE_FROM_LIST__LIST:
				return getList();
			case DiffModelPackage.REMOVE_FROM_LIST__REF_ID:
				return getRefID();
		}

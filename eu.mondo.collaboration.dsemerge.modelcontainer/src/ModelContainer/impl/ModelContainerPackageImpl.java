...
public class ModelContainerPackageImpl extends EPackageImpl implements ModelContainerPackage {
	...
	public static ModelContainerPackage init() {
		...
		DiffModelPackage.eINSTANCE.eClass();
	...
	public void initializePackageContents() {
		...
		DiffModelPackage theDiffModelPackage = (DiffModelPackage)EPackage.Registry.INSTANCE.getEPackage(DiffModelPackage.eNS_URI);
		...
		initEReference(getMainRoot_DeltaOA(), theDiffModelPackage.getDiffContainer(), null, "deltaOA", null, 0, 1, MainRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMainRoot_DeltaOB(), theDiffModelPackage.getDiffContainer(), null, "deltaOB", null, 0, 1, MainRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

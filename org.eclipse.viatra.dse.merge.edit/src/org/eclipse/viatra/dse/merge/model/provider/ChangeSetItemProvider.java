...
/**
 * This is the item provider adapter for a {@link org.eclipse.viatra.dse.merge.model.ChangeSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChangeSetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.CHANGE_SET__CHANGES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.CHANGE_SET__CHANGES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ChangeSet.class)) {
			case ModelPackage.CHANGE_SET__CHANGES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CHANGE_SET__CHANGES,
				 ModelFactory.eINSTANCE.createCreate()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CHANGE_SET__CHANGES,
				 ModelFactory.eINSTANCE.createDelete()));
	...
	public Collection<?> getChildren(Object object) {
		...
		return ChangeSetFilter.filterChildren(result);

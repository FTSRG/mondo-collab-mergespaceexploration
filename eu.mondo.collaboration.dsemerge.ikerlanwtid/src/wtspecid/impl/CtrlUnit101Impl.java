 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit101Impl#getInput__iSpeed <em>Input iSpeed</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit101Impl#getInput__iPosition <em>Input iPosition</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit101Impl#getOutput__oSpeed <em>Output oSpeed</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit101Impl#getOutput__oSpeedMonitoring <em>Output oSpeed Monitoring</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit101Impl#getParameter__pOffset <em>Parameter pOffset</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit101Impl#getParameter__pConversionFactor <em>Parameter pConversion Factor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit101Impl extends wtcImpl implements CtrlUnit101 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit101();
	}
		...
		if (input__iSpeed != null && input__iSpeed.eIsProxy()) {
			...
			if (input__iSpeed != oldInput__iSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT101__INPUT_ISPEED, oldInput__iSpeed, input__iSpeed));
			}
		}
	...
	public void setInput__iSpeed(WTCInput newInput__iSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT101__INPUT_ISPEED, oldInput__iSpeed, input__iSpeed));
	}
	...
	public WTCInput getInput__iPosition() {
		if (input__iPosition != null && input__iPosition.eIsProxy()) {
			...
			if (input__iPosition != oldInput__iPosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT101__INPUT_IPOSITION, oldInput__iPosition, input__iPosition));
			}
		}
	...
	public void setInput__iPosition(WTCInput newInput__iPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT101__INPUT_IPOSITION, oldInput__iPosition, input__iPosition));
	}
	...
	public WTCOutput getOutput__oSpeed() {
		if (output__oSpeed != null && output__oSpeed.eIsProxy()) {
			...
			if (output__oSpeed != oldOutput__oSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT101__OUTPUT_OSPEED, oldOutput__oSpeed, output__oSpeed));
			}
		}
	...
	public void setOutput__oSpeed(WTCOutput newOutput__oSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT101__OUTPUT_OSPEED, oldOutput__oSpeed, output__oSpeed));
	}
	...
	public WTCOutput getOutput__oSpeedMonitoring() {
		if (output__oSpeedMonitoring != null && output__oSpeedMonitoring.eIsProxy()) {
			...
			if (output__oSpeedMonitoring != oldOutput__oSpeedMonitoring) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT101__OUTPUT_OSPEED_MONITORING, oldOutput__oSpeedMonitoring, output__oSpeedMonitoring));
			}
		}
	...
	public void setOutput__oSpeedMonitoring(WTCOutput newOutput__oSpeedMonitoring) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT101__OUTPUT_OSPEED_MONITORING, oldOutput__oSpeedMonitoring, output__oSpeedMonitoring));
	}
	...
	public WTCParam getParameter__pOffset() {
		if (parameter__pOffset != null && parameter__pOffset.eIsProxy()) {
			...
			if (parameter__pOffset != oldParameter__pOffset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT101__PARAMETER_POFFSET, oldParameter__pOffset, parameter__pOffset));
			}
		}
	...
	public void setParameter__pOffset(WTCParam newParameter__pOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT101__PARAMETER_POFFSET, oldParameter__pOffset, parameter__pOffset));
	}
	...
	public WTCParam getParameter__pConversionFactor() {
		if (parameter__pConversionFactor != null && parameter__pConversionFactor.eIsProxy()) {
			...
			if (parameter__pConversionFactor != oldParameter__pConversionFactor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT101__PARAMETER_PCONVERSION_FACTOR, oldParameter__pConversionFactor, parameter__pConversionFactor));
			}
		}
	...
	public void setParameter__pConversionFactor(WTCParam newParameter__pConversionFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT101__PARAMETER_PCONVERSION_FACTOR, oldParameter__pConversionFactor, parameter__pConversionFactor));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit77Impl#getInput__iYawInhibited <em>Input iYaw Inhibited</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit77Impl#getInput__iYawCwOrder <em>Input iYaw Cw Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit77Impl#getInput__iYawCcwOrder <em>Input iYaw Ccw Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit77Impl#getInput__iFlagIntoWind <em>Input iFlag Into Wind</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit77Impl#getOutput__oOpcYawStatus <em>Output oOpc Yaw Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit77Impl extends wtcImpl implements CtrlUnit77 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit77();
	}
		...
		if (input__iYawInhibited != null && input__iYawInhibited.eIsProxy()) {
			...
			if (input__iYawInhibited != oldInput__iYawInhibited) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT77__INPUT_IYAW_INHIBITED, oldInput__iYawInhibited, input__iYawInhibited));
			}
		}
	...
	public void setInput__iYawInhibited(WTCInput newInput__iYawInhibited) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT77__INPUT_IYAW_INHIBITED, oldInput__iYawInhibited, input__iYawInhibited));
	}
	...
	public WTCInput getInput__iYawCwOrder() {
		if (input__iYawCwOrder != null && input__iYawCwOrder.eIsProxy()) {
			...
			if (input__iYawCwOrder != oldInput__iYawCwOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT77__INPUT_IYAW_CW_ORDER, oldInput__iYawCwOrder, input__iYawCwOrder));
			}
		}
	...
	public void setInput__iYawCwOrder(WTCInput newInput__iYawCwOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT77__INPUT_IYAW_CW_ORDER, oldInput__iYawCwOrder, input__iYawCwOrder));
	}
	...
	public WTCInput getInput__iYawCcwOrder() {
		if (input__iYawCcwOrder != null && input__iYawCcwOrder.eIsProxy()) {
			...
			if (input__iYawCcwOrder != oldInput__iYawCcwOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT77__INPUT_IYAW_CCW_ORDER, oldInput__iYawCcwOrder, input__iYawCcwOrder));
			}
		}
	...
	public void setInput__iYawCcwOrder(WTCInput newInput__iYawCcwOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT77__INPUT_IYAW_CCW_ORDER, oldInput__iYawCcwOrder, input__iYawCcwOrder));
	}
	...
	public WTCInput getInput__iFlagIntoWind() {
		if (input__iFlagIntoWind != null && input__iFlagIntoWind.eIsProxy()) {
			...
			if (input__iFlagIntoWind != oldInput__iFlagIntoWind) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT77__INPUT_IFLAG_INTO_WIND, oldInput__iFlagIntoWind, input__iFlagIntoWind));
			}
		}
	...
	public void setInput__iFlagIntoWind(WTCInput newInput__iFlagIntoWind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT77__INPUT_IFLAG_INTO_WIND, oldInput__iFlagIntoWind, input__iFlagIntoWind));
	}
	...
	public WTCOutput getOutput__oOpcYawStatus() {
		if (output__oOpcYawStatus != null && output__oOpcYawStatus.eIsProxy()) {
			...
			if (output__oOpcYawStatus != oldOutput__oOpcYawStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT77__OUTPUT_OOPC_YAW_STATUS, oldOutput__oOpcYawStatus, output__oOpcYawStatus));
			}
		}
	...
	public void setOutput__oOpcYawStatus(WTCOutput newOutput__oOpcYawStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT77__OUTPUT_OOPC_YAW_STATUS, oldOutput__oOpcYawStatus, output__oOpcYawStatus));
	}

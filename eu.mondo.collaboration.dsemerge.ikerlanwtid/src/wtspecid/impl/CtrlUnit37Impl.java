 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit37Impl#getInput__iInput <em>Input iInput</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit37Impl#getInput__iBadInputQuality <em>Input iBad Input Quality</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit37Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit37Impl#getOutput__oSendReset <em>Output oSend Reset</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit37Impl#getFault__fFault <em>Fault fFault</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit37Impl#getTimer__tCheckInputDelay <em>Timer tCheck Input Delay</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit37Impl#getBhvParam__bpLogicType <em>Bhv Param bp Logic Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit37Impl extends wtcImpl implements CtrlUnit37 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit37();
	}
		...
		if (input__iInput != null && input__iInput.eIsProxy()) {
			...
			if (input__iInput != oldInput__iInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT37__INPUT_IINPUT, oldInput__iInput, input__iInput));
			}
		}
	...
	public void setInput__iInput(WTCInput newInput__iInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT37__INPUT_IINPUT, oldInput__iInput, input__iInput));
	}
	...
	public WTCInput getInput__iBadInputQuality() {
		if (input__iBadInputQuality != null && input__iBadInputQuality.eIsProxy()) {
			...
			if (input__iBadInputQuality != oldInput__iBadInputQuality) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT37__INPUT_IBAD_INPUT_QUALITY, oldInput__iBadInputQuality, input__iBadInputQuality));
			}
		}
	...
	public void setInput__iBadInputQuality(WTCInput newInput__iBadInputQuality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT37__INPUT_IBAD_INPUT_QUALITY, oldInput__iBadInputQuality, input__iBadInputQuality));
	}
	...
	public WTCInput getInput__iDontCheckInput() {
		if (input__iDontCheckInput != null && input__iDontCheckInput.eIsProxy()) {
			...
			if (input__iDontCheckInput != oldInput__iDontCheckInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT37__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
			}
		}
	...
	public void setInput__iDontCheckInput(WTCInput newInput__iDontCheckInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT37__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
	}
	...
	public WTCOutput getOutput__oSendReset() {
		if (output__oSendReset != null && output__oSendReset.eIsProxy()) {
			...
			if (output__oSendReset != oldOutput__oSendReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT37__OUTPUT_OSEND_RESET, oldOutput__oSendReset, output__oSendReset));
			}
		}
	...
	public void setOutput__oSendReset(WTCOutput newOutput__oSendReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT37__OUTPUT_OSEND_RESET, oldOutput__oSendReset, output__oSendReset));
	}
	...
	public WTCFault getFault__fFault() {
		if (fault__fFault != null && fault__fFault.eIsProxy()) {
			...
			if (fault__fFault != oldFault__fFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT37__FAULT_FFAULT, oldFault__fFault, fault__fFault));
			}
		}
	...
	public void setFault__fFault(WTCFault newFault__fFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT37__FAULT_FFAULT, oldFault__fFault, fault__fFault));
	}
	...
	public WTCTimer getTimer__tCheckInputDelay() {
		if (timer__tCheckInputDelay != null && timer__tCheckInputDelay.eIsProxy()) {
			...
			if (timer__tCheckInputDelay != oldTimer__tCheckInputDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT37__TIMER_TCHECK_INPUT_DELAY, oldTimer__tCheckInputDelay, timer__tCheckInputDelay));
			}
		}
	...
	public void setTimer__tCheckInputDelay(WTCTimer newTimer__tCheckInputDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT37__TIMER_TCHECK_INPUT_DELAY, oldTimer__tCheckInputDelay, timer__tCheckInputDelay));
	}
	...
	public void setBhvParam__bpLogicType(String newBhvParam__bpLogicType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT37__BHV_PARAM_BP_LOGIC_TYPE, oldBhvParam__bpLogicType, bhvParam__bpLogicType));
	}

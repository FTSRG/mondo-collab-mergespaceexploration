 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getInput__iInput3 <em>Input iInput3</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getParameter__pParam1 <em>Parameter pParam1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getParameter__pParam2 <em>Parameter pParam2</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getParameter__pParam3 <em>Parameter pParam3</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getFault__fFault1 <em>Fault fFault1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getFault__fFault2 <em>Fault fFault2</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getFault__fFault3 <em>Fault fFault3</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getErrorReaction__eReaction1 <em>Error Reaction eReaction1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getErrorReaction__eReaction2 <em>Error Reaction eReaction2</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getGuard__gGuardToMain <em>Guard gGuard To Main</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getGuard__gGuardFromMain <em>Guard gGuard From Main</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getGuard__gGuardToOn <em>Guard gGuard To On</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit41Impl#getGuard__gGuardToOff <em>Guard gGuard To Off</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit41Impl extends wtcImpl implements CtrlUnit41 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit41();
	}
		...
		if (input__iInput1 != null && input__iInput1.eIsProxy()) {
			...
			if (input__iInput1 != oldInput__iInput1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
			}
		}
	...
	public void setInput__iInput1(WTCInput newInput__iInput1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
	}
	...
	public WTCInput getInput__iInput2() {
		if (input__iInput2 != null && input__iInput2.eIsProxy()) {
			...
			if (input__iInput2 != oldInput__iInput2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
			}
		}
	...
	public void setInput__iInput2(WTCInput newInput__iInput2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
	}
	...
	public WTCInput getInput__iInput3() {
		if (input__iInput3 != null && input__iInput3.eIsProxy()) {
			...
			if (input__iInput3 != oldInput__iInput3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__INPUT_IINPUT3, oldInput__iInput3, input__iInput3));
			}
		}
	...
	public void setInput__iInput3(WTCInput newInput__iInput3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__INPUT_IINPUT3, oldInput__iInput3, input__iInput3));
	}
	...
	public WTCOutput getOutput__oOutput() {
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public WTCParam getParameter__pParam1() {
		if (parameter__pParam1 != null && parameter__pParam1.eIsProxy()) {
			...
			if (parameter__pParam1 != oldParameter__pParam1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__PARAMETER_PPARAM1, oldParameter__pParam1, parameter__pParam1));
			}
		}
	...
	public void setParameter__pParam1(WTCParam newParameter__pParam1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__PARAMETER_PPARAM1, oldParameter__pParam1, parameter__pParam1));
	}
	...
	public WTCParam getParameter__pParam2() {
		if (parameter__pParam2 != null && parameter__pParam2.eIsProxy()) {
			...
			if (parameter__pParam2 != oldParameter__pParam2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__PARAMETER_PPARAM2, oldParameter__pParam2, parameter__pParam2));
			}
		}
	...
	public void setParameter__pParam2(WTCParam newParameter__pParam2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__PARAMETER_PPARAM2, oldParameter__pParam2, parameter__pParam2));
	}
	...
	public WTCParam getParameter__pParam3() {
		if (parameter__pParam3 != null && parameter__pParam3.eIsProxy()) {
			...
			if (parameter__pParam3 != oldParameter__pParam3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__PARAMETER_PPARAM3, oldParameter__pParam3, parameter__pParam3));
			}
		}
	...
	public void setParameter__pParam3(WTCParam newParameter__pParam3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__PARAMETER_PPARAM3, oldParameter__pParam3, parameter__pParam3));
	}
	...
	public WTCFault getFault__fFault1() {
		if (fault__fFault1 != null && fault__fFault1.eIsProxy()) {
			...
			if (fault__fFault1 != oldFault__fFault1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__FAULT_FFAULT1, oldFault__fFault1, fault__fFault1));
			}
		}
	...
	public void setFault__fFault1(WTCFault newFault__fFault1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__FAULT_FFAULT1, oldFault__fFault1, fault__fFault1));
	}
	...
	public WTCFault getFault__fFault2() {
		if (fault__fFault2 != null && fault__fFault2.eIsProxy()) {
			...
			if (fault__fFault2 != oldFault__fFault2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__FAULT_FFAULT2, oldFault__fFault2, fault__fFault2));
			}
		}
	...
	public void setFault__fFault2(WTCFault newFault__fFault2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__FAULT_FFAULT2, oldFault__fFault2, fault__fFault2));
	}
	...
	public WTCFault getFault__fFault3() {
		if (fault__fFault3 != null && fault__fFault3.eIsProxy()) {
			...
			if (fault__fFault3 != oldFault__fFault3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__FAULT_FFAULT3, oldFault__fFault3, fault__fFault3));
			}
		}
	...
	public void setFault__fFault3(WTCFault newFault__fFault3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__FAULT_FFAULT3, oldFault__fFault3, fault__fFault3));
	}
	...
	public WTCErrorReaction getErrorReaction__eReaction1() {
		if (errorReaction__eReaction1 != null && errorReaction__eReaction1.eIsProxy()) {
			...
			if (errorReaction__eReaction1 != oldErrorReaction__eReaction1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__ERROR_REACTION_EREACTION1, oldErrorReaction__eReaction1, errorReaction__eReaction1));
			}
		}
	...
	public void setErrorReaction__eReaction1(WTCErrorReaction newErrorReaction__eReaction1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__ERROR_REACTION_EREACTION1, oldErrorReaction__eReaction1, errorReaction__eReaction1));
	}
	...
	public WTCErrorReaction getErrorReaction__eReaction2() {
		if (errorReaction__eReaction2 != null && errorReaction__eReaction2.eIsProxy()) {
			...
			if (errorReaction__eReaction2 != oldErrorReaction__eReaction2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT41__ERROR_REACTION_EREACTION2, oldErrorReaction__eReaction2, errorReaction__eReaction2));
			}
		}
	...
	public void setErrorReaction__eReaction2(WTCErrorReaction newErrorReaction__eReaction2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__ERROR_REACTION_EREACTION2, oldErrorReaction__eReaction2, errorReaction__eReaction2));
	}
	...
	public void setGuard__gGuardToMain(String newGuard__gGuardToMain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__GUARD_GGUARD_TO_MAIN, oldGuard__gGuardToMain, guard__gGuardToMain));
	}
	...
	public void setGuard__gGuardFromMain(String newGuard__gGuardFromMain) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__GUARD_GGUARD_FROM_MAIN, oldGuard__gGuardFromMain, guard__gGuardFromMain));
	}
	...
	public void setGuard__gGuardToOn(String newGuard__gGuardToOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__GUARD_GGUARD_TO_ON, oldGuard__gGuardToOn, guard__gGuardToOn));
	}
	...
	public void setGuard__gGuardToOff(String newGuard__gGuardToOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT41__GUARD_GGUARD_TO_OFF, oldGuard__gGuardToOff, guard__gGuardToOff));
	}

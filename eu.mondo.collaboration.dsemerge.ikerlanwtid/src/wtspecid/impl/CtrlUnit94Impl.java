 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit94Impl#getInput__iResetOrder <em>Input iReset Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit94Impl#getOutput__oValueToReset <em>Output oValue To Reset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit94Impl extends wtcImpl implements CtrlUnit94 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit94();
	}
		...
		if (input__iResetOrder != null && input__iResetOrder.eIsProxy()) {
			...
			if (input__iResetOrder != oldInput__iResetOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT94__INPUT_IRESET_ORDER, oldInput__iResetOrder, input__iResetOrder));
			}
		}
	...
	public void setInput__iResetOrder(WTCInput newInput__iResetOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT94__INPUT_IRESET_ORDER, oldInput__iResetOrder, input__iResetOrder));
	}
	...
	public WTCOutput getOutput__oValueToReset() {
		if (output__oValueToReset != null && output__oValueToReset.eIsProxy()) {
			...
			if (output__oValueToReset != oldOutput__oValueToReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT94__OUTPUT_OVALUE_TO_RESET, oldOutput__oValueToReset, output__oValueToReset));
			}
		}
	...
	public void setOutput__oValueToReset(WTCOutput newOutput__oValueToReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT94__OUTPUT_OVALUE_TO_RESET, oldOutput__oValueToReset, output__oValueToReset));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT94__INPUT_IRESET_ORDER:
				if (resolve) return getInput__iResetOrder();
				return basicGetInput__iResetOrder();
			case WtspecidPackage.CTRL_UNIT94__OUTPUT_OVALUE_TO_RESET:

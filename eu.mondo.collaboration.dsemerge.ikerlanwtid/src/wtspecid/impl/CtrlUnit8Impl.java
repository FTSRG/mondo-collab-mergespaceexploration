 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit8Impl#getInput__i1 <em>Input i1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit8Impl#getOutput__o1 <em>Output o1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit8Impl#getParameter__pDelay <em>Parameter pDelay</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit8Impl#getBhvParam__bpFilter <em>Bhv Param bp Filter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit8Impl extends wtcImpl implements CtrlUnit8 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit8();
	}
		...
		if (input__i1 != null && input__i1.eIsProxy()) {
			...
			if (input__i1 != oldInput__i1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT8__INPUT_I1, oldInput__i1, input__i1));
			}
		}
		return input__i1;
	}
	...
	public void setInput__i1(WTCInput newInput__i1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT8__INPUT_I1, oldInput__i1, input__i1));
	}
	...
	public WTCOutput getOutput__o1() {
		if (output__o1 != null && output__o1.eIsProxy()) {
			...
			if (output__o1 != oldOutput__o1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT8__OUTPUT_O1, oldOutput__o1, output__o1));
			}
		}
		return output__o1;
	}
	...
	public void setOutput__o1(WTCOutput newOutput__o1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT8__OUTPUT_O1, oldOutput__o1, output__o1));
	}
	...
	public WTCParam getParameter__pDelay() {
		if (parameter__pDelay != null && parameter__pDelay.eIsProxy()) {
			...
			if (parameter__pDelay != oldParameter__pDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT8__PARAMETER_PDELAY, oldParameter__pDelay, parameter__pDelay));
			}
		}
	...
	public void setParameter__pDelay(WTCParam newParameter__pDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT8__PARAMETER_PDELAY, oldParameter__pDelay, parameter__pDelay));
	}
	...
	public void setBhvParam__bpFilter(String newBhvParam__bpFilter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT8__BHV_PARAM_BP_FILTER, oldBhvParam__bpFilter, bhvParam__bpFilter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT8__INPUT_I1:
				if (resolve) return getInput__i1();
				return basicGetInput__i1();
			case WtspecidPackage.CTRL_UNIT8__OUTPUT_O1:
				if (resolve) return getOutput__o1();
				return basicGetOutput__o1();
			case WtspecidPackage.CTRL_UNIT8__PARAMETER_PDELAY:
				if (resolve) return getParameter__pDelay();
				return basicGetParameter__pDelay();
			case WtspecidPackage.CTRL_UNIT8__BHV_PARAM_BP_FILTER:

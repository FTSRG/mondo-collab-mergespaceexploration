 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit125Impl#getInput__iInvRol <em>Input iInv Rol</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit125Impl#getOutput__oSpeedRef <em>Output oSpeed Ref</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit125Impl#getParameter__pSpeed <em>Parameter pSpeed</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit125Impl#getParameter__pOffset <em>Parameter pOffset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit125Impl extends wtcImpl implements CtrlUnit125 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit125();
	}
		...
		if (input__iInvRol != null && input__iInvRol.eIsProxy()) {
			...
			if (input__iInvRol != oldInput__iInvRol) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT125__INPUT_IINV_ROL, oldInput__iInvRol, input__iInvRol));
			}
		}
	...
	public void setInput__iInvRol(WTCInput newInput__iInvRol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT125__INPUT_IINV_ROL, oldInput__iInvRol, input__iInvRol));
	}
	...
	public WTCOutput getOutput__oSpeedRef() {
		if (output__oSpeedRef != null && output__oSpeedRef.eIsProxy()) {
			...
			if (output__oSpeedRef != oldOutput__oSpeedRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT125__OUTPUT_OSPEED_REF, oldOutput__oSpeedRef, output__oSpeedRef));
			}
		}
	...
	public void setOutput__oSpeedRef(WTCOutput newOutput__oSpeedRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT125__OUTPUT_OSPEED_REF, oldOutput__oSpeedRef, output__oSpeedRef));
	}
	...
	public WTCParam getParameter__pSpeed() {
		if (parameter__pSpeed != null && parameter__pSpeed.eIsProxy()) {
			...
			if (parameter__pSpeed != oldParameter__pSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT125__PARAMETER_PSPEED, oldParameter__pSpeed, parameter__pSpeed));
			}
		}
	...
	public void setParameter__pSpeed(WTCParam newParameter__pSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT125__PARAMETER_PSPEED, oldParameter__pSpeed, parameter__pSpeed));
	}
	...
	public WTCParam getParameter__pOffset() {
		if (parameter__pOffset != null && parameter__pOffset.eIsProxy()) {
			...
			if (parameter__pOffset != oldParameter__pOffset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT125__PARAMETER_POFFSET, oldParameter__pOffset, parameter__pOffset));
			}
		}
	...
	public void setParameter__pOffset(WTCParam newParameter__pOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT125__PARAMETER_POFFSET, oldParameter__pOffset, parameter__pOffset));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT125__INPUT_IINV_ROL:
				if (resolve) return getInput__iInvRol();
				return basicGetInput__iInvRol();
			case WtspecidPackage.CTRL_UNIT125__OUTPUT_OSPEED_REF:
				if (resolve) return getOutput__oSpeedRef();
				return basicGetOutput__oSpeedRef();
			case WtspecidPackage.CTRL_UNIT125__PARAMETER_PSPEED:
				if (resolve) return getParameter__pSpeed();
				return basicGetParameter__pSpeed();
			case WtspecidPackage.CTRL_UNIT125__PARAMETER_POFFSET:

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit79Impl#getInput__iOverPressureCmd <em>Input iOver Pressure Cmd</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit79Impl#getOutput__oYawBrakeHighPressureCmd <em>Output oYaw Brake High Pressure Cmd</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit79Impl#getFault__fYawBrakeBlock <em>Fault fYaw Brake Block</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit79Impl#getFault__fYawBrakeLoose <em>Fault fYaw Brake Loose</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit79Impl#getFault__fYawBrakeActive <em>Fault fYaw Brake Active</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit79Impl#getFault__fWarning <em>Fault fWarning</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit79Impl#getFault__fFault <em>Fault fFault</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit79Impl#getDecisionSequence__dsCommands <em>Decision Sequence ds Commands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit79Impl extends wtcImpl implements CtrlUnit79 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit79();
	}
		...
		if (input__iOverPressureCmd != null && input__iOverPressureCmd.eIsProxy()) {
			...
			if (input__iOverPressureCmd != oldInput__iOverPressureCmd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT79__INPUT_IOVER_PRESSURE_CMD, oldInput__iOverPressureCmd, input__iOverPressureCmd));
			}
		}
	...
	public void setInput__iOverPressureCmd(WTCInput newInput__iOverPressureCmd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT79__INPUT_IOVER_PRESSURE_CMD, oldInput__iOverPressureCmd, input__iOverPressureCmd));
	}
	...
	public WTCOutput getOutput__oYawBrakeHighPressureCmd() {
		if (output__oYawBrakeHighPressureCmd != null && output__oYawBrakeHighPressureCmd.eIsProxy()) {
			...
			if (output__oYawBrakeHighPressureCmd != oldOutput__oYawBrakeHighPressureCmd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT79__OUTPUT_OYAW_BRAKE_HIGH_PRESSURE_CMD, oldOutput__oYawBrakeHighPressureCmd, output__oYawBrakeHighPressureCmd));
			}
		}
	...
	public void setOutput__oYawBrakeHighPressureCmd(WTCOutput newOutput__oYawBrakeHighPressureCmd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT79__OUTPUT_OYAW_BRAKE_HIGH_PRESSURE_CMD, oldOutput__oYawBrakeHighPressureCmd, output__oYawBrakeHighPressureCmd));
	}
	...
	public WTCFault getFault__fYawBrakeBlock() {
		if (fault__fYawBrakeBlock != null && fault__fYawBrakeBlock.eIsProxy()) {
			...
			if (fault__fYawBrakeBlock != oldFault__fYawBrakeBlock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT79__FAULT_FYAW_BRAKE_BLOCK, oldFault__fYawBrakeBlock, fault__fYawBrakeBlock));
			}
		}
	...
	public void setFault__fYawBrakeBlock(WTCFault newFault__fYawBrakeBlock) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT79__FAULT_FYAW_BRAKE_BLOCK, oldFault__fYawBrakeBlock, fault__fYawBrakeBlock));
	}
	...
	public WTCFault getFault__fYawBrakeLoose() {
		if (fault__fYawBrakeLoose != null && fault__fYawBrakeLoose.eIsProxy()) {
			...
			if (fault__fYawBrakeLoose != oldFault__fYawBrakeLoose) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT79__FAULT_FYAW_BRAKE_LOOSE, oldFault__fYawBrakeLoose, fault__fYawBrakeLoose));
			}
		}
	...
	public void setFault__fYawBrakeLoose(WTCFault newFault__fYawBrakeLoose) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT79__FAULT_FYAW_BRAKE_LOOSE, oldFault__fYawBrakeLoose, fault__fYawBrakeLoose));
	}
	...
	public WTCFault getFault__fYawBrakeActive() {
		if (fault__fYawBrakeActive != null && fault__fYawBrakeActive.eIsProxy()) {
			...
			if (fault__fYawBrakeActive != oldFault__fYawBrakeActive) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT79__FAULT_FYAW_BRAKE_ACTIVE, oldFault__fYawBrakeActive, fault__fYawBrakeActive));
			}
		}
	...
	public void setFault__fYawBrakeActive(WTCFault newFault__fYawBrakeActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT79__FAULT_FYAW_BRAKE_ACTIVE, oldFault__fYawBrakeActive, fault__fYawBrakeActive));
	}
	...
	public WTCFault getFault__fWarning() {
		if (fault__fWarning != null && fault__fWarning.eIsProxy()) {
			...
			if (fault__fWarning != oldFault__fWarning) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT79__FAULT_FWARNING, oldFault__fWarning, fault__fWarning));
			}
		}
	...
	public void setFault__fWarning(WTCFault newFault__fWarning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT79__FAULT_FWARNING, oldFault__fWarning, fault__fWarning));
	}
	...
	public WTCFault getFault__fFault() {
		if (fault__fFault != null && fault__fFault.eIsProxy()) {
			...
			if (fault__fFault != oldFault__fFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT79__FAULT_FFAULT, oldFault__fFault, fault__fFault));
			}
		}
	...
	public void setFault__fFault(WTCFault newFault__fFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT79__FAULT_FFAULT, oldFault__fFault, fault__fFault));
	}
	...
	public void setDecisionSequence__dsCommands(String newDecisionSequence__dsCommands) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT79__DECISION_SEQUENCE_DS_COMMANDS, oldDecisionSequence__dsCommands, decisionSequence__dsCommands));
	}

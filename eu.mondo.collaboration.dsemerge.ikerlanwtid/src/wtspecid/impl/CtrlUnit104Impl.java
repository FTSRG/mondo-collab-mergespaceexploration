 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit104Impl#getInput__iOrder <em>Input iOrder</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit104Impl#getOutput__oOrder <em>Output oOrder</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit104Impl#getTimer__tTimer <em>Timer tTimer</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit104Impl#getTimer__tDelay <em>Timer tDelay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit104Impl extends wtcImpl implements CtrlUnit104 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit104();
	}
		...
		if (input__iOrder != null && input__iOrder.eIsProxy()) {
			...
			if (input__iOrder != oldInput__iOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT104__INPUT_IORDER, oldInput__iOrder, input__iOrder));
			}
		}
	...
	public void setInput__iOrder(WTCInput newInput__iOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT104__INPUT_IORDER, oldInput__iOrder, input__iOrder));
	}
	...
	public WTCOutput getOutput__oOrder() {
		if (output__oOrder != null && output__oOrder.eIsProxy()) {
			...
			if (output__oOrder != oldOutput__oOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT104__OUTPUT_OORDER, oldOutput__oOrder, output__oOrder));
			}
		}
	...
	public void setOutput__oOrder(WTCOutput newOutput__oOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT104__OUTPUT_OORDER, oldOutput__oOrder, output__oOrder));
	}
	...
	public WTCTimer getTimer__tTimer() {
		if (timer__tTimer != null && timer__tTimer.eIsProxy()) {
			...
			if (timer__tTimer != oldTimer__tTimer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT104__TIMER_TTIMER, oldTimer__tTimer, timer__tTimer));
			}
		}
	...
	public void setTimer__tTimer(WTCTimer newTimer__tTimer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT104__TIMER_TTIMER, oldTimer__tTimer, timer__tTimer));
	}
	...
	public WTCTimer getTimer__tDelay() {
		if (timer__tDelay != null && timer__tDelay.eIsProxy()) {
			...
			if (timer__tDelay != oldTimer__tDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT104__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
			}
		}
	...
	public void setTimer__tDelay(WTCTimer newTimer__tDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT104__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT104__INPUT_IORDER:
				if (resolve) return getInput__iOrder();
				return basicGetInput__iOrder();
			case WtspecidPackage.CTRL_UNIT104__OUTPUT_OORDER:
				if (resolve) return getOutput__oOrder();
				return basicGetOutput__oOrder();
			case WtspecidPackage.CTRL_UNIT104__TIMER_TTIMER:
				if (resolve) return getTimer__tTimer();
				return basicGetTimer__tTimer();
			case WtspecidPackage.CTRL_UNIT104__TIMER_TDELAY:

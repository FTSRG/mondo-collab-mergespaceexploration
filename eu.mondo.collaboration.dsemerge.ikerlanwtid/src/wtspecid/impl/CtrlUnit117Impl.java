 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getInput__iYawBrakeCommand <em>Input iYaw Brake Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getInput__iYawElectrobrakeStatus <em>Input iYaw Electrobrake Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getInput__iYawHydraulicbrakeStatus <em>Input iYaw Hydraulicbrake Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getInput__iInhibitYaw <em>Input iInhibit Yaw</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getOutput__oYawBrakeStatus <em>Output oYaw Brake Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getOutput__oYawElectrobrakeOrder <em>Output oYaw Electrobrake Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getOutput__oYawHydraulicbrakeOrder <em>Output oYaw Hydraulicbrake Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getOutput__oBrakesSetProblem <em>Output oBrakes Set Problem</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getOutput__oBrakesLiftedProblem <em>Output oBrakes Lifted Problem</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit117Impl#getTimer__tYawBrakeActionsDelay <em>Timer tYaw Brake Actions Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit117Impl extends wtcImpl implements CtrlUnit117 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit117();
	}
		...
		if (input__iYawBrakeCommand != null && input__iYawBrakeCommand.eIsProxy()) {
			...
			if (input__iYawBrakeCommand != oldInput__iYawBrakeCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__INPUT_IYAW_BRAKE_COMMAND, oldInput__iYawBrakeCommand, input__iYawBrakeCommand));
			}
		}
	...
	public void setInput__iYawBrakeCommand(WTCInput newInput__iYawBrakeCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__INPUT_IYAW_BRAKE_COMMAND, oldInput__iYawBrakeCommand, input__iYawBrakeCommand));
	}
	...
	public WTCInput getInput__iYawElectrobrakeStatus() {
		if (input__iYawElectrobrakeStatus != null && input__iYawElectrobrakeStatus.eIsProxy()) {
			...
			if (input__iYawElectrobrakeStatus != oldInput__iYawElectrobrakeStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__INPUT_IYAW_ELECTROBRAKE_STATUS, oldInput__iYawElectrobrakeStatus, input__iYawElectrobrakeStatus));
			}
		}
	...
	public void setInput__iYawElectrobrakeStatus(WTCInput newInput__iYawElectrobrakeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__INPUT_IYAW_ELECTROBRAKE_STATUS, oldInput__iYawElectrobrakeStatus, input__iYawElectrobrakeStatus));
	}
	...
	public WTCInput getInput__iYawHydraulicbrakeStatus() {
		if (input__iYawHydraulicbrakeStatus != null && input__iYawHydraulicbrakeStatus.eIsProxy()) {
			...
			if (input__iYawHydraulicbrakeStatus != oldInput__iYawHydraulicbrakeStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__INPUT_IYAW_HYDRAULICBRAKE_STATUS, oldInput__iYawHydraulicbrakeStatus, input__iYawHydraulicbrakeStatus));
			}
		}
	...
	public void setInput__iYawHydraulicbrakeStatus(WTCInput newInput__iYawHydraulicbrakeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__INPUT_IYAW_HYDRAULICBRAKE_STATUS, oldInput__iYawHydraulicbrakeStatus, input__iYawHydraulicbrakeStatus));
	}
	...
	public WTCInput getInput__iInhibitYaw() {
		if (input__iInhibitYaw != null && input__iInhibitYaw.eIsProxy()) {
			...
			if (input__iInhibitYaw != oldInput__iInhibitYaw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__INPUT_IINHIBIT_YAW, oldInput__iInhibitYaw, input__iInhibitYaw));
			}
		}
	...
	public void setInput__iInhibitYaw(WTCInput newInput__iInhibitYaw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__INPUT_IINHIBIT_YAW, oldInput__iInhibitYaw, input__iInhibitYaw));
	}
	...
	public WTCOutput getOutput__oYawBrakeStatus() {
		if (output__oYawBrakeStatus != null && output__oYawBrakeStatus.eIsProxy()) {
			...
			if (output__oYawBrakeStatus != oldOutput__oYawBrakeStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__OUTPUT_OYAW_BRAKE_STATUS, oldOutput__oYawBrakeStatus, output__oYawBrakeStatus));
			}
		}
	...
	public void setOutput__oYawBrakeStatus(WTCOutput newOutput__oYawBrakeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__OUTPUT_OYAW_BRAKE_STATUS, oldOutput__oYawBrakeStatus, output__oYawBrakeStatus));
	}
	...
	public WTCOutput getOutput__oYawElectrobrakeOrder() {
		if (output__oYawElectrobrakeOrder != null && output__oYawElectrobrakeOrder.eIsProxy()) {
			...
			if (output__oYawElectrobrakeOrder != oldOutput__oYawElectrobrakeOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__OUTPUT_OYAW_ELECTROBRAKE_ORDER, oldOutput__oYawElectrobrakeOrder, output__oYawElectrobrakeOrder));
			}
		}
	...
	public void setOutput__oYawElectrobrakeOrder(WTCOutput newOutput__oYawElectrobrakeOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__OUTPUT_OYAW_ELECTROBRAKE_ORDER, oldOutput__oYawElectrobrakeOrder, output__oYawElectrobrakeOrder));
	}
	...
	public WTCOutput getOutput__oYawHydraulicbrakeOrder() {
		if (output__oYawHydraulicbrakeOrder != null && output__oYawHydraulicbrakeOrder.eIsProxy()) {
			...
			if (output__oYawHydraulicbrakeOrder != oldOutput__oYawHydraulicbrakeOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__OUTPUT_OYAW_HYDRAULICBRAKE_ORDER, oldOutput__oYawHydraulicbrakeOrder, output__oYawHydraulicbrakeOrder));
			}
		}
	...
	public void setOutput__oYawHydraulicbrakeOrder(WTCOutput newOutput__oYawHydraulicbrakeOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__OUTPUT_OYAW_HYDRAULICBRAKE_ORDER, oldOutput__oYawHydraulicbrakeOrder, output__oYawHydraulicbrakeOrder));
	}
	...
	public WTCOutput getOutput__oBrakesSetProblem() {
		if (output__oBrakesSetProblem != null && output__oBrakesSetProblem.eIsProxy()) {
			...
			if (output__oBrakesSetProblem != oldOutput__oBrakesSetProblem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__OUTPUT_OBRAKES_SET_PROBLEM, oldOutput__oBrakesSetProblem, output__oBrakesSetProblem));
			}
		}
	...
	public void setOutput__oBrakesSetProblem(WTCOutput newOutput__oBrakesSetProblem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__OUTPUT_OBRAKES_SET_PROBLEM, oldOutput__oBrakesSetProblem, output__oBrakesSetProblem));
	}
	...
	public WTCOutput getOutput__oBrakesLiftedProblem() {
		if (output__oBrakesLiftedProblem != null && output__oBrakesLiftedProblem.eIsProxy()) {
			...
			if (output__oBrakesLiftedProblem != oldOutput__oBrakesLiftedProblem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__OUTPUT_OBRAKES_LIFTED_PROBLEM, oldOutput__oBrakesLiftedProblem, output__oBrakesLiftedProblem));
			}
		}
	...
	public void setOutput__oBrakesLiftedProblem(WTCOutput newOutput__oBrakesLiftedProblem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__OUTPUT_OBRAKES_LIFTED_PROBLEM, oldOutput__oBrakesLiftedProblem, output__oBrakesLiftedProblem));
	}
	...
	public WTCTimer getTimer__tYawBrakeActionsDelay() {
		if (timer__tYawBrakeActionsDelay != null && timer__tYawBrakeActionsDelay.eIsProxy()) {
			...
			if (timer__tYawBrakeActionsDelay != oldTimer__tYawBrakeActionsDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT117__TIMER_TYAW_BRAKE_ACTIONS_DELAY, oldTimer__tYawBrakeActionsDelay, timer__tYawBrakeActionsDelay));
			}
		}
	...
	public void setTimer__tYawBrakeActionsDelay(WTCTimer newTimer__tYawBrakeActionsDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT117__TIMER_TYAW_BRAKE_ACTIONS_DELAY, oldTimer__tYawBrakeActionsDelay, timer__tYawBrakeActionsDelay));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit114Impl#getInput__iWindDirectionRaw <em>Input iWind Direction Raw</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit114Impl#getInput__iNacelleDirection <em>Input iNacelle Direction</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit114Impl#getOutput__oWindDirection <em>Output oWind Direction</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit114Impl#getOutput__oWindDirectionAverage <em>Output oWind Direction Average</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit114Impl#getOutput__oWindDirectionDispAbsolute <em>Output oWind Direction Disp Absolute</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit114Impl#getOutput__oWindDirectionDispRelative <em>Output oWind Direction Disp Relative</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit114Impl#getParameter__pVaneOffset <em>Parameter pVane Offset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit114Impl extends wtcImpl implements CtrlUnit114 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit114();
	}
		...
		if (input__iWindDirectionRaw != null && input__iWindDirectionRaw.eIsProxy()) {
			...
			if (input__iWindDirectionRaw != oldInput__iWindDirectionRaw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT114__INPUT_IWIND_DIRECTION_RAW, oldInput__iWindDirectionRaw, input__iWindDirectionRaw));
			}
		}
	...
	public void setInput__iWindDirectionRaw(WTCInput newInput__iWindDirectionRaw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT114__INPUT_IWIND_DIRECTION_RAW, oldInput__iWindDirectionRaw, input__iWindDirectionRaw));
	}
	...
	public WTCInput getInput__iNacelleDirection() {
		if (input__iNacelleDirection != null && input__iNacelleDirection.eIsProxy()) {
			...
			if (input__iNacelleDirection != oldInput__iNacelleDirection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT114__INPUT_INACELLE_DIRECTION, oldInput__iNacelleDirection, input__iNacelleDirection));
			}
		}
	...
	public void setInput__iNacelleDirection(WTCInput newInput__iNacelleDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT114__INPUT_INACELLE_DIRECTION, oldInput__iNacelleDirection, input__iNacelleDirection));
	}
	...
	public WTCOutput getOutput__oWindDirection() {
		if (output__oWindDirection != null && output__oWindDirection.eIsProxy()) {
			...
			if (output__oWindDirection != oldOutput__oWindDirection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT114__OUTPUT_OWIND_DIRECTION, oldOutput__oWindDirection, output__oWindDirection));
			}
		}
	...
	public void setOutput__oWindDirection(WTCOutput newOutput__oWindDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT114__OUTPUT_OWIND_DIRECTION, oldOutput__oWindDirection, output__oWindDirection));
	}
	...
	public WTCOutput getOutput__oWindDirectionAverage() {
		if (output__oWindDirectionAverage != null && output__oWindDirectionAverage.eIsProxy()) {
			...
			if (output__oWindDirectionAverage != oldOutput__oWindDirectionAverage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT114__OUTPUT_OWIND_DIRECTION_AVERAGE, oldOutput__oWindDirectionAverage, output__oWindDirectionAverage));
			}
		}
	...
	public void setOutput__oWindDirectionAverage(WTCOutput newOutput__oWindDirectionAverage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT114__OUTPUT_OWIND_DIRECTION_AVERAGE, oldOutput__oWindDirectionAverage, output__oWindDirectionAverage));
	}
	...
	public WTCOutput getOutput__oWindDirectionDispAbsolute() {
		if (output__oWindDirectionDispAbsolute != null && output__oWindDirectionDispAbsolute.eIsProxy()) {
			...
			if (output__oWindDirectionDispAbsolute != oldOutput__oWindDirectionDispAbsolute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT114__OUTPUT_OWIND_DIRECTION_DISP_ABSOLUTE, oldOutput__oWindDirectionDispAbsolute, output__oWindDirectionDispAbsolute));
			}
		}
	...
	public void setOutput__oWindDirectionDispAbsolute(WTCOutput newOutput__oWindDirectionDispAbsolute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT114__OUTPUT_OWIND_DIRECTION_DISP_ABSOLUTE, oldOutput__oWindDirectionDispAbsolute, output__oWindDirectionDispAbsolute));
	}
	...
	public WTCOutput getOutput__oWindDirectionDispRelative() {
		if (output__oWindDirectionDispRelative != null && output__oWindDirectionDispRelative.eIsProxy()) {
			...
			if (output__oWindDirectionDispRelative != oldOutput__oWindDirectionDispRelative) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT114__OUTPUT_OWIND_DIRECTION_DISP_RELATIVE, oldOutput__oWindDirectionDispRelative, output__oWindDirectionDispRelative));
			}
		}
	...
	public void setOutput__oWindDirectionDispRelative(WTCOutput newOutput__oWindDirectionDispRelative) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT114__OUTPUT_OWIND_DIRECTION_DISP_RELATIVE, oldOutput__oWindDirectionDispRelative, output__oWindDirectionDispRelative));
	}
	...
	public WTCParam getParameter__pVaneOffset() {
		if (parameter__pVaneOffset != null && parameter__pVaneOffset.eIsProxy()) {
			...
			if (parameter__pVaneOffset != oldParameter__pVaneOffset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT114__PARAMETER_PVANE_OFFSET, oldParameter__pVaneOffset, parameter__pVaneOffset));
			}
		}
	...
	public void setParameter__pVaneOffset(WTCParam newParameter__pVaneOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT114__PARAMETER_PVANE_OFFSET, oldParameter__pVaneOffset, parameter__pVaneOffset));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit124Impl#getInput__iTorqueVal <em>Input iTorque Val</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit124Impl#getInput__iRolConverter <em>Input iRol Converter</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit124Impl#getOutput__oTorqueRef <em>Output oTorque Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit124Impl extends wtcImpl implements CtrlUnit124 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit124();
	}
		...
		if (input__iTorqueVal != null && input__iTorqueVal.eIsProxy()) {
			...
			if (input__iTorqueVal != oldInput__iTorqueVal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT124__INPUT_ITORQUE_VAL, oldInput__iTorqueVal, input__iTorqueVal));
			}
		}
	...
	public void setInput__iTorqueVal(WTCInput newInput__iTorqueVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT124__INPUT_ITORQUE_VAL, oldInput__iTorqueVal, input__iTorqueVal));
	}
	...
	public WTCInput getInput__iRolConverter() {
		if (input__iRolConverter != null && input__iRolConverter.eIsProxy()) {
			...
			if (input__iRolConverter != oldInput__iRolConverter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT124__INPUT_IROL_CONVERTER, oldInput__iRolConverter, input__iRolConverter));
			}
		}
	...
	public void setInput__iRolConverter(WTCInput newInput__iRolConverter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT124__INPUT_IROL_CONVERTER, oldInput__iRolConverter, input__iRolConverter));
	}
	...
	public WTCOutput getOutput__oTorqueRef() {
		if (output__oTorqueRef != null && output__oTorqueRef.eIsProxy()) {
			...
			if (output__oTorqueRef != oldOutput__oTorqueRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT124__OUTPUT_OTORQUE_REF, oldOutput__oTorqueRef, output__oTorqueRef));
			}
		}
	...
	public void setOutput__oTorqueRef(WTCOutput newOutput__oTorqueRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT124__OUTPUT_OTORQUE_REF, oldOutput__oTorqueRef, output__oTorqueRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT124__INPUT_ITORQUE_VAL:
				if (resolve) return getInput__iTorqueVal();
				return basicGetInput__iTorqueVal();
			case WtspecidPackage.CTRL_UNIT124__INPUT_IROL_CONVERTER:
				if (resolve) return getInput__iRolConverter();
				return basicGetInput__iRolConverter();
			case WtspecidPackage.CTRL_UNIT124__OUTPUT_OTORQUE_REF:

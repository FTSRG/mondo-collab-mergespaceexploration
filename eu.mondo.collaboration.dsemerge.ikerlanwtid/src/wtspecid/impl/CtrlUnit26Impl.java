 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit26Impl#getInput__iCounter <em>Input iCounter</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit26Impl#getInput__iActivator <em>Input iActivator</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit26Impl#getOutput__oCounter <em>Output oCounter</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit26Impl#getOutput__oLimitReached <em>Output oLimit Reached</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit26Impl#getParameter__pLimit <em>Parameter pLimit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit26Impl extends wtcImpl implements CtrlUnit26 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit26();
	}
		...
		if (input__iCounter != null && input__iCounter.eIsProxy()) {
			...
			if (input__iCounter != oldInput__iCounter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT26__INPUT_ICOUNTER, oldInput__iCounter, input__iCounter));
			}
		}
	...
	public void setInput__iCounter(WTCInput newInput__iCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT26__INPUT_ICOUNTER, oldInput__iCounter, input__iCounter));
	}
	...
	public WTCInput getInput__iActivator() {
		if (input__iActivator != null && input__iActivator.eIsProxy()) {
			...
			if (input__iActivator != oldInput__iActivator) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT26__INPUT_IACTIVATOR, oldInput__iActivator, input__iActivator));
			}
		}
	...
	public void setInput__iActivator(WTCInput newInput__iActivator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT26__INPUT_IACTIVATOR, oldInput__iActivator, input__iActivator));
	}
	...
	public WTCOutput getOutput__oCounter() {
		if (output__oCounter != null && output__oCounter.eIsProxy()) {
			...
			if (output__oCounter != oldOutput__oCounter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT26__OUTPUT_OCOUNTER, oldOutput__oCounter, output__oCounter));
			}
		}
	...
	public void setOutput__oCounter(WTCOutput newOutput__oCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT26__OUTPUT_OCOUNTER, oldOutput__oCounter, output__oCounter));
	}
	...
	public WTCOutput getOutput__oLimitReached() {
		if (output__oLimitReached != null && output__oLimitReached.eIsProxy()) {
			...
			if (output__oLimitReached != oldOutput__oLimitReached) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT26__OUTPUT_OLIMIT_REACHED, oldOutput__oLimitReached, output__oLimitReached));
			}
		}
	...
	public void setOutput__oLimitReached(WTCOutput newOutput__oLimitReached) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT26__OUTPUT_OLIMIT_REACHED, oldOutput__oLimitReached, output__oLimitReached));
	}
	...
	public WTCParam getParameter__pLimit() {
		if (parameter__pLimit != null && parameter__pLimit.eIsProxy()) {
			...
			if (parameter__pLimit != oldParameter__pLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT26__PARAMETER_PLIMIT, oldParameter__pLimit, parameter__pLimit));
			}
		}
	...
	public void setParameter__pLimit(WTCParam newParameter__pLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT26__PARAMETER_PLIMIT, oldParameter__pLimit, parameter__pLimit));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit128Impl#getInput__iYawStatus <em>Input iYaw Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit128Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit128Impl#getOutput__oYawMotionProblem <em>Output oYaw Motion Problem</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit128Impl#getParameter__pDegreesPerSecond <em>Parameter pDegrees Per Second</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit128Impl#getTimer__tCheckFrequency <em>Timer tCheck Frequency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit128Impl extends wtcImpl implements CtrlUnit128 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit128();
	}
		...
		if (input__iYawStatus != null && input__iYawStatus.eIsProxy()) {
			...
			if (input__iYawStatus != oldInput__iYawStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT128__INPUT_IYAW_STATUS, oldInput__iYawStatus, input__iYawStatus));
			}
		}
	...
	public void setInput__iYawStatus(WTCInput newInput__iYawStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT128__INPUT_IYAW_STATUS, oldInput__iYawStatus, input__iYawStatus));
	}
	...
	public WTCInput getInput__iTwistAngle() {
		if (input__iTwistAngle != null && input__iTwistAngle.eIsProxy()) {
			...
			if (input__iTwistAngle != oldInput__iTwistAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT128__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
			}
		}
	...
	public void setInput__iTwistAngle(WTCInput newInput__iTwistAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT128__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
	}
	...
	public WTCOutput getOutput__oYawMotionProblem() {
		if (output__oYawMotionProblem != null && output__oYawMotionProblem.eIsProxy()) {
			...
			if (output__oYawMotionProblem != oldOutput__oYawMotionProblem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT128__OUTPUT_OYAW_MOTION_PROBLEM, oldOutput__oYawMotionProblem, output__oYawMotionProblem));
			}
		}
	...
	public void setOutput__oYawMotionProblem(WTCOutput newOutput__oYawMotionProblem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT128__OUTPUT_OYAW_MOTION_PROBLEM, oldOutput__oYawMotionProblem, output__oYawMotionProblem));
	}
	...
	public WTCParam getParameter__pDegreesPerSecond() {
		if (parameter__pDegreesPerSecond != null && parameter__pDegreesPerSecond.eIsProxy()) {
			...
			if (parameter__pDegreesPerSecond != oldParameter__pDegreesPerSecond) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT128__PARAMETER_PDEGREES_PER_SECOND, oldParameter__pDegreesPerSecond, parameter__pDegreesPerSecond));
			}
		}
	...
	public void setParameter__pDegreesPerSecond(WTCParam newParameter__pDegreesPerSecond) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT128__PARAMETER_PDEGREES_PER_SECOND, oldParameter__pDegreesPerSecond, parameter__pDegreesPerSecond));
	}
	...
	public WTCTimer getTimer__tCheckFrequency() {
		if (timer__tCheckFrequency != null && timer__tCheckFrequency.eIsProxy()) {
			...
			if (timer__tCheckFrequency != oldTimer__tCheckFrequency) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT128__TIMER_TCHECK_FREQUENCY, oldTimer__tCheckFrequency, timer__tCheckFrequency));
			}
		}
	...
	public void setTimer__tCheckFrequency(WTCTimer newTimer__tCheckFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT128__TIMER_TCHECK_FREQUENCY, oldTimer__tCheckFrequency, timer__tCheckFrequency));
	}

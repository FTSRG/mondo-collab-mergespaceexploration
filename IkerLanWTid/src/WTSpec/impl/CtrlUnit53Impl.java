 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getInput__iMachineStatusIndicator <em>Input iMachine Status Indicator</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getInput__iStopConditionIndicator <em>Input iStop Condition Indicator</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getInput__iManualByPass <em>Input iManual By Pass</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getInput__iMotorizing <em>Input iMotorizing</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getInput__iFlagIntoWind <em>Input iFlag Into Wind</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getInput__iProtectionCondition <em>Input iProtection Condition</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getInput__iEmergencyCondition <em>Input iEmergency Condition</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getInput__iDeenergizeCondition <em>Input iDeenergize Condition</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getOutput__oAutoStopCommand <em>Output oAuto Stop Command</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getFault__fRunFault <em>Fault fRun Fault</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getTimer__tStartDelay <em>Timer tStart Delay</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getTimer__tCheckRunFault <em>Timer tCheck Run Fault</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit53Impl#getErrorReaction__erMotorizing <em>Error Reaction er Motorizing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

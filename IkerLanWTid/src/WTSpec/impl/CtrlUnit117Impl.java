 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getInput__iYawBrakeCommand <em>Input iYaw Brake Command</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getInput__iYawElectrobrakeStatus <em>Input iYaw Electrobrake Status</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getInput__iYawHydraulicbrakeStatus <em>Input iYaw Hydraulicbrake Status</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getInput__iInhibitYaw <em>Input iInhibit Yaw</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getOutput__oYawBrakeStatus <em>Output oYaw Brake Status</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getOutput__oYawElectrobrakeOrder <em>Output oYaw Electrobrake Order</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getOutput__oYawHydraulicbrakeOrder <em>Output oYaw Hydraulicbrake Order</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getOutput__oBrakesSetProblem <em>Output oBrakes Set Problem</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getOutput__oBrakesLiftedProblem <em>Output oBrakes Lifted Problem</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit117Impl#getTimer__tYawBrakeActionsDelay <em>Timer tYaw Brake Actions Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit16Impl#getInput__iVarInput <em>Input iVar Input</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit16Impl#getOutput__oVarOutput <em>Output oVar Output</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit16Impl extends wtcImpl implements CtrlUnit16 {
	...
	protected EClass eStaticClass() {
		return WTSpecPackage.eINSTANCE.getCtrlUnit16();
	}
		...
		if (input__iVarInput != null && input__iVarInput.eIsProxy()) {
			...
			if (input__iVarInput != oldInput__iVarInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT16__INPUT_IVAR_INPUT, oldInput__iVarInput, input__iVarInput));
			}
		}
	...
	public void setInput__iVarInput(WTCInput newInput__iVarInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT16__INPUT_IVAR_INPUT, oldInput__iVarInput, input__iVarInput));
	}
	...
	public WTCOutput getOutput__oVarOutput() {
		if (output__oVarOutput != null && output__oVarOutput.eIsProxy()) {
			...
			if (output__oVarOutput != oldOutput__oVarOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT16__OUTPUT_OVAR_OUTPUT, oldOutput__oVarOutput, output__oVarOutput));
			}
		}
	...
	public void setOutput__oVarOutput(WTCOutput newOutput__oVarOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT16__OUTPUT_OVAR_OUTPUT, oldOutput__oVarOutput, output__oVarOutput));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecPackage.CTRL_UNIT16__INPUT_IVAR_INPUT:
				if (resolve) return getInput__iVarInput();
				return basicGetInput__iVarInput();
			case WTSpecPackage.CTRL_UNIT16__OUTPUT_OVAR_OUTPUT:

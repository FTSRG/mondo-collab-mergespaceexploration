 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit128Impl#getInput__iYawStatus <em>Input iYaw Status</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit128Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit128Impl#getOutput__oYawMotionProblem <em>Output oYaw Motion Problem</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit128Impl#getParameter__pDegreesPerSecond <em>Parameter pDegrees Per Second</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit128Impl#getTimer__tCheckFrequency <em>Timer tCheck Frequency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

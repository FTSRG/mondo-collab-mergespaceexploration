 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit21Impl#getInput__iWindDirection <em>Input iWind Direction</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit21Impl#getInput__iFlagBrakes <em>Input iFlag Brakes</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit21Impl#getInput__iFlagIntoWind <em>Input iFlag Into Wind</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit21Impl#getOutput__oBackWindDetected <em>Output oBack Wind Detected</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit21Impl#getParameter__pMaxAbsoluteAngle <em>Parameter pMax Absolute Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated

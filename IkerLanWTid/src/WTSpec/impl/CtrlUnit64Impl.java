 ...
 * <ul>
 *   <li>{@link WTSpec.impl.CtrlUnit64Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link WTSpec.impl.CtrlUnit64Impl#getErrorReaction__erErrorReaction <em>Error Reaction er Error Reaction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit64Impl extends wtcImpl implements CtrlUnit64 {
	...
	protected EClass eStaticClass() {
		return WTSpecPackage.eINSTANCE.getCtrlUnit64();
	}
		...
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT64__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT64__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public WTCErrorReaction getErrorReaction__erErrorReaction() {
		if (errorReaction__erErrorReaction != null && errorReaction__erErrorReaction.eIsProxy()) {
			...
			if (errorReaction__erErrorReaction != oldErrorReaction__erErrorReaction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecPackage.CTRL_UNIT64__ERROR_REACTION_ER_ERROR_REACTION, oldErrorReaction__erErrorReaction, errorReaction__erErrorReaction));
			}
		}
	...
	public void setErrorReaction__erErrorReaction(WTCErrorReaction newErrorReaction__erErrorReaction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecPackage.CTRL_UNIT64__ERROR_REACTION_ER_ERROR_REACTION, oldErrorReaction__erErrorReaction, errorReaction__erErrorReaction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecPackage.CTRL_UNIT64__OUTPUT_OOUTPUT:
				if (resolve) return getOutput__oOutput();
				return basicGetOutput__oOutput();
			case WTSpecPackage.CTRL_UNIT64__ERROR_REACTION_ER_ERROR_REACTION:

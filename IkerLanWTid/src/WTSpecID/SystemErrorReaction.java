 ...
 * <ul>
 *   <li>{@link WTSpecID.SystemErrorReaction#getSysId <em>Sys Id</em>}</li>
 * </ul>
 * </p>
 *
 * @see WTSpecID.WTSpecIDPackage#getSystemErrorReaction()
 * @model
 * @generated
 */
public interface SystemErrorReaction extends WTCErrorReaction {
	 ...
	 * @see #setSysId(String)
	 * @see WTSpecID.WTSpecIDPackage#getSystemErrorReaction_SysId()
	 * @model
	 * @generated
	 */
	String getSysId();
	...
	/**
	 * Sets the value of the '{@link WTSpecID.SystemErrorReaction#getSysId <em>Sys Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

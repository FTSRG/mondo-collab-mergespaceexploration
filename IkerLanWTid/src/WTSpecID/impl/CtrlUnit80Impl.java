 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit80Impl#getInput__iAccessState <em>Input iAccess State</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit80Impl#getInput__iMaintenanceStatus <em>Input iMaintenance Status</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit80Impl#getInput__iButtonStateNC2 <em>Input iButton State NC2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit80Impl#getInput__iButtonStateTC <em>Input iButton State TC</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit80Impl#getInput__iButtonStateRemote <em>Input iButton State Remote</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit80Impl#getOutput__oButtonState <em>Output oButton State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit80Impl extends wtcImpl implements CtrlUnit80 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit80();
	}
		...
		if (input__iAccessState != null && input__iAccessState.eIsProxy()) {
			...
			if (input__iAccessState != oldInput__iAccessState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT80__INPUT_IACCESS_STATE, oldInput__iAccessState, input__iAccessState));
			}
		}
	...
	public void setInput__iAccessState(WTCInput newInput__iAccessState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT80__INPUT_IACCESS_STATE, oldInput__iAccessState, input__iAccessState));
	}
	...
	public WTCInput getInput__iMaintenanceStatus() {
		if (input__iMaintenanceStatus != null && input__iMaintenanceStatus.eIsProxy()) {
			...
			if (input__iMaintenanceStatus != oldInput__iMaintenanceStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT80__INPUT_IMAINTENANCE_STATUS, oldInput__iMaintenanceStatus, input__iMaintenanceStatus));
			}
		}
	...
	public void setInput__iMaintenanceStatus(WTCInput newInput__iMaintenanceStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT80__INPUT_IMAINTENANCE_STATUS, oldInput__iMaintenanceStatus, input__iMaintenanceStatus));
	}
	...
	public WTCInput getInput__iButtonStateNC2() {
		if (input__iButtonStateNC2 != null && input__iButtonStateNC2.eIsProxy()) {
			...
			if (input__iButtonStateNC2 != oldInput__iButtonStateNC2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT80__INPUT_IBUTTON_STATE_NC2, oldInput__iButtonStateNC2, input__iButtonStateNC2));
			}
		}
	...
	public void setInput__iButtonStateNC2(WTCInput newInput__iButtonStateNC2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT80__INPUT_IBUTTON_STATE_NC2, oldInput__iButtonStateNC2, input__iButtonStateNC2));
	}
	...
	public WTCInput getInput__iButtonStateTC() {
		if (input__iButtonStateTC != null && input__iButtonStateTC.eIsProxy()) {
			...
			if (input__iButtonStateTC != oldInput__iButtonStateTC) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT80__INPUT_IBUTTON_STATE_TC, oldInput__iButtonStateTC, input__iButtonStateTC));
			}
		}
	...
	public void setInput__iButtonStateTC(WTCInput newInput__iButtonStateTC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT80__INPUT_IBUTTON_STATE_TC, oldInput__iButtonStateTC, input__iButtonStateTC));
	}
	...
	public WTCInput getInput__iButtonStateRemote() {
		if (input__iButtonStateRemote != null && input__iButtonStateRemote.eIsProxy()) {
			...
			if (input__iButtonStateRemote != oldInput__iButtonStateRemote) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT80__INPUT_IBUTTON_STATE_REMOTE, oldInput__iButtonStateRemote, input__iButtonStateRemote));
			}
		}
	...
	public void setInput__iButtonStateRemote(WTCInput newInput__iButtonStateRemote) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT80__INPUT_IBUTTON_STATE_REMOTE, oldInput__iButtonStateRemote, input__iButtonStateRemote));
	}
	...
	public WTCOutput getOutput__oButtonState() {
		if (output__oButtonState != null && output__oButtonState.eIsProxy()) {
			...
			if (output__oButtonState != oldOutput__oButtonState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT80__OUTPUT_OBUTTON_STATE, oldOutput__oButtonState, output__oButtonState));
			}
		}
	...
	public void setOutput__oButtonState(WTCOutput newOutput__oButtonState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT80__OUTPUT_OBUTTON_STATE, oldOutput__oButtonState, output__oButtonState));
	}

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit44Impl#getInput__iInput <em>Input iInput</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit44Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit44Impl extends wtcImpl implements CtrlUnit44 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit44();
	}
		...
		if (input__iInput != null && input__iInput.eIsProxy()) {
			...
			if (input__iInput != oldInput__iInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT44__INPUT_IINPUT, oldInput__iInput, input__iInput));
			}
		}
	...
	public void setInput__iInput(WTCInput newInput__iInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT44__INPUT_IINPUT, oldInput__iInput, input__iInput));
	}
	...
	public WTCOutput getOutput__oOutput() {
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT44__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT44__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT44__INPUT_IINPUT:
				if (resolve) return getInput__iInput();
				return basicGetInput__iInput();
			case WTSpecIDPackage.CTRL_UNIT44__OUTPUT_OOUTPUT:

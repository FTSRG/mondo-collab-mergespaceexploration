 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit62Impl#getInput__iInverterTorqueRef <em>Input iInverter Torque Ref</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit62Impl#getInput__iInverterTorqueRefLocking <em>Input iInverter Torque Ref Locking</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit62Impl#getInput__iMotorizing <em>Input iMotorizing</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit62Impl#getOutput__oInverterTorqueRefFinal <em>Output oInverter Torque Ref Final</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit62Impl#getOutput__oInverterMotorizeCommand <em>Output oInverter Motorize Command</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit62Impl extends wtcImpl implements CtrlUnit62 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit62();
	}
		...
		if (input__iInverterTorqueRef != null && input__iInverterTorqueRef.eIsProxy()) {
			...
			if (input__iInverterTorqueRef != oldInput__iInverterTorqueRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT62__INPUT_IINVERTER_TORQUE_REF, oldInput__iInverterTorqueRef, input__iInverterTorqueRef));
			}
		}
	...
	public void setInput__iInverterTorqueRef(WTCInput newInput__iInverterTorqueRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT62__INPUT_IINVERTER_TORQUE_REF, oldInput__iInverterTorqueRef, input__iInverterTorqueRef));
	}
	...
	public WTCInput getInput__iInverterTorqueRefLocking() {
		if (input__iInverterTorqueRefLocking != null && input__iInverterTorqueRefLocking.eIsProxy()) {
			...
			if (input__iInverterTorqueRefLocking != oldInput__iInverterTorqueRefLocking) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT62__INPUT_IINVERTER_TORQUE_REF_LOCKING, oldInput__iInverterTorqueRefLocking, input__iInverterTorqueRefLocking));
			}
		}
	...
	public void setInput__iInverterTorqueRefLocking(WTCInput newInput__iInverterTorqueRefLocking) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT62__INPUT_IINVERTER_TORQUE_REF_LOCKING, oldInput__iInverterTorqueRefLocking, input__iInverterTorqueRefLocking));
	}
	...
	public WTCInput getInput__iMotorizing() {
		if (input__iMotorizing != null && input__iMotorizing.eIsProxy()) {
			...
			if (input__iMotorizing != oldInput__iMotorizing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT62__INPUT_IMOTORIZING, oldInput__iMotorizing, input__iMotorizing));
			}
		}
	...
	public void setInput__iMotorizing(WTCInput newInput__iMotorizing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT62__INPUT_IMOTORIZING, oldInput__iMotorizing, input__iMotorizing));
	}
	...
	public WTCOutput getOutput__oInverterTorqueRefFinal() {
		if (output__oInverterTorqueRefFinal != null && output__oInverterTorqueRefFinal.eIsProxy()) {
			...
			if (output__oInverterTorqueRefFinal != oldOutput__oInverterTorqueRefFinal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT62__OUTPUT_OINVERTER_TORQUE_REF_FINAL, oldOutput__oInverterTorqueRefFinal, output__oInverterTorqueRefFinal));
			}
		}
	...
	public void setOutput__oInverterTorqueRefFinal(WTCOutput newOutput__oInverterTorqueRefFinal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT62__OUTPUT_OINVERTER_TORQUE_REF_FINAL, oldOutput__oInverterTorqueRefFinal, output__oInverterTorqueRefFinal));
	}
	...
	public WTCOutput getOutput__oInverterMotorizeCommand() {
		if (output__oInverterMotorizeCommand != null && output__oInverterMotorizeCommand.eIsProxy()) {
			...
			if (output__oInverterMotorizeCommand != oldOutput__oInverterMotorizeCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT62__OUTPUT_OINVERTER_MOTORIZE_COMMAND, oldOutput__oInverterMotorizeCommand, output__oInverterMotorizeCommand));
			}
		}
	...
	public void setOutput__oInverterMotorizeCommand(WTCOutput newOutput__oInverterMotorizeCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT62__OUTPUT_OINVERTER_MOTORIZE_COMMAND, oldOutput__oInverterMotorizeCommand, output__oInverterMotorizeCommand));
	}

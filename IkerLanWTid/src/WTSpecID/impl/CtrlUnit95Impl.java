 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit95Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit95Impl#getInput__iAccessState <em>Input iAccess State</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit95Impl#getOutput__oTwistAngleLeftLimit <em>Output oTwist Angle Left Limit</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit95Impl#getOutput__oTwistAngleRightLimit <em>Output oTwist Angle Right Limit</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit95Impl#getOutput__oRetwistPreCommand <em>Output oRetwist Pre Command</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit95Impl#getFault__fTwistExcessiveCW <em>Fault fTwist Excessive CW</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit95Impl#getFault__fTwistExcessiveCCW <em>Fault fTwist Excessive CCW</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit95Impl extends wtcImpl implements CtrlUnit95 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit95();
	}
		...
		if (input__iTwistAngle != null && input__iTwistAngle.eIsProxy()) {
			...
			if (input__iTwistAngle != oldInput__iTwistAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT95__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
			}
		}
	...
	public void setInput__iTwistAngle(WTCInput newInput__iTwistAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT95__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
	}
	...
	public WTCInput getInput__iAccessState() {
		if (input__iAccessState != null && input__iAccessState.eIsProxy()) {
			...
			if (input__iAccessState != oldInput__iAccessState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT95__INPUT_IACCESS_STATE, oldInput__iAccessState, input__iAccessState));
			}
		}
	...
	public void setInput__iAccessState(WTCInput newInput__iAccessState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT95__INPUT_IACCESS_STATE, oldInput__iAccessState, input__iAccessState));
	}
	...
	public WTCOutput getOutput__oTwistAngleLeftLimit() {
		if (output__oTwistAngleLeftLimit != null && output__oTwistAngleLeftLimit.eIsProxy()) {
			...
			if (output__oTwistAngleLeftLimit != oldOutput__oTwistAngleLeftLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT95__OUTPUT_OTWIST_ANGLE_LEFT_LIMIT, oldOutput__oTwistAngleLeftLimit, output__oTwistAngleLeftLimit));
			}
		}
	...
	public void setOutput__oTwistAngleLeftLimit(WTCOutput newOutput__oTwistAngleLeftLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT95__OUTPUT_OTWIST_ANGLE_LEFT_LIMIT, oldOutput__oTwistAngleLeftLimit, output__oTwistAngleLeftLimit));
	}
	...
	public WTCOutput getOutput__oTwistAngleRightLimit() {
		if (output__oTwistAngleRightLimit != null && output__oTwistAngleRightLimit.eIsProxy()) {
			...
			if (output__oTwistAngleRightLimit != oldOutput__oTwistAngleRightLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT95__OUTPUT_OTWIST_ANGLE_RIGHT_LIMIT, oldOutput__oTwistAngleRightLimit, output__oTwistAngleRightLimit));
			}
		}
	...
	public void setOutput__oTwistAngleRightLimit(WTCOutput newOutput__oTwistAngleRightLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT95__OUTPUT_OTWIST_ANGLE_RIGHT_LIMIT, oldOutput__oTwistAngleRightLimit, output__oTwistAngleRightLimit));
	}
	...
	public WTCOutput getOutput__oRetwistPreCommand() {
		if (output__oRetwistPreCommand != null && output__oRetwistPreCommand.eIsProxy()) {
			...
			if (output__oRetwistPreCommand != oldOutput__oRetwistPreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT95__OUTPUT_ORETWIST_PRE_COMMAND, oldOutput__oRetwistPreCommand, output__oRetwistPreCommand));
			}
		}
	...
	public void setOutput__oRetwistPreCommand(WTCOutput newOutput__oRetwistPreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT95__OUTPUT_ORETWIST_PRE_COMMAND, oldOutput__oRetwistPreCommand, output__oRetwistPreCommand));
	}
	...
	public WTCFault getFault__fTwistExcessiveCW() {
		if (fault__fTwistExcessiveCW != null && fault__fTwistExcessiveCW.eIsProxy()) {
			...
			if (fault__fTwistExcessiveCW != oldFault__fTwistExcessiveCW) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT95__FAULT_FTWIST_EXCESSIVE_CW, oldFault__fTwistExcessiveCW, fault__fTwistExcessiveCW));
			}
		}
	...
	public void setFault__fTwistExcessiveCW(WTCFault newFault__fTwistExcessiveCW) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT95__FAULT_FTWIST_EXCESSIVE_CW, oldFault__fTwistExcessiveCW, fault__fTwistExcessiveCW));
	}
	...
	public WTCFault getFault__fTwistExcessiveCCW() {
		if (fault__fTwistExcessiveCCW != null && fault__fTwistExcessiveCCW.eIsProxy()) {
			...
			if (fault__fTwistExcessiveCCW != oldFault__fTwistExcessiveCCW) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT95__FAULT_FTWIST_EXCESSIVE_CCW, oldFault__fTwistExcessiveCCW, fault__fTwistExcessiveCCW));
			}
		}
	...
	public void setFault__fTwistExcessiveCCW(WTCFault newFault__fTwistExcessiveCCW) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT95__FAULT_FTWIST_EXCESSIVE_CCW, oldFault__fTwistExcessiveCCW, fault__fTwistExcessiveCCW));
	}

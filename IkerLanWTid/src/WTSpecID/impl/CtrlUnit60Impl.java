 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iDisconnect <em>Input iDisconnect</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iStopCommand <em>Input iStop Command</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iPitchBraked <em>Input iPitch Braked</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iInverterRpm <em>Input iInverter Rpm</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iReadyForOn <em>Input iReady For On</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iReadyForRun <em>Input iReady For Run</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iReadyForRef <em>Input iReady For Ref</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iResetOrder <em>Input iReset Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iForceInvOff <em>Input iForce Inv Off</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getInput__iSafetyInput <em>Input iSafety Input</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getOutput__oInverterRun <em>Output oInverter Run</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getOutput__oInverterToOn <em>Output oInverter To On</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getParameter__pInverterConnSpeed <em>Parameter pInverter Conn Speed</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getParameter__pInverterConnSpeedHysteresis <em>Parameter pInverter Conn Speed Hysteresis</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getFault__fReconnectWarning <em>Fault fReconnect Warning</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getFault__fReadyRefWarning <em>Fault fReady Ref Warning</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getTimer__tConnection <em>Timer tConnection</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit60Impl#getTimer__tRunningDelay <em>Timer tRunning Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit60Impl extends wtcImpl implements CtrlUnit60 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit60();
	}
		...
		if (input__iDisconnect != null && input__iDisconnect.eIsProxy()) {
			...
			if (input__iDisconnect != oldInput__iDisconnect) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_IDISCONNECT, oldInput__iDisconnect, input__iDisconnect));
			}
		}
	...
	public void setInput__iDisconnect(WTCInput newInput__iDisconnect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_IDISCONNECT, oldInput__iDisconnect, input__iDisconnect));
	}
	...
	public WTCInput getInput__iStopCommand() {
		if (input__iStopCommand != null && input__iStopCommand.eIsProxy()) {
			...
			if (input__iStopCommand != oldInput__iStopCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_ISTOP_COMMAND, oldInput__iStopCommand, input__iStopCommand));
			}
		}
	...
	public void setInput__iStopCommand(WTCInput newInput__iStopCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_ISTOP_COMMAND, oldInput__iStopCommand, input__iStopCommand));
	}
	...
	public WTCInput getInput__iPitchBraked() {
		if (input__iPitchBraked != null && input__iPitchBraked.eIsProxy()) {
			...
			if (input__iPitchBraked != oldInput__iPitchBraked) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_IPITCH_BRAKED, oldInput__iPitchBraked, input__iPitchBraked));
			}
		}
	...
	public void setInput__iPitchBraked(WTCInput newInput__iPitchBraked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_IPITCH_BRAKED, oldInput__iPitchBraked, input__iPitchBraked));
	}
	...
	public WTCInput getInput__iInverterRpm() {
		if (input__iInverterRpm != null && input__iInverterRpm.eIsProxy()) {
			...
			if (input__iInverterRpm != oldInput__iInverterRpm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_IINVERTER_RPM, oldInput__iInverterRpm, input__iInverterRpm));
			}
		}
	...
	public void setInput__iInverterRpm(WTCInput newInput__iInverterRpm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_IINVERTER_RPM, oldInput__iInverterRpm, input__iInverterRpm));
	}
	...
	public WTCInput getInput__iReadyForOn() {
		if (input__iReadyForOn != null && input__iReadyForOn.eIsProxy()) {
			...
			if (input__iReadyForOn != oldInput__iReadyForOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_IREADY_FOR_ON, oldInput__iReadyForOn, input__iReadyForOn));
			}
		}
	...
	public void setInput__iReadyForOn(WTCInput newInput__iReadyForOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_IREADY_FOR_ON, oldInput__iReadyForOn, input__iReadyForOn));
	}
	...
	public WTCInput getInput__iReadyForRun() {
		if (input__iReadyForRun != null && input__iReadyForRun.eIsProxy()) {
			...
			if (input__iReadyForRun != oldInput__iReadyForRun) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_IREADY_FOR_RUN, oldInput__iReadyForRun, input__iReadyForRun));
			}
		}
	...
	public void setInput__iReadyForRun(WTCInput newInput__iReadyForRun) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_IREADY_FOR_RUN, oldInput__iReadyForRun, input__iReadyForRun));
	}
	...
	public WTCInput getInput__iReadyForRef() {
		if (input__iReadyForRef != null && input__iReadyForRef.eIsProxy()) {
			...
			if (input__iReadyForRef != oldInput__iReadyForRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_IREADY_FOR_REF, oldInput__iReadyForRef, input__iReadyForRef));
			}
		}
	...
	public void setInput__iReadyForRef(WTCInput newInput__iReadyForRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_IREADY_FOR_REF, oldInput__iReadyForRef, input__iReadyForRef));
	}
	...
	public WTCInput getInput__iResetOrder() {
		if (input__iResetOrder != null && input__iResetOrder.eIsProxy()) {
			...
			if (input__iResetOrder != oldInput__iResetOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_IRESET_ORDER, oldInput__iResetOrder, input__iResetOrder));
			}
		}
	...
	public void setInput__iResetOrder(WTCInput newInput__iResetOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_IRESET_ORDER, oldInput__iResetOrder, input__iResetOrder));
	}
	...
	public WTCInput getInput__iForceInvOff() {
		if (input__iForceInvOff != null && input__iForceInvOff.eIsProxy()) {
			...
			if (input__iForceInvOff != oldInput__iForceInvOff) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_IFORCE_INV_OFF, oldInput__iForceInvOff, input__iForceInvOff));
			}
		}
	...
	public void setInput__iForceInvOff(WTCInput newInput__iForceInvOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_IFORCE_INV_OFF, oldInput__iForceInvOff, input__iForceInvOff));
	}
	...
	public WTCInput getInput__iSafetyInput() {
		if (input__iSafetyInput != null && input__iSafetyInput.eIsProxy()) {
			...
			if (input__iSafetyInput != oldInput__iSafetyInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__INPUT_ISAFETY_INPUT, oldInput__iSafetyInput, input__iSafetyInput));
			}
		}
	...
	public void setInput__iSafetyInput(WTCInput newInput__iSafetyInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__INPUT_ISAFETY_INPUT, oldInput__iSafetyInput, input__iSafetyInput));
	}
	...
	public WTCOutput getOutput__oInverterRun() {
		if (output__oInverterRun != null && output__oInverterRun.eIsProxy()) {
			...
			if (output__oInverterRun != oldOutput__oInverterRun) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__OUTPUT_OINVERTER_RUN, oldOutput__oInverterRun, output__oInverterRun));
			}
		}
	...
	public void setOutput__oInverterRun(WTCOutput newOutput__oInverterRun) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__OUTPUT_OINVERTER_RUN, oldOutput__oInverterRun, output__oInverterRun));
	}
	...
	public WTCOutput getOutput__oInverterToOn() {
		if (output__oInverterToOn != null && output__oInverterToOn.eIsProxy()) {
			...
			if (output__oInverterToOn != oldOutput__oInverterToOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__OUTPUT_OINVERTER_TO_ON, oldOutput__oInverterToOn, output__oInverterToOn));
			}
		}
	...
	public void setOutput__oInverterToOn(WTCOutput newOutput__oInverterToOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__OUTPUT_OINVERTER_TO_ON, oldOutput__oInverterToOn, output__oInverterToOn));
	}
	...
	public WTCParam getParameter__pInverterConnSpeed() {
		if (parameter__pInverterConnSpeed != null && parameter__pInverterConnSpeed.eIsProxy()) {
			...
			if (parameter__pInverterConnSpeed != oldParameter__pInverterConnSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__PARAMETER_PINVERTER_CONN_SPEED, oldParameter__pInverterConnSpeed, parameter__pInverterConnSpeed));
			}
		}
	...
	public void setParameter__pInverterConnSpeed(WTCParam newParameter__pInverterConnSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__PARAMETER_PINVERTER_CONN_SPEED, oldParameter__pInverterConnSpeed, parameter__pInverterConnSpeed));
	}
	...
	public WTCParam getParameter__pInverterConnSpeedHysteresis() {
		if (parameter__pInverterConnSpeedHysteresis != null && parameter__pInverterConnSpeedHysteresis.eIsProxy()) {
			...
			if (parameter__pInverterConnSpeedHysteresis != oldParameter__pInverterConnSpeedHysteresis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__PARAMETER_PINVERTER_CONN_SPEED_HYSTERESIS, oldParameter__pInverterConnSpeedHysteresis, parameter__pInverterConnSpeedHysteresis));
			}
		}
	...
	public void setParameter__pInverterConnSpeedHysteresis(WTCParam newParameter__pInverterConnSpeedHysteresis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__PARAMETER_PINVERTER_CONN_SPEED_HYSTERESIS, oldParameter__pInverterConnSpeedHysteresis, parameter__pInverterConnSpeedHysteresis));
	}
	...
	public WTCFault getFault__fReconnectWarning() {
		if (fault__fReconnectWarning != null && fault__fReconnectWarning.eIsProxy()) {
			...
			if (fault__fReconnectWarning != oldFault__fReconnectWarning) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__FAULT_FRECONNECT_WARNING, oldFault__fReconnectWarning, fault__fReconnectWarning));
			}
		}
	...
	public void setFault__fReconnectWarning(WTCFault newFault__fReconnectWarning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__FAULT_FRECONNECT_WARNING, oldFault__fReconnectWarning, fault__fReconnectWarning));
	}
	...
	public WTCFault getFault__fReadyRefWarning() {
		if (fault__fReadyRefWarning != null && fault__fReadyRefWarning.eIsProxy()) {
			...
			if (fault__fReadyRefWarning != oldFault__fReadyRefWarning) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__FAULT_FREADY_REF_WARNING, oldFault__fReadyRefWarning, fault__fReadyRefWarning));
			}
		}
	...
	public void setFault__fReadyRefWarning(WTCFault newFault__fReadyRefWarning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__FAULT_FREADY_REF_WARNING, oldFault__fReadyRefWarning, fault__fReadyRefWarning));
	}
	...
	public WTCTimer getTimer__tConnection() {
		if (timer__tConnection != null && timer__tConnection.eIsProxy()) {
			...
			if (timer__tConnection != oldTimer__tConnection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__TIMER_TCONNECTION, oldTimer__tConnection, timer__tConnection));
			}
		}
	...
	public void setTimer__tConnection(WTCTimer newTimer__tConnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__TIMER_TCONNECTION, oldTimer__tConnection, timer__tConnection));
	}
	...
	public WTCTimer getTimer__tRunningDelay() {
		if (timer__tRunningDelay != null && timer__tRunningDelay.eIsProxy()) {
			...
			if (timer__tRunningDelay != oldTimer__tRunningDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT60__TIMER_TRUNNING_DELAY, oldTimer__tRunningDelay, timer__tRunningDelay));
			}
		}
	...
	public void setTimer__tRunningDelay(WTCTimer newTimer__tRunningDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT60__TIMER_TRUNNING_DELAY, oldTimer__tRunningDelay, timer__tRunningDelay));
	}

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit19Impl#getInput__iPitchTorque <em>Input iPitch Torque</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit19Impl#getOutput__oPitchRms <em>Output oPitch Rms</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit19Impl#getParameter__pDivisor <em>Parameter pDivisor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit19Impl extends wtcImpl implements CtrlUnit19 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit19();
	}
		...
		if (input__iPitchTorque != null && input__iPitchTorque.eIsProxy()) {
			...
			if (input__iPitchTorque != oldInput__iPitchTorque) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT19__INPUT_IPITCH_TORQUE, oldInput__iPitchTorque, input__iPitchTorque));
			}
		}
	...
	public void setInput__iPitchTorque(WTCInput newInput__iPitchTorque) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT19__INPUT_IPITCH_TORQUE, oldInput__iPitchTorque, input__iPitchTorque));
	}
	...
	public WTCOutput getOutput__oPitchRms() {
		if (output__oPitchRms != null && output__oPitchRms.eIsProxy()) {
			...
			if (output__oPitchRms != oldOutput__oPitchRms) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT19__OUTPUT_OPITCH_RMS, oldOutput__oPitchRms, output__oPitchRms));
			}
		}
	...
	public void setOutput__oPitchRms(WTCOutput newOutput__oPitchRms) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT19__OUTPUT_OPITCH_RMS, oldOutput__oPitchRms, output__oPitchRms));
	}
	...
	public WTCParam getParameter__pDivisor() {
		if (parameter__pDivisor != null && parameter__pDivisor.eIsProxy()) {
			...
			if (parameter__pDivisor != oldParameter__pDivisor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT19__PARAMETER_PDIVISOR, oldParameter__pDivisor, parameter__pDivisor));
			}
		}
	...
	public void setParameter__pDivisor(WTCParam newParameter__pDivisor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT19__PARAMETER_PDIVISOR, oldParameter__pDivisor, parameter__pDivisor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT19__INPUT_IPITCH_TORQUE:
				if (resolve) return getInput__iPitchTorque();
				return basicGetInput__iPitchTorque();
			case WTSpecIDPackage.CTRL_UNIT19__OUTPUT_OPITCH_RMS:
				if (resolve) return getOutput__oPitchRms();
				return basicGetOutput__oPitchRms();
			case WTSpecIDPackage.CTRL_UNIT19__PARAMETER_PDIVISOR:

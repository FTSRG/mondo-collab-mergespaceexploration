 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit46Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit46Impl#getErrorReaction__erErrorReaction <em>Error Reaction er Error Reaction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit46Impl extends wtcImpl implements CtrlUnit46 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit46();
	}
		...
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT46__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT46__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public WTCErrorReaction getErrorReaction__erErrorReaction() {
		if (errorReaction__erErrorReaction != null && errorReaction__erErrorReaction.eIsProxy()) {
			...
			if (errorReaction__erErrorReaction != oldErrorReaction__erErrorReaction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT46__ERROR_REACTION_ER_ERROR_REACTION, oldErrorReaction__erErrorReaction, errorReaction__erErrorReaction));
			}
		}
	...
	public void setErrorReaction__erErrorReaction(WTCErrorReaction newErrorReaction__erErrorReaction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT46__ERROR_REACTION_ER_ERROR_REACTION, oldErrorReaction__erErrorReaction, errorReaction__erErrorReaction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT46__OUTPUT_OOUTPUT:
				if (resolve) return getOutput__oOutput();
				return basicGetOutput__oOutput();
			case WTSpecIDPackage.CTRL_UNIT46__ERROR_REACTION_ER_ERROR_REACTION:

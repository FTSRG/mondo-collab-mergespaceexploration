 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit96Impl#getInput__iHMIDisableOrder <em>Input iHMI Disable Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit96Impl#getInput__iElementStatus <em>Input iElement Status</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit96Impl#getOutput__oElementRol <em>Output oElement Rol</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit96Impl#getParameter__pMaxElements <em>Parameter pMax Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit96Impl extends wtcImpl implements CtrlUnit96 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit96();
	}
		...
		if (input__iHMIDisableOrder != null && input__iHMIDisableOrder.eIsProxy()) {
			...
			if (input__iHMIDisableOrder != oldInput__iHMIDisableOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT96__INPUT_IHMI_DISABLE_ORDER, oldInput__iHMIDisableOrder, input__iHMIDisableOrder));
			}
		}
	...
	public void setInput__iHMIDisableOrder(WTCInput newInput__iHMIDisableOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT96__INPUT_IHMI_DISABLE_ORDER, oldInput__iHMIDisableOrder, input__iHMIDisableOrder));
	}
	...
	public WTCInput getInput__iElementStatus() {
		if (input__iElementStatus != null && input__iElementStatus.eIsProxy()) {
			...
			if (input__iElementStatus != oldInput__iElementStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT96__INPUT_IELEMENT_STATUS, oldInput__iElementStatus, input__iElementStatus));
			}
		}
	...
	public void setInput__iElementStatus(WTCInput newInput__iElementStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT96__INPUT_IELEMENT_STATUS, oldInput__iElementStatus, input__iElementStatus));
	}
	...
	public WTCOutput getOutput__oElementRol() {
		if (output__oElementRol != null && output__oElementRol.eIsProxy()) {
			...
			if (output__oElementRol != oldOutput__oElementRol) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT96__OUTPUT_OELEMENT_ROL, oldOutput__oElementRol, output__oElementRol));
			}
		}
	...
	public void setOutput__oElementRol(WTCOutput newOutput__oElementRol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT96__OUTPUT_OELEMENT_ROL, oldOutput__oElementRol, output__oElementRol));
	}
	...
	public WTCParam getParameter__pMaxElements() {
		if (parameter__pMaxElements != null && parameter__pMaxElements.eIsProxy()) {
			...
			if (parameter__pMaxElements != oldParameter__pMaxElements) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT96__PARAMETER_PMAX_ELEMENTS, oldParameter__pMaxElements, parameter__pMaxElements));
			}
		}
	...
	public void setParameter__pMaxElements(WTCParam newParameter__pMaxElements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT96__PARAMETER_PMAX_ELEMENTS, oldParameter__pMaxElements, parameter__pMaxElements));
	}

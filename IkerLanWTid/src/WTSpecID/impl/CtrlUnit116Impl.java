 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit116Impl#getInput__iInhibitAutoYawCondition <em>Input iInhibit Auto Yaw Condition</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit116Impl#getInput__iInhibitYawCondition <em>Input iInhibit Yaw Condition</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit116Impl#getOutput__oInhibitAutoYaw <em>Output oInhibit Auto Yaw</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit116Impl#getOutput__oInhibitYaw <em>Output oInhibit Yaw</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit116Impl#getOutput__oYawStatus <em>Output oYaw Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit116Impl extends wtcImpl implements CtrlUnit116 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit116();
	}
		...
		if (input__iInhibitAutoYawCondition != null && input__iInhibitAutoYawCondition.eIsProxy()) {
			...
			if (input__iInhibitAutoYawCondition != oldInput__iInhibitAutoYawCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT116__INPUT_IINHIBIT_AUTO_YAW_CONDITION, oldInput__iInhibitAutoYawCondition, input__iInhibitAutoYawCondition));
			}
		}
	...
	public void setInput__iInhibitAutoYawCondition(WTCInput newInput__iInhibitAutoYawCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT116__INPUT_IINHIBIT_AUTO_YAW_CONDITION, oldInput__iInhibitAutoYawCondition, input__iInhibitAutoYawCondition));
	}
	...
	public WTCInput getInput__iInhibitYawCondition() {
		if (input__iInhibitYawCondition != null && input__iInhibitYawCondition.eIsProxy()) {
			...
			if (input__iInhibitYawCondition != oldInput__iInhibitYawCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT116__INPUT_IINHIBIT_YAW_CONDITION, oldInput__iInhibitYawCondition, input__iInhibitYawCondition));
			}
		}
	...
	public void setInput__iInhibitYawCondition(WTCInput newInput__iInhibitYawCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT116__INPUT_IINHIBIT_YAW_CONDITION, oldInput__iInhibitYawCondition, input__iInhibitYawCondition));
	}
	...
	public WTCOutput getOutput__oInhibitAutoYaw() {
		if (output__oInhibitAutoYaw != null && output__oInhibitAutoYaw.eIsProxy()) {
			...
			if (output__oInhibitAutoYaw != oldOutput__oInhibitAutoYaw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT116__OUTPUT_OINHIBIT_AUTO_YAW, oldOutput__oInhibitAutoYaw, output__oInhibitAutoYaw));
			}
		}
	...
	public void setOutput__oInhibitAutoYaw(WTCOutput newOutput__oInhibitAutoYaw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT116__OUTPUT_OINHIBIT_AUTO_YAW, oldOutput__oInhibitAutoYaw, output__oInhibitAutoYaw));
	}
	...
	public WTCOutput getOutput__oInhibitYaw() {
		if (output__oInhibitYaw != null && output__oInhibitYaw.eIsProxy()) {
			...
			if (output__oInhibitYaw != oldOutput__oInhibitYaw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT116__OUTPUT_OINHIBIT_YAW, oldOutput__oInhibitYaw, output__oInhibitYaw));
			}
		}
	...
	public void setOutput__oInhibitYaw(WTCOutput newOutput__oInhibitYaw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT116__OUTPUT_OINHIBIT_YAW, oldOutput__oInhibitYaw, output__oInhibitYaw));
	}
	...
	public WTCOutput getOutput__oYawStatus() {
		if (output__oYawStatus != null && output__oYawStatus.eIsProxy()) {
			...
			if (output__oYawStatus != oldOutput__oYawStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT116__OUTPUT_OYAW_STATUS, oldOutput__oYawStatus, output__oYawStatus));
			}
		}
	...
	public void setOutput__oYawStatus(WTCOutput newOutput__oYawStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT116__OUTPUT_OYAW_STATUS, oldOutput__oYawStatus, output__oYawStatus));
	}

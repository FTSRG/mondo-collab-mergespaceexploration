 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit83Impl#getInput__iPinSafetyCmd <em>Input iPin Safety Cmd</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit83Impl#getInput__iPinAutoCmd <em>Input iPin Auto Cmd</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit83Impl#getInput__iPinManualCmd <em>Input iPin Manual Cmd</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit83Impl#getInput__iLockingSet <em>Input iLocking Set</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit83Impl#getInput__iManualMode <em>Input iManual Mode</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit83Impl#getInput__iSafetyBlock <em>Input iSafety Block</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit83Impl#getOutput__oPinEnable <em>Output oPin Enable</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit83Impl#getOutput__oPinExtend <em>Output oPin Extend</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit83Impl#getOutput__oPinRetract <em>Output oPin Retract</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit83Impl extends wtcImpl implements CtrlUnit83 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit83();
	}
		...
		if (input__iPinSafetyCmd != null && input__iPinSafetyCmd.eIsProxy()) {
			...
			if (input__iPinSafetyCmd != oldInput__iPinSafetyCmd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT83__INPUT_IPIN_SAFETY_CMD, oldInput__iPinSafetyCmd, input__iPinSafetyCmd));
			}
		}
	...
	public void setInput__iPinSafetyCmd(WTCInput newInput__iPinSafetyCmd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT83__INPUT_IPIN_SAFETY_CMD, oldInput__iPinSafetyCmd, input__iPinSafetyCmd));
	}
	...
	public WTCInput getInput__iPinAutoCmd() {
		if (input__iPinAutoCmd != null && input__iPinAutoCmd.eIsProxy()) {
			...
			if (input__iPinAutoCmd != oldInput__iPinAutoCmd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT83__INPUT_IPIN_AUTO_CMD, oldInput__iPinAutoCmd, input__iPinAutoCmd));
			}
		}
	...
	public void setInput__iPinAutoCmd(WTCInput newInput__iPinAutoCmd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT83__INPUT_IPIN_AUTO_CMD, oldInput__iPinAutoCmd, input__iPinAutoCmd));
	}
	...
	public WTCInput getInput__iPinManualCmd() {
		if (input__iPinManualCmd != null && input__iPinManualCmd.eIsProxy()) {
			...
			if (input__iPinManualCmd != oldInput__iPinManualCmd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT83__INPUT_IPIN_MANUAL_CMD, oldInput__iPinManualCmd, input__iPinManualCmd));
			}
		}
	...
	public void setInput__iPinManualCmd(WTCInput newInput__iPinManualCmd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT83__INPUT_IPIN_MANUAL_CMD, oldInput__iPinManualCmd, input__iPinManualCmd));
	}
	...
	public WTCInput getInput__iLockingSet() {
		if (input__iLockingSet != null && input__iLockingSet.eIsProxy()) {
			...
			if (input__iLockingSet != oldInput__iLockingSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT83__INPUT_ILOCKING_SET, oldInput__iLockingSet, input__iLockingSet));
			}
		}
	...
	public void setInput__iLockingSet(WTCInput newInput__iLockingSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT83__INPUT_ILOCKING_SET, oldInput__iLockingSet, input__iLockingSet));
	}
	...
	public WTCInput getInput__iManualMode() {
		if (input__iManualMode != null && input__iManualMode.eIsProxy()) {
			...
			if (input__iManualMode != oldInput__iManualMode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT83__INPUT_IMANUAL_MODE, oldInput__iManualMode, input__iManualMode));
			}
		}
	...
	public void setInput__iManualMode(WTCInput newInput__iManualMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT83__INPUT_IMANUAL_MODE, oldInput__iManualMode, input__iManualMode));
	}
	...
	public WTCInput getInput__iSafetyBlock() {
		if (input__iSafetyBlock != null && input__iSafetyBlock.eIsProxy()) {
			...
			if (input__iSafetyBlock != oldInput__iSafetyBlock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT83__INPUT_ISAFETY_BLOCK, oldInput__iSafetyBlock, input__iSafetyBlock));
			}
		}
	...
	public void setInput__iSafetyBlock(WTCInput newInput__iSafetyBlock) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT83__INPUT_ISAFETY_BLOCK, oldInput__iSafetyBlock, input__iSafetyBlock));
	}
	...
	public WTCOutput getOutput__oPinEnable() {
		if (output__oPinEnable != null && output__oPinEnable.eIsProxy()) {
			...
			if (output__oPinEnable != oldOutput__oPinEnable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT83__OUTPUT_OPIN_ENABLE, oldOutput__oPinEnable, output__oPinEnable));
			}
		}
	...
	public void setOutput__oPinEnable(WTCOutput newOutput__oPinEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT83__OUTPUT_OPIN_ENABLE, oldOutput__oPinEnable, output__oPinEnable));
	}
	...
	public WTCOutput getOutput__oPinExtend() {
		if (output__oPinExtend != null && output__oPinExtend.eIsProxy()) {
			...
			if (output__oPinExtend != oldOutput__oPinExtend) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT83__OUTPUT_OPIN_EXTEND, oldOutput__oPinExtend, output__oPinExtend));
			}
		}
	...
	public void setOutput__oPinExtend(WTCOutput newOutput__oPinExtend) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT83__OUTPUT_OPIN_EXTEND, oldOutput__oPinExtend, output__oPinExtend));
	}
	...
	public WTCOutput getOutput__oPinRetract() {
		if (output__oPinRetract != null && output__oPinRetract.eIsProxy()) {
			...
			if (output__oPinRetract != oldOutput__oPinRetract) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT83__OUTPUT_OPIN_RETRACT, oldOutput__oPinRetract, output__oPinRetract));
			}
		}
	...
	public void setOutput__oPinRetract(WTCOutput newOutput__oPinRetract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT83__OUTPUT_OPIN_RETRACT, oldOutput__oPinRetract, output__oPinRetract));
	}

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit13Impl#getInput__iSelect <em>Input iSelect</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit13Impl#getInput__iInput1 <em>Input iInput1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit13Impl#getInput__iInput2 <em>Input iInput2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit13Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit13Impl#getParameter__pParam1 <em>Parameter pParam1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit13Impl#getParameter__pParam2 <em>Parameter pParam2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit13Impl#getBhvParam__bpType <em>Bhv Param bp Type</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit13Impl#getBhvParam__bpInputType <em>Bhv Param bp Input Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit13Impl extends wtcImpl implements CtrlUnit13 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit13();
	}
		...
		if (input__iSelect != null && input__iSelect.eIsProxy()) {
			...
			if (input__iSelect != oldInput__iSelect) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT13__INPUT_ISELECT, oldInput__iSelect, input__iSelect));
			}
		}
	...
	public void setInput__iSelect(WTCInput newInput__iSelect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT13__INPUT_ISELECT, oldInput__iSelect, input__iSelect));
	}
	...
	public WTCInput getInput__iInput1() {
		if (input__iInput1 != null && input__iInput1.eIsProxy()) {
			...
			if (input__iInput1 != oldInput__iInput1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT13__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
			}
		}
	...
	public void setInput__iInput1(WTCInput newInput__iInput1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT13__INPUT_IINPUT1, oldInput__iInput1, input__iInput1));
	}
	...
	public WTCInput getInput__iInput2() {
		if (input__iInput2 != null && input__iInput2.eIsProxy()) {
			...
			if (input__iInput2 != oldInput__iInput2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT13__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
			}
		}
	...
	public void setInput__iInput2(WTCInput newInput__iInput2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT13__INPUT_IINPUT2, oldInput__iInput2, input__iInput2));
	}
	...
	public WTCOutput getOutput__oOutput() {
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT13__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT13__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public WTCParam getParameter__pParam1() {
		if (parameter__pParam1 != null && parameter__pParam1.eIsProxy()) {
			...
			if (parameter__pParam1 != oldParameter__pParam1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT13__PARAMETER_PPARAM1, oldParameter__pParam1, parameter__pParam1));
			}
		}
	...
	public void setParameter__pParam1(WTCParam newParameter__pParam1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT13__PARAMETER_PPARAM1, oldParameter__pParam1, parameter__pParam1));
	}
	...
	public WTCParam getParameter__pParam2() {
		if (parameter__pParam2 != null && parameter__pParam2.eIsProxy()) {
			...
			if (parameter__pParam2 != oldParameter__pParam2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT13__PARAMETER_PPARAM2, oldParameter__pParam2, parameter__pParam2));
			}
		}
	...
	public void setParameter__pParam2(WTCParam newParameter__pParam2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT13__PARAMETER_PPARAM2, oldParameter__pParam2, parameter__pParam2));
	}
	...
	public void setBhvParam__bpType(String newBhvParam__bpType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT13__BHV_PARAM_BP_TYPE, oldBhvParam__bpType, bhvParam__bpType));
	}
	...
	public void setBhvParam__bpInputType(String newBhvParam__bpInputType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT13__BHV_PARAM_BP_INPUT_TYPE, oldBhvParam__bpInputType, bhvParam__bpInputType));
	}

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit20Impl#getInput__iMasterOrder <em>Input iMaster Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit20Impl#getInput__iInverterOrder <em>Input iInverter Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit20Impl#getInput__iChangeOrder <em>Input iChange Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit20Impl#getInput__iManualStop <em>Input iManual Stop</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit20Impl#getOutput__oMasterSelected <em>Output oMaster Selected</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit20Impl#getOutput__oInverterEnabled <em>Output oInverter Enabled</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit20Impl#getOutput__oForceInvOff <em>Output oForce Inv Off</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit20Impl extends wtcImpl implements CtrlUnit20 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit20();
	}
		...
		if (input__iMasterOrder != null && input__iMasterOrder.eIsProxy()) {
			...
			if (input__iMasterOrder != oldInput__iMasterOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT20__INPUT_IMASTER_ORDER, oldInput__iMasterOrder, input__iMasterOrder));
			}
		}
	...
	public void setInput__iMasterOrder(WTCInput newInput__iMasterOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT20__INPUT_IMASTER_ORDER, oldInput__iMasterOrder, input__iMasterOrder));
	}
	...
	public WTCInput getInput__iInverterOrder() {
		if (input__iInverterOrder != null && input__iInverterOrder.eIsProxy()) {
			...
			if (input__iInverterOrder != oldInput__iInverterOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT20__INPUT_IINVERTER_ORDER, oldInput__iInverterOrder, input__iInverterOrder));
			}
		}
	...
	public void setInput__iInverterOrder(WTCInput newInput__iInverterOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT20__INPUT_IINVERTER_ORDER, oldInput__iInverterOrder, input__iInverterOrder));
	}
	...
	public WTCInput getInput__iChangeOrder() {
		if (input__iChangeOrder != null && input__iChangeOrder.eIsProxy()) {
			...
			if (input__iChangeOrder != oldInput__iChangeOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT20__INPUT_ICHANGE_ORDER, oldInput__iChangeOrder, input__iChangeOrder));
			}
		}
	...
	public void setInput__iChangeOrder(WTCInput newInput__iChangeOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT20__INPUT_ICHANGE_ORDER, oldInput__iChangeOrder, input__iChangeOrder));
	}
	...
	public WTCInput getInput__iManualStop() {
		if (input__iManualStop != null && input__iManualStop.eIsProxy()) {
			...
			if (input__iManualStop != oldInput__iManualStop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT20__INPUT_IMANUAL_STOP, oldInput__iManualStop, input__iManualStop));
			}
		}
	...
	public void setInput__iManualStop(WTCInput newInput__iManualStop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT20__INPUT_IMANUAL_STOP, oldInput__iManualStop, input__iManualStop));
	}
	...
	public WTCOutput getOutput__oMasterSelected() {
		if (output__oMasterSelected != null && output__oMasterSelected.eIsProxy()) {
			...
			if (output__oMasterSelected != oldOutput__oMasterSelected) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT20__OUTPUT_OMASTER_SELECTED, oldOutput__oMasterSelected, output__oMasterSelected));
			}
		}
	...
	public void setOutput__oMasterSelected(WTCOutput newOutput__oMasterSelected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT20__OUTPUT_OMASTER_SELECTED, oldOutput__oMasterSelected, output__oMasterSelected));
	}
	...
	public WTCOutput getOutput__oInverterEnabled() {
		if (output__oInverterEnabled != null && output__oInverterEnabled.eIsProxy()) {
			...
			if (output__oInverterEnabled != oldOutput__oInverterEnabled) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT20__OUTPUT_OINVERTER_ENABLED, oldOutput__oInverterEnabled, output__oInverterEnabled));
			}
		}
	...
	public void setOutput__oInverterEnabled(WTCOutput newOutput__oInverterEnabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT20__OUTPUT_OINVERTER_ENABLED, oldOutput__oInverterEnabled, output__oInverterEnabled));
	}
	...
	public WTCOutput getOutput__oForceInvOff() {
		if (output__oForceInvOff != null && output__oForceInvOff.eIsProxy()) {
			...
			if (output__oForceInvOff != oldOutput__oForceInvOff) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT20__OUTPUT_OFORCE_INV_OFF, oldOutput__oForceInvOff, output__oForceInvOff));
			}
		}
	...
	public void setOutput__oForceInvOff(WTCOutput newOutput__oForceInvOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT20__OUTPUT_OFORCE_INV_OFF, oldOutput__oForceInvOff, output__oForceInvOff));
	}

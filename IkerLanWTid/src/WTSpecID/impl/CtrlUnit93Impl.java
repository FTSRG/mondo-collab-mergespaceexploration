 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit93Impl#getInput__iActualVal <em>Input iActual Val</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit93Impl#getOutput__oLastVal <em>Output oLast Val</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit93Impl#getParameter__pRateLimiter <em>Parameter pRate Limiter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit93Impl extends wtcImpl implements CtrlUnit93 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit93();
	}
		...
		if (input__iActualVal != null && input__iActualVal.eIsProxy()) {
			...
			if (input__iActualVal != oldInput__iActualVal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT93__INPUT_IACTUAL_VAL, oldInput__iActualVal, input__iActualVal));
			}
		}
	...
	public void setInput__iActualVal(WTCInput newInput__iActualVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT93__INPUT_IACTUAL_VAL, oldInput__iActualVal, input__iActualVal));
	}
	...
	public WTCOutput getOutput__oLastVal() {
		if (output__oLastVal != null && output__oLastVal.eIsProxy()) {
			...
			if (output__oLastVal != oldOutput__oLastVal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT93__OUTPUT_OLAST_VAL, oldOutput__oLastVal, output__oLastVal));
			}
		}
	...
	public void setOutput__oLastVal(WTCOutput newOutput__oLastVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT93__OUTPUT_OLAST_VAL, oldOutput__oLastVal, output__oLastVal));
	}
	...
	public WTCParam getParameter__pRateLimiter() {
		if (parameter__pRateLimiter != null && parameter__pRateLimiter.eIsProxy()) {
			...
			if (parameter__pRateLimiter != oldParameter__pRateLimiter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT93__PARAMETER_PRATE_LIMITER, oldParameter__pRateLimiter, parameter__pRateLimiter));
			}
		}
	...
	public void setParameter__pRateLimiter(WTCParam newParameter__pRateLimiter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT93__PARAMETER_PRATE_LIMITER, oldParameter__pRateLimiter, parameter__pRateLimiter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT93__INPUT_IACTUAL_VAL:
				if (resolve) return getInput__iActualVal();
				return basicGetInput__iActualVal();
			case WTSpecIDPackage.CTRL_UNIT93__OUTPUT_OLAST_VAL:
				if (resolve) return getOutput__oLastVal();
				return basicGetOutput__oLastVal();
			case WTSpecIDPackage.CTRL_UNIT93__PARAMETER_PRATE_LIMITER:

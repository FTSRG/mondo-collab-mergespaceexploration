 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit58Impl#getInput__iInput <em>Input iInput</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit58Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit58Impl#getParameter__pParam <em>Parameter pParam</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit58Impl#getBhvParam__bpLogicType <em>Bhv Param bp Logic Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit58Impl extends wtcImpl implements CtrlUnit58 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit58();
	}
		...
		if (input__iInput != null && input__iInput.eIsProxy()) {
			...
			if (input__iInput != oldInput__iInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT58__INPUT_IINPUT, oldInput__iInput, input__iInput));
			}
		}
	...
	public void setInput__iInput(WTCInput newInput__iInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT58__INPUT_IINPUT, oldInput__iInput, input__iInput));
	}
	...
	public WTCOutput getOutput__oOutput() {
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT58__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT58__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public WTCParam getParameter__pParam() {
		if (parameter__pParam != null && parameter__pParam.eIsProxy()) {
			...
			if (parameter__pParam != oldParameter__pParam) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT58__PARAMETER_PPARAM, oldParameter__pParam, parameter__pParam));
			}
		}
	...
	public void setParameter__pParam(WTCParam newParameter__pParam) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT58__PARAMETER_PPARAM, oldParameter__pParam, parameter__pParam));
	}
	...
	public void setBhvParam__bpLogicType(String newBhvParam__bpLogicType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT58__BHV_PARAM_BP_LOGIC_TYPE, oldBhvParam__bpLogicType, bhvParam__bpLogicType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT58__INPUT_IINPUT:
				if (resolve) return getInput__iInput();
				return basicGetInput__iInput();
			case WTSpecIDPackage.CTRL_UNIT58__OUTPUT_OOUTPUT:
				if (resolve) return getOutput__oOutput();
				return basicGetOutput__oOutput();
			case WTSpecIDPackage.CTRL_UNIT58__PARAMETER_PPARAM:
				if (resolve) return getParameter__pParam();
				return basicGetParameter__pParam();
			case WTSpecIDPackage.CTRL_UNIT58__BHV_PARAM_BP_LOGIC_TYPE:

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit111Impl#getInput__iOrder <em>Input iOrder</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit111Impl#getTimer__tTimer <em>Timer tTimer</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit111Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit111Impl extends wtcImpl implements CtrlUnit111 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit111();
	}
		...
		if (input__iOrder != null && input__iOrder.eIsProxy()) {
			...
			if (input__iOrder != oldInput__iOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT111__INPUT_IORDER, oldInput__iOrder, input__iOrder));
			}
		}
	...
	public void setInput__iOrder(WTCInput newInput__iOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT111__INPUT_IORDER, oldInput__iOrder, input__iOrder));
	}
	...
	public WTCTimer getTimer__tTimer() {
		if (timer__tTimer != null && timer__tTimer.eIsProxy()) {
			...
			if (timer__tTimer != oldTimer__tTimer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT111__TIMER_TTIMER, oldTimer__tTimer, timer__tTimer));
			}
		}
	...
	public void setTimer__tTimer(WTCTimer newTimer__tTimer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT111__TIMER_TTIMER, oldTimer__tTimer, timer__tTimer));
	}
	...
	public void setBhvParam__bpMode(String newBhvParam__bpMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT111__BHV_PARAM_BP_MODE, oldBhvParam__bpMode, bhvParam__bpMode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT111__INPUT_IORDER:
				if (resolve) return getInput__iOrder();
				return basicGetInput__iOrder();
			case WTSpecIDPackage.CTRL_UNIT111__TIMER_TTIMER:
				if (resolve) return getTimer__tTimer();
				return basicGetTimer__tTimer();
			case WTSpecIDPackage.CTRL_UNIT111__BHV_PARAM_BP_MODE:

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit74Impl#getInput__iConverterTripped <em>Input iConverter Tripped</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit74Impl#getInput__iConverterRunning <em>Input iConverter Running</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit74Impl#getOutput__oOpcCnvOperationMode <em>Output oOpc Cnv Operation Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit74Impl extends wtcImpl implements CtrlUnit74 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit74();
	}
		...
		if (input__iConverterTripped != null && input__iConverterTripped.eIsProxy()) {
			...
			if (input__iConverterTripped != oldInput__iConverterTripped) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT74__INPUT_ICONVERTER_TRIPPED, oldInput__iConverterTripped, input__iConverterTripped));
			}
		}
	...
	public void setInput__iConverterTripped(WTCInput newInput__iConverterTripped) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT74__INPUT_ICONVERTER_TRIPPED, oldInput__iConverterTripped, input__iConverterTripped));
	}
	...
	public WTCInput getInput__iConverterRunning() {
		if (input__iConverterRunning != null && input__iConverterRunning.eIsProxy()) {
			...
			if (input__iConverterRunning != oldInput__iConverterRunning) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT74__INPUT_ICONVERTER_RUNNING, oldInput__iConverterRunning, input__iConverterRunning));
			}
		}
	...
	public void setInput__iConverterRunning(WTCInput newInput__iConverterRunning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT74__INPUT_ICONVERTER_RUNNING, oldInput__iConverterRunning, input__iConverterRunning));
	}
	...
	public WTCOutput getOutput__oOpcCnvOperationMode() {
		if (output__oOpcCnvOperationMode != null && output__oOpcCnvOperationMode.eIsProxy()) {
			...
			if (output__oOpcCnvOperationMode != oldOutput__oOpcCnvOperationMode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT74__OUTPUT_OOPC_CNV_OPERATION_MODE, oldOutput__oOpcCnvOperationMode, output__oOpcCnvOperationMode));
			}
		}
	...
	public void setOutput__oOpcCnvOperationMode(WTCOutput newOutput__oOpcCnvOperationMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT74__OUTPUT_OOPC_CNV_OPERATION_MODE, oldOutput__oOpcCnvOperationMode, output__oOpcCnvOperationMode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT74__INPUT_ICONVERTER_TRIPPED:
				if (resolve) return getInput__iConverterTripped();
				return basicGetInput__iConverterTripped();
			case WTSpecIDPackage.CTRL_UNIT74__INPUT_ICONVERTER_RUNNING:
				if (resolve) return getInput__iConverterRunning();
				return basicGetInput__iConverterRunning();
			case WTSpecIDPackage.CTRL_UNIT74__OUTPUT_OOPC_CNV_OPERATION_MODE:

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit87Impl#getInput__iExternalOrder <em>Input iExternal Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit87Impl#getInput__iExternalFailure <em>Input iExternal Failure</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit87Impl#getOutput__oLubricationOrder <em>Output oLubrication Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit87Impl#getTimer__tDelay <em>Timer tDelay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit87Impl extends wtcImpl implements CtrlUnit87 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit87();
	}
		...
		if (input__iExternalOrder != null && input__iExternalOrder.eIsProxy()) {
			...
			if (input__iExternalOrder != oldInput__iExternalOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT87__INPUT_IEXTERNAL_ORDER, oldInput__iExternalOrder, input__iExternalOrder));
			}
		}
	...
	public void setInput__iExternalOrder(WTCInput newInput__iExternalOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT87__INPUT_IEXTERNAL_ORDER, oldInput__iExternalOrder, input__iExternalOrder));
	}
	...
	public WTCInput getInput__iExternalFailure() {
		if (input__iExternalFailure != null && input__iExternalFailure.eIsProxy()) {
			...
			if (input__iExternalFailure != oldInput__iExternalFailure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT87__INPUT_IEXTERNAL_FAILURE, oldInput__iExternalFailure, input__iExternalFailure));
			}
		}
	...
	public void setInput__iExternalFailure(WTCInput newInput__iExternalFailure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT87__INPUT_IEXTERNAL_FAILURE, oldInput__iExternalFailure, input__iExternalFailure));
	}
	...
	public WTCOutput getOutput__oLubricationOrder() {
		if (output__oLubricationOrder != null && output__oLubricationOrder.eIsProxy()) {
			...
			if (output__oLubricationOrder != oldOutput__oLubricationOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT87__OUTPUT_OLUBRICATION_ORDER, oldOutput__oLubricationOrder, output__oLubricationOrder));
			}
		}
	...
	public void setOutput__oLubricationOrder(WTCOutput newOutput__oLubricationOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT87__OUTPUT_OLUBRICATION_ORDER, oldOutput__oLubricationOrder, output__oLubricationOrder));
	}
	...
	public WTCTimer getTimer__tDelay() {
		if (timer__tDelay != null && timer__tDelay.eIsProxy()) {
			...
			if (timer__tDelay != oldTimer__tDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT87__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
			}
		}
	...
	public void setTimer__tDelay(WTCTimer newTimer__tDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT87__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
	}

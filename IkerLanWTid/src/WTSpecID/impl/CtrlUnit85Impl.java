 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit85Impl#getInput__iPitchAngle1 <em>Input iPitch Angle1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit85Impl#getInput__iPitchAngle2 <em>Input iPitch Angle2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit85Impl#getInput__iPitchAngle3 <em>Input iPitch Angle3</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit85Impl#getOutput__oPitchBrakePosition <em>Output oPitch Brake Position</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit85Impl#getParameter__pPitchMaxBrakeAngle <em>Parameter pPitch Max Brake Angle</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit85Impl#getParameter__pPitchMinBrakeAngle <em>Parameter pPitch Min Brake Angle</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit85Impl#getParameter__pPitchBrakeAngleHysteresis <em>Parameter pPitch Brake Angle Hysteresis</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit85Impl extends wtcImpl implements CtrlUnit85 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit85();
	}
		...
		if (input__iPitchAngle1 != null && input__iPitchAngle1.eIsProxy()) {
			...
			if (input__iPitchAngle1 != oldInput__iPitchAngle1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT85__INPUT_IPITCH_ANGLE1, oldInput__iPitchAngle1, input__iPitchAngle1));
			}
		}
	...
	public void setInput__iPitchAngle1(WTCInput newInput__iPitchAngle1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT85__INPUT_IPITCH_ANGLE1, oldInput__iPitchAngle1, input__iPitchAngle1));
	}
	...
	public WTCInput getInput__iPitchAngle2() {
		if (input__iPitchAngle2 != null && input__iPitchAngle2.eIsProxy()) {
			...
			if (input__iPitchAngle2 != oldInput__iPitchAngle2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT85__INPUT_IPITCH_ANGLE2, oldInput__iPitchAngle2, input__iPitchAngle2));
			}
		}
	...
	public void setInput__iPitchAngle2(WTCInput newInput__iPitchAngle2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT85__INPUT_IPITCH_ANGLE2, oldInput__iPitchAngle2, input__iPitchAngle2));
	}
	...
	public WTCInput getInput__iPitchAngle3() {
		if (input__iPitchAngle3 != null && input__iPitchAngle3.eIsProxy()) {
			...
			if (input__iPitchAngle3 != oldInput__iPitchAngle3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT85__INPUT_IPITCH_ANGLE3, oldInput__iPitchAngle3, input__iPitchAngle3));
			}
		}
	...
	public void setInput__iPitchAngle3(WTCInput newInput__iPitchAngle3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT85__INPUT_IPITCH_ANGLE3, oldInput__iPitchAngle3, input__iPitchAngle3));
	}
	...
	public WTCOutput getOutput__oPitchBrakePosition() {
		if (output__oPitchBrakePosition != null && output__oPitchBrakePosition.eIsProxy()) {
			...
			if (output__oPitchBrakePosition != oldOutput__oPitchBrakePosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT85__OUTPUT_OPITCH_BRAKE_POSITION, oldOutput__oPitchBrakePosition, output__oPitchBrakePosition));
			}
		}
	...
	public void setOutput__oPitchBrakePosition(WTCOutput newOutput__oPitchBrakePosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT85__OUTPUT_OPITCH_BRAKE_POSITION, oldOutput__oPitchBrakePosition, output__oPitchBrakePosition));
	}
	...
	public WTCParam getParameter__pPitchMaxBrakeAngle() {
		if (parameter__pPitchMaxBrakeAngle != null && parameter__pPitchMaxBrakeAngle.eIsProxy()) {
			...
			if (parameter__pPitchMaxBrakeAngle != oldParameter__pPitchMaxBrakeAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT85__PARAMETER_PPITCH_MAX_BRAKE_ANGLE, oldParameter__pPitchMaxBrakeAngle, parameter__pPitchMaxBrakeAngle));
			}
		}
	...
	public void setParameter__pPitchMaxBrakeAngle(WTCParam newParameter__pPitchMaxBrakeAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT85__PARAMETER_PPITCH_MAX_BRAKE_ANGLE, oldParameter__pPitchMaxBrakeAngle, parameter__pPitchMaxBrakeAngle));
	}
	...
	public WTCParam getParameter__pPitchMinBrakeAngle() {
		if (parameter__pPitchMinBrakeAngle != null && parameter__pPitchMinBrakeAngle.eIsProxy()) {
			...
			if (parameter__pPitchMinBrakeAngle != oldParameter__pPitchMinBrakeAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT85__PARAMETER_PPITCH_MIN_BRAKE_ANGLE, oldParameter__pPitchMinBrakeAngle, parameter__pPitchMinBrakeAngle));
			}
		}
	...
	public void setParameter__pPitchMinBrakeAngle(WTCParam newParameter__pPitchMinBrakeAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT85__PARAMETER_PPITCH_MIN_BRAKE_ANGLE, oldParameter__pPitchMinBrakeAngle, parameter__pPitchMinBrakeAngle));
	}
	...
	public WTCParam getParameter__pPitchBrakeAngleHysteresis() {
		if (parameter__pPitchBrakeAngleHysteresis != null && parameter__pPitchBrakeAngleHysteresis.eIsProxy()) {
			...
			if (parameter__pPitchBrakeAngleHysteresis != oldParameter__pPitchBrakeAngleHysteresis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT85__PARAMETER_PPITCH_BRAKE_ANGLE_HYSTERESIS, oldParameter__pPitchBrakeAngleHysteresis, parameter__pPitchBrakeAngleHysteresis));
			}
		}
	...
	public void setParameter__pPitchBrakeAngleHysteresis(WTCParam newParameter__pPitchBrakeAngleHysteresis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT85__PARAMETER_PPITCH_BRAKE_ANGLE_HYSTERESIS, oldParameter__pPitchBrakeAngleHysteresis, parameter__pPitchBrakeAngleHysteresis));
	}

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit24Impl#getInput__iInverterReady <em>Input iInverter Ready</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit24Impl#getInput__iInverterPower <em>Input iInverter Power</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit24Impl#getInput__iAlgorithmCommand <em>Input iAlgorithm Command</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit24Impl#getParameter__pPowerLimit <em>Parameter pPower Limit</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit24Impl#getFault__fYawProblem <em>Fault fYaw Problem</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit24Impl#getTimer__tDelayProblemNotify <em>Timer tDelay Problem Notify</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit24Impl#getDecisionSequence__dsDecisionTree <em>Decision Sequence ds Decision Tree</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit24Impl extends wtcImpl implements CtrlUnit24 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit24();
	}
		...
		if (input__iInverterReady != null && input__iInverterReady.eIsProxy()) {
			...
			if (input__iInverterReady != oldInput__iInverterReady) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT24__INPUT_IINVERTER_READY, oldInput__iInverterReady, input__iInverterReady));
			}
		}
	...
	public void setInput__iInverterReady(WTCInput newInput__iInverterReady) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT24__INPUT_IINVERTER_READY, oldInput__iInverterReady, input__iInverterReady));
	}
	...
	public WTCInput getInput__iInverterPower() {
		if (input__iInverterPower != null && input__iInverterPower.eIsProxy()) {
			...
			if (input__iInverterPower != oldInput__iInverterPower) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT24__INPUT_IINVERTER_POWER, oldInput__iInverterPower, input__iInverterPower));
			}
		}
	...
	public void setInput__iInverterPower(WTCInput newInput__iInverterPower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT24__INPUT_IINVERTER_POWER, oldInput__iInverterPower, input__iInverterPower));
	}
	...
	public WTCInput getInput__iAlgorithmCommand() {
		if (input__iAlgorithmCommand != null && input__iAlgorithmCommand.eIsProxy()) {
			...
			if (input__iAlgorithmCommand != oldInput__iAlgorithmCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT24__INPUT_IALGORITHM_COMMAND, oldInput__iAlgorithmCommand, input__iAlgorithmCommand));
			}
		}
	...
	public void setInput__iAlgorithmCommand(WTCInput newInput__iAlgorithmCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT24__INPUT_IALGORITHM_COMMAND, oldInput__iAlgorithmCommand, input__iAlgorithmCommand));
	}
	...
	public WTCParam getParameter__pPowerLimit() {
		if (parameter__pPowerLimit != null && parameter__pPowerLimit.eIsProxy()) {
			...
			if (parameter__pPowerLimit != oldParameter__pPowerLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT24__PARAMETER_PPOWER_LIMIT, oldParameter__pPowerLimit, parameter__pPowerLimit));
			}
		}
	...
	public void setParameter__pPowerLimit(WTCParam newParameter__pPowerLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT24__PARAMETER_PPOWER_LIMIT, oldParameter__pPowerLimit, parameter__pPowerLimit));
	}
	...
	public WTCFault getFault__fYawProblem() {
		if (fault__fYawProblem != null && fault__fYawProblem.eIsProxy()) {
			...
			if (fault__fYawProblem != oldFault__fYawProblem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT24__FAULT_FYAW_PROBLEM, oldFault__fYawProblem, fault__fYawProblem));
			}
		}
	...
	public void setFault__fYawProblem(WTCFault newFault__fYawProblem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT24__FAULT_FYAW_PROBLEM, oldFault__fYawProblem, fault__fYawProblem));
	}
	...
	public WTCTimer getTimer__tDelayProblemNotify() {
		if (timer__tDelayProblemNotify != null && timer__tDelayProblemNotify.eIsProxy()) {
			...
			if (timer__tDelayProblemNotify != oldTimer__tDelayProblemNotify) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT24__TIMER_TDELAY_PROBLEM_NOTIFY, oldTimer__tDelayProblemNotify, timer__tDelayProblemNotify));
			}
		}
	...
	public void setTimer__tDelayProblemNotify(WTCTimer newTimer__tDelayProblemNotify) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT24__TIMER_TDELAY_PROBLEM_NOTIFY, oldTimer__tDelayProblemNotify, timer__tDelayProblemNotify));
	}
	...
	public void setDecisionSequence__dsDecisionTree(String newDecisionSequence__dsDecisionTree) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT24__DECISION_SEQUENCE_DS_DECISION_TREE, oldDecisionSequence__dsDecisionTree, decisionSequence__dsDecisionTree));
	}

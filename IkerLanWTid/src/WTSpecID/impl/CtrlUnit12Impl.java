 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getInput__iPinPosition <em>Input iPin Position</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getInput__iInductive <em>Input iInductive</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getInput__iFlInPosition <em>Input iFl In Position</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getInput__iLockingOrder <em>Input iLocking Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getInput__iLockingSet <em>Input iLocking Set</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getOutput__oPinAutoCmd <em>Output oPin Auto Cmd</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getParameter__pPinNoBackPos <em>Parameter pPin No Back Pos</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getParameter__pPinExtendedPos <em>Parameter pPin Extended Pos</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getParameter__pPinRetractedPos <em>Parameter pPin Retracted Pos</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit12Impl#getParameter__pPinHysteresis <em>Parameter pPin Hysteresis</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit12Impl extends wtcImpl implements CtrlUnit12 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit12();
	}
		...
		if (input__iPinPosition != null && input__iPinPosition.eIsProxy()) {
			...
			if (input__iPinPosition != oldInput__iPinPosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__INPUT_IPIN_POSITION, oldInput__iPinPosition, input__iPinPosition));
			}
		}
	...
	public void setInput__iPinPosition(WTCInput newInput__iPinPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__INPUT_IPIN_POSITION, oldInput__iPinPosition, input__iPinPosition));
	}
	...
	public WTCInput getInput__iInductive() {
		if (input__iInductive != null && input__iInductive.eIsProxy()) {
			...
			if (input__iInductive != oldInput__iInductive) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__INPUT_IINDUCTIVE, oldInput__iInductive, input__iInductive));
			}
		}
	...
	public void setInput__iInductive(WTCInput newInput__iInductive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__INPUT_IINDUCTIVE, oldInput__iInductive, input__iInductive));
	}
	...
	public WTCInput getInput__iFlInPosition() {
		if (input__iFlInPosition != null && input__iFlInPosition.eIsProxy()) {
			...
			if (input__iFlInPosition != oldInput__iFlInPosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__INPUT_IFL_IN_POSITION, oldInput__iFlInPosition, input__iFlInPosition));
			}
		}
	...
	public void setInput__iFlInPosition(WTCInput newInput__iFlInPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__INPUT_IFL_IN_POSITION, oldInput__iFlInPosition, input__iFlInPosition));
	}
	...
	public WTCInput getInput__iLockingOrder() {
		if (input__iLockingOrder != null && input__iLockingOrder.eIsProxy()) {
			...
			if (input__iLockingOrder != oldInput__iLockingOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__INPUT_ILOCKING_ORDER, oldInput__iLockingOrder, input__iLockingOrder));
			}
		}
	...
	public void setInput__iLockingOrder(WTCInput newInput__iLockingOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__INPUT_ILOCKING_ORDER, oldInput__iLockingOrder, input__iLockingOrder));
	}
	...
	public WTCInput getInput__iLockingSet() {
		if (input__iLockingSet != null && input__iLockingSet.eIsProxy()) {
			...
			if (input__iLockingSet != oldInput__iLockingSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__INPUT_ILOCKING_SET, oldInput__iLockingSet, input__iLockingSet));
			}
		}
	...
	public void setInput__iLockingSet(WTCInput newInput__iLockingSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__INPUT_ILOCKING_SET, oldInput__iLockingSet, input__iLockingSet));
	}
	...
	public WTCOutput getOutput__oPinAutoCmd() {
		if (output__oPinAutoCmd != null && output__oPinAutoCmd.eIsProxy()) {
			...
			if (output__oPinAutoCmd != oldOutput__oPinAutoCmd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__OUTPUT_OPIN_AUTO_CMD, oldOutput__oPinAutoCmd, output__oPinAutoCmd));
			}
		}
	...
	public void setOutput__oPinAutoCmd(WTCOutput newOutput__oPinAutoCmd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__OUTPUT_OPIN_AUTO_CMD, oldOutput__oPinAutoCmd, output__oPinAutoCmd));
	}
	...
	public WTCParam getParameter__pPinNoBackPos() {
		if (parameter__pPinNoBackPos != null && parameter__pPinNoBackPos.eIsProxy()) {
			...
			if (parameter__pPinNoBackPos != oldParameter__pPinNoBackPos) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__PARAMETER_PPIN_NO_BACK_POS, oldParameter__pPinNoBackPos, parameter__pPinNoBackPos));
			}
		}
	...
	public void setParameter__pPinNoBackPos(WTCParam newParameter__pPinNoBackPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__PARAMETER_PPIN_NO_BACK_POS, oldParameter__pPinNoBackPos, parameter__pPinNoBackPos));
	}
	...
	public WTCParam getParameter__pPinExtendedPos() {
		if (parameter__pPinExtendedPos != null && parameter__pPinExtendedPos.eIsProxy()) {
			...
			if (parameter__pPinExtendedPos != oldParameter__pPinExtendedPos) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__PARAMETER_PPIN_EXTENDED_POS, oldParameter__pPinExtendedPos, parameter__pPinExtendedPos));
			}
		}
	...
	public void setParameter__pPinExtendedPos(WTCParam newParameter__pPinExtendedPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__PARAMETER_PPIN_EXTENDED_POS, oldParameter__pPinExtendedPos, parameter__pPinExtendedPos));
	}
	...
	public WTCParam getParameter__pPinRetractedPos() {
		if (parameter__pPinRetractedPos != null && parameter__pPinRetractedPos.eIsProxy()) {
			...
			if (parameter__pPinRetractedPos != oldParameter__pPinRetractedPos) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__PARAMETER_PPIN_RETRACTED_POS, oldParameter__pPinRetractedPos, parameter__pPinRetractedPos));
			}
		}
	...
	public void setParameter__pPinRetractedPos(WTCParam newParameter__pPinRetractedPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__PARAMETER_PPIN_RETRACTED_POS, oldParameter__pPinRetractedPos, parameter__pPinRetractedPos));
	}
	...
	public WTCParam getParameter__pPinHysteresis() {
		if (parameter__pPinHysteresis != null && parameter__pPinHysteresis.eIsProxy()) {
			...
			if (parameter__pPinHysteresis != oldParameter__pPinHysteresis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT12__PARAMETER_PPIN_HYSTERESIS, oldParameter__pPinHysteresis, parameter__pPinHysteresis));
			}
		}
	...
	public void setParameter__pPinHysteresis(WTCParam newParameter__pPinHysteresis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT12__PARAMETER_PPIN_HYSTERESIS, oldParameter__pPinHysteresis, parameter__pPinHysteresis));
	}

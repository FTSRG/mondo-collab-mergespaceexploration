 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit108Impl#getInput__iVoltageDrop <em>Input iVoltage Drop</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit108Impl#getFault__fVoltageDrop <em>Fault fVoltage Drop</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit108Impl#getTimer__tAutoReset <em>Timer tAuto Reset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit108Impl extends wtcImpl implements CtrlUnit108 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit108();
	}
		...
		if (input__iVoltageDrop != null && input__iVoltageDrop.eIsProxy()) {
			...
			if (input__iVoltageDrop != oldInput__iVoltageDrop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT108__INPUT_IVOLTAGE_DROP, oldInput__iVoltageDrop, input__iVoltageDrop));
			}
		}
	...
	public void setInput__iVoltageDrop(WTCInput newInput__iVoltageDrop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT108__INPUT_IVOLTAGE_DROP, oldInput__iVoltageDrop, input__iVoltageDrop));
	}
	...
	public WTCFault getFault__fVoltageDrop() {
		if (fault__fVoltageDrop != null && fault__fVoltageDrop.eIsProxy()) {
			...
			if (fault__fVoltageDrop != oldFault__fVoltageDrop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT108__FAULT_FVOLTAGE_DROP, oldFault__fVoltageDrop, fault__fVoltageDrop));
			}
		}
	...
	public void setFault__fVoltageDrop(WTCFault newFault__fVoltageDrop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT108__FAULT_FVOLTAGE_DROP, oldFault__fVoltageDrop, fault__fVoltageDrop));
	}
	...
	public WTCTimer getTimer__tAutoReset() {
		if (timer__tAutoReset != null && timer__tAutoReset.eIsProxy()) {
			...
			if (timer__tAutoReset != oldTimer__tAutoReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT108__TIMER_TAUTO_RESET, oldTimer__tAutoReset, timer__tAutoReset));
			}
		}
	...
	public void setTimer__tAutoReset(WTCTimer newTimer__tAutoReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT108__TIMER_TAUTO_RESET, oldTimer__tAutoReset, timer__tAutoReset));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT108__INPUT_IVOLTAGE_DROP:
				if (resolve) return getInput__iVoltageDrop();
				return basicGetInput__iVoltageDrop();
			case WTSpecIDPackage.CTRL_UNIT108__FAULT_FVOLTAGE_DROP:
				if (resolve) return getFault__fVoltageDrop();
				return basicGetFault__fVoltageDrop();
			case WTSpecIDPackage.CTRL_UNIT108__TIMER_TAUTO_RESET:

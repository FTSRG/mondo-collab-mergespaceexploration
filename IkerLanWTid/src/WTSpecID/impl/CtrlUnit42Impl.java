 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit42Impl#getInput__iInput <em>Input iInput</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit42Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit42Impl#getOutput__oActive <em>Output oActive</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit42Impl#getOutput__oPulsing <em>Output oPulsing</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit42Impl#getTimer__tDelay <em>Timer tDelay</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit42Impl#getTimer__tActive <em>Timer tActive</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit42Impl extends wtcImpl implements CtrlUnit42 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit42();
	}
		...
		if (input__iInput != null && input__iInput.eIsProxy()) {
			...
			if (input__iInput != oldInput__iInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT42__INPUT_IINPUT, oldInput__iInput, input__iInput));
			}
		}
	...
	public void setInput__iInput(WTCInput newInput__iInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT42__INPUT_IINPUT, oldInput__iInput, input__iInput));
	}
	...
	public WTCInput getInput__iDontCheckInput() {
		if (input__iDontCheckInput != null && input__iDontCheckInput.eIsProxy()) {
			...
			if (input__iDontCheckInput != oldInput__iDontCheckInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT42__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
			}
		}
	...
	public void setInput__iDontCheckInput(WTCInput newInput__iDontCheckInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT42__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
	}
	...
	public WTCOutput getOutput__oActive() {
		if (output__oActive != null && output__oActive.eIsProxy()) {
			...
			if (output__oActive != oldOutput__oActive) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT42__OUTPUT_OACTIVE, oldOutput__oActive, output__oActive));
			}
		}
	...
	public void setOutput__oActive(WTCOutput newOutput__oActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT42__OUTPUT_OACTIVE, oldOutput__oActive, output__oActive));
	}
	...
	public WTCOutput getOutput__oPulsing() {
		if (output__oPulsing != null && output__oPulsing.eIsProxy()) {
			...
			if (output__oPulsing != oldOutput__oPulsing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT42__OUTPUT_OPULSING, oldOutput__oPulsing, output__oPulsing));
			}
		}
	...
	public void setOutput__oPulsing(WTCOutput newOutput__oPulsing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT42__OUTPUT_OPULSING, oldOutput__oPulsing, output__oPulsing));
	}
	...
	public WTCTimer getTimer__tDelay() {
		if (timer__tDelay != null && timer__tDelay.eIsProxy()) {
			...
			if (timer__tDelay != oldTimer__tDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT42__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
			}
		}
	...
	public void setTimer__tDelay(WTCTimer newTimer__tDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT42__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
	}
	...
	public WTCTimer getTimer__tActive() {
		if (timer__tActive != null && timer__tActive.eIsProxy()) {
			...
			if (timer__tActive != oldTimer__tActive) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT42__TIMER_TACTIVE, oldTimer__tActive, timer__tActive));
			}
		}
	...
	public void setTimer__tActive(WTCTimer newTimer__tActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT42__TIMER_TACTIVE, oldTimer__tActive, timer__tActive));
	}

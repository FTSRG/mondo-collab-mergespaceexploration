 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit132Impl#getInput__iTeeth1 <em>Input iTeeth1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit132Impl#getInput__iTeeth2 <em>Input iTeeth2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit132Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit132Impl#getOutput__oTwistAngle <em>Output oTwist Angle</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit132Impl#getParameter__pDegreesPerPulse <em>Parameter pDegrees Per Pulse</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit132Impl extends wtcImpl implements CtrlUnit132 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit132();
	}
		...
		if (input__iTeeth1 != null && input__iTeeth1.eIsProxy()) {
			...
			if (input__iTeeth1 != oldInput__iTeeth1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT132__INPUT_ITEETH1, oldInput__iTeeth1, input__iTeeth1));
			}
		}
	...
	public void setInput__iTeeth1(WTCInput newInput__iTeeth1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT132__INPUT_ITEETH1, oldInput__iTeeth1, input__iTeeth1));
	}
	...
	public WTCInput getInput__iTeeth2() {
		if (input__iTeeth2 != null && input__iTeeth2.eIsProxy()) {
			...
			if (input__iTeeth2 != oldInput__iTeeth2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT132__INPUT_ITEETH2, oldInput__iTeeth2, input__iTeeth2));
			}
		}
	...
	public void setInput__iTeeth2(WTCInput newInput__iTeeth2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT132__INPUT_ITEETH2, oldInput__iTeeth2, input__iTeeth2));
	}
	...
	public WTCInput getInput__iTwistAngle() {
		if (input__iTwistAngle != null && input__iTwistAngle.eIsProxy()) {
			...
			if (input__iTwistAngle != oldInput__iTwistAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT132__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
			}
		}
	...
	public void setInput__iTwistAngle(WTCInput newInput__iTwistAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT132__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
	}
	...
	public WTCOutput getOutput__oTwistAngle() {
		if (output__oTwistAngle != null && output__oTwistAngle.eIsProxy()) {
			...
			if (output__oTwistAngle != oldOutput__oTwistAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT132__OUTPUT_OTWIST_ANGLE, oldOutput__oTwistAngle, output__oTwistAngle));
			}
		}
	...
	public void setOutput__oTwistAngle(WTCOutput newOutput__oTwistAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT132__OUTPUT_OTWIST_ANGLE, oldOutput__oTwistAngle, output__oTwistAngle));
	}
	...
	public WTCParam getParameter__pDegreesPerPulse() {
		if (parameter__pDegreesPerPulse != null && parameter__pDegreesPerPulse.eIsProxy()) {
			...
			if (parameter__pDegreesPerPulse != oldParameter__pDegreesPerPulse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT132__PARAMETER_PDEGREES_PER_PULSE, oldParameter__pDegreesPerPulse, parameter__pDegreesPerPulse));
			}
		}
	...
	public void setParameter__pDegreesPerPulse(WTCParam newParameter__pDegreesPerPulse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT132__PARAMETER_PDEGREES_PER_PULSE, oldParameter__pDegreesPerPulse, parameter__pDegreesPerPulse));
	}

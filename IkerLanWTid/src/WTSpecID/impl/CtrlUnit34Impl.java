 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit34Impl#getInput__iInput <em>Input iInput</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit34Impl#getInput__iFeedback <em>Input iFeedback</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit34Impl#getOutput__oFaultOn <em>Output oFault On</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit34Impl#getOutput__oFaultOff <em>Output oFault Off</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit34Impl#getTimer__tDelayOn <em>Timer tDelay On</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit34Impl#getTimer__tDelayOff <em>Timer tDelay Off</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit34Impl#getBhvParam__bpLogicType <em>Bhv Param bp Logic Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit34Impl extends wtcImpl implements CtrlUnit34 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit34();
	}
		...
		if (input__iInput != null && input__iInput.eIsProxy()) {
			...
			if (input__iInput != oldInput__iInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT34__INPUT_IINPUT, oldInput__iInput, input__iInput));
			}
		}
	...
	public void setInput__iInput(WTCInput newInput__iInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT34__INPUT_IINPUT, oldInput__iInput, input__iInput));
	}
	...
	public WTCInput getInput__iFeedback() {
		if (input__iFeedback != null && input__iFeedback.eIsProxy()) {
			...
			if (input__iFeedback != oldInput__iFeedback) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT34__INPUT_IFEEDBACK, oldInput__iFeedback, input__iFeedback));
			}
		}
	...
	public void setInput__iFeedback(WTCInput newInput__iFeedback) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT34__INPUT_IFEEDBACK, oldInput__iFeedback, input__iFeedback));
	}
	...
	public WTCOutput getOutput__oFaultOn() {
		if (output__oFaultOn != null && output__oFaultOn.eIsProxy()) {
			...
			if (output__oFaultOn != oldOutput__oFaultOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT34__OUTPUT_OFAULT_ON, oldOutput__oFaultOn, output__oFaultOn));
			}
		}
	...
	public void setOutput__oFaultOn(WTCOutput newOutput__oFaultOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT34__OUTPUT_OFAULT_ON, oldOutput__oFaultOn, output__oFaultOn));
	}
	...
	public WTCOutput getOutput__oFaultOff() {
		if (output__oFaultOff != null && output__oFaultOff.eIsProxy()) {
			...
			if (output__oFaultOff != oldOutput__oFaultOff) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT34__OUTPUT_OFAULT_OFF, oldOutput__oFaultOff, output__oFaultOff));
			}
		}
	...
	public void setOutput__oFaultOff(WTCOutput newOutput__oFaultOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT34__OUTPUT_OFAULT_OFF, oldOutput__oFaultOff, output__oFaultOff));
	}
	...
	public WTCTimer getTimer__tDelayOn() {
		if (timer__tDelayOn != null && timer__tDelayOn.eIsProxy()) {
			...
			if (timer__tDelayOn != oldTimer__tDelayOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT34__TIMER_TDELAY_ON, oldTimer__tDelayOn, timer__tDelayOn));
			}
		}
	...
	public void setTimer__tDelayOn(WTCTimer newTimer__tDelayOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT34__TIMER_TDELAY_ON, oldTimer__tDelayOn, timer__tDelayOn));
	}
	...
	public WTCTimer getTimer__tDelayOff() {
		if (timer__tDelayOff != null && timer__tDelayOff.eIsProxy()) {
			...
			if (timer__tDelayOff != oldTimer__tDelayOff) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT34__TIMER_TDELAY_OFF, oldTimer__tDelayOff, timer__tDelayOff));
			}
		}
	...
	public void setTimer__tDelayOff(WTCTimer newTimer__tDelayOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT34__TIMER_TDELAY_OFF, oldTimer__tDelayOff, timer__tDelayOff));
	}
	...
	public void setBhvParam__bpLogicType(String newBhvParam__bpLogicType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT34__BHV_PARAM_BP_LOGIC_TYPE, oldBhvParam__bpLogicType, bhvParam__bpLogicType));
	}

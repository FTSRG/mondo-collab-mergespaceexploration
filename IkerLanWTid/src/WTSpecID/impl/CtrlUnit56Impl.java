 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit56Impl#getInput__iInternalFailure <em>Input iInternal Failure</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit56Impl#getOutput__oInhibit <em>Output oInhibit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit56Impl extends wtcImpl implements CtrlUnit56 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit56();
	}
		...
		if (input__iInternalFailure != null && input__iInternalFailure.eIsProxy()) {
			...
			if (input__iInternalFailure != oldInput__iInternalFailure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT56__INPUT_IINTERNAL_FAILURE, oldInput__iInternalFailure, input__iInternalFailure));
			}
		}
	...
	public void setInput__iInternalFailure(WTCInput newInput__iInternalFailure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT56__INPUT_IINTERNAL_FAILURE, oldInput__iInternalFailure, input__iInternalFailure));
	}
	...
	public WTCOutput getOutput__oInhibit() {
		if (output__oInhibit != null && output__oInhibit.eIsProxy()) {
			...
			if (output__oInhibit != oldOutput__oInhibit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT56__OUTPUT_OINHIBIT, oldOutput__oInhibit, output__oInhibit));
			}
		}
	...
	public void setOutput__oInhibit(WTCOutput newOutput__oInhibit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT56__OUTPUT_OINHIBIT, oldOutput__oInhibit, output__oInhibit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT56__INPUT_IINTERNAL_FAILURE:
				if (resolve) return getInput__iInternalFailure();
				return basicGetInput__iInternalFailure();
			case WTSpecIDPackage.CTRL_UNIT56__OUTPUT_OINHIBIT:

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit106Impl#getInput__i1 <em>Input i1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit106Impl#getOutput__o1 <em>Output o1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit106Impl#getTimer__t1 <em>Timer t1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit106Impl#getTimer__t2 <em>Timer t2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit106Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit106Impl extends wtcImpl implements CtrlUnit106 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit106();
	}
		...
		if (input__i1 != null && input__i1.eIsProxy()) {
			...
			if (input__i1 != oldInput__i1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT106__INPUT_I1, oldInput__i1, input__i1));
			}
		}
		return input__i1;
	}
	...
	public void setInput__i1(WTCInput newInput__i1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT106__INPUT_I1, oldInput__i1, input__i1));
	}
	...
	public WTCOutput getOutput__o1() {
		if (output__o1 != null && output__o1.eIsProxy()) {
			...
			if (output__o1 != oldOutput__o1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT106__OUTPUT_O1, oldOutput__o1, output__o1));
			}
		}
		return output__o1;
	}
	...
	public void setOutput__o1(WTCOutput newOutput__o1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT106__OUTPUT_O1, oldOutput__o1, output__o1));
	}
	...
	public WTCTimer getTimer__t1() {
		if (timer__t1 != null && timer__t1.eIsProxy()) {
			...
			if (timer__t1 != oldTimer__t1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT106__TIMER_T1, oldTimer__t1, timer__t1));
			}
		}
		return timer__t1;
	}
	...
	public void setTimer__t1(WTCTimer newTimer__t1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT106__TIMER_T1, oldTimer__t1, timer__t1));
	}
	...
	public WTCTimer getTimer__t2() {
		if (timer__t2 != null && timer__t2.eIsProxy()) {
			...
			if (timer__t2 != oldTimer__t2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT106__TIMER_T2, oldTimer__t2, timer__t2));
			}
		}
		return timer__t2;
	}
	...
	public void setTimer__t2(WTCTimer newTimer__t2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT106__TIMER_T2, oldTimer__t2, timer__t2));
	}
	...
	public void setBhvParam__bpMode(String newBhvParam__bpMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT106__BHV_PARAM_BP_MODE, oldBhvParam__bpMode, bhvParam__bpMode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT106__INPUT_I1:
				if (resolve) return getInput__i1();
				return basicGetInput__i1();
			case WTSpecIDPackage.CTRL_UNIT106__OUTPUT_O1:
				if (resolve) return getOutput__o1();
				return basicGetOutput__o1();
			case WTSpecIDPackage.CTRL_UNIT106__TIMER_T1:
				if (resolve) return getTimer__t1();
				return basicGetTimer__t1();
			case WTSpecIDPackage.CTRL_UNIT106__TIMER_T2:
				if (resolve) return getTimer__t2();
				return basicGetTimer__t2();
			case WTSpecIDPackage.CTRL_UNIT106__BHV_PARAM_BP_MODE:

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit122Impl#getInput__iYawCommand <em>Input iYaw Command</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit122Impl#getInput__iYawBrakeStatus <em>Input iYaw Brake Status</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit122Impl#getInput__iInhibitYaw <em>Input iInhibit Yaw</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit122Impl#getOutput__oYawStatus <em>Output oYaw Status</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit122Impl#getOutput__oYawBrakeCommand <em>Output oYaw Brake Command</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit122Impl#getOutput__oYawCwOrder <em>Output oYaw Cw Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit122Impl#getOutput__oYawCcwOrder <em>Output oYaw Ccw Order</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit122Impl#getTimer__tDelayYawingControl <em>Timer tDelay Yawing Control</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit122Impl#getTimer__tDelayYawingToStop <em>Timer tDelay Yawing To Stop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit122Impl extends wtcImpl implements CtrlUnit122 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit122();
	}
		...
		if (input__iYawCommand != null && input__iYawCommand.eIsProxy()) {
			...
			if (input__iYawCommand != oldInput__iYawCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT122__INPUT_IYAW_COMMAND, oldInput__iYawCommand, input__iYawCommand));
			}
		}
	...
	public void setInput__iYawCommand(WTCInput newInput__iYawCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT122__INPUT_IYAW_COMMAND, oldInput__iYawCommand, input__iYawCommand));
	}
	...
	public WTCInput getInput__iYawBrakeStatus() {
		if (input__iYawBrakeStatus != null && input__iYawBrakeStatus.eIsProxy()) {
			...
			if (input__iYawBrakeStatus != oldInput__iYawBrakeStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT122__INPUT_IYAW_BRAKE_STATUS, oldInput__iYawBrakeStatus, input__iYawBrakeStatus));
			}
		}
	...
	public void setInput__iYawBrakeStatus(WTCInput newInput__iYawBrakeStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT122__INPUT_IYAW_BRAKE_STATUS, oldInput__iYawBrakeStatus, input__iYawBrakeStatus));
	}
	...
	public WTCInput getInput__iInhibitYaw() {
		if (input__iInhibitYaw != null && input__iInhibitYaw.eIsProxy()) {
			...
			if (input__iInhibitYaw != oldInput__iInhibitYaw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT122__INPUT_IINHIBIT_YAW, oldInput__iInhibitYaw, input__iInhibitYaw));
			}
		}
	...
	public void setInput__iInhibitYaw(WTCInput newInput__iInhibitYaw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT122__INPUT_IINHIBIT_YAW, oldInput__iInhibitYaw, input__iInhibitYaw));
	}
	...
	public WTCOutput getOutput__oYawStatus() {
		if (output__oYawStatus != null && output__oYawStatus.eIsProxy()) {
			...
			if (output__oYawStatus != oldOutput__oYawStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT122__OUTPUT_OYAW_STATUS, oldOutput__oYawStatus, output__oYawStatus));
			}
		}
	...
	public void setOutput__oYawStatus(WTCOutput newOutput__oYawStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT122__OUTPUT_OYAW_STATUS, oldOutput__oYawStatus, output__oYawStatus));
	}
	...
	public WTCOutput getOutput__oYawBrakeCommand() {
		if (output__oYawBrakeCommand != null && output__oYawBrakeCommand.eIsProxy()) {
			...
			if (output__oYawBrakeCommand != oldOutput__oYawBrakeCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT122__OUTPUT_OYAW_BRAKE_COMMAND, oldOutput__oYawBrakeCommand, output__oYawBrakeCommand));
			}
		}
	...
	public void setOutput__oYawBrakeCommand(WTCOutput newOutput__oYawBrakeCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT122__OUTPUT_OYAW_BRAKE_COMMAND, oldOutput__oYawBrakeCommand, output__oYawBrakeCommand));
	}
	...
	public WTCOutput getOutput__oYawCwOrder() {
		if (output__oYawCwOrder != null && output__oYawCwOrder.eIsProxy()) {
			...
			if (output__oYawCwOrder != oldOutput__oYawCwOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT122__OUTPUT_OYAW_CW_ORDER, oldOutput__oYawCwOrder, output__oYawCwOrder));
			}
		}
	...
	public void setOutput__oYawCwOrder(WTCOutput newOutput__oYawCwOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT122__OUTPUT_OYAW_CW_ORDER, oldOutput__oYawCwOrder, output__oYawCwOrder));
	}
	...
	public WTCOutput getOutput__oYawCcwOrder() {
		if (output__oYawCcwOrder != null && output__oYawCcwOrder.eIsProxy()) {
			...
			if (output__oYawCcwOrder != oldOutput__oYawCcwOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT122__OUTPUT_OYAW_CCW_ORDER, oldOutput__oYawCcwOrder, output__oYawCcwOrder));
			}
		}
	...
	public void setOutput__oYawCcwOrder(WTCOutput newOutput__oYawCcwOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT122__OUTPUT_OYAW_CCW_ORDER, oldOutput__oYawCcwOrder, output__oYawCcwOrder));
	}
	...
	public WTCTimer getTimer__tDelayYawingControl() {
		if (timer__tDelayYawingControl != null && timer__tDelayYawingControl.eIsProxy()) {
			...
			if (timer__tDelayYawingControl != oldTimer__tDelayYawingControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT122__TIMER_TDELAY_YAWING_CONTROL, oldTimer__tDelayYawingControl, timer__tDelayYawingControl));
			}
		}
	...
	public void setTimer__tDelayYawingControl(WTCTimer newTimer__tDelayYawingControl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT122__TIMER_TDELAY_YAWING_CONTROL, oldTimer__tDelayYawingControl, timer__tDelayYawingControl));
	}
	...
	public WTCTimer getTimer__tDelayYawingToStop() {
		if (timer__tDelayYawingToStop != null && timer__tDelayYawingToStop.eIsProxy()) {
			...
			if (timer__tDelayYawingToStop != oldTimer__tDelayYawingToStop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT122__TIMER_TDELAY_YAWING_TO_STOP, oldTimer__tDelayYawingToStop, timer__tDelayYawingToStop));
			}
		}
	...
	public void setTimer__tDelayYawingToStop(WTCTimer newTimer__tDelayYawingToStop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT122__TIMER_TDELAY_YAWING_TO_STOP, oldTimer__tDelayYawingToStop, timer__tDelayYawingToStop));
	}

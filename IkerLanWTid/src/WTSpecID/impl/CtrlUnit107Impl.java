 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit107Impl#getFault__fDLLWarning <em>Fault fDLL Warning</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit107Impl#getFault__fDLLError <em>Fault fDLL Error</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit107Impl extends wtcImpl implements CtrlUnit107 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit107();
	}
		...
		if (fault__fDLLWarning != null && fault__fDLLWarning.eIsProxy()) {
			...
			if (fault__fDLLWarning != oldFault__fDLLWarning) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT107__FAULT_FDLL_WARNING, oldFault__fDLLWarning, fault__fDLLWarning));
			}
		}
	...
	public void setFault__fDLLWarning(WTCFault newFault__fDLLWarning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT107__FAULT_FDLL_WARNING, oldFault__fDLLWarning, fault__fDLLWarning));
	}
	...
	public WTCFault getFault__fDLLError() {
		if (fault__fDLLError != null && fault__fDLLError.eIsProxy()) {
			...
			if (fault__fDLLError != oldFault__fDLLError) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT107__FAULT_FDLL_ERROR, oldFault__fDLLError, fault__fDLLError));
			}
		}
	...
	public void setFault__fDLLError(WTCFault newFault__fDLLError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT107__FAULT_FDLL_ERROR, oldFault__fDLLError, fault__fDLLError));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT107__FAULT_FDLL_WARNING:
				if (resolve) return getFault__fDLLWarning();
				return basicGetFault__fDLLWarning();
			case WTSpecIDPackage.CTRL_UNIT107__FAULT_FDLL_ERROR:

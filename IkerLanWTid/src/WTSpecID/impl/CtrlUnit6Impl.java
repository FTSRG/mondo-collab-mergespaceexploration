 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit6Impl#getInput__iStatus <em>Input iStatus</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit6Impl#getInput__iOverloadAlarm <em>Input iOverload Alarm</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit6Impl#getInput__iAlarmCounter <em>Input iAlarm Counter</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit6Impl#getOutput__oAlarmCounter <em>Output oAlarm Counter</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit6Impl#getParameter__pTimePeriod <em>Parameter pTime Period</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit6Impl#getParameter__pOverloadTimeLimit <em>Parameter pOverload Time Limit</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit6Impl#getFault__fOverload <em>Fault fOverload</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit6Impl#getTimer__tSyncDelay <em>Timer tSync Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit6Impl extends wtcImpl implements CtrlUnit6 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit6();
	}
		...
		if (input__iStatus != null && input__iStatus.eIsProxy()) {
			...
			if (input__iStatus != oldInput__iStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT6__INPUT_ISTATUS, oldInput__iStatus, input__iStatus));
			}
		}
	...
	public void setInput__iStatus(WTCInput newInput__iStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT6__INPUT_ISTATUS, oldInput__iStatus, input__iStatus));
	}
	...
	public WTCInput getInput__iOverloadAlarm() {
		if (input__iOverloadAlarm != null && input__iOverloadAlarm.eIsProxy()) {
			...
			if (input__iOverloadAlarm != oldInput__iOverloadAlarm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT6__INPUT_IOVERLOAD_ALARM, oldInput__iOverloadAlarm, input__iOverloadAlarm));
			}
		}
	...
	public void setInput__iOverloadAlarm(WTCInput newInput__iOverloadAlarm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT6__INPUT_IOVERLOAD_ALARM, oldInput__iOverloadAlarm, input__iOverloadAlarm));
	}
	...
	public WTCInput getInput__iAlarmCounter() {
		if (input__iAlarmCounter != null && input__iAlarmCounter.eIsProxy()) {
			...
			if (input__iAlarmCounter != oldInput__iAlarmCounter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT6__INPUT_IALARM_COUNTER, oldInput__iAlarmCounter, input__iAlarmCounter));
			}
		}
	...
	public void setInput__iAlarmCounter(WTCInput newInput__iAlarmCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT6__INPUT_IALARM_COUNTER, oldInput__iAlarmCounter, input__iAlarmCounter));
	}
	...
	public WTCOutput getOutput__oAlarmCounter() {
		if (output__oAlarmCounter != null && output__oAlarmCounter.eIsProxy()) {
			...
			if (output__oAlarmCounter != oldOutput__oAlarmCounter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT6__OUTPUT_OALARM_COUNTER, oldOutput__oAlarmCounter, output__oAlarmCounter));
			}
		}
	...
	public void setOutput__oAlarmCounter(WTCOutput newOutput__oAlarmCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT6__OUTPUT_OALARM_COUNTER, oldOutput__oAlarmCounter, output__oAlarmCounter));
	}
	...
	public WTCParam getParameter__pTimePeriod() {
		if (parameter__pTimePeriod != null && parameter__pTimePeriod.eIsProxy()) {
			...
			if (parameter__pTimePeriod != oldParameter__pTimePeriod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT6__PARAMETER_PTIME_PERIOD, oldParameter__pTimePeriod, parameter__pTimePeriod));
			}
		}
	...
	public void setParameter__pTimePeriod(WTCParam newParameter__pTimePeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT6__PARAMETER_PTIME_PERIOD, oldParameter__pTimePeriod, parameter__pTimePeriod));
	}
	...
	public WTCParam getParameter__pOverloadTimeLimit() {
		if (parameter__pOverloadTimeLimit != null && parameter__pOverloadTimeLimit.eIsProxy()) {
			...
			if (parameter__pOverloadTimeLimit != oldParameter__pOverloadTimeLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT6__PARAMETER_POVERLOAD_TIME_LIMIT, oldParameter__pOverloadTimeLimit, parameter__pOverloadTimeLimit));
			}
		}
	...
	public void setParameter__pOverloadTimeLimit(WTCParam newParameter__pOverloadTimeLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT6__PARAMETER_POVERLOAD_TIME_LIMIT, oldParameter__pOverloadTimeLimit, parameter__pOverloadTimeLimit));
	}
	...
	public WTCFault getFault__fOverload() {
		if (fault__fOverload != null && fault__fOverload.eIsProxy()) {
			...
			if (fault__fOverload != oldFault__fOverload) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT6__FAULT_FOVERLOAD, oldFault__fOverload, fault__fOverload));
			}
		}
	...
	public void setFault__fOverload(WTCFault newFault__fOverload) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT6__FAULT_FOVERLOAD, oldFault__fOverload, fault__fOverload));
	}
	...
	public WTCTimer getTimer__tSyncDelay() {
		if (timer__tSyncDelay != null && timer__tSyncDelay.eIsProxy()) {
			...
			if (timer__tSyncDelay != oldTimer__tSyncDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT6__TIMER_TSYNC_DELAY, oldTimer__tSyncDelay, timer__tSyncDelay));
			}
		}
	...
	public void setTimer__tSyncDelay(WTCTimer newTimer__tSyncDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT6__TIMER_TSYNC_DELAY, oldTimer__tSyncDelay, timer__tSyncDelay));
	}

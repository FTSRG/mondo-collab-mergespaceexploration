 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit30Impl#getInput__iDigitalInput <em>Input iDigital Input</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit30Impl#getInput__iOffOrder <em>Input iOff Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit30Impl extends wtcImpl implements CtrlUnit30 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit30();
	}
		...
		if (input__iDigitalInput != null && input__iDigitalInput.eIsProxy()) {
			...
			if (input__iDigitalInput != oldInput__iDigitalInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT30__INPUT_IDIGITAL_INPUT, oldInput__iDigitalInput, input__iDigitalInput));
			}
		}
	...
	public void setInput__iDigitalInput(WTCInput newInput__iDigitalInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT30__INPUT_IDIGITAL_INPUT, oldInput__iDigitalInput, input__iDigitalInput));
	}
	...
	public WTCInput getInput__iOffOrder() {
		if (input__iOffOrder != null && input__iOffOrder.eIsProxy()) {
			...
			if (input__iOffOrder != oldInput__iOffOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT30__INPUT_IOFF_ORDER, oldInput__iOffOrder, input__iOffOrder));
			}
		}
	...
	public void setInput__iOffOrder(WTCInput newInput__iOffOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT30__INPUT_IOFF_ORDER, oldInput__iOffOrder, input__iOffOrder));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT30__INPUT_IDIGITAL_INPUT:
				if (resolve) return getInput__iDigitalInput();
				return basicGetInput__iDigitalInput();
			case WTSpecIDPackage.CTRL_UNIT30__INPUT_IOFF_ORDER:

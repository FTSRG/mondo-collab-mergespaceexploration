 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit1Impl#getInput__iTwistAngle <em>Input iTwist Angle</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit1Impl#getOutput__oNacelleDirection <em>Output oNacelle Direction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit1Impl extends wtcImpl implements CtrlUnit1 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit1();
	}
		...
		if (input__iTwistAngle != null && input__iTwistAngle.eIsProxy()) {
			...
			if (input__iTwistAngle != oldInput__iTwistAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT1__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
			}
		}
	...
	public void setInput__iTwistAngle(WTCInput newInput__iTwistAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT1__INPUT_ITWIST_ANGLE, oldInput__iTwistAngle, input__iTwistAngle));
	}
	...
	public WTCOutput getOutput__oNacelleDirection() {
		if (output__oNacelleDirection != null && output__oNacelleDirection.eIsProxy()) {
			...
			if (output__oNacelleDirection != oldOutput__oNacelleDirection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT1__OUTPUT_ONACELLE_DIRECTION, oldOutput__oNacelleDirection, output__oNacelleDirection));
			}
		}
	...
	public void setOutput__oNacelleDirection(WTCOutput newOutput__oNacelleDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT1__OUTPUT_ONACELLE_DIRECTION, oldOutput__oNacelleDirection, output__oNacelleDirection));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT1__INPUT_ITWIST_ANGLE:
				if (resolve) return getInput__iTwistAngle();
				return basicGetInput__iTwistAngle();
			case WTSpecIDPackage.CTRL_UNIT1__OUTPUT_ONACELLE_DIRECTION:

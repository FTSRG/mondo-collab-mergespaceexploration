 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit10Impl#getInput__iAnalogInput <em>Input iAnalog Input</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit10Impl#getOutput__oAnalogScaled <em>Output oAnalog Scaled</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit10Impl#getParameter__pFactor <em>Parameter pFactor</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit10Impl#getParameter__pOffset <em>Parameter pOffset</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit10Impl#getParameter__pUpLimit <em>Parameter pUp Limit</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit10Impl#getParameter__pUpValue <em>Parameter pUp Value</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit10Impl#getParameter__pDownLimit <em>Parameter pDown Limit</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit10Impl#getParameter__pDownValue <em>Parameter pDown Value</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit10Impl#getBhvParam__bpOperation <em>Bhv Param bp Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit10Impl extends wtcImpl implements CtrlUnit10 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit10();
	}
		...
		if (input__iAnalogInput != null && input__iAnalogInput.eIsProxy()) {
			...
			if (input__iAnalogInput != oldInput__iAnalogInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT10__INPUT_IANALOG_INPUT, oldInput__iAnalogInput, input__iAnalogInput));
			}
		}
	...
	public void setInput__iAnalogInput(WTCInput newInput__iAnalogInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT10__INPUT_IANALOG_INPUT, oldInput__iAnalogInput, input__iAnalogInput));
	}
	...
	public WTCOutput getOutput__oAnalogScaled() {
		if (output__oAnalogScaled != null && output__oAnalogScaled.eIsProxy()) {
			...
			if (output__oAnalogScaled != oldOutput__oAnalogScaled) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT10__OUTPUT_OANALOG_SCALED, oldOutput__oAnalogScaled, output__oAnalogScaled));
			}
		}
	...
	public void setOutput__oAnalogScaled(WTCOutput newOutput__oAnalogScaled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT10__OUTPUT_OANALOG_SCALED, oldOutput__oAnalogScaled, output__oAnalogScaled));
	}
	...
	public WTCParam getParameter__pFactor() {
		if (parameter__pFactor != null && parameter__pFactor.eIsProxy()) {
			...
			if (parameter__pFactor != oldParameter__pFactor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PFACTOR, oldParameter__pFactor, parameter__pFactor));
			}
		}
	...
	public void setParameter__pFactor(WTCParam newParameter__pFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PFACTOR, oldParameter__pFactor, parameter__pFactor));
	}
	...
	public WTCParam getParameter__pOffset() {
		if (parameter__pOffset != null && parameter__pOffset.eIsProxy()) {
			...
			if (parameter__pOffset != oldParameter__pOffset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_POFFSET, oldParameter__pOffset, parameter__pOffset));
			}
		}
	...
	public void setParameter__pOffset(WTCParam newParameter__pOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_POFFSET, oldParameter__pOffset, parameter__pOffset));
	}
	...
	public WTCParam getParameter__pUpLimit() {
		if (parameter__pUpLimit != null && parameter__pUpLimit.eIsProxy()) {
			...
			if (parameter__pUpLimit != oldParameter__pUpLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PUP_LIMIT, oldParameter__pUpLimit, parameter__pUpLimit));
			}
		}
	...
	public void setParameter__pUpLimit(WTCParam newParameter__pUpLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PUP_LIMIT, oldParameter__pUpLimit, parameter__pUpLimit));
	}
	...
	public WTCParam getParameter__pUpValue() {
		if (parameter__pUpValue != null && parameter__pUpValue.eIsProxy()) {
			...
			if (parameter__pUpValue != oldParameter__pUpValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PUP_VALUE, oldParameter__pUpValue, parameter__pUpValue));
			}
		}
	...
	public void setParameter__pUpValue(WTCParam newParameter__pUpValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PUP_VALUE, oldParameter__pUpValue, parameter__pUpValue));
	}
	...
	public WTCParam getParameter__pDownLimit() {
		if (parameter__pDownLimit != null && parameter__pDownLimit.eIsProxy()) {
			...
			if (parameter__pDownLimit != oldParameter__pDownLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PDOWN_LIMIT, oldParameter__pDownLimit, parameter__pDownLimit));
			}
		}
	...
	public void setParameter__pDownLimit(WTCParam newParameter__pDownLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PDOWN_LIMIT, oldParameter__pDownLimit, parameter__pDownLimit));
	}
	...
	public WTCParam getParameter__pDownValue() {
		if (parameter__pDownValue != null && parameter__pDownValue.eIsProxy()) {
			...
			if (parameter__pDownValue != oldParameter__pDownValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PDOWN_VALUE, oldParameter__pDownValue, parameter__pDownValue));
			}
		}
	...
	public void setParameter__pDownValue(WTCParam newParameter__pDownValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT10__PARAMETER_PDOWN_VALUE, oldParameter__pDownValue, parameter__pDownValue));
	}
	...
	public void setBhvParam__bpOperation(String newBhvParam__bpOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT10__BHV_PARAM_BP_OPERATION, oldBhvParam__bpOperation, bhvParam__bpOperation));
	}

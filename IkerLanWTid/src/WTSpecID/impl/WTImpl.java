...
import WTSpecID.SystemErrorReaction;
import WTSpecID.SystemFault;
import WTSpecID.SystemInput;
import WTSpecID.SystemOutput;
 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.WTImpl#getSysId <em>Sys Id</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getModel <em>Model</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getItsSubsystems <em>Its Subsystems</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getItsInputs <em>Its Inputs</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getItsOutputs <em>Its Outputs</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getItsParams <em>Its Params</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getItsTimers <em>Its Timers</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getItsFaults <em>Its Faults</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getItsVariables <em>Its Variables</em>}</li>
 *   <li>{@link WTSpecID.impl.WTImpl#getItsErrorReactions <em>Its Error Reactions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WTImpl extends IdentifiableImpl implements WT {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getWT();
	}
	...
	public void setSysId(String newSysId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.WT__SYS_ID, oldSysId, sysId));
	}
	...
	public void setModel(String newModel) {
		...
		model = newModel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.WT__MODEL, oldModel, model));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.WT__VERSION, oldVersion, version));
	}
	...
	public EList<Subsystem> getItsSubsystems() {
		if (itsSubsystems == null) {
			itsSubsystems = new EObjectContainmentEList<Subsystem>(Subsystem.class, this, WTSpecIDPackage.WT__ITS_SUBSYSTEMS);
		}
	...
	public EList<SystemInput> getItsInputs() {
		if (itsInputs == null) {
			itsInputs = new EObjectContainmentEList<SystemInput>(SystemInput.class, this, WTSpecIDPackage.WT__ITS_INPUTS);
		}
		return itsInputs;
	}
	...
	public EList<SystemOutput> getItsOutputs() {
		if (itsOutputs == null) {
			itsOutputs = new EObjectContainmentEList<SystemOutput>(SystemOutput.class, this, WTSpecIDPackage.WT__ITS_OUTPUTS);
		}
		return itsOutputs;
	}
	...
	public EList<SystemParam> getItsParams() {
		if (itsParams == null) {
			itsParams = new EObjectContainmentEList<SystemParam>(SystemParam.class, this, WTSpecIDPackage.WT__ITS_PARAMS);
		}
		return itsParams;
	}
	...
	public EList<SystemTimer> getItsTimers() {
		if (itsTimers == null) {
			itsTimers = new EObjectContainmentEList<SystemTimer>(SystemTimer.class, this, WTSpecIDPackage.WT__ITS_TIMERS);
		}
		return itsTimers;
	}
	...
	public EList<SystemFault> getItsFaults() {
		if (itsFaults == null) {
			itsFaults = new EObjectContainmentEList<SystemFault>(SystemFault.class, this, WTSpecIDPackage.WT__ITS_FAULTS);
		}
		return itsFaults;
	}
	...
	public EList<SystemVariable> getItsVariables() {
		if (itsVariables == null) {
			itsVariables = new EObjectContainmentEList<SystemVariable>(SystemVariable.class, this, WTSpecIDPackage.WT__ITS_VARIABLES);
		}
		return itsVariables;
	}
	...
	public EList<SystemErrorReaction> getItsErrorReactions() {
		if (itsErrorReactions == null) {
			itsErrorReactions = new EObjectContainmentEList<SystemErrorReaction>(SystemErrorReaction.class, this, WTSpecIDPackage.WT__ITS_ERROR_REACTIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.WT__SYS_ID:
				return getSysId();
			case WTSpecIDPackage.WT__MODEL:
				return getModel();
			case WTSpecIDPackage.WT__VERSION:
				return getVersion();
			case WTSpecIDPackage.WT__ITS_SUBSYSTEMS:

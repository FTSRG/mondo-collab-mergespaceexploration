 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getInput__iTemp1 <em>Input iTemp1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getInput__iTemp2 <em>Input iTemp2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getInput__iTemp3 <em>Input iTemp3</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getOutput__oFan <em>Output oFan</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getParameter__pTempLimit1 <em>Parameter pTemp Limit1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getParameter__pTempLimit2 <em>Parameter pTemp Limit2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getParameter__pTempLimit3 <em>Parameter pTemp Limit3</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getFault__fFault1 <em>Fault fFault1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getErrorReaction__erReaction1 <em>Error Reaction er Reaction1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit48Impl#getErrorReaction__erReaction2 <em>Error Reaction er Reaction2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit48Impl extends wtcImpl implements CtrlUnit48 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit48();
	}
		...
		if (input__iTemp1 != null && input__iTemp1.eIsProxy()) {
			...
			if (input__iTemp1 != oldInput__iTemp1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__INPUT_ITEMP1, oldInput__iTemp1, input__iTemp1));
			}
		}
	...
	public void setInput__iTemp1(WTCInput newInput__iTemp1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__INPUT_ITEMP1, oldInput__iTemp1, input__iTemp1));
	}
	...
	public WTCInput getInput__iTemp2() {
		if (input__iTemp2 != null && input__iTemp2.eIsProxy()) {
			...
			if (input__iTemp2 != oldInput__iTemp2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__INPUT_ITEMP2, oldInput__iTemp2, input__iTemp2));
			}
		}
	...
	public void setInput__iTemp2(WTCInput newInput__iTemp2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__INPUT_ITEMP2, oldInput__iTemp2, input__iTemp2));
	}
	...
	public WTCInput getInput__iTemp3() {
		if (input__iTemp3 != null && input__iTemp3.eIsProxy()) {
			...
			if (input__iTemp3 != oldInput__iTemp3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__INPUT_ITEMP3, oldInput__iTemp3, input__iTemp3));
			}
		}
	...
	public void setInput__iTemp3(WTCInput newInput__iTemp3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__INPUT_ITEMP3, oldInput__iTemp3, input__iTemp3));
	}
	...
	public WTCOutput getOutput__oFan() {
		if (output__oFan != null && output__oFan.eIsProxy()) {
			...
			if (output__oFan != oldOutput__oFan) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__OUTPUT_OFAN, oldOutput__oFan, output__oFan));
			}
		}
		return output__oFan;
	}
	...
	public void setOutput__oFan(WTCOutput newOutput__oFan) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__OUTPUT_OFAN, oldOutput__oFan, output__oFan));
	}
	...
	public WTCParam getParameter__pTempLimit1() {
		if (parameter__pTempLimit1 != null && parameter__pTempLimit1.eIsProxy()) {
			...
			if (parameter__pTempLimit1 != oldParameter__pTempLimit1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__PARAMETER_PTEMP_LIMIT1, oldParameter__pTempLimit1, parameter__pTempLimit1));
			}
		}
	...
	public void setParameter__pTempLimit1(WTCParam newParameter__pTempLimit1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__PARAMETER_PTEMP_LIMIT1, oldParameter__pTempLimit1, parameter__pTempLimit1));
	}
	...
	public WTCParam getParameter__pTempLimit2() {
		if (parameter__pTempLimit2 != null && parameter__pTempLimit2.eIsProxy()) {
			...
			if (parameter__pTempLimit2 != oldParameter__pTempLimit2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__PARAMETER_PTEMP_LIMIT2, oldParameter__pTempLimit2, parameter__pTempLimit2));
			}
		}
	...
	public void setParameter__pTempLimit2(WTCParam newParameter__pTempLimit2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__PARAMETER_PTEMP_LIMIT2, oldParameter__pTempLimit2, parameter__pTempLimit2));
	}
	...
	public WTCParam getParameter__pTempLimit3() {
		if (parameter__pTempLimit3 != null && parameter__pTempLimit3.eIsProxy()) {
			...
			if (parameter__pTempLimit3 != oldParameter__pTempLimit3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__PARAMETER_PTEMP_LIMIT3, oldParameter__pTempLimit3, parameter__pTempLimit3));
			}
		}
	...
	public void setParameter__pTempLimit3(WTCParam newParameter__pTempLimit3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__PARAMETER_PTEMP_LIMIT3, oldParameter__pTempLimit3, parameter__pTempLimit3));
	}
	...
	public WTCFault getFault__fFault1() {
		if (fault__fFault1 != null && fault__fFault1.eIsProxy()) {
			...
			if (fault__fFault1 != oldFault__fFault1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__FAULT_FFAULT1, oldFault__fFault1, fault__fFault1));
			}
		}
	...
	public void setFault__fFault1(WTCFault newFault__fFault1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__FAULT_FFAULT1, oldFault__fFault1, fault__fFault1));
	}
	...
	public WTCErrorReaction getErrorReaction__erReaction1() {
		if (errorReaction__erReaction1 != null && errorReaction__erReaction1.eIsProxy()) {
			...
			if (errorReaction__erReaction1 != oldErrorReaction__erReaction1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__ERROR_REACTION_ER_REACTION1, oldErrorReaction__erReaction1, errorReaction__erReaction1));
			}
		}
	...
	public void setErrorReaction__erReaction1(WTCErrorReaction newErrorReaction__erReaction1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__ERROR_REACTION_ER_REACTION1, oldErrorReaction__erReaction1, errorReaction__erReaction1));
	}
	...
	public WTCErrorReaction getErrorReaction__erReaction2() {
		if (errorReaction__erReaction2 != null && errorReaction__erReaction2.eIsProxy()) {
			...
			if (errorReaction__erReaction2 != oldErrorReaction__erReaction2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT48__ERROR_REACTION_ER_REACTION2, oldErrorReaction__erReaction2, errorReaction__erReaction2));
			}
		}
	...
	public void setErrorReaction__erReaction2(WTCErrorReaction newErrorReaction__erReaction2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT48__ERROR_REACTION_ER_REACTION2, oldErrorReaction__erReaction2, errorReaction__erReaction2));
	}

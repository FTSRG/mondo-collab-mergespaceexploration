 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit81Impl#getInput__iInput <em>Input iInput</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit81Impl#getOutput__oPercentVal <em>Output oPercent Val</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit81Impl#getParameter__pPercent <em>Parameter pPercent</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit81Impl#getParameter__pInput <em>Parameter pInput</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit81Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit81Impl#getBhvParam__bpSelect <em>Bhv Param bp Select</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit81Impl extends wtcImpl implements CtrlUnit81 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit81();
	}
		...
		if (input__iInput != null && input__iInput.eIsProxy()) {
			...
			if (input__iInput != oldInput__iInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT81__INPUT_IINPUT, oldInput__iInput, input__iInput));
			}
		}
	...
	public void setInput__iInput(WTCInput newInput__iInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT81__INPUT_IINPUT, oldInput__iInput, input__iInput));
	}
	...
	public WTCOutput getOutput__oPercentVal() {
		if (output__oPercentVal != null && output__oPercentVal.eIsProxy()) {
			...
			if (output__oPercentVal != oldOutput__oPercentVal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT81__OUTPUT_OPERCENT_VAL, oldOutput__oPercentVal, output__oPercentVal));
			}
		}
	...
	public void setOutput__oPercentVal(WTCOutput newOutput__oPercentVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT81__OUTPUT_OPERCENT_VAL, oldOutput__oPercentVal, output__oPercentVal));
	}
	...
	public WTCParam getParameter__pPercent() {
		if (parameter__pPercent != null && parameter__pPercent.eIsProxy()) {
			...
			if (parameter__pPercent != oldParameter__pPercent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT81__PARAMETER_PPERCENT, oldParameter__pPercent, parameter__pPercent));
			}
		}
	...
	public void setParameter__pPercent(WTCParam newParameter__pPercent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT81__PARAMETER_PPERCENT, oldParameter__pPercent, parameter__pPercent));
	}
	...
	public WTCParam getParameter__pInput() {
		if (parameter__pInput != null && parameter__pInput.eIsProxy()) {
			...
			if (parameter__pInput != oldParameter__pInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT81__PARAMETER_PINPUT, oldParameter__pInput, parameter__pInput));
			}
		}
	...
	public void setParameter__pInput(WTCParam newParameter__pInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT81__PARAMETER_PINPUT, oldParameter__pInput, parameter__pInput));
	}
	...
	public void setBhvParam__bpMode(String newBhvParam__bpMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT81__BHV_PARAM_BP_MODE, oldBhvParam__bpMode, bhvParam__bpMode));
	}
	...
	public void setBhvParam__bpSelect(String newBhvParam__bpSelect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT81__BHV_PARAM_BP_SELECT, oldBhvParam__bpSelect, bhvParam__bpSelect));
	}

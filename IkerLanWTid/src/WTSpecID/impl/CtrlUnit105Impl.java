 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit105Impl#getInput__iEntryToCount <em>Input iEntry To Count</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit105Impl#getInput__iResetPartial <em>Input iReset Partial</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit105Impl#getOutput__oSecondsOnTotal <em>Output oSeconds On Total</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit105Impl#getOutput__oSecondsOnPartial <em>Output oSeconds On Partial</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit105Impl extends wtcImpl implements CtrlUnit105 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit105();
	}
		...
		if (input__iEntryToCount != null && input__iEntryToCount.eIsProxy()) {
			...
			if (input__iEntryToCount != oldInput__iEntryToCount) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT105__INPUT_IENTRY_TO_COUNT, oldInput__iEntryToCount, input__iEntryToCount));
			}
		}
	...
	public void setInput__iEntryToCount(WTCInput newInput__iEntryToCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT105__INPUT_IENTRY_TO_COUNT, oldInput__iEntryToCount, input__iEntryToCount));
	}
	...
	public WTCInput getInput__iResetPartial() {
		if (input__iResetPartial != null && input__iResetPartial.eIsProxy()) {
			...
			if (input__iResetPartial != oldInput__iResetPartial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT105__INPUT_IRESET_PARTIAL, oldInput__iResetPartial, input__iResetPartial));
			}
		}
	...
	public void setInput__iResetPartial(WTCInput newInput__iResetPartial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT105__INPUT_IRESET_PARTIAL, oldInput__iResetPartial, input__iResetPartial));
	}
	...
	public WTCOutput getOutput__oSecondsOnTotal() {
		if (output__oSecondsOnTotal != null && output__oSecondsOnTotal.eIsProxy()) {
			...
			if (output__oSecondsOnTotal != oldOutput__oSecondsOnTotal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT105__OUTPUT_OSECONDS_ON_TOTAL, oldOutput__oSecondsOnTotal, output__oSecondsOnTotal));
			}
		}
	...
	public void setOutput__oSecondsOnTotal(WTCOutput newOutput__oSecondsOnTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT105__OUTPUT_OSECONDS_ON_TOTAL, oldOutput__oSecondsOnTotal, output__oSecondsOnTotal));
	}
	...
	public WTCOutput getOutput__oSecondsOnPartial() {
		if (output__oSecondsOnPartial != null && output__oSecondsOnPartial.eIsProxy()) {
			...
			if (output__oSecondsOnPartial != oldOutput__oSecondsOnPartial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT105__OUTPUT_OSECONDS_ON_PARTIAL, oldOutput__oSecondsOnPartial, output__oSecondsOnPartial));
			}
		}
	...
	public void setOutput__oSecondsOnPartial(WTCOutput newOutput__oSecondsOnPartial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT105__OUTPUT_OSECONDS_ON_PARTIAL, oldOutput__oSecondsOnPartial, output__oSecondsOnPartial));
	}

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iAngleReference1 <em>Input iAngle Reference1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iAngleReference2 <em>Input iAngle Reference2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iAngleReference3 <em>Input iAngle Reference3</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iSpeedReference <em>Input iSpeed Reference</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iAccelerationReference <em>Input iAcceleration Reference</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iPitchManualControl <em>Input iPitch Manual Control</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iPitchManualAngle <em>Input iPitch Manual Angle</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iMaintenanceStatus <em>Input iMaintenance Status</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iGeneratorSpeed <em>Input iGenerator Speed</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getInput__iPitchBraked <em>Input iPitch Braked</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getOutput__oPitchAngleRef1 <em>Output oPitch Angle Ref1</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getOutput__oPitchAngleRef2 <em>Output oPitch Angle Ref2</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getOutput__oPitchAngleRef3 <em>Output oPitch Angle Ref3</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getOutput__oPitchSpeedRef <em>Output oPitch Speed Ref</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getOutput__oPitchAccelerationRef <em>Output oPitch Acceleration Ref</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getOutput__oPitchStopCommand <em>Output oPitch Stop Command</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getParameter__pGeneratorSpeed <em>Parameter pGenerator Speed</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getParameter__pPitchBrakeAngle <em>Parameter pPitch Brake Angle</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getParameter__pPitchStdSpeed <em>Parameter pPitch Std Speed</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getParameter__pPitchStdAcceleration <em>Parameter pPitch Std Acceleration</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getFault__fManualStop <em>Fault fManual Stop</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getTimer__tMaxStopOperationLength <em>Timer tMax Stop Operation Length</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit89Impl#getErrorReaction__erStop <em>Error Reaction er Stop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit89Impl extends wtcImpl implements CtrlUnit89 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit89();
	}
		...
		if (input__iAngleReference1 != null && input__iAngleReference1.eIsProxy()) {
			...
			if (input__iAngleReference1 != oldInput__iAngleReference1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_IANGLE_REFERENCE1, oldInput__iAngleReference1, input__iAngleReference1));
			}
		}
	...
	public void setInput__iAngleReference1(WTCInput newInput__iAngleReference1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_IANGLE_REFERENCE1, oldInput__iAngleReference1, input__iAngleReference1));
	}
	...
	public WTCInput getInput__iAngleReference2() {
		if (input__iAngleReference2 != null && input__iAngleReference2.eIsProxy()) {
			...
			if (input__iAngleReference2 != oldInput__iAngleReference2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_IANGLE_REFERENCE2, oldInput__iAngleReference2, input__iAngleReference2));
			}
		}
	...
	public void setInput__iAngleReference2(WTCInput newInput__iAngleReference2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_IANGLE_REFERENCE2, oldInput__iAngleReference2, input__iAngleReference2));
	}
	...
	public WTCInput getInput__iAngleReference3() {
		if (input__iAngleReference3 != null && input__iAngleReference3.eIsProxy()) {
			...
			if (input__iAngleReference3 != oldInput__iAngleReference3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_IANGLE_REFERENCE3, oldInput__iAngleReference3, input__iAngleReference3));
			}
		}
	...
	public void setInput__iAngleReference3(WTCInput newInput__iAngleReference3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_IANGLE_REFERENCE3, oldInput__iAngleReference3, input__iAngleReference3));
	}
	...
	public WTCInput getInput__iSpeedReference() {
		if (input__iSpeedReference != null && input__iSpeedReference.eIsProxy()) {
			...
			if (input__iSpeedReference != oldInput__iSpeedReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_ISPEED_REFERENCE, oldInput__iSpeedReference, input__iSpeedReference));
			}
		}
	...
	public void setInput__iSpeedReference(WTCInput newInput__iSpeedReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_ISPEED_REFERENCE, oldInput__iSpeedReference, input__iSpeedReference));
	}
	...
	public WTCInput getInput__iAccelerationReference() {
		if (input__iAccelerationReference != null && input__iAccelerationReference.eIsProxy()) {
			...
			if (input__iAccelerationReference != oldInput__iAccelerationReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_IACCELERATION_REFERENCE, oldInput__iAccelerationReference, input__iAccelerationReference));
			}
		}
	...
	public void setInput__iAccelerationReference(WTCInput newInput__iAccelerationReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_IACCELERATION_REFERENCE, oldInput__iAccelerationReference, input__iAccelerationReference));
	}
	...
	public WTCInput getInput__iPitchManualControl() {
		if (input__iPitchManualControl != null && input__iPitchManualControl.eIsProxy()) {
			...
			if (input__iPitchManualControl != oldInput__iPitchManualControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_IPITCH_MANUAL_CONTROL, oldInput__iPitchManualControl, input__iPitchManualControl));
			}
		}
	...
	public void setInput__iPitchManualControl(WTCInput newInput__iPitchManualControl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_IPITCH_MANUAL_CONTROL, oldInput__iPitchManualControl, input__iPitchManualControl));
	}
	...
	public WTCInput getInput__iPitchManualAngle() {
		if (input__iPitchManualAngle != null && input__iPitchManualAngle.eIsProxy()) {
			...
			if (input__iPitchManualAngle != oldInput__iPitchManualAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_IPITCH_MANUAL_ANGLE, oldInput__iPitchManualAngle, input__iPitchManualAngle));
			}
		}
	...
	public void setInput__iPitchManualAngle(WTCInput newInput__iPitchManualAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_IPITCH_MANUAL_ANGLE, oldInput__iPitchManualAngle, input__iPitchManualAngle));
	}
	...
	public WTCInput getInput__iMaintenanceStatus() {
		if (input__iMaintenanceStatus != null && input__iMaintenanceStatus.eIsProxy()) {
			...
			if (input__iMaintenanceStatus != oldInput__iMaintenanceStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_IMAINTENANCE_STATUS, oldInput__iMaintenanceStatus, input__iMaintenanceStatus));
			}
		}
	...
	public void setInput__iMaintenanceStatus(WTCInput newInput__iMaintenanceStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_IMAINTENANCE_STATUS, oldInput__iMaintenanceStatus, input__iMaintenanceStatus));
	}
	...
	public WTCInput getInput__iGeneratorSpeed() {
		if (input__iGeneratorSpeed != null && input__iGeneratorSpeed.eIsProxy()) {
			...
			if (input__iGeneratorSpeed != oldInput__iGeneratorSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_IGENERATOR_SPEED, oldInput__iGeneratorSpeed, input__iGeneratorSpeed));
			}
		}
	...
	public void setInput__iGeneratorSpeed(WTCInput newInput__iGeneratorSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_IGENERATOR_SPEED, oldInput__iGeneratorSpeed, input__iGeneratorSpeed));
	}
	...
	public WTCInput getInput__iPitchBraked() {
		if (input__iPitchBraked != null && input__iPitchBraked.eIsProxy()) {
			...
			if (input__iPitchBraked != oldInput__iPitchBraked) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__INPUT_IPITCH_BRAKED, oldInput__iPitchBraked, input__iPitchBraked));
			}
		}
	...
	public void setInput__iPitchBraked(WTCInput newInput__iPitchBraked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__INPUT_IPITCH_BRAKED, oldInput__iPitchBraked, input__iPitchBraked));
	}
	...
	public WTCOutput getOutput__oPitchAngleRef1() {
		if (output__oPitchAngleRef1 != null && output__oPitchAngleRef1.eIsProxy()) {
			...
			if (output__oPitchAngleRef1 != oldOutput__oPitchAngleRef1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_ANGLE_REF1, oldOutput__oPitchAngleRef1, output__oPitchAngleRef1));
			}
		}
	...
	public void setOutput__oPitchAngleRef1(WTCOutput newOutput__oPitchAngleRef1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_ANGLE_REF1, oldOutput__oPitchAngleRef1, output__oPitchAngleRef1));
	}
	...
	public WTCOutput getOutput__oPitchAngleRef2() {
		if (output__oPitchAngleRef2 != null && output__oPitchAngleRef2.eIsProxy()) {
			...
			if (output__oPitchAngleRef2 != oldOutput__oPitchAngleRef2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_ANGLE_REF2, oldOutput__oPitchAngleRef2, output__oPitchAngleRef2));
			}
		}
	...
	public void setOutput__oPitchAngleRef2(WTCOutput newOutput__oPitchAngleRef2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_ANGLE_REF2, oldOutput__oPitchAngleRef2, output__oPitchAngleRef2));
	}
	...
	public WTCOutput getOutput__oPitchAngleRef3() {
		if (output__oPitchAngleRef3 != null && output__oPitchAngleRef3.eIsProxy()) {
			...
			if (output__oPitchAngleRef3 != oldOutput__oPitchAngleRef3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_ANGLE_REF3, oldOutput__oPitchAngleRef3, output__oPitchAngleRef3));
			}
		}
	...
	public void setOutput__oPitchAngleRef3(WTCOutput newOutput__oPitchAngleRef3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_ANGLE_REF3, oldOutput__oPitchAngleRef3, output__oPitchAngleRef3));
	}
	...
	public WTCOutput getOutput__oPitchSpeedRef() {
		if (output__oPitchSpeedRef != null && output__oPitchSpeedRef.eIsProxy()) {
			...
			if (output__oPitchSpeedRef != oldOutput__oPitchSpeedRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_SPEED_REF, oldOutput__oPitchSpeedRef, output__oPitchSpeedRef));
			}
		}
	...
	public void setOutput__oPitchSpeedRef(WTCOutput newOutput__oPitchSpeedRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_SPEED_REF, oldOutput__oPitchSpeedRef, output__oPitchSpeedRef));
	}
	...
	public WTCOutput getOutput__oPitchAccelerationRef() {
		if (output__oPitchAccelerationRef != null && output__oPitchAccelerationRef.eIsProxy()) {
			...
			if (output__oPitchAccelerationRef != oldOutput__oPitchAccelerationRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_ACCELERATION_REF, oldOutput__oPitchAccelerationRef, output__oPitchAccelerationRef));
			}
		}
	...
	public void setOutput__oPitchAccelerationRef(WTCOutput newOutput__oPitchAccelerationRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_ACCELERATION_REF, oldOutput__oPitchAccelerationRef, output__oPitchAccelerationRef));
	}
	...
	public WTCOutput getOutput__oPitchStopCommand() {
		if (output__oPitchStopCommand != null && output__oPitchStopCommand.eIsProxy()) {
			...
			if (output__oPitchStopCommand != oldOutput__oPitchStopCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_STOP_COMMAND, oldOutput__oPitchStopCommand, output__oPitchStopCommand));
			}
		}
	...
	public void setOutput__oPitchStopCommand(WTCOutput newOutput__oPitchStopCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__OUTPUT_OPITCH_STOP_COMMAND, oldOutput__oPitchStopCommand, output__oPitchStopCommand));
	}
	...
	public WTCParam getParameter__pGeneratorSpeed() {
		if (parameter__pGeneratorSpeed != null && parameter__pGeneratorSpeed.eIsProxy()) {
			...
			if (parameter__pGeneratorSpeed != oldParameter__pGeneratorSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__PARAMETER_PGENERATOR_SPEED, oldParameter__pGeneratorSpeed, parameter__pGeneratorSpeed));
			}
		}
	...
	public void setParameter__pGeneratorSpeed(WTCParam newParameter__pGeneratorSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__PARAMETER_PGENERATOR_SPEED, oldParameter__pGeneratorSpeed, parameter__pGeneratorSpeed));
	}
	...
	public WTCParam getParameter__pPitchBrakeAngle() {
		if (parameter__pPitchBrakeAngle != null && parameter__pPitchBrakeAngle.eIsProxy()) {
			...
			if (parameter__pPitchBrakeAngle != oldParameter__pPitchBrakeAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__PARAMETER_PPITCH_BRAKE_ANGLE, oldParameter__pPitchBrakeAngle, parameter__pPitchBrakeAngle));
			}
		}
	...
	public void setParameter__pPitchBrakeAngle(WTCParam newParameter__pPitchBrakeAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__PARAMETER_PPITCH_BRAKE_ANGLE, oldParameter__pPitchBrakeAngle, parameter__pPitchBrakeAngle));
	}
	...
	public WTCParam getParameter__pPitchStdSpeed() {
		if (parameter__pPitchStdSpeed != null && parameter__pPitchStdSpeed.eIsProxy()) {
			...
			if (parameter__pPitchStdSpeed != oldParameter__pPitchStdSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__PARAMETER_PPITCH_STD_SPEED, oldParameter__pPitchStdSpeed, parameter__pPitchStdSpeed));
			}
		}
	...
	public void setParameter__pPitchStdSpeed(WTCParam newParameter__pPitchStdSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__PARAMETER_PPITCH_STD_SPEED, oldParameter__pPitchStdSpeed, parameter__pPitchStdSpeed));
	}
	...
	public WTCParam getParameter__pPitchStdAcceleration() {
		if (parameter__pPitchStdAcceleration != null && parameter__pPitchStdAcceleration.eIsProxy()) {
			...
			if (parameter__pPitchStdAcceleration != oldParameter__pPitchStdAcceleration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__PARAMETER_PPITCH_STD_ACCELERATION, oldParameter__pPitchStdAcceleration, parameter__pPitchStdAcceleration));
			}
		}
	...
	public void setParameter__pPitchStdAcceleration(WTCParam newParameter__pPitchStdAcceleration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__PARAMETER_PPITCH_STD_ACCELERATION, oldParameter__pPitchStdAcceleration, parameter__pPitchStdAcceleration));
	}
	...
	public WTCFault getFault__fManualStop() {
		if (fault__fManualStop != null && fault__fManualStop.eIsProxy()) {
			...
			if (fault__fManualStop != oldFault__fManualStop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__FAULT_FMANUAL_STOP, oldFault__fManualStop, fault__fManualStop));
			}
		}
	...
	public void setFault__fManualStop(WTCFault newFault__fManualStop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__FAULT_FMANUAL_STOP, oldFault__fManualStop, fault__fManualStop));
	}
	...
	public WTCTimer getTimer__tMaxStopOperationLength() {
		if (timer__tMaxStopOperationLength != null && timer__tMaxStopOperationLength.eIsProxy()) {
			...
			if (timer__tMaxStopOperationLength != oldTimer__tMaxStopOperationLength) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__TIMER_TMAX_STOP_OPERATION_LENGTH, oldTimer__tMaxStopOperationLength, timer__tMaxStopOperationLength));
			}
		}
	...
	public void setTimer__tMaxStopOperationLength(WTCTimer newTimer__tMaxStopOperationLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__TIMER_TMAX_STOP_OPERATION_LENGTH, oldTimer__tMaxStopOperationLength, timer__tMaxStopOperationLength));
	}
	...
	public WTCErrorReaction getErrorReaction__erStop() {
		if (errorReaction__erStop != null && errorReaction__erStop.eIsProxy()) {
			...
			if (errorReaction__erStop != oldErrorReaction__erStop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT89__ERROR_REACTION_ER_STOP, oldErrorReaction__erStop, errorReaction__erStop));
			}
		}
	...
	public void setErrorReaction__erStop(WTCErrorReaction newErrorReaction__erStop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT89__ERROR_REACTION_ER_STOP, oldErrorReaction__erStop, errorReaction__erStop));
	}

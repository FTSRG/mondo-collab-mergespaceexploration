 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit119Impl#getInput__iManualYawBrakePreCommand <em>Input iManual Yaw Brake Pre Command</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit119Impl#getInput__iAutoYawBrakePreCommand <em>Input iAuto Yaw Brake Pre Command</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit119Impl#getOutput__oYawBrakeCommand <em>Output oYaw Brake Command</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit119Impl extends wtcImpl implements CtrlUnit119 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit119();
	}
		...
		if (input__iManualYawBrakePreCommand != null && input__iManualYawBrakePreCommand.eIsProxy()) {
			...
			if (input__iManualYawBrakePreCommand != oldInput__iManualYawBrakePreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT119__INPUT_IMANUAL_YAW_BRAKE_PRE_COMMAND, oldInput__iManualYawBrakePreCommand, input__iManualYawBrakePreCommand));
			}
		}
	...
	public void setInput__iManualYawBrakePreCommand(WTCInput newInput__iManualYawBrakePreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT119__INPUT_IMANUAL_YAW_BRAKE_PRE_COMMAND, oldInput__iManualYawBrakePreCommand, input__iManualYawBrakePreCommand));
	}
	...
	public WTCInput getInput__iAutoYawBrakePreCommand() {
		if (input__iAutoYawBrakePreCommand != null && input__iAutoYawBrakePreCommand.eIsProxy()) {
			...
			if (input__iAutoYawBrakePreCommand != oldInput__iAutoYawBrakePreCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT119__INPUT_IAUTO_YAW_BRAKE_PRE_COMMAND, oldInput__iAutoYawBrakePreCommand, input__iAutoYawBrakePreCommand));
			}
		}
	...
	public void setInput__iAutoYawBrakePreCommand(WTCInput newInput__iAutoYawBrakePreCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT119__INPUT_IAUTO_YAW_BRAKE_PRE_COMMAND, oldInput__iAutoYawBrakePreCommand, input__iAutoYawBrakePreCommand));
	}
	...
	public WTCOutput getOutput__oYawBrakeCommand() {
		if (output__oYawBrakeCommand != null && output__oYawBrakeCommand.eIsProxy()) {
			...
			if (output__oYawBrakeCommand != oldOutput__oYawBrakeCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT119__OUTPUT_OYAW_BRAKE_COMMAND, oldOutput__oYawBrakeCommand, output__oYawBrakeCommand));
			}
		}
	...
	public void setOutput__oYawBrakeCommand(WTCOutput newOutput__oYawBrakeCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT119__OUTPUT_OYAW_BRAKE_COMMAND, oldOutput__oYawBrakeCommand, output__oYawBrakeCommand));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WTSpecIDPackage.CTRL_UNIT119__INPUT_IMANUAL_YAW_BRAKE_PRE_COMMAND:
				if (resolve) return getInput__iManualYawBrakePreCommand();
				return basicGetInput__iManualYawBrakePreCommand();
			case WTSpecIDPackage.CTRL_UNIT119__INPUT_IAUTO_YAW_BRAKE_PRE_COMMAND:
				if (resolve) return getInput__iAutoYawBrakePreCommand();
				return basicGetInput__iAutoYawBrakePreCommand();
			case WTSpecIDPackage.CTRL_UNIT119__OUTPUT_OYAW_BRAKE_COMMAND:

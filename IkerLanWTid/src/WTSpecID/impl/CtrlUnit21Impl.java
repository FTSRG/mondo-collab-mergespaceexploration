 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit21Impl#getInput__iWindDirection <em>Input iWind Direction</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit21Impl#getInput__iFlagBrakes <em>Input iFlag Brakes</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit21Impl#getInput__iFlagIntoWind <em>Input iFlag Into Wind</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit21Impl#getOutput__oBackWindDetected <em>Output oBack Wind Detected</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit21Impl#getParameter__pMaxAbsoluteAngle <em>Parameter pMax Absolute Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit21Impl extends wtcImpl implements CtrlUnit21 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit21();
	}
		...
		if (input__iWindDirection != null && input__iWindDirection.eIsProxy()) {
			...
			if (input__iWindDirection != oldInput__iWindDirection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT21__INPUT_IWIND_DIRECTION, oldInput__iWindDirection, input__iWindDirection));
			}
		}
	...
	public void setInput__iWindDirection(WTCInput newInput__iWindDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT21__INPUT_IWIND_DIRECTION, oldInput__iWindDirection, input__iWindDirection));
	}
	...
	public WTCInput getInput__iFlagBrakes() {
		if (input__iFlagBrakes != null && input__iFlagBrakes.eIsProxy()) {
			...
			if (input__iFlagBrakes != oldInput__iFlagBrakes) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT21__INPUT_IFLAG_BRAKES, oldInput__iFlagBrakes, input__iFlagBrakes));
			}
		}
	...
	public void setInput__iFlagBrakes(WTCInput newInput__iFlagBrakes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT21__INPUT_IFLAG_BRAKES, oldInput__iFlagBrakes, input__iFlagBrakes));
	}
	...
	public WTCInput getInput__iFlagIntoWind() {
		if (input__iFlagIntoWind != null && input__iFlagIntoWind.eIsProxy()) {
			...
			if (input__iFlagIntoWind != oldInput__iFlagIntoWind) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT21__INPUT_IFLAG_INTO_WIND, oldInput__iFlagIntoWind, input__iFlagIntoWind));
			}
		}
	...
	public void setInput__iFlagIntoWind(WTCInput newInput__iFlagIntoWind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT21__INPUT_IFLAG_INTO_WIND, oldInput__iFlagIntoWind, input__iFlagIntoWind));
	}
	...
	public WTCOutput getOutput__oBackWindDetected() {
		if (output__oBackWindDetected != null && output__oBackWindDetected.eIsProxy()) {
			...
			if (output__oBackWindDetected != oldOutput__oBackWindDetected) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT21__OUTPUT_OBACK_WIND_DETECTED, oldOutput__oBackWindDetected, output__oBackWindDetected));
			}
		}
	...
	public void setOutput__oBackWindDetected(WTCOutput newOutput__oBackWindDetected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT21__OUTPUT_OBACK_WIND_DETECTED, oldOutput__oBackWindDetected, output__oBackWindDetected));
	}
	...
	public WTCParam getParameter__pMaxAbsoluteAngle() {
		if (parameter__pMaxAbsoluteAngle != null && parameter__pMaxAbsoluteAngle.eIsProxy()) {
			...
			if (parameter__pMaxAbsoluteAngle != oldParameter__pMaxAbsoluteAngle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT21__PARAMETER_PMAX_ABSOLUTE_ANGLE, oldParameter__pMaxAbsoluteAngle, parameter__pMaxAbsoluteAngle));
			}
		}
	...
	public void setParameter__pMaxAbsoluteAngle(WTCParam newParameter__pMaxAbsoluteAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT21__PARAMETER_PMAX_ABSOLUTE_ANGLE, oldParameter__pMaxAbsoluteAngle, parameter__pMaxAbsoluteAngle));
	}

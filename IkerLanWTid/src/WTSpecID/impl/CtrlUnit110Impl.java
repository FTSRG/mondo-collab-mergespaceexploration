 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit110Impl#getInput__iManualStopRequest <em>Input iManual Stop Request</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit110Impl#getInput__iRemoteStopRequest <em>Input iRemote Stop Request</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit110Impl#getInput__iManualStartRequest <em>Input iManual Start Request</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit110Impl#getInput__iRemoteStartRequest <em>Input iRemote Start Request</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit110Impl#getInput__iStopped <em>Input iStopped</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit110Impl#getOutput__oMachineStopOrder <em>Output oMachine Stop Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit110Impl extends wtcImpl implements CtrlUnit110 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit110();
	}
		...
		if (input__iManualStopRequest != null && input__iManualStopRequest.eIsProxy()) {
			...
			if (input__iManualStopRequest != oldInput__iManualStopRequest) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT110__INPUT_IMANUAL_STOP_REQUEST, oldInput__iManualStopRequest, input__iManualStopRequest));
			}
		}
	...
	public void setInput__iManualStopRequest(WTCInput newInput__iManualStopRequest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT110__INPUT_IMANUAL_STOP_REQUEST, oldInput__iManualStopRequest, input__iManualStopRequest));
	}
	...
	public WTCInput getInput__iRemoteStopRequest() {
		if (input__iRemoteStopRequest != null && input__iRemoteStopRequest.eIsProxy()) {
			...
			if (input__iRemoteStopRequest != oldInput__iRemoteStopRequest) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT110__INPUT_IREMOTE_STOP_REQUEST, oldInput__iRemoteStopRequest, input__iRemoteStopRequest));
			}
		}
	...
	public void setInput__iRemoteStopRequest(WTCInput newInput__iRemoteStopRequest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT110__INPUT_IREMOTE_STOP_REQUEST, oldInput__iRemoteStopRequest, input__iRemoteStopRequest));
	}
	...
	public WTCInput getInput__iManualStartRequest() {
		if (input__iManualStartRequest != null && input__iManualStartRequest.eIsProxy()) {
			...
			if (input__iManualStartRequest != oldInput__iManualStartRequest) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT110__INPUT_IMANUAL_START_REQUEST, oldInput__iManualStartRequest, input__iManualStartRequest));
			}
		}
	...
	public void setInput__iManualStartRequest(WTCInput newInput__iManualStartRequest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT110__INPUT_IMANUAL_START_REQUEST, oldInput__iManualStartRequest, input__iManualStartRequest));
	}
	...
	public WTCInput getInput__iRemoteStartRequest() {
		if (input__iRemoteStartRequest != null && input__iRemoteStartRequest.eIsProxy()) {
			...
			if (input__iRemoteStartRequest != oldInput__iRemoteStartRequest) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT110__INPUT_IREMOTE_START_REQUEST, oldInput__iRemoteStartRequest, input__iRemoteStartRequest));
			}
		}
	...
	public void setInput__iRemoteStartRequest(WTCInput newInput__iRemoteStartRequest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT110__INPUT_IREMOTE_START_REQUEST, oldInput__iRemoteStartRequest, input__iRemoteStartRequest));
	}
	...
	public WTCInput getInput__iStopped() {
		if (input__iStopped != null && input__iStopped.eIsProxy()) {
			...
			if (input__iStopped != oldInput__iStopped) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT110__INPUT_ISTOPPED, oldInput__iStopped, input__iStopped));
			}
		}
	...
	public void setInput__iStopped(WTCInput newInput__iStopped) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT110__INPUT_ISTOPPED, oldInput__iStopped, input__iStopped));
	}
	...
	public WTCOutput getOutput__oMachineStopOrder() {
		if (output__oMachineStopOrder != null && output__oMachineStopOrder.eIsProxy()) {
			...
			if (output__oMachineStopOrder != oldOutput__oMachineStopOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT110__OUTPUT_OMACHINE_STOP_ORDER, oldOutput__oMachineStopOrder, output__oMachineStopOrder));
			}
		}
	...
	public void setOutput__oMachineStopOrder(WTCOutput newOutput__oMachineStopOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT110__OUTPUT_OMACHINE_STOP_ORDER, oldOutput__oMachineStopOrder, output__oMachineStopOrder));
	}

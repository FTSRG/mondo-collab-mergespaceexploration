 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit113Impl#getInput__iWindSpeed <em>Input iWind Speed</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit113Impl#getInput__iWindSpeedAverage <em>Input iWind Speed Average</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit113Impl#getOutput__oExcessiveWindAcceleration <em>Output oExcessive Wind Acceleration</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit113Impl#getParameter__pConsideredTime <em>Parameter pConsidered Time</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit113Impl#getParameter__pWindAccelerationLimit <em>Parameter pWind Acceleration Limit</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit113Impl#getParameter__pHiWindLimitReset <em>Parameter pHi Wind Limit Reset</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit113Impl#getParameter__pMaxAbsoluteWindSpeed <em>Parameter pMax Absolute Wind Speed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit113Impl extends wtcImpl implements CtrlUnit113 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit113();
	}
		...
		if (input__iWindSpeed != null && input__iWindSpeed.eIsProxy()) {
			...
			if (input__iWindSpeed != oldInput__iWindSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT113__INPUT_IWIND_SPEED, oldInput__iWindSpeed, input__iWindSpeed));
			}
		}
	...
	public void setInput__iWindSpeed(WTCInput newInput__iWindSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT113__INPUT_IWIND_SPEED, oldInput__iWindSpeed, input__iWindSpeed));
	}
	...
	public WTCInput getInput__iWindSpeedAverage() {
		if (input__iWindSpeedAverage != null && input__iWindSpeedAverage.eIsProxy()) {
			...
			if (input__iWindSpeedAverage != oldInput__iWindSpeedAverage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT113__INPUT_IWIND_SPEED_AVERAGE, oldInput__iWindSpeedAverage, input__iWindSpeedAverage));
			}
		}
	...
	public void setInput__iWindSpeedAverage(WTCInput newInput__iWindSpeedAverage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT113__INPUT_IWIND_SPEED_AVERAGE, oldInput__iWindSpeedAverage, input__iWindSpeedAverage));
	}
	...
	public WTCOutput getOutput__oExcessiveWindAcceleration() {
		if (output__oExcessiveWindAcceleration != null && output__oExcessiveWindAcceleration.eIsProxy()) {
			...
			if (output__oExcessiveWindAcceleration != oldOutput__oExcessiveWindAcceleration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT113__OUTPUT_OEXCESSIVE_WIND_ACCELERATION, oldOutput__oExcessiveWindAcceleration, output__oExcessiveWindAcceleration));
			}
		}
	...
	public void setOutput__oExcessiveWindAcceleration(WTCOutput newOutput__oExcessiveWindAcceleration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT113__OUTPUT_OEXCESSIVE_WIND_ACCELERATION, oldOutput__oExcessiveWindAcceleration, output__oExcessiveWindAcceleration));
	}
	...
	public WTCParam getParameter__pConsideredTime() {
		if (parameter__pConsideredTime != null && parameter__pConsideredTime.eIsProxy()) {
			...
			if (parameter__pConsideredTime != oldParameter__pConsideredTime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT113__PARAMETER_PCONSIDERED_TIME, oldParameter__pConsideredTime, parameter__pConsideredTime));
			}
		}
	...
	public void setParameter__pConsideredTime(WTCParam newParameter__pConsideredTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT113__PARAMETER_PCONSIDERED_TIME, oldParameter__pConsideredTime, parameter__pConsideredTime));
	}
	...
	public WTCParam getParameter__pWindAccelerationLimit() {
		if (parameter__pWindAccelerationLimit != null && parameter__pWindAccelerationLimit.eIsProxy()) {
			...
			if (parameter__pWindAccelerationLimit != oldParameter__pWindAccelerationLimit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT113__PARAMETER_PWIND_ACCELERATION_LIMIT, oldParameter__pWindAccelerationLimit, parameter__pWindAccelerationLimit));
			}
		}
	...
	public void setParameter__pWindAccelerationLimit(WTCParam newParameter__pWindAccelerationLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT113__PARAMETER_PWIND_ACCELERATION_LIMIT, oldParameter__pWindAccelerationLimit, parameter__pWindAccelerationLimit));
	}
	...
	public WTCParam getParameter__pHiWindLimitReset() {
		if (parameter__pHiWindLimitReset != null && parameter__pHiWindLimitReset.eIsProxy()) {
			...
			if (parameter__pHiWindLimitReset != oldParameter__pHiWindLimitReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT113__PARAMETER_PHI_WIND_LIMIT_RESET, oldParameter__pHiWindLimitReset, parameter__pHiWindLimitReset));
			}
		}
	...
	public void setParameter__pHiWindLimitReset(WTCParam newParameter__pHiWindLimitReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT113__PARAMETER_PHI_WIND_LIMIT_RESET, oldParameter__pHiWindLimitReset, parameter__pHiWindLimitReset));
	}
	...
	public WTCParam getParameter__pMaxAbsoluteWindSpeed() {
		if (parameter__pMaxAbsoluteWindSpeed != null && parameter__pMaxAbsoluteWindSpeed.eIsProxy()) {
			...
			if (parameter__pMaxAbsoluteWindSpeed != oldParameter__pMaxAbsoluteWindSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT113__PARAMETER_PMAX_ABSOLUTE_WIND_SPEED, oldParameter__pMaxAbsoluteWindSpeed, parameter__pMaxAbsoluteWindSpeed));
			}
		}
	...
	public void setParameter__pMaxAbsoluteWindSpeed(WTCParam newParameter__pMaxAbsoluteWindSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT113__PARAMETER_PMAX_ABSOLUTE_WIND_SPEED, oldParameter__pMaxAbsoluteWindSpeed, parameter__pMaxAbsoluteWindSpeed));
	}

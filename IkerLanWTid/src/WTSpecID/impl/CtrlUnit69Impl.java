 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit69Impl#getInput__iLocalMaxPower <em>Input iLocal Max Power</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit69Impl#getInput__iRemoteMaxPower <em>Input iRemote Max Power</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit69Impl#getInput__iTorqueControlMaxPower <em>Input iTorque Control Max Power</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit69Impl#getOutput__oMaxPower <em>Output oMax Power</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit69Impl#getParameter__pMaxPower <em>Parameter pMax Power</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit69Impl extends wtcImpl implements CtrlUnit69 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit69();
	}
		...
		if (input__iLocalMaxPower != null && input__iLocalMaxPower.eIsProxy()) {
			...
			if (input__iLocalMaxPower != oldInput__iLocalMaxPower) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT69__INPUT_ILOCAL_MAX_POWER, oldInput__iLocalMaxPower, input__iLocalMaxPower));
			}
		}
	...
	public void setInput__iLocalMaxPower(WTCInput newInput__iLocalMaxPower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT69__INPUT_ILOCAL_MAX_POWER, oldInput__iLocalMaxPower, input__iLocalMaxPower));
	}
	...
	public WTCInput getInput__iRemoteMaxPower() {
		if (input__iRemoteMaxPower != null && input__iRemoteMaxPower.eIsProxy()) {
			...
			if (input__iRemoteMaxPower != oldInput__iRemoteMaxPower) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT69__INPUT_IREMOTE_MAX_POWER, oldInput__iRemoteMaxPower, input__iRemoteMaxPower));
			}
		}
	...
	public void setInput__iRemoteMaxPower(WTCInput newInput__iRemoteMaxPower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT69__INPUT_IREMOTE_MAX_POWER, oldInput__iRemoteMaxPower, input__iRemoteMaxPower));
	}
	...
	public WTCInput getInput__iTorqueControlMaxPower() {
		if (input__iTorqueControlMaxPower != null && input__iTorqueControlMaxPower.eIsProxy()) {
			...
			if (input__iTorqueControlMaxPower != oldInput__iTorqueControlMaxPower) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT69__INPUT_ITORQUE_CONTROL_MAX_POWER, oldInput__iTorqueControlMaxPower, input__iTorqueControlMaxPower));
			}
		}
	...
	public void setInput__iTorqueControlMaxPower(WTCInput newInput__iTorqueControlMaxPower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT69__INPUT_ITORQUE_CONTROL_MAX_POWER, oldInput__iTorqueControlMaxPower, input__iTorqueControlMaxPower));
	}
	...
	public WTCOutput getOutput__oMaxPower() {
		if (output__oMaxPower != null && output__oMaxPower.eIsProxy()) {
			...
			if (output__oMaxPower != oldOutput__oMaxPower) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT69__OUTPUT_OMAX_POWER, oldOutput__oMaxPower, output__oMaxPower));
			}
		}
	...
	public void setOutput__oMaxPower(WTCOutput newOutput__oMaxPower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT69__OUTPUT_OMAX_POWER, oldOutput__oMaxPower, output__oMaxPower));
	}
	...
	public WTCParam getParameter__pMaxPower() {
		if (parameter__pMaxPower != null && parameter__pMaxPower.eIsProxy()) {
			...
			if (parameter__pMaxPower != oldParameter__pMaxPower) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT69__PARAMETER_PMAX_POWER, oldParameter__pMaxPower, parameter__pMaxPower));
			}
		}
	...
	public void setParameter__pMaxPower(WTCParam newParameter__pMaxPower) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT69__PARAMETER_PMAX_POWER, oldParameter__pMaxPower, parameter__pMaxPower));
	}

 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit97Impl#getInput__iSafetyLineGeneralStatus <em>Input iSafety Line General Status</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit97Impl#getOutput__oDontCheckEmergency <em>Output oDont Check Emergency</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit97Impl#getFault__fSecLoopOff <em>Fault fSec Loop Off</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit97Impl extends wtcImpl implements CtrlUnit97 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit97();
	}
		...
		if (input__iSafetyLineGeneralStatus != null && input__iSafetyLineGeneralStatus.eIsProxy()) {
			...
			if (input__iSafetyLineGeneralStatus != oldInput__iSafetyLineGeneralStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT97__INPUT_ISAFETY_LINE_GENERAL_STATUS, oldInput__iSafetyLineGeneralStatus, input__iSafetyLineGeneralStatus));
			}
		}
	...
	public void setInput__iSafetyLineGeneralStatus(WTCInput newInput__iSafetyLineGeneralStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT97__INPUT_ISAFETY_LINE_GENERAL_STATUS, oldInput__iSafetyLineGeneralStatus, input__iSafetyLineGeneralStatus));
	}
	...
	public WTCOutput getOutput__oDontCheckEmergency() {
		if (output__oDontCheckEmergency != null && output__oDontCheckEmergency.eIsProxy()) {
			...
			if (output__oDontCheckEmergency != oldOutput__oDontCheckEmergency) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT97__OUTPUT_ODONT_CHECK_EMERGENCY, oldOutput__oDontCheckEmergency, output__oDontCheckEmergency));
			}
		}
	...
	public void setOutput__oDontCheckEmergency(WTCOutput newOutput__oDontCheckEmergency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT97__OUTPUT_ODONT_CHECK_EMERGENCY, oldOutput__oDontCheckEmergency, output__oDontCheckEmergency));
	}
	...
	public WTCFault getFault__fSecLoopOff() {
		if (fault__fSecLoopOff != null && fault__fSecLoopOff.eIsProxy()) {
			...
			if (fault__fSecLoopOff != oldFault__fSecLoopOff) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT97__FAULT_FSEC_LOOP_OFF, oldFault__fSecLoopOff, fault__fSecLoopOff));
			}
		}
	...
	public void setFault__fSecLoopOff(WTCFault newFault__fSecLoopOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT97__FAULT_FSEC_LOOP_OFF, oldFault__fSecLoopOff, fault__fSecLoopOff));
	}

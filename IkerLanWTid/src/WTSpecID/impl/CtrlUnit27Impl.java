 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit27Impl#getInput__iOrder <em>Input iOrder</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit27Impl#getInput__iFailure <em>Input iFailure</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit27Impl#getOutput__oOrder <em>Output oOrder</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit27Impl#getOutput__oCounter <em>Output oCounter</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit27Impl#getParameter__pMaxCount <em>Parameter pMax Count</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit27Impl extends wtcImpl implements CtrlUnit27 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit27();
	}
		...
		if (input__iOrder != null && input__iOrder.eIsProxy()) {
			...
			if (input__iOrder != oldInput__iOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT27__INPUT_IORDER, oldInput__iOrder, input__iOrder));
			}
		}
	...
	public void setInput__iOrder(WTCInput newInput__iOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT27__INPUT_IORDER, oldInput__iOrder, input__iOrder));
	}
	...
	public WTCInput getInput__iFailure() {
		if (input__iFailure != null && input__iFailure.eIsProxy()) {
			...
			if (input__iFailure != oldInput__iFailure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT27__INPUT_IFAILURE, oldInput__iFailure, input__iFailure));
			}
		}
	...
	public void setInput__iFailure(WTCInput newInput__iFailure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT27__INPUT_IFAILURE, oldInput__iFailure, input__iFailure));
	}
	...
	public WTCOutput getOutput__oOrder() {
		if (output__oOrder != null && output__oOrder.eIsProxy()) {
			...
			if (output__oOrder != oldOutput__oOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT27__OUTPUT_OORDER, oldOutput__oOrder, output__oOrder));
			}
		}
	...
	public void setOutput__oOrder(WTCOutput newOutput__oOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT27__OUTPUT_OORDER, oldOutput__oOrder, output__oOrder));
	}
	...
	public WTCOutput getOutput__oCounter() {
		if (output__oCounter != null && output__oCounter.eIsProxy()) {
			...
			if (output__oCounter != oldOutput__oCounter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT27__OUTPUT_OCOUNTER, oldOutput__oCounter, output__oCounter));
			}
		}
	...
	public void setOutput__oCounter(WTCOutput newOutput__oCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT27__OUTPUT_OCOUNTER, oldOutput__oCounter, output__oCounter));
	}
	...
	public WTCParam getParameter__pMaxCount() {
		if (parameter__pMaxCount != null && parameter__pMaxCount.eIsProxy()) {
			...
			if (parameter__pMaxCount != oldParameter__pMaxCount) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT27__PARAMETER_PMAX_COUNT, oldParameter__pMaxCount, parameter__pMaxCount));
			}
		}
	...
	public void setParameter__pMaxCount(WTCParam newParameter__pMaxCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT27__PARAMETER_PMAX_COUNT, oldParameter__pMaxCount, parameter__pMaxCount));
	}

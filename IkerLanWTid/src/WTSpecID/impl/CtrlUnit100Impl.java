 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit100Impl#getInput__iPinPosition <em>Input iPin Position</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit100Impl#getOutput__oPinSafetyCmd <em>Output oPin Safety Cmd</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit100Impl#getParameter__pPinNoBackPos <em>Parameter pPin No Back Pos</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit100Impl#getParameter__pPinExtendedPos <em>Parameter pPin Extended Pos</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit100Impl#getParameter__pPinRetractedPos <em>Parameter pPin Retracted Pos</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit100Impl#getParameter__pPinHysteresis <em>Parameter pPin Hysteresis</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit100Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit100Impl extends wtcImpl implements CtrlUnit100 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit100();
	}
		...
		if (input__iPinPosition != null && input__iPinPosition.eIsProxy()) {
			...
			if (input__iPinPosition != oldInput__iPinPosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT100__INPUT_IPIN_POSITION, oldInput__iPinPosition, input__iPinPosition));
			}
		}
	...
	public void setInput__iPinPosition(WTCInput newInput__iPinPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT100__INPUT_IPIN_POSITION, oldInput__iPinPosition, input__iPinPosition));
	}
	...
	public WTCOutput getOutput__oPinSafetyCmd() {
		if (output__oPinSafetyCmd != null && output__oPinSafetyCmd.eIsProxy()) {
			...
			if (output__oPinSafetyCmd != oldOutput__oPinSafetyCmd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT100__OUTPUT_OPIN_SAFETY_CMD, oldOutput__oPinSafetyCmd, output__oPinSafetyCmd));
			}
		}
	...
	public void setOutput__oPinSafetyCmd(WTCOutput newOutput__oPinSafetyCmd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT100__OUTPUT_OPIN_SAFETY_CMD, oldOutput__oPinSafetyCmd, output__oPinSafetyCmd));
	}
	...
	public WTCParam getParameter__pPinNoBackPos() {
		if (parameter__pPinNoBackPos != null && parameter__pPinNoBackPos.eIsProxy()) {
			...
			if (parameter__pPinNoBackPos != oldParameter__pPinNoBackPos) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT100__PARAMETER_PPIN_NO_BACK_POS, oldParameter__pPinNoBackPos, parameter__pPinNoBackPos));
			}
		}
	...
	public void setParameter__pPinNoBackPos(WTCParam newParameter__pPinNoBackPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT100__PARAMETER_PPIN_NO_BACK_POS, oldParameter__pPinNoBackPos, parameter__pPinNoBackPos));
	}
	...
	public WTCParam getParameter__pPinExtendedPos() {
		if (parameter__pPinExtendedPos != null && parameter__pPinExtendedPos.eIsProxy()) {
			...
			if (parameter__pPinExtendedPos != oldParameter__pPinExtendedPos) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT100__PARAMETER_PPIN_EXTENDED_POS, oldParameter__pPinExtendedPos, parameter__pPinExtendedPos));
			}
		}
	...
	public void setParameter__pPinExtendedPos(WTCParam newParameter__pPinExtendedPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT100__PARAMETER_PPIN_EXTENDED_POS, oldParameter__pPinExtendedPos, parameter__pPinExtendedPos));
	}
	...
	public WTCParam getParameter__pPinRetractedPos() {
		if (parameter__pPinRetractedPos != null && parameter__pPinRetractedPos.eIsProxy()) {
			...
			if (parameter__pPinRetractedPos != oldParameter__pPinRetractedPos) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT100__PARAMETER_PPIN_RETRACTED_POS, oldParameter__pPinRetractedPos, parameter__pPinRetractedPos));
			}
		}
	...
	public void setParameter__pPinRetractedPos(WTCParam newParameter__pPinRetractedPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT100__PARAMETER_PPIN_RETRACTED_POS, oldParameter__pPinRetractedPos, parameter__pPinRetractedPos));
	}
	...
	public WTCParam getParameter__pPinHysteresis() {
		if (parameter__pPinHysteresis != null && parameter__pPinHysteresis.eIsProxy()) {
			...
			if (parameter__pPinHysteresis != oldParameter__pPinHysteresis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT100__PARAMETER_PPIN_HYSTERESIS, oldParameter__pPinHysteresis, parameter__pPinHysteresis));
			}
		}
	...
	public void setParameter__pPinHysteresis(WTCParam newParameter__pPinHysteresis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT100__PARAMETER_PPIN_HYSTERESIS, oldParameter__pPinHysteresis, parameter__pPinHysteresis));
	}
	...
	public void setBhvParam__bpMode(String newBhvParam__bpMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT100__BHV_PARAM_BP_MODE, oldBhvParam__bpMode, bhvParam__bpMode));
	}

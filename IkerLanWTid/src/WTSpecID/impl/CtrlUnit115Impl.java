 ...
 * <ul>
 *   <li>{@link WTSpecID.impl.CtrlUnit115Impl#getInput__iWindSpeedRaw <em>Input iWind Speed Raw</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit115Impl#getOutput__oWindSpeed <em>Output oWind Speed</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit115Impl#getOutput__oWindSpeedAverage <em>Output oWind Speed Average</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit115Impl#getParameter__pNacelleSlope <em>Parameter pNacelle Slope</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit115Impl#getParameter__pNacelleOffset <em>Parameter pNacelle Offset</em>}</li>
 *   <li>{@link WTSpecID.impl.CtrlUnit115Impl#getParameter__pWindSpeedAveragePeriod <em>Parameter pWind Speed Average Period</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit115Impl extends wtcImpl implements CtrlUnit115 {
	...
	protected EClass eStaticClass() {
		return WTSpecIDPackage.eINSTANCE.getCtrlUnit115();
	}
		...
		if (input__iWindSpeedRaw != null && input__iWindSpeedRaw.eIsProxy()) {
			...
			if (input__iWindSpeedRaw != oldInput__iWindSpeedRaw) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT115__INPUT_IWIND_SPEED_RAW, oldInput__iWindSpeedRaw, input__iWindSpeedRaw));
			}
		}
	...
	public void setInput__iWindSpeedRaw(WTCInput newInput__iWindSpeedRaw) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT115__INPUT_IWIND_SPEED_RAW, oldInput__iWindSpeedRaw, input__iWindSpeedRaw));
	}
	...
	public WTCOutput getOutput__oWindSpeed() {
		if (output__oWindSpeed != null && output__oWindSpeed.eIsProxy()) {
			...
			if (output__oWindSpeed != oldOutput__oWindSpeed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT115__OUTPUT_OWIND_SPEED, oldOutput__oWindSpeed, output__oWindSpeed));
			}
		}
	...
	public void setOutput__oWindSpeed(WTCOutput newOutput__oWindSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT115__OUTPUT_OWIND_SPEED, oldOutput__oWindSpeed, output__oWindSpeed));
	}
	...
	public WTCOutput getOutput__oWindSpeedAverage() {
		if (output__oWindSpeedAverage != null && output__oWindSpeedAverage.eIsProxy()) {
			...
			if (output__oWindSpeedAverage != oldOutput__oWindSpeedAverage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT115__OUTPUT_OWIND_SPEED_AVERAGE, oldOutput__oWindSpeedAverage, output__oWindSpeedAverage));
			}
		}
	...
	public void setOutput__oWindSpeedAverage(WTCOutput newOutput__oWindSpeedAverage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT115__OUTPUT_OWIND_SPEED_AVERAGE, oldOutput__oWindSpeedAverage, output__oWindSpeedAverage));
	}
	...
	public WTCParam getParameter__pNacelleSlope() {
		if (parameter__pNacelleSlope != null && parameter__pNacelleSlope.eIsProxy()) {
			...
			if (parameter__pNacelleSlope != oldParameter__pNacelleSlope) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT115__PARAMETER_PNACELLE_SLOPE, oldParameter__pNacelleSlope, parameter__pNacelleSlope));
			}
		}
	...
	public void setParameter__pNacelleSlope(WTCParam newParameter__pNacelleSlope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT115__PARAMETER_PNACELLE_SLOPE, oldParameter__pNacelleSlope, parameter__pNacelleSlope));
	}
	...
	public WTCParam getParameter__pNacelleOffset() {
		if (parameter__pNacelleOffset != null && parameter__pNacelleOffset.eIsProxy()) {
			...
			if (parameter__pNacelleOffset != oldParameter__pNacelleOffset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT115__PARAMETER_PNACELLE_OFFSET, oldParameter__pNacelleOffset, parameter__pNacelleOffset));
			}
		}
	...
	public void setParameter__pNacelleOffset(WTCParam newParameter__pNacelleOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT115__PARAMETER_PNACELLE_OFFSET, oldParameter__pNacelleOffset, parameter__pNacelleOffset));
	}
	...
	public WTCParam getParameter__pWindSpeedAveragePeriod() {
		if (parameter__pWindSpeedAveragePeriod != null && parameter__pWindSpeedAveragePeriod.eIsProxy()) {
			...
			if (parameter__pWindSpeedAveragePeriod != oldParameter__pWindSpeedAveragePeriod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WTSpecIDPackage.CTRL_UNIT115__PARAMETER_PWIND_SPEED_AVERAGE_PERIOD, oldParameter__pWindSpeedAveragePeriod, parameter__pWindSpeedAveragePeriod));
			}
		}
	...
	public void setParameter__pWindSpeedAveragePeriod(WTCParam newParameter__pWindSpeedAveragePeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WTSpecIDPackage.CTRL_UNIT115__PARAMETER_PWIND_SPEED_AVERAGE_PERIOD, oldParameter__pWindSpeedAveragePeriod, parameter__pWindSpeedAveragePeriod));
	}

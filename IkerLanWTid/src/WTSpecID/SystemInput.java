 ...
 * <ul>
 *   <li>{@link WTSpecID.SystemInput#getSysId <em>Sys Id</em>}</li>
 * </ul>
 * </p>
 *
 * @see WTSpecID.WTSpecIDPackage#getSystemInput()
 * @model
 * @generated
 */
public interface SystemInput extends WTCInput {
	 ...
	 * @see #setSysId(String)
	 * @see WTSpecID.WTSpecIDPackage#getSystemInput_SysId()
	 * @model
	 * @generated
	 */
	String getSysId();
	...
	/**
	 * Sets the value of the '{@link WTSpecID.SystemInput#getSysId <em>Sys Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->

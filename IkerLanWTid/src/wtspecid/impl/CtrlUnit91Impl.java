 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit91Impl#getInput__iTemp <em>Input iTemp</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit91Impl#getInput__iDontCheckInput <em>Input iDont Check Input</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit91Impl#getInput__iLimitError <em>Input iLimit Error</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit91Impl#getParameter__pLimitReset <em>Parameter pLimit Reset</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit91Impl#getFault__fError <em>Fault fError</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit91Impl#getTimer__tDelay <em>Timer tDelay</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit91Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit91Impl extends wtcImpl implements CtrlUnit91 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit91();
	}
		...
		if (input__iTemp != null && input__iTemp.eIsProxy()) {
			...
			if (input__iTemp != oldInput__iTemp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT91__INPUT_ITEMP, oldInput__iTemp, input__iTemp));
			}
		}
		return input__iTemp;
	}
	...
	public void setInput__iTemp(WTCInput newInput__iTemp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT91__INPUT_ITEMP, oldInput__iTemp, input__iTemp));
	}
	...
	public WTCInput getInput__iDontCheckInput() {
		if (input__iDontCheckInput != null && input__iDontCheckInput.eIsProxy()) {
			...
			if (input__iDontCheckInput != oldInput__iDontCheckInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT91__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
			}
		}
	...
	public void setInput__iDontCheckInput(WTCInput newInput__iDontCheckInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT91__INPUT_IDONT_CHECK_INPUT, oldInput__iDontCheckInput, input__iDontCheckInput));
	}
	...
	public WTCInput getInput__iLimitError() {
		if (input__iLimitError != null && input__iLimitError.eIsProxy()) {
			...
			if (input__iLimitError != oldInput__iLimitError) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT91__INPUT_ILIMIT_ERROR, oldInput__iLimitError, input__iLimitError));
			}
		}
	...
	public void setInput__iLimitError(WTCInput newInput__iLimitError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT91__INPUT_ILIMIT_ERROR, oldInput__iLimitError, input__iLimitError));
	}
	...
	public WTCParam getParameter__pLimitReset() {
		if (parameter__pLimitReset != null && parameter__pLimitReset.eIsProxy()) {
			...
			if (parameter__pLimitReset != oldParameter__pLimitReset) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT91__PARAMETER_PLIMIT_RESET, oldParameter__pLimitReset, parameter__pLimitReset));
			}
		}
	...
	public void setParameter__pLimitReset(WTCParam newParameter__pLimitReset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT91__PARAMETER_PLIMIT_RESET, oldParameter__pLimitReset, parameter__pLimitReset));
	}
	...
	public WTCFault getFault__fError() {
		if (fault__fError != null && fault__fError.eIsProxy()) {
			...
			if (fault__fError != oldFault__fError) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT91__FAULT_FERROR, oldFault__fError, fault__fError));
			}
		}
	...
	public void setFault__fError(WTCFault newFault__fError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT91__FAULT_FERROR, oldFault__fError, fault__fError));
	}
	...
	public WTCTimer getTimer__tDelay() {
		if (timer__tDelay != null && timer__tDelay.eIsProxy()) {
			...
			if (timer__tDelay != oldTimer__tDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT91__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
			}
		}
	...
	public void setTimer__tDelay(WTCTimer newTimer__tDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT91__TIMER_TDELAY, oldTimer__tDelay, timer__tDelay));
	}
	...
	public void setBhvParam__bpMode(String newBhvParam__bpMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT91__BHV_PARAM_BP_MODE, oldBhvParam__bpMode, bhvParam__bpMode));
	}

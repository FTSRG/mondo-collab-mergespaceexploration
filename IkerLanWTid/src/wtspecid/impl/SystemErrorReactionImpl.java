 ...
 * <ul>
 *   <li>{@link wtspecid.impl.SystemErrorReactionImpl#getSysId <em>Sys Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemErrorReactionImpl extends WTCErrorReactionImpl implements SystemErrorReaction {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getSystemErrorReaction();
	}
	...
	public void setSysId(String newSysId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.SYSTEM_ERROR_REACTION__SYS_ID, oldSysId, sysId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.SYSTEM_ERROR_REACTION__SYS_ID:
				return getSysId();
		}

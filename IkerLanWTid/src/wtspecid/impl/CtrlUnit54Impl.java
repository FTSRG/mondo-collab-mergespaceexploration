 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit54Impl#getInput__iSafety <em>Input iSafety</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit54Impl#getInput__iLockingOrderSelected <em>Input iLocking Order Selected</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit54Impl#getInput__iMachineStateL <em>Input iMachine State L</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit54Impl#getInput__iMachineStateU <em>Input iMachine State U</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit54Impl#getInput__iMachineStateS <em>Input iMachine State S</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit54Impl#getInput__iInitialConditions <em>Input iInitial Conditions</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit54Impl#getInput__iPinState <em>Input iPin State</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit54Impl#getOutput__oLockingOrder <em>Output oLocking Order</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit54Impl extends wtcImpl implements CtrlUnit54 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit54();
	}
		...
		if (input__iSafety != null && input__iSafety.eIsProxy()) {
			...
			if (input__iSafety != oldInput__iSafety) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT54__INPUT_ISAFETY, oldInput__iSafety, input__iSafety));
			}
		}
	...
	public void setInput__iSafety(WTCInput newInput__iSafety) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT54__INPUT_ISAFETY, oldInput__iSafety, input__iSafety));
	}
	...
	public WTCInput getInput__iLockingOrderSelected() {
		if (input__iLockingOrderSelected != null && input__iLockingOrderSelected.eIsProxy()) {
			...
			if (input__iLockingOrderSelected != oldInput__iLockingOrderSelected) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT54__INPUT_ILOCKING_ORDER_SELECTED, oldInput__iLockingOrderSelected, input__iLockingOrderSelected));
			}
		}
	...
	public void setInput__iLockingOrderSelected(WTCInput newInput__iLockingOrderSelected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT54__INPUT_ILOCKING_ORDER_SELECTED, oldInput__iLockingOrderSelected, input__iLockingOrderSelected));
	}
	...
	public WTCInput getInput__iMachineStateL() {
		if (input__iMachineStateL != null && input__iMachineStateL.eIsProxy()) {
			...
			if (input__iMachineStateL != oldInput__iMachineStateL) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT54__INPUT_IMACHINE_STATE_L, oldInput__iMachineStateL, input__iMachineStateL));
			}
		}
	...
	public void setInput__iMachineStateL(WTCInput newInput__iMachineStateL) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT54__INPUT_IMACHINE_STATE_L, oldInput__iMachineStateL, input__iMachineStateL));
	}
	...
	public WTCInput getInput__iMachineStateU() {
		if (input__iMachineStateU != null && input__iMachineStateU.eIsProxy()) {
			...
			if (input__iMachineStateU != oldInput__iMachineStateU) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT54__INPUT_IMACHINE_STATE_U, oldInput__iMachineStateU, input__iMachineStateU));
			}
		}
	...
	public void setInput__iMachineStateU(WTCInput newInput__iMachineStateU) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT54__INPUT_IMACHINE_STATE_U, oldInput__iMachineStateU, input__iMachineStateU));
	}
	...
	public WTCInput getInput__iMachineStateS() {
		if (input__iMachineStateS != null && input__iMachineStateS.eIsProxy()) {
			...
			if (input__iMachineStateS != oldInput__iMachineStateS) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT54__INPUT_IMACHINE_STATE_S, oldInput__iMachineStateS, input__iMachineStateS));
			}
		}
	...
	public void setInput__iMachineStateS(WTCInput newInput__iMachineStateS) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT54__INPUT_IMACHINE_STATE_S, oldInput__iMachineStateS, input__iMachineStateS));
	}
	...
	public WTCInput getInput__iInitialConditions() {
		if (input__iInitialConditions != null && input__iInitialConditions.eIsProxy()) {
			...
			if (input__iInitialConditions != oldInput__iInitialConditions) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT54__INPUT_IINITIAL_CONDITIONS, oldInput__iInitialConditions, input__iInitialConditions));
			}
		}
	...
	public void setInput__iInitialConditions(WTCInput newInput__iInitialConditions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT54__INPUT_IINITIAL_CONDITIONS, oldInput__iInitialConditions, input__iInitialConditions));
	}
	...
	public WTCInput getInput__iPinState() {
		if (input__iPinState != null && input__iPinState.eIsProxy()) {
			...
			if (input__iPinState != oldInput__iPinState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT54__INPUT_IPIN_STATE, oldInput__iPinState, input__iPinState));
			}
		}
	...
	public void setInput__iPinState(WTCInput newInput__iPinState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT54__INPUT_IPIN_STATE, oldInput__iPinState, input__iPinState));
	}
	...
	public WTCOutput getOutput__oLockingOrder() {
		if (output__oLockingOrder != null && output__oLockingOrder.eIsProxy()) {
			...
			if (output__oLockingOrder != oldOutput__oLockingOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT54__OUTPUT_OLOCKING_ORDER, oldOutput__oLockingOrder, output__oLockingOrder));
			}
		}
	...
	public void setOutput__oLockingOrder(WTCOutput newOutput__oLockingOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT54__OUTPUT_OLOCKING_ORDER, oldOutput__oLockingOrder, output__oLockingOrder));
	}

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit102Impl#getInput__iOriginalStatus <em>Input iOriginal Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit102Impl#getInput__iResetRequest <em>Input iReset Request</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit102Impl#getOutput__oFilteredStatus <em>Output oFiltered Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit102Impl#getFault__fFault <em>Fault fFault</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit102Impl extends wtcImpl implements CtrlUnit102 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit102();
	}
		...
		if (input__iOriginalStatus != null && input__iOriginalStatus.eIsProxy()) {
			...
			if (input__iOriginalStatus != oldInput__iOriginalStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT102__INPUT_IORIGINAL_STATUS, oldInput__iOriginalStatus, input__iOriginalStatus));
			}
		}
	...
	public void setInput__iOriginalStatus(WTCInput newInput__iOriginalStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT102__INPUT_IORIGINAL_STATUS, oldInput__iOriginalStatus, input__iOriginalStatus));
	}
	...
	public WTCInput getInput__iResetRequest() {
		if (input__iResetRequest != null && input__iResetRequest.eIsProxy()) {
			...
			if (input__iResetRequest != oldInput__iResetRequest) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT102__INPUT_IRESET_REQUEST, oldInput__iResetRequest, input__iResetRequest));
			}
		}
	...
	public void setInput__iResetRequest(WTCInput newInput__iResetRequest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT102__INPUT_IRESET_REQUEST, oldInput__iResetRequest, input__iResetRequest));
	}
	...
	public WTCOutput getOutput__oFilteredStatus() {
		if (output__oFilteredStatus != null && output__oFilteredStatus.eIsProxy()) {
			...
			if (output__oFilteredStatus != oldOutput__oFilteredStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT102__OUTPUT_OFILTERED_STATUS, oldOutput__oFilteredStatus, output__oFilteredStatus));
			}
		}
	...
	public void setOutput__oFilteredStatus(WTCOutput newOutput__oFilteredStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT102__OUTPUT_OFILTERED_STATUS, oldOutput__oFilteredStatus, output__oFilteredStatus));
	}
	...
	public WTCFault getFault__fFault() {
		if (fault__fFault != null && fault__fFault.eIsProxy()) {
			...
			if (fault__fFault != oldFault__fFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT102__FAULT_FFAULT, oldFault__fFault, fault__fFault));
			}
		}
	...
	public void setFault__fFault(WTCFault newFault__fFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT102__FAULT_FFAULT, oldFault__fFault, fault__fFault));
	}

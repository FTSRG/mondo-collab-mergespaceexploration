 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit45Impl#getInput__iInput <em>Input iInput</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit45Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit45Impl#getBhvParam__bpType <em>Bhv Param bp Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit45Impl extends wtcImpl implements CtrlUnit45 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit45();
	}
		...
		if (input__iInput != null && input__iInput.eIsProxy()) {
			...
			if (input__iInput != oldInput__iInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT45__INPUT_IINPUT, oldInput__iInput, input__iInput));
			}
		}
	...
	public void setInput__iInput(WTCInput newInput__iInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT45__INPUT_IINPUT, oldInput__iInput, input__iInput));
	}
	...
	public WTCOutput getOutput__oOutput() {
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT45__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT45__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public void setBhvParam__bpType(String newBhvParam__bpType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT45__BHV_PARAM_BP_TYPE, oldBhvParam__bpType, bhvParam__bpType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT45__INPUT_IINPUT:
				if (resolve) return getInput__iInput();
				return basicGetInput__iInput();
			case WtspecidPackage.CTRL_UNIT45__OUTPUT_OOUTPUT:
				if (resolve) return getOutput__oOutput();
				return basicGetOutput__oOutput();
			case WtspecidPackage.CTRL_UNIT45__BHV_PARAM_BP_TYPE:

 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit67Impl#getInput__iHMIOrder <em>Input iHMI Order</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit67Impl#getInput__iElementStatus <em>Input iElement Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit67Impl#getInput__iMasterPos <em>Input iMaster Pos</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit67Impl#getOutput__oElementRol <em>Output oElement Rol</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit67Impl#getParameter__pMaxElements <em>Parameter pMax Elements</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit67Impl#getBhvParam__bpMode <em>Bhv Param bp Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit67Impl extends wtcImpl implements CtrlUnit67 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit67();
	}
		...
		if (input__iHMIOrder != null && input__iHMIOrder.eIsProxy()) {
			...
			if (input__iHMIOrder != oldInput__iHMIOrder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT67__INPUT_IHMI_ORDER, oldInput__iHMIOrder, input__iHMIOrder));
			}
		}
	...
	public void setInput__iHMIOrder(WTCInput newInput__iHMIOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT67__INPUT_IHMI_ORDER, oldInput__iHMIOrder, input__iHMIOrder));
	}
	...
	public WTCInput getInput__iElementStatus() {
		if (input__iElementStatus != null && input__iElementStatus.eIsProxy()) {
			...
			if (input__iElementStatus != oldInput__iElementStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT67__INPUT_IELEMENT_STATUS, oldInput__iElementStatus, input__iElementStatus));
			}
		}
	...
	public void setInput__iElementStatus(WTCInput newInput__iElementStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT67__INPUT_IELEMENT_STATUS, oldInput__iElementStatus, input__iElementStatus));
	}
	...
	public WTCInput getInput__iMasterPos() {
		if (input__iMasterPos != null && input__iMasterPos.eIsProxy()) {
			...
			if (input__iMasterPos != oldInput__iMasterPos) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT67__INPUT_IMASTER_POS, oldInput__iMasterPos, input__iMasterPos));
			}
		}
	...
	public void setInput__iMasterPos(WTCInput newInput__iMasterPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT67__INPUT_IMASTER_POS, oldInput__iMasterPos, input__iMasterPos));
	}
	...
	public WTCOutput getOutput__oElementRol() {
		if (output__oElementRol != null && output__oElementRol.eIsProxy()) {
			...
			if (output__oElementRol != oldOutput__oElementRol) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT67__OUTPUT_OELEMENT_ROL, oldOutput__oElementRol, output__oElementRol));
			}
		}
	...
	public void setOutput__oElementRol(WTCOutput newOutput__oElementRol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT67__OUTPUT_OELEMENT_ROL, oldOutput__oElementRol, output__oElementRol));
	}
	...
	public WTCParam getParameter__pMaxElements() {
		if (parameter__pMaxElements != null && parameter__pMaxElements.eIsProxy()) {
			...
			if (parameter__pMaxElements != oldParameter__pMaxElements) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT67__PARAMETER_PMAX_ELEMENTS, oldParameter__pMaxElements, parameter__pMaxElements));
			}
		}
	...
	public void setParameter__pMaxElements(WTCParam newParameter__pMaxElements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT67__PARAMETER_PMAX_ELEMENTS, oldParameter__pMaxElements, parameter__pMaxElements));
	}
	...
	public void setBhvParam__bpMode(String newBhvParam__bpMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT67__BHV_PARAM_BP_MODE, oldBhvParam__bpMode, bhvParam__bpMode));
	}

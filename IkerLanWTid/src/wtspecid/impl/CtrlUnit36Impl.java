 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit36Impl#getInput__i1 <em>Input i1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit36Impl#getOutput__o1 <em>Output o1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit36Impl#getParameter__pDelayOn <em>Parameter pDelay On</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit36Impl#getParameter__pDelayOff <em>Parameter pDelay Off</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit36Impl extends wtcImpl implements CtrlUnit36 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit36();
	}
		...
		if (input__i1 != null && input__i1.eIsProxy()) {
			...
			if (input__i1 != oldInput__i1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT36__INPUT_I1, oldInput__i1, input__i1));
			}
		}
		return input__i1;
	}
	...
	public void setInput__i1(WTCInput newInput__i1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT36__INPUT_I1, oldInput__i1, input__i1));
	}
	...
	public WTCOutput getOutput__o1() {
		if (output__o1 != null && output__o1.eIsProxy()) {
			...
			if (output__o1 != oldOutput__o1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT36__OUTPUT_O1, oldOutput__o1, output__o1));
			}
		}
		return output__o1;
	}
	...
	public void setOutput__o1(WTCOutput newOutput__o1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT36__OUTPUT_O1, oldOutput__o1, output__o1));
	}
	...
	public WTCParam getParameter__pDelayOn() {
		if (parameter__pDelayOn != null && parameter__pDelayOn.eIsProxy()) {
			...
			if (parameter__pDelayOn != oldParameter__pDelayOn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT36__PARAMETER_PDELAY_ON, oldParameter__pDelayOn, parameter__pDelayOn));
			}
		}
	...
	public void setParameter__pDelayOn(WTCParam newParameter__pDelayOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT36__PARAMETER_PDELAY_ON, oldParameter__pDelayOn, parameter__pDelayOn));
	}
	...
	public WTCParam getParameter__pDelayOff() {
		if (parameter__pDelayOff != null && parameter__pDelayOff.eIsProxy()) {
			...
			if (parameter__pDelayOff != oldParameter__pDelayOff) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT36__PARAMETER_PDELAY_OFF, oldParameter__pDelayOff, parameter__pDelayOff));
			}
		}
	...
	public void setParameter__pDelayOff(WTCParam newParameter__pDelayOff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT36__PARAMETER_PDELAY_OFF, oldParameter__pDelayOff, parameter__pDelayOff));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT36__INPUT_I1:
				if (resolve) return getInput__i1();
				return basicGetInput__i1();
			case WtspecidPackage.CTRL_UNIT36__OUTPUT_O1:
				if (resolve) return getOutput__o1();
				return basicGetOutput__o1();
			case WtspecidPackage.CTRL_UNIT36__PARAMETER_PDELAY_ON:
				if (resolve) return getParameter__pDelayOn();
				return basicGetParameter__pDelayOn();
			case WtspecidPackage.CTRL_UNIT36__PARAMETER_PDELAY_OFF:

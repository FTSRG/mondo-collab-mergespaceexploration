 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iMaintenanceStatus <em>Input iMaintenance Status</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iFlBrakes <em>Input iFl Brakes</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iWTGStopped <em>Input iWTG Stopped</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iGridError <em>Input iGrid Error</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iReTwisting <em>Input iRe Twisting</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iHiWind <em>Input iHi Wind</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iHiGust <em>Input iHi Gust</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iLowWind <em>Input iLow Wind</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iBackWind <em>Input iBack Wind</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getInput__iEnEstela <em>Input iEn Estela</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit75Impl#getOutput__oOpcTurbineStatus <em>Output oOpc Turbine Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit75Impl extends wtcImpl implements CtrlUnit75 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit75();
	}
		...
		if (input__iMaintenanceStatus != null && input__iMaintenanceStatus.eIsProxy()) {
			...
			if (input__iMaintenanceStatus != oldInput__iMaintenanceStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_IMAINTENANCE_STATUS, oldInput__iMaintenanceStatus, input__iMaintenanceStatus));
			}
		}
	...
	public void setInput__iMaintenanceStatus(WTCInput newInput__iMaintenanceStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_IMAINTENANCE_STATUS, oldInput__iMaintenanceStatus, input__iMaintenanceStatus));
	}
	...
	public WTCInput getInput__iFlBrakes() {
		if (input__iFlBrakes != null && input__iFlBrakes.eIsProxy()) {
			...
			if (input__iFlBrakes != oldInput__iFlBrakes) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_IFL_BRAKES, oldInput__iFlBrakes, input__iFlBrakes));
			}
		}
	...
	public void setInput__iFlBrakes(WTCInput newInput__iFlBrakes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_IFL_BRAKES, oldInput__iFlBrakes, input__iFlBrakes));
	}
	...
	public WTCInput getInput__iWTGStopped() {
		if (input__iWTGStopped != null && input__iWTGStopped.eIsProxy()) {
			...
			if (input__iWTGStopped != oldInput__iWTGStopped) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_IWTG_STOPPED, oldInput__iWTGStopped, input__iWTGStopped));
			}
		}
	...
	public void setInput__iWTGStopped(WTCInput newInput__iWTGStopped) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_IWTG_STOPPED, oldInput__iWTGStopped, input__iWTGStopped));
	}
	...
	public WTCInput getInput__iGridError() {
		if (input__iGridError != null && input__iGridError.eIsProxy()) {
			...
			if (input__iGridError != oldInput__iGridError) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_IGRID_ERROR, oldInput__iGridError, input__iGridError));
			}
		}
	...
	public void setInput__iGridError(WTCInput newInput__iGridError) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_IGRID_ERROR, oldInput__iGridError, input__iGridError));
	}
	...
	public WTCInput getInput__iReTwisting() {
		if (input__iReTwisting != null && input__iReTwisting.eIsProxy()) {
			...
			if (input__iReTwisting != oldInput__iReTwisting) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_IRE_TWISTING, oldInput__iReTwisting, input__iReTwisting));
			}
		}
	...
	public void setInput__iReTwisting(WTCInput newInput__iReTwisting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_IRE_TWISTING, oldInput__iReTwisting, input__iReTwisting));
	}
	...
	public WTCInput getInput__iHiWind() {
		if (input__iHiWind != null && input__iHiWind.eIsProxy()) {
			...
			if (input__iHiWind != oldInput__iHiWind) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_IHI_WIND, oldInput__iHiWind, input__iHiWind));
			}
		}
	...
	public void setInput__iHiWind(WTCInput newInput__iHiWind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_IHI_WIND, oldInput__iHiWind, input__iHiWind));
	}
	...
	public WTCInput getInput__iHiGust() {
		if (input__iHiGust != null && input__iHiGust.eIsProxy()) {
			...
			if (input__iHiGust != oldInput__iHiGust) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_IHI_GUST, oldInput__iHiGust, input__iHiGust));
			}
		}
	...
	public void setInput__iHiGust(WTCInput newInput__iHiGust) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_IHI_GUST, oldInput__iHiGust, input__iHiGust));
	}
	...
	public WTCInput getInput__iLowWind() {
		if (input__iLowWind != null && input__iLowWind.eIsProxy()) {
			...
			if (input__iLowWind != oldInput__iLowWind) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_ILOW_WIND, oldInput__iLowWind, input__iLowWind));
			}
		}
	...
	public void setInput__iLowWind(WTCInput newInput__iLowWind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_ILOW_WIND, oldInput__iLowWind, input__iLowWind));
	}
	...
	public WTCInput getInput__iBackWind() {
		if (input__iBackWind != null && input__iBackWind.eIsProxy()) {
			...
			if (input__iBackWind != oldInput__iBackWind) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_IBACK_WIND, oldInput__iBackWind, input__iBackWind));
			}
		}
	...
	public void setInput__iBackWind(WTCInput newInput__iBackWind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_IBACK_WIND, oldInput__iBackWind, input__iBackWind));
	}
	...
	public WTCInput getInput__iEnEstela() {
		if (input__iEnEstela != null && input__iEnEstela.eIsProxy()) {
			...
			if (input__iEnEstela != oldInput__iEnEstela) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__INPUT_IEN_ESTELA, oldInput__iEnEstela, input__iEnEstela));
			}
		}
	...
	public void setInput__iEnEstela(WTCInput newInput__iEnEstela) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__INPUT_IEN_ESTELA, oldInput__iEnEstela, input__iEnEstela));
	}
	...
	public WTCOutput getOutput__oOpcTurbineStatus() {
		if (output__oOpcTurbineStatus != null && output__oOpcTurbineStatus.eIsProxy()) {
			...
			if (output__oOpcTurbineStatus != oldOutput__oOpcTurbineStatus) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT75__OUTPUT_OOPC_TURBINE_STATUS, oldOutput__oOpcTurbineStatus, output__oOpcTurbineStatus));
			}
		}
	...
	public void setOutput__oOpcTurbineStatus(WTCOutput newOutput__oOpcTurbineStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT75__OUTPUT_OOPC_TURBINE_STATUS, oldOutput__oOpcTurbineStatus, output__oOpcTurbineStatus));
	}

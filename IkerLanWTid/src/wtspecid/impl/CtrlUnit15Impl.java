 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit15Impl#getInput__iInput <em>Input iInput</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit15Impl#getOutput__oOutput <em>Output oOutput</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit15Impl#getParameter__pMask <em>Parameter pMask</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit15Impl extends wtcImpl implements CtrlUnit15 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit15();
	}
		...
		if (input__iInput != null && input__iInput.eIsProxy()) {
			...
			if (input__iInput != oldInput__iInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT15__INPUT_IINPUT, oldInput__iInput, input__iInput));
			}
		}
	...
	public void setInput__iInput(WTCInput newInput__iInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT15__INPUT_IINPUT, oldInput__iInput, input__iInput));
	}
	...
	public WTCOutput getOutput__oOutput() {
		if (output__oOutput != null && output__oOutput.eIsProxy()) {
			...
			if (output__oOutput != oldOutput__oOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT15__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
			}
		}
	...
	public void setOutput__oOutput(WTCOutput newOutput__oOutput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT15__OUTPUT_OOUTPUT, oldOutput__oOutput, output__oOutput));
	}
	...
	public WTCParam getParameter__pMask() {
		if (parameter__pMask != null && parameter__pMask.eIsProxy()) {
			...
			if (parameter__pMask != oldParameter__pMask) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT15__PARAMETER_PMASK, oldParameter__pMask, parameter__pMask));
			}
		}
	...
	public void setParameter__pMask(WTCParam newParameter__pMask) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT15__PARAMETER_PMASK, oldParameter__pMask, parameter__pMask));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT15__INPUT_IINPUT:
				if (resolve) return getInput__iInput();
				return basicGetInput__iInput();
			case WtspecidPackage.CTRL_UNIT15__OUTPUT_OOUTPUT:
				if (resolve) return getOutput__oOutput();
				return basicGetOutput__oOutput();
			case WtspecidPackage.CTRL_UNIT15__PARAMETER_PMASK:

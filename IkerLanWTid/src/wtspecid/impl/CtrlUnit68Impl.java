 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit68Impl#getInput__iValue1 <em>Input iValue1</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit68Impl#getInput__iValue2 <em>Input iValue2</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit68Impl#getOutput__oResult <em>Output oResult</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit68Impl#getBhvParam__bpOperationType <em>Bhv Param bp Operation Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit68Impl extends wtcImpl implements CtrlUnit68 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit68();
	}
		...
		if (input__iValue1 != null && input__iValue1.eIsProxy()) {
			...
			if (input__iValue1 != oldInput__iValue1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT68__INPUT_IVALUE1, oldInput__iValue1, input__iValue1));
			}
		}
	...
	public void setInput__iValue1(WTCInput newInput__iValue1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT68__INPUT_IVALUE1, oldInput__iValue1, input__iValue1));
	}
	...
	public WTCInput getInput__iValue2() {
		if (input__iValue2 != null && input__iValue2.eIsProxy()) {
			...
			if (input__iValue2 != oldInput__iValue2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT68__INPUT_IVALUE2, oldInput__iValue2, input__iValue2));
			}
		}
	...
	public void setInput__iValue2(WTCInput newInput__iValue2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT68__INPUT_IVALUE2, oldInput__iValue2, input__iValue2));
	}
	...
	public WTCOutput getOutput__oResult() {
		if (output__oResult != null && output__oResult.eIsProxy()) {
			...
			if (output__oResult != oldOutput__oResult) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT68__OUTPUT_ORESULT, oldOutput__oResult, output__oResult));
			}
		}
	...
	public void setOutput__oResult(WTCOutput newOutput__oResult) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT68__OUTPUT_ORESULT, oldOutput__oResult, output__oResult));
	}
	...
	public void setBhvParam__bpOperationType(String newBhvParam__bpOperationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT68__BHV_PARAM_BP_OPERATION_TYPE, oldBhvParam__bpOperationType, bhvParam__bpOperationType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.CTRL_UNIT68__INPUT_IVALUE1:
				if (resolve) return getInput__iValue1();
				return basicGetInput__iValue1();
			case WtspecidPackage.CTRL_UNIT68__INPUT_IVALUE2:
				if (resolve) return getInput__iValue2();
				return basicGetInput__iValue2();
			case WtspecidPackage.CTRL_UNIT68__OUTPUT_ORESULT:
				if (resolve) return getOutput__oResult();
				return basicGetOutput__oResult();
			case WtspecidPackage.CTRL_UNIT68__BHV_PARAM_BP_OPERATION_TYPE:

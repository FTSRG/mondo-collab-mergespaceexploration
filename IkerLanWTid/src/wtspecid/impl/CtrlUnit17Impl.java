 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit17Impl#getParameter__pParam <em>Parameter pParam</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit17Impl#getFault__fWarning <em>Fault fWarning</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit17Impl#getFault__fFault <em>Fault fFault</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit17Impl#getTimer__tTimer <em>Timer tTimer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit17Impl extends wtcImpl implements CtrlUnit17 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit17();
	}
		...
		if (parameter__pParam != null && parameter__pParam.eIsProxy()) {
			...
			if (parameter__pParam != oldParameter__pParam) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT17__PARAMETER_PPARAM, oldParameter__pParam, parameter__pParam));
			}
		}
	...
	public void setParameter__pParam(WTCParam newParameter__pParam) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT17__PARAMETER_PPARAM, oldParameter__pParam, parameter__pParam));
	}
	...
	public WTCFault getFault__fWarning() {
		if (fault__fWarning != null && fault__fWarning.eIsProxy()) {
			...
			if (fault__fWarning != oldFault__fWarning) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT17__FAULT_FWARNING, oldFault__fWarning, fault__fWarning));
			}
		}
	...
	public void setFault__fWarning(WTCFault newFault__fWarning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT17__FAULT_FWARNING, oldFault__fWarning, fault__fWarning));
	}
	...
	public WTCFault getFault__fFault() {
		if (fault__fFault != null && fault__fFault.eIsProxy()) {
			...
			if (fault__fFault != oldFault__fFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT17__FAULT_FFAULT, oldFault__fFault, fault__fFault));
			}
		}
	...
	public void setFault__fFault(WTCFault newFault__fFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT17__FAULT_FFAULT, oldFault__fFault, fault__fFault));
	}
	...
	public WTCTimer getTimer__tTimer() {
		if (timer__tTimer != null && timer__tTimer.eIsProxy()) {
			...
			if (timer__tTimer != oldTimer__tTimer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT17__TIMER_TTIMER, oldTimer__tTimer, timer__tTimer));
			}
		}
	...
	public void setTimer__tTimer(WTCTimer newTimer__tTimer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT17__TIMER_TTIMER, oldTimer__tTimer, timer__tTimer));
	}

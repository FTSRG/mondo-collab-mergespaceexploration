 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getInput__iMachineStatusIndicator <em>Input iMachine Status Indicator</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getInput__iStopConditionIndicator <em>Input iStop Condition Indicator</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getInput__iManualByPass <em>Input iManual By Pass</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getInput__iMotorizing <em>Input iMotorizing</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getInput__iFlagIntoWind <em>Input iFlag Into Wind</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getInput__iProtectionCondition <em>Input iProtection Condition</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getInput__iEmergencyCondition <em>Input iEmergency Condition</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getInput__iDeenergizeCondition <em>Input iDeenergize Condition</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getOutput__oAutoStopCommand <em>Output oAuto Stop Command</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getFault__fRunFault <em>Fault fRun Fault</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getTimer__tStartDelay <em>Timer tStart Delay</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getTimer__tCheckRunFault <em>Timer tCheck Run Fault</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit53Impl#getErrorReaction__erMotorizing <em>Error Reaction er Motorizing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit53Impl extends wtcImpl implements CtrlUnit53 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit53();
	}
		...
		if (input__iMachineStatusIndicator != null && input__iMachineStatusIndicator.eIsProxy()) {
			...
			if (input__iMachineStatusIndicator != oldInput__iMachineStatusIndicator) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__INPUT_IMACHINE_STATUS_INDICATOR, oldInput__iMachineStatusIndicator, input__iMachineStatusIndicator));
			}
		}
	...
	public void setInput__iMachineStatusIndicator(WTCInput newInput__iMachineStatusIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__INPUT_IMACHINE_STATUS_INDICATOR, oldInput__iMachineStatusIndicator, input__iMachineStatusIndicator));
	}
	...
	public WTCInput getInput__iStopConditionIndicator() {
		if (input__iStopConditionIndicator != null && input__iStopConditionIndicator.eIsProxy()) {
			...
			if (input__iStopConditionIndicator != oldInput__iStopConditionIndicator) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__INPUT_ISTOP_CONDITION_INDICATOR, oldInput__iStopConditionIndicator, input__iStopConditionIndicator));
			}
		}
	...
	public void setInput__iStopConditionIndicator(WTCInput newInput__iStopConditionIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__INPUT_ISTOP_CONDITION_INDICATOR, oldInput__iStopConditionIndicator, input__iStopConditionIndicator));
	}
	...
	public WTCInput getInput__iManualByPass() {
		if (input__iManualByPass != null && input__iManualByPass.eIsProxy()) {
			...
			if (input__iManualByPass != oldInput__iManualByPass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__INPUT_IMANUAL_BY_PASS, oldInput__iManualByPass, input__iManualByPass));
			}
		}
	...
	public void setInput__iManualByPass(WTCInput newInput__iManualByPass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__INPUT_IMANUAL_BY_PASS, oldInput__iManualByPass, input__iManualByPass));
	}
	...
	public WTCInput getInput__iMotorizing() {
		if (input__iMotorizing != null && input__iMotorizing.eIsProxy()) {
			...
			if (input__iMotorizing != oldInput__iMotorizing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__INPUT_IMOTORIZING, oldInput__iMotorizing, input__iMotorizing));
			}
		}
	...
	public void setInput__iMotorizing(WTCInput newInput__iMotorizing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__INPUT_IMOTORIZING, oldInput__iMotorizing, input__iMotorizing));
	}
	...
	public WTCInput getInput__iFlagIntoWind() {
		if (input__iFlagIntoWind != null && input__iFlagIntoWind.eIsProxy()) {
			...
			if (input__iFlagIntoWind != oldInput__iFlagIntoWind) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__INPUT_IFLAG_INTO_WIND, oldInput__iFlagIntoWind, input__iFlagIntoWind));
			}
		}
	...
	public void setInput__iFlagIntoWind(WTCInput newInput__iFlagIntoWind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__INPUT_IFLAG_INTO_WIND, oldInput__iFlagIntoWind, input__iFlagIntoWind));
	}
	...
	public WTCInput getInput__iProtectionCondition() {
		if (input__iProtectionCondition != null && input__iProtectionCondition.eIsProxy()) {
			...
			if (input__iProtectionCondition != oldInput__iProtectionCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__INPUT_IPROTECTION_CONDITION, oldInput__iProtectionCondition, input__iProtectionCondition));
			}
		}
	...
	public void setInput__iProtectionCondition(WTCInput newInput__iProtectionCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__INPUT_IPROTECTION_CONDITION, oldInput__iProtectionCondition, input__iProtectionCondition));
	}
	...
	public WTCInput getInput__iEmergencyCondition() {
		if (input__iEmergencyCondition != null && input__iEmergencyCondition.eIsProxy()) {
			...
			if (input__iEmergencyCondition != oldInput__iEmergencyCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__INPUT_IEMERGENCY_CONDITION, oldInput__iEmergencyCondition, input__iEmergencyCondition));
			}
		}
	...
	public void setInput__iEmergencyCondition(WTCInput newInput__iEmergencyCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__INPUT_IEMERGENCY_CONDITION, oldInput__iEmergencyCondition, input__iEmergencyCondition));
	}
	...
	public WTCInput getInput__iDeenergizeCondition() {
		if (input__iDeenergizeCondition != null && input__iDeenergizeCondition.eIsProxy()) {
			...
			if (input__iDeenergizeCondition != oldInput__iDeenergizeCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__INPUT_IDEENERGIZE_CONDITION, oldInput__iDeenergizeCondition, input__iDeenergizeCondition));
			}
		}
	...
	public void setInput__iDeenergizeCondition(WTCInput newInput__iDeenergizeCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__INPUT_IDEENERGIZE_CONDITION, oldInput__iDeenergizeCondition, input__iDeenergizeCondition));
	}
	...
	public WTCOutput getOutput__oAutoStopCommand() {
		if (output__oAutoStopCommand != null && output__oAutoStopCommand.eIsProxy()) {
			...
			if (output__oAutoStopCommand != oldOutput__oAutoStopCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__OUTPUT_OAUTO_STOP_COMMAND, oldOutput__oAutoStopCommand, output__oAutoStopCommand));
			}
		}
	...
	public void setOutput__oAutoStopCommand(WTCOutput newOutput__oAutoStopCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__OUTPUT_OAUTO_STOP_COMMAND, oldOutput__oAutoStopCommand, output__oAutoStopCommand));
	}
	...
	public WTCFault getFault__fRunFault() {
		if (fault__fRunFault != null && fault__fRunFault.eIsProxy()) {
			...
			if (fault__fRunFault != oldFault__fRunFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__FAULT_FRUN_FAULT, oldFault__fRunFault, fault__fRunFault));
			}
		}
	...
	public void setFault__fRunFault(WTCFault newFault__fRunFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__FAULT_FRUN_FAULT, oldFault__fRunFault, fault__fRunFault));
	}
	...
	public WTCTimer getTimer__tStartDelay() {
		if (timer__tStartDelay != null && timer__tStartDelay.eIsProxy()) {
			...
			if (timer__tStartDelay != oldTimer__tStartDelay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__TIMER_TSTART_DELAY, oldTimer__tStartDelay, timer__tStartDelay));
			}
		}
	...
	public void setTimer__tStartDelay(WTCTimer newTimer__tStartDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__TIMER_TSTART_DELAY, oldTimer__tStartDelay, timer__tStartDelay));
	}
	...
	public WTCTimer getTimer__tCheckRunFault() {
		if (timer__tCheckRunFault != null && timer__tCheckRunFault.eIsProxy()) {
			...
			if (timer__tCheckRunFault != oldTimer__tCheckRunFault) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__TIMER_TCHECK_RUN_FAULT, oldTimer__tCheckRunFault, timer__tCheckRunFault));
			}
		}
	...
	public void setTimer__tCheckRunFault(WTCTimer newTimer__tCheckRunFault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__TIMER_TCHECK_RUN_FAULT, oldTimer__tCheckRunFault, timer__tCheckRunFault));
	}
	...
	public WTCErrorReaction getErrorReaction__erMotorizing() {
		if (errorReaction__erMotorizing != null && errorReaction__erMotorizing.eIsProxy()) {
			...
			if (errorReaction__erMotorizing != oldErrorReaction__erMotorizing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT53__ERROR_REACTION_ER_MOTORIZING, oldErrorReaction__erMotorizing, errorReaction__erMotorizing));
			}
		}
	...
	public void setErrorReaction__erMotorizing(WTCErrorReaction newErrorReaction__erMotorizing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT53__ERROR_REACTION_ER_MOTORIZING, oldErrorReaction__erMotorizing, errorReaction__erMotorizing));
	}

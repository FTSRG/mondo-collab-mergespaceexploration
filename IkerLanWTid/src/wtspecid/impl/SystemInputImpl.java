 ...
 * <ul>
 *   <li>{@link wtspecid.impl.SystemInputImpl#getSysId <em>Sys Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemInputImpl extends WTCInputImpl implements SystemInput {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getSystemInput();
	}
	...
	public void setSysId(String newSysId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.SYSTEM_INPUT__SYS_ID, oldSysId, sysId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WtspecidPackage.SYSTEM_INPUT__SYS_ID:
				return getSysId();
		}

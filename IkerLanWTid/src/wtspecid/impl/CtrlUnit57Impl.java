 ...
 * <ul>
 *   <li>{@link wtspecid.impl.CtrlUnit57Impl#getInput__iUp <em>Input iUp</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit57Impl#getInput__iDown <em>Input iDown</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit57Impl#getOutput__oAnalogOut <em>Output oAnalog Out</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit57Impl#getParameter__pParam <em>Parameter pParam</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit57Impl#getParameter__pMax <em>Parameter pMax</em>}</li>
 *   <li>{@link wtspecid.impl.CtrlUnit57Impl#getParameter__pMin <em>Parameter pMin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CtrlUnit57Impl extends wtcImpl implements CtrlUnit57 {
	...
	protected EClass eStaticClass() {
		return WtspecidPackage.eINSTANCE.getCtrlUnit57();
	}
		...
		if (input__iUp != null && input__iUp.eIsProxy()) {
			...
			if (input__iUp != oldInput__iUp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT57__INPUT_IUP, oldInput__iUp, input__iUp));
			}
		}
		return input__iUp;
	}
	...
	public void setInput__iUp(WTCInput newInput__iUp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT57__INPUT_IUP, oldInput__iUp, input__iUp));
	}
	...
	public WTCInput getInput__iDown() {
		if (input__iDown != null && input__iDown.eIsProxy()) {
			...
			if (input__iDown != oldInput__iDown) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT57__INPUT_IDOWN, oldInput__iDown, input__iDown));
			}
		}
		return input__iDown;
	}
	...
	public void setInput__iDown(WTCInput newInput__iDown) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT57__INPUT_IDOWN, oldInput__iDown, input__iDown));
	}
	...
	public WTCOutput getOutput__oAnalogOut() {
		if (output__oAnalogOut != null && output__oAnalogOut.eIsProxy()) {
			...
			if (output__oAnalogOut != oldOutput__oAnalogOut) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT57__OUTPUT_OANALOG_OUT, oldOutput__oAnalogOut, output__oAnalogOut));
			}
		}
	...
	public void setOutput__oAnalogOut(WTCOutput newOutput__oAnalogOut) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT57__OUTPUT_OANALOG_OUT, oldOutput__oAnalogOut, output__oAnalogOut));
	}
	...
	public WTCParam getParameter__pParam() {
		if (parameter__pParam != null && parameter__pParam.eIsProxy()) {
			...
			if (parameter__pParam != oldParameter__pParam) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT57__PARAMETER_PPARAM, oldParameter__pParam, parameter__pParam));
			}
		}
	...
	public void setParameter__pParam(WTCParam newParameter__pParam) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT57__PARAMETER_PPARAM, oldParameter__pParam, parameter__pParam));
	}
	...
	public WTCParam getParameter__pMax() {
		if (parameter__pMax != null && parameter__pMax.eIsProxy()) {
			...
			if (parameter__pMax != oldParameter__pMax) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT57__PARAMETER_PMAX, oldParameter__pMax, parameter__pMax));
			}
		}
	...
	public void setParameter__pMax(WTCParam newParameter__pMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT57__PARAMETER_PMAX, oldParameter__pMax, parameter__pMax));
	}
	...
	public WTCParam getParameter__pMin() {
		if (parameter__pMin != null && parameter__pMin.eIsProxy()) {
			...
			if (parameter__pMin != oldParameter__pMin) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WtspecidPackage.CTRL_UNIT57__PARAMETER_PMIN, oldParameter__pMin, parameter__pMin));
			}
		}
	...
	public void setParameter__pMin(WTCParam newParameter__pMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WtspecidPackage.CTRL_UNIT57__PARAMETER_PMIN, oldParameter__pMin, parameter__pMin));
	}

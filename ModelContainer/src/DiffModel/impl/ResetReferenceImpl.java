...
public class ResetReferenceImpl extends IdentifiableImpl implements ResetReference {
	...
	protected EClass eStaticClass() {
		return DiffModelPackage.Literals.RESET_REFERENCE;
	}
	...
	public void setReference(String newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffModelPackage.RESET_REFERENCE__REFERENCE, oldReference, reference));
	}

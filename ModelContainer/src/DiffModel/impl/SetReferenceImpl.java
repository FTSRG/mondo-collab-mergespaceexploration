 ...
 * <ul>
 *   <li>{@link DiffModel.impl.SetReferenceImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link DiffModel.impl.SetReferenceImpl#getRefID <em>Ref ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetReferenceImpl extends IdentifiableImpl implements SetReference {
	...
	protected EClass eStaticClass() {
		return DiffModelPackage.Literals.SET_REFERENCE;
	}
	...
	public void setReference(String newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffModelPackage.SET_REFERENCE__REFERENCE, oldReference, reference));
	}
	...
	public void setRefID(String newRefID) {
		...
		refID = newRefID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffModelPackage.SET_REFERENCE__REF_ID, oldRefID, refID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DiffModelPackage.SET_REFERENCE__REFERENCE:
				return getReference();
			case DiffModelPackage.SET_REFERENCE__REF_ID:
				return getRefID();
		}

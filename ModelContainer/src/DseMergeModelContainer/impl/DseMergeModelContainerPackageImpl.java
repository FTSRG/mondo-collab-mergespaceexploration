...
import DseMergeModelContainer.DseMergeModelContainerFactory;
 ...
 * @generated
 */
public class DseMergeModelContainerPackageImpl extends EPackageImpl implements DseMergeModelContainerPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see DseMergeModelContainer.DseMergeModelContainerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DseMergeModelContainerPackageImpl() {
		super(eNS_URI, DseMergeModelContainerFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link DseMergeModelContainerPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DseMergeModelContainerPackage init() {
		if (isInited) return (DseMergeModelContainerPackage)EPackage.Registry.INSTANCE.getEPackage(DseMergeModelContainerPackage.eNS_URI);

		// Obtain or create and register package
		DseMergeModelContainerPackageImpl theDseMergeModelContainerPackage = (DseMergeModelContainerPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DseMergeModelContainerPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DseMergeModelContainerPackageImpl());
		...
		theDseMergeModelContainerPackage.createPackageContents();

		// Initialize created meta-data
		theDseMergeModelContainerPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theDseMergeModelContainerPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DseMergeModelContainerPackage.eNS_URI, theDseMergeModelContainerPackage);
		return theDseMergeModelContainerPackage;
	}
	 ...
	 * @generated
	 */
	public DseMergeModelContainerFactory getDseMergeModelContainerFactory() {
		return (DseMergeModelContainerFactory)getEFactoryInstance();
	}
...
} //DseMergeModelContainerPackageImpl

 ...
 * AddAttributeMatcher in a type-safe way.
 * 
...
public final class AddAttributeQuerySpecification extends
		BaseGeneratedEMFQuerySpecification<AddAttributeMatcher> {
	private AddAttributeQuerySpecification(PQuery id2object) {
	 ...
	 * 
	 */
	public static AddAttributeQuerySpecification instance()
			throws IncQueryException {
		return LazyHolder.INSTANCE;
	}

	public static AddAttributeQuerySpecification instance(PQuery id2object)
			throws IncQueryException {
		try {
	...
	@Override
	protected AddAttributeMatcher instantiate(final IncQueryEngine engine)
			throws IncQueryException {
		return AddAttributeMatcher.on(engine);
	}

	@Override
	public AddAttributeMatch newEmptyMatch() {
		return AddAttributeMatch.newEmptyMatch();
	}

	@Override
	public AddAttributeMatch newMatch(final Object... parameters) {
		return AddAttributeMatch.newMatch(
	...
	private static class LazyHolder {
		...
		private static AddAttributeQuerySpecification INSTANCE;

		public static AddAttributeQuerySpecification make(PQuery id2object) {

			return INSTANCE = new AddAttributeQuerySpecification(id2object);
		}
	}
			...
			try {
				{
					...
					PVariable var_src = body
					        .getOrCreateVariableByName("src");

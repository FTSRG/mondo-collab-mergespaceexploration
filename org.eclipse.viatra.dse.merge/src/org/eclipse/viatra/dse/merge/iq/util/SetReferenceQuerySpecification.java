 ...
 * SetReferenceMatcher in a type-safe way.
 * 
...
public final class SetReferenceQuerySpecification extends
		BaseGeneratedEMFQuerySpecification<SetReferenceMatcher> {
	private SetReferenceQuerySpecification(PQuery id2object) {
	...
	public static SetReferenceQuerySpecification instance()
			throws IncQueryException {
	...
	@Override
	protected SetReferenceMatcher instantiate(final IncQueryEngine engine)
			throws IncQueryException {
	...
	public SetReferenceMatch newMatch(final Object... parameters) {
		return SetReferenceMatch.newMatch(
	...
	private static class LazyHolder {
		...
		private static SetReferenceQuerySpecification INSTANCE;

		public static SetReferenceQuerySpecification make(
				PQuery id2object) {
			return INSTANCE = new SetReferenceQuerySpecification(id2object);
		}
	}
	...
	private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
		...
		public String getFullyQualifiedName() {
			return "org.eclipse.viatra.dse.merge.iq.setReference";
		}

...
/**
 * Generated pattern matcher API of the org.eclipse.viatra.dse.merge.iq.removeReference pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link RemoveReferenceMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * pattern removeReference(src : EObject, trg : EObject, change : Reference) {
 ...
 * @see RemoveReferenceQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class RemoveReferenceMatcher extends BaseMatcher<RemoveReferenceMatch> {
  /**
   ...
   * 
   */
  public static RemoveReferenceMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    RemoveReferenceMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new RemoveReferenceMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(RemoveReferenceMatcher.class);
   ...
   */
  @Deprecated
  public RemoveReferenceMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public RemoveReferenceMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a RemoveReferenceMatch object.
   * 
   */
  public Collection<RemoveReferenceMatch> getAllMatches(final EObject pSrc, final EObject pTrg, final Reference pChange) {
   ...
   * @param pTrg the fixed value of pattern parameter trg, or null if not bound.
   * @param pChange the fixed value of pattern parameter change, or null if not bound.
   * @return a match represented as a RemoveReferenceMatch object, or null if no match is found.
   * 
   */
  public RemoveReferenceMatch getOneArbitraryMatch(final EObject pSrc, final EObject pTrg, final Reference pChange) {
   ...
   * 
   */
  public void forEachMatch(final EObject pSrc, final EObject pTrg, final Reference pChange, final IMatchProcessor<? super RemoveReferenceMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final EObject pSrc, final EObject pTrg, final Reference pChange, final IMatchProcessor<? super RemoveReferenceMatch> processor) {
   ...
   * 
   */
  public RemoveReferenceMatch newMatch(final EObject pSrc, final EObject pTrg, final Reference pChange) {
    return RemoveReferenceMatch.newMatch(pSrc, pTrg, pChange);
  }
   ...
   * 
   */
  public Set<EObject> getAllValuesOfsrc(final RemoveReferenceMatch partialMatch) {
   ...
   * 
   */
  public Set<EObject> getAllValuesOftrg(final RemoveReferenceMatch partialMatch) {
   ...
   * 
   */
  public Set<Reference> getAllValuesOfchange(final RemoveReferenceMatch partialMatch) {
  ...
  @Override
  protected RemoveReferenceMatch tupleToMatch(final Tuple t) {
    try {
    	return RemoveReferenceMatch.newMatch((org.eclipse.emf.ecore.EObject) t.get(POSITION_SRC), (org.eclipse.emf.ecore.EObject) t.get(POSITION_TRG), (org.eclipse.viatra.dse.merge.model.Reference) t.get(POSITION_CHANGE));
  ...
  @Override
  protected RemoveReferenceMatch arrayToMatch(final Object[] match) {
    try {
    	return RemoveReferenceMatch.newMatch((org.eclipse.emf.ecore.EObject) match[POSITION_SRC], (org.eclipse.emf.ecore.EObject) match[POSITION_TRG], (org.eclipse.viatra.dse.merge.model.Reference) match[POSITION_CHANGE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected RemoveReferenceMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return RemoveReferenceMatch.newMutableMatch((org.eclipse.emf.ecore.EObject) match[POSITION_SRC], (org.eclipse.emf.ecore.EObject) match[POSITION_TRG], (org.eclipse.viatra.dse.merge.model.Reference) match[POSITION_CHANGE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<RemoveReferenceMatcher> querySpecification() throws IncQueryException {

...
/**
 * Pattern-specific match representation of the org.eclipse.viatra.dse.merge.iq.setReference pattern,
...
public abstract class SetReferenceMatch extends BasePatternMatch {
  ...
  private SetReferenceMatch(final EObject pSrc, final EObject pTrg, final Reference pChange) {
    this.fSrc = pSrc;
    this.fTrg = pTrg;
   ...
   * 
   */
  public static SetReferenceMatch newMutableMatch(final EObject pSrc, final EObject pTrg, final Reference pChange) {
   ...
   * 
   */
  public static SetReferenceMatch newMatch(final EObject pSrc, final EObject pTrg, final Reference pChange) {

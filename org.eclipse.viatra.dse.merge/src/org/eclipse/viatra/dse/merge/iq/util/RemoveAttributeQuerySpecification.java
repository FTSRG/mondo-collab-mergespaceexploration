 ...
 * RemoveAttributeMatcher in a type-safe way.
 * 
...
public final class RemoveAttributeQuerySpecification extends
		BaseGeneratedEMFQuerySpecification<RemoveAttributeMatcher> {
	private RemoveAttributeQuerySpecification(PQuery id2object) {
	...
	public static RemoveAttributeQuerySpecification instance()
			throws IncQueryException {
	...
	@Override
	protected RemoveAttributeMatcher instantiate(final IncQueryEngine engine)
			throws IncQueryException {
		return RemoveAttributeMatcher.on(engine);
	}

	@Override
	public RemoveAttributeMatch newEmptyMatch() {
		return RemoveAttributeMatch.newEmptyMatch();
	}

	@Override
	public RemoveAttributeMatch newMatch(final Object... parameters) {
		return RemoveAttributeMatch.newMatch(
	...
	private static class LazyHolder {
		...
		private static RemoveAttributeQuerySpecification INSTANCE;

		public static RemoveAttributeQuerySpecification make(
				PQuery id2object) {
			return INSTANCE = new RemoveAttributeQuerySpecification(id2object);
		}
	}

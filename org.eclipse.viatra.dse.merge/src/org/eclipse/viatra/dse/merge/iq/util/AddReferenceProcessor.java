...
/**
 * A match processor tailored for the org.eclipse.viatra.dse.merge.iq.addReference pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class AddReferenceProcessor implements IMatchProcessor<AddReferenceMatch> {
  /**
  ...
  @Override
  public void process(final AddReferenceMatch match) {

...
/**
 * A match processor tailored for the org.eclipse.viatra.dse.merge.iq.unsetReference pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class UnsetReferenceProcessor implements IMatchProcessor<UnsetReferenceMatch> {
  /**
   ...
   * 
   */
  public abstract void _process(final EObject pSrc, final Reference pChange);
  
  @Override
  public void process(final UnsetReferenceMatch match) {

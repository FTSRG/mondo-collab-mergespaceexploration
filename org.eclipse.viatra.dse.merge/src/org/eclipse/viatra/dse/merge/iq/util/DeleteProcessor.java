...
/**
 * A match processor tailored for the org.eclipse.viatra.dse.merge.iq.delete pattern.
 * 
...
public abstract class DeleteProcessor implements IMatchProcessor<DeleteMatch> {
   ...
   * 
   */
  public abstract void _process(final EObject pSrc, final Delete pChange);

...
/**
 * A match processor tailored for the org.eclipse.viatra.dse.merge.iq.addAttribute pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class AddAttributeProcessor implements IMatchProcessor<AddAttributeMatch> {
  /**
  ...
  @Override
  public void process(final AddAttributeMatch match) {
